...
%%% cascade test (A->B->C->D->E)
% ICtot_copyP1 -> IAtot
in_all = connect_SRAM(in_all,0,0,9,0); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,0,0); % groupSel, blockSel, variableSel, wireSe
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,1,12,1); % groupSel, blockSel, variableSel, wireSel
...
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,2,12,3); % groupSel, blockSel, variableSel, wireSel
...
in_all = connect_SRAM(in_all,0,3,0,4); % groupSel, blockSel, variableSel, wireSel
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,3,12,5); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,2,2,5); % groupSel, blockSel, variableSel, wireSel

% ICtot_copyP1 -> IAtot
in_all = connect_SRAM(in_all,0,3,9,6); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,0,6); % groupSel, blockSel, variableSel, wireSel
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,4,12,7); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,3,2,7); % groupSel, blockSel, variableSel, wireSel
% % ICtot_copyP1 -> ICfree
% in_all = connect_SRAM(in_all,0,4,9,8); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,4,2,8); % groupSel, blockSel, variableSel, wireSel
...
%%% fanout test (C->F->G)
% IAfree_copy2 -> IAtot
in_all = connect_SRAM(in_all,0,3,13,13); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,1,0,0,13); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyN1 -> IAtot (subtract)
in_all = connect_SRAM(in_all,1,0,7,14); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,3,0,14); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP1 -> IAtot
in_all = connect_SRAM(in_all,1,0,9,15); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,1,1,0,15); % groupSel, blockSel, variableSel, wireSel
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,1,1,12,16); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,1,0,2,16); % groupSel, blockSel, variableSel, wireSel
% % ICtot_copyP1 -> ICfree
% in_all = connect_SRAM(in_all,1,1,9,17); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,1,1,2,17); % groupSel, blockSel, variableSel, wireSel
...
in_all = connect_SRAM(in_all,0,1,13,77); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy2 to SRAM wire 78
in_all = connect_SRAM(in_all,0,2,13,78); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy1 to SRAM wire 79
in_all = connect_SRAM(in_all,1,0,12,79); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy2 to SRAM wire 80
in_all = connect_SRAM(in_all,0,4,13,80); % groupSel, blockSel, variableSel, wireSel
% connect ICtot_copyP2 to SRAM wire 81
in_all = connect_SRAM(in_all,0,4,10,81); % groupSel, blockSel, variableSel, wireSel
...
% in_all = connect_SRAM(in_all,0,3,10,82); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,1,0,10,83); % groupSel, blockSel, variableSel, wireSel
