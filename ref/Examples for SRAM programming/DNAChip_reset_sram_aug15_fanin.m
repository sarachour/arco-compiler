...
%%% Fanin test (0->A1<->B<->C->0, 0->A2<->B)
% ICtot_copyP1 -> IAtot (A1 init condition)
...
% % ICtot_copyP1 -> IAtot
% in_all = connect_SRAM(in_all,0,1,9,1); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,2,0,1); % groupSel, blockSel, variableSel, wireSel
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,2,12,2); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,1,2,2); % groupSel, blockSel, variableSel, wireSel
% % ICtot_copyP1 -> ICfree
% in_all = connect_SRAM(in_all,0,2,9,3); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,2,2,3); % groupSel, blockSel, variableSel, wireSel
% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,1,12,16); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,0,2,16); % groupSel, blockSel, variableSel, wireSel

% ICtot_copyP1 -> IAtot (A2 init condition)
in_all = connect_SRAM(in_all,0,3,9,4); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,0,4); % groupSel, blockSel, variableSel, wireSel
% Irate_fw -> ICprod
in_all = connect_SRAM(in_all,0,4,16,5); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,4,5); % groupSel, blockSel, variableSel, wireSel
% Irate_rv -> ICdeg
in_all = connect_SRAM(in_all,0,4,17,6); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,5,6); % groupSel, blockSel, variableSel, wireSel
% Irate_fw_tot -> ICprod
in_all = connect_SRAM(in_all,0,1,18,7); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,4,7); % groupSel, blockSel, variableSel, wireSel
% Irate_rv_tot -> ICdeg
in_all = connect_SRAM(in_all,0,1,19,8); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,5,8); % groupSel, blockSel, variableSel, wireSel
% Irate_fw_up1 -> ICprod
in_all = connect_SRAM(in_all,0,1,20,9); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,4,9); % groupSel, blockSel, variableSel, wireSel
% Irate_fw_up1 -> ICprod
in_all = connect_SRAM(in_all,0,4,20,10); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,3,4,10); % groupSel, blockSel, variableSel, wireSel
% Irate_rv_up1 -> ICdeg
in_all = connect_SRAM(in_all,0,4,22,13); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,3,5,13); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP2 -> ICtot_in
in_all = connect_SRAM(in_all,0,1,10,14); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,6,14); % groupSel, blockSel, variableSel, wireSel
% ICfree_copy -> ICfree
in_all = connect_SRAM(in_all,0,1,24,15); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,4,2,15); % groupSel, blockSel, variableSel, wireSel

% % IAfree_copy1 -> ICfree
% in_all = connect_SRAM(in_all,0,4,12,17); % groupSel, blockSel, variableSel, wireSel
% in_all = connect_SRAM(in_all,0,3,2,17); % groupSel, blockSel, variableSel, wireSel
...
% connect IAfree_copy2 to SRAM wire 76
in_all = connect_SRAM(in_all,0,1,13,76); % groupSel, blockSel, variableSel, wireSel
% % connect IAfree_copy2 to SRAM wire 77
% in_all = connect_SRAM(in_all,0,2,13,77); % groupSel, blockSel, variableSel, wireSel
% connect ICtot_copyP1 to SRAM wire 77
in_all = connect_SRAM(in_all,0,1,9,77); % groupSel, blockSel, variableSel, wireSel
% connect ICtot_copyP2 to SRAM wire 78
in_all = connect_SRAM(in_all,0,2,10,78); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy2 to SRAM wire 79
in_all = connect_SRAM(in_all,0,4,13,79); % groupSel, blockSel, variableSel, wireSel
% connect Irate_rv_up1 to SRAM wire 80
in_all = connect_SRAM(in_all,0,3,10,80); % groupSel, blockSel, variableSel, wireSel
% % connect ICtot_copyP2 to SRAM wire 81
% in_all = connect_SRAM(in_all,0,2,10,81); % groupSel, blockSel, variableSel, wireSel
