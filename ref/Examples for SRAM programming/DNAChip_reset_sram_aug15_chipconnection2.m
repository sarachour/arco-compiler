...
%%% Chip connection test (0->A->0)
% IAfree_copy1 -> ICfree
in_all = connect_SRAM(in_all,0,1,12,0); % groupSel, blockSel, variableSel, wireSel
...
% connect ICtot_copyP1 to SRAM wire 76
in_all = connect_SRAM(in_all,0,0,9,76); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy1 to SRAM wire 77
in_all = connect_SRAM(in_all,0,2,12,77); % groupSel, blockSel, variableSel, wireSel
% connect ICfree_copy to SRAM wire 78
in_all = connect_SRAM(in_all,0,0,24,78); % groupSel, blockSel, variableSel, wireSel
% connect IAfree_copy2 to SRAM wire 79
in_all = connect_SRAM(in_all,0,1,13,79); % groupSel, blockSel, variableSel, wireSel
% % connect IAfree_copy2 to SRAM wire 79
