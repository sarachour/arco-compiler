...
%%% dimerization test (A+A<->A^2)
% ICtot_copyN1 -> IAtot (subtract)
in_all = connect_SRAM(in_all,0,0,7,0); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,0,0); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP1 -> ICfree
...
% IAfree_copy1 -> IBtot
in_all = connect_SRAM(in_all,0,0,12,2); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,1,2); % groupSel, blockSel, variableSel, wireSel
...
in_all = connect_SRAM(in_all,0,0,13,76); % groupSel, blockSel, variableSel, wireSel
% connect IBfree_copy1 to SRAM wire 77
in_all = connect_SRAM(in_all,0,0,14,77); % groupSel, blockSel, variableSel, wireSel
% connect ICtot_copyP2 to SRAM wire 78
in_all = connect_SRAM(in_all,0,0,10,78); % groupSel, blockSel, variableSel, wireSel
