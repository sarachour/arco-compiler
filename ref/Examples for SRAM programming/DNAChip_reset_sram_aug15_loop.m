...
% IAfree_copy1 -> ICfree
in_all = connect_SRAM(in_all,0,1,12,2); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,2,2); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP1 -> IAtot
in_all = connect_SRAM(in_all,0,2,9,3); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,3,0,3); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP1 -> ICfree
in_all = connect_SRAM(in_all,0,3,9,4); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,3,2,4); % groupSel, blockSel, variableSel, wireSel
% ICtot_copyP1 -> IAtot
in_all = connect_SRAM(in_all,0,3,10,5); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,0,5); % groupSel, blockSel, variableSel, wireSel

% ICtot_copyP3 -> IAtot
in_all = connect_SRAM(in_all,0,3,11,6); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,4,6); % groupSel, blockSel, variableSel, wireSel
...
in_all = connect_SRAM(in_all,0,3,13,78); % groupSel, blockSel, variableSel, wireSel
% % connect ICtot_copyP3 to SRAM wire 79
% in_all = connect_SRAM(in_all,0,3,11,79); % groupSel, blockSel, variableSel, wireSel
