...
%%% monomerization test (A^2<->A+A)
% ICtot_copyP1 -> ICfree
in_all = connect_SRAM(in_all,0,0,9,0); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,10,0); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,2,0); % groupSel, blockSel, variableSel, wireSel
% ICfree_copy -> IDfree
in_all = connect_SRAM(in_all,0,0,24,1); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,0,3,1); % groupSel, blockSel, variableSel, wireSel
...
% in_all = connect_SRAM(in_all,0,0,11,77); % groupSel, blockSel, variableSel, wireSel
% connect IDfree_copy to SRAM wire 78
in_all = connect_SRAM(in_all,0,0,25,78); % groupSel, blockSel, variableSel, wireSel
