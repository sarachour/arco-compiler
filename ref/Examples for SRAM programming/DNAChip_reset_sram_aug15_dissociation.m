...
% Irate_fw -> ICprod
in_all = connect_SRAM(in_all,0,1,16,1); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,2,4,1); % groupSel, blockSel, variableSel, wireSe
% Irate_rv -> ICdeg
in_all = connect_SRAM(in_all,0,1,17,2); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,2,5,2); % groupSel, blockSel, variableSel, wireSe

% ICtot_copyP1 -> ICfree
in_all = connect_SRAM(in_all,0,1,9,3); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,2,3); % groupSel, blockSel, variableSel, wireSe
% ICtot_copyP1 -> IDfree
in_all = connect_SRAM(in_all,0,2,9,4); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,1,3,4); % groupSel, blockSel, variableSel, wireSe
% ICtot_copyP2 -> ICfree (for deg)
in_all = connect_SRAM(in_all,0,2,10,5); % groupSel, blockSel, variableSel, wireSel
in_all = connect_SRAM(in_all,0,2,2,5); % groupSel, blockSel, variableSel, wireSe
...
in_all = connect_SRAM(in_all,0,1,10,78); % groupSel, blockSel, variableSel, wireSel
% connect ICtot_copyP3 to SRAM wire 79
in_all = connect_SRAM(in_all,0,2,11,79); % groupSel, blockSel, variableSel, wireSel
% % connect IAfree_copy1 to SRAM wire 80
% in_all = connect_SRAM(in_all,0,2,22,80); % groupSel, blockSel, variableSel, wireSel
