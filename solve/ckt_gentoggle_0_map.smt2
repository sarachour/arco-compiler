...
; 
; =  {(((sc.vgain[12].P*0.)+of.vgain[12].P)+sl.min.vgain[12].P)} {1.51515151515e-12}
(assert (= (+ (+ (* sc_3 0.) of_3) slbot_3) 1.51515151515e-12))
; 
; =  {(((sc.vgain[12].P*103.621514368)+of.vgain[12].P)+sl.max.vgain[12].P)} {5445000.}
(assert (= (+ (+ (* sc_3 103.621514368) of_3) sltop_3) 5445000.))
(declare-fun slbot_2 () Real)
(declare-fun sltop_2 () Real)
; 
; =  {(((sc.vgain[12].Z*0.)+of.vgain[12].Z)+sl.min.vgain[12].Z)} {0.0001}
(assert (= (+ (+ (* sc_2 0.) of_2) slbot_2) 0.0001))
; 
; =  {(((sc.vgain[12].Z*103.621514368)+of.vgain[12].Z)+sl.max.vgain[12].Z)} {3300.}
...
; 
; =  {(((sc.switch[14].PROD*103.621514368)+of.switch[14].PROD)+sl.max.switch[14].PROD)} {9.9999999}
...
; 
; =  {(((sc.vadd[5].B*61.4415124065)+of.vadd[5].B)+sl.min.vadd[5].B)} {0.}
...
; 
; =  {(((sc.vadd[5].OUT*61.4415124065)+of.vadd[5].OUT)+sl.min.vadd[5].OUT)} {-1650.}
...
; 
; =  {(((sc.vtoi[11].Y*0.00965050555471)+of.vtoi[11].Y)+sl.max.vtoi[11].Y)} {3300.}
...
; 
; =  {(((sc.vtoi[11].K*103.621514368)+of.vtoi[11].K)+sl.max.vtoi[11].K)} {3300.}
...
; 
; =  {(((sc.igenebind[8].TF*0.)+of.igenebind[8].TF)+sl.min.igenebind[8].TF)} {0.0001}
(assert (= (+ (+ (* sc_93 0.) of_93) slbot_93) 0.0001))
; 
; =  {(((sc.igenebind[8].TF*0.00965050555471)+of.igenebind[8].TF)+sl.max.igenebind[8].TF)} {10.}
...
; 
; =  {(((sc.igenebind[8].GE*1.54756521331)+of.igenebind[8].GE)+sl.min.igenebind[8].GE)} {9.90099009901e-07}
(assert (= (+ (+ (* sc_96 1.54756521331) of_96) slbot_96) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[8].GE*1.5625)+of.igenebind[8].GE)+sl.max.igenebind[8].GE)} {9.9999999}
(assert (= (+ (+ (* sc_96 1.5625) of_96) sltop_96) 9.9999999))
; 
; >=  {((sc.igenebind[8].Vmax*1.5625)+of.igenebind[8].Vmax)} {10.}
(assert (<= (+ (* sc_95 1.5625) of_95) 10.))
; 
; <=  {((sc.igenebind[8].Vmax*1.5625)+of.igenebind[8].Vmax)} {0.0001}
...
(assert (= of_100 0.))
; 
; >=  {((sc.igenebind[6].TF*1.)+of.igenebind[6].TF)} {10.}
(assert (<= (+ (* sc_97 1.) of_97) 10.))
; 
; <=  {((sc.igenebind[6].TF*1.)+of.igenebind[6].TF)} {0.0001}
(assert (>= (+ (* sc_97 1.) of_97) 0.0001))
(declare-fun slbot_98 () Real)
(declare-fun sltop_98 () Real)
; 
; =  {(((sc.igenebind[6].K*0.)+of.igenebind[6].K)+sl.min.igenebind[6].K)} {0.0001}
(assert (= (+ (+ (* sc_98 0.) of_98) slbot_98) 0.0001))
; 
; =  {(((sc.igenebind[6].K*0.0156)+of.igenebind[6].K)+sl.max.igenebind[6].K)} {10.}
(assert (= (+ (+ (* sc_98 0.0156) of_98) sltop_98) 10.))
(declare-fun slbot_100 () Real)
(declare-fun sltop_100 () Real)
; 
; =  {(((sc.igenebind[6].GE*0.153603781016)+of.igenebind[6].GE)+sl.min.igenebind[6].GE)} {9.90099009901e-07}
(assert (= (+ (+ (* sc_100 0.153603781016) of_100) slbot_100) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[6].GE*0.156)+of.igenebind[6].GE)+sl.max.igenebind[6].GE)} {9.9999999}
(assert (= (+ (+ (* sc_100 0.156) of_100) sltop_100) 9.9999999))
; 
; >=  {((sc.igenebind[6].Vmax*0.156)+of.igenebind[6].Vmax)} {10.}
(assert (<= (+ (* sc_99 0.156) of_99) 10.))
; 
; <=  {((sc.igenebind[6].Vmax*0.156)+of.igenebind[6].Vmax)} {0.0001}
...
; 
; =  {(((sc.itov[13].X*103.621514368)+of.itov[13].X)+sl.max.itov[13].X)} {10.}
...
; 
; =  {(((sc.itov[13].Y*103.621514368)+of.itov[13].Y)+sl.max.itov[13].Y)} {3300.}
...
(assert (<= (+ (* sc_140 400.) of_140) 10.))
; 
; <=  {((sc.itov[15].X*400.)+of.itov[15].X)} {0.0001}
(assert (>= (+ (* sc_140 400.) of_140) 0.0001))
(declare-fun slbot_142 () Real)
(declare-fun sltop_142 () Real)
; 
; =  {(((sc.itov[15].Y*619.026085325)+of.itov[15].Y)+sl.min.itov[15].Y)} {0.0001}
(assert (= (+ (+ (* sc_142 619.026085325) of_142) slbot_142) 0.0001))
; 
; =  {(((sc.itov[15].Y*625.)+of.itov[15].Y)+sl.max.itov[15].Y)} {3300.}
(assert (= (+ (+ (* sc_142 625.) of_142) sltop_142) 3300.))
(declare-fun slbot_141 () Real)
(declare-fun sltop_141 () Real)
; 
; =  {(((sc.itov[15].K*1.54756521331)+of.itov[15].K)+sl.min.itov[15].K)} {1.}
(assert (= (+ (+ (* sc_141 1.54756521331) of_141) slbot_141) 1.))
; 
; =  {(((sc.itov[15].K*1.5625)+of.itov[15].K)+sl.max.itov[15].K)} {330.}
(assert (= (+ (+ (* sc_141 1.5625) of_141) sltop_141) 330.))
(declare-fun slbot_142 () Real)
(declare-fun sltop_142 () Real)
; 
; =  {(((sc.itov[15].Y*619.026085325)+of.itov[15].Y)+sl.min.itov[15].Y)} {0.0001}
...
; 
; =  {(((sc.itov[4].X*0.153603781016)+of.itov[4].X)+sl.min.itov[4].X)} {0.0001}
(assert (= (+ (+ (* sc_143 0.153603781016) of_143) slbot_143) 0.0001))
; 
; =  {(((sc.itov[4].X*0.156)+of.itov[4].X)+sl.max.itov[4].X)} {10.}
(assert (= (+ (+ (* sc_143 0.156) of_143) sltop_143) 10.))
(declare-fun slbot_145 () Real)
(declare-fun sltop_145 () Real)
; 
; =  {(((sc.itov[4].Y*61.4415124065)+of.itov[4].Y)+sl.min.itov[4].Y)} {0.0001}
(assert (= (+ (+ (* sc_145 61.4415124065) of_145) slbot_145) 0.0001))
; 
; =  {(((sc.itov[4].Y*62.4)+of.itov[4].Y)+sl.max.itov[4].Y)} {3300.}
(assert (= (+ (+ (* sc_145 62.4) of_145) sltop_145) 3300.))
; 
; >=  {((sc.itov[4].K*400.)+of.itov[4].K)} {330.}
(assert (<= (+ (* sc_144 400.) of_144) 330.))
; 
; <=  {((sc.itov[4].K*400.)+of.itov[4].K)} {1.}
(assert (>= (+ (* sc_144 400.) of_144) 1.))
(declare-fun slbot_145 () Real)
(declare-fun sltop_145 () Real)
; 
; =  {(((sc.itov[4].Y*61.4415124065)+of.itov[4].Y)+sl.min.itov[4].Y)} {0.0001}
...
; 
; >=  {((sc.iadd[7].D*1.)+of.iadd[7].D)} {5.}
(assert (<= (+ (* sc_151 1.) of_151) 5.))
; 
; <=  {((sc.iadd[7].D*1.)+of.iadd[7].D)} {0.}
...
(assert (= (+ (+ (* sc_155 -1.) of_155) slbot_155) -10.))
; 
; =  {(((sc.iadd[7].OUT*-0.84375)+of.iadd[7].OUT)+sl.max.iadd[7].OUT)} {10.}
(assert (= (+ (+ (* sc_155 -0.84375) of_155) sltop_155) 10.))
; 
...
; 
; =  {(((sc.iadd[7].B*0.15625)+of.iadd[7].B)+sl.max.iadd[7].B)} {5.}
(assert (= (+ (+ (* sc_154 0.15625) of_154) sltop_154) 5.))
(declare-fun slbot_155 () Real)
(declare-fun sltop_155 () Real)
; 
; =  {(((sc.iadd[7].OUT*-1.)+of.iadd[7].OUT)+sl.min.iadd[7].OUT)} {-10.}
...
; 
; =  {(((sc.iadd[9].OUT*0.00965050555471)+of.iadd[9].OUT)+sl.max.iadd[9].OUT)} {10.}
(assert (= (+ (+ (* sc_160 0.00965050555471) of_160) sltop_160) 10.))
; 
...
; 
; =  {(((sc.iadd[9].B*0.00965050555471)+of.iadd[9].B)+sl.max.iadd[9].B)} {5.}
(assert (= (+ (+ (* sc_159 0.00965050555471) of_159) sltop_159) 5.))
(declare-fun slbot_160 () Real)
(declare-fun sltop_160 () Real)
; 
; =  {(((sc.iadd[9].OUT*0.)+of.iadd[9].OUT)+sl.min.iadd[9].OUT)} {-10.}
...
; 
; =  {(((sc.iadd[11].A*0.0156)+of.iadd[11].A)+sl.max.iadd[11].A)} {5.}
...
; 
; =  {(((sc.iadd[11].OUT*0.0156)+of.iadd[11].OUT)+sl.max.iadd[11].OUT)} {10.}
...
; 
; =  {(((sc.iadd[10].OUT*0.00965050555471)+of.iadd[10].OUT)+sl.max.iadd[10].OUT)} {10.}
...
; 
; =  {(((sc.iadd[10].B*0.00965050555471)+of.iadd[10].B)+sl.max.iadd[10].B)} {5.}
...
(assert (= (+ (+ (* sc_175 1.66666666667) of_175) sltop_175) 10.))
; 
; =  {sc.switch[1].PROD} {sc.iadd[11].A}
(assert (= sc_13 sc_163))
; 
; =  {of.switch[1].PROD} {of.iadd[11].A}
(assert (= of_13 of_163))
; 
...
(assert (= of_139 of_2))
; 
; =  {sc.vtoi[12].Y} {sc.iadd[7].B}
(assert (= sc_86 sc_154))
; 
; =  {of.vtoi[12].Y} {of.iadd[7].B}
(assert (= of_86 of_154))
; 
...
(assert (= of_29 of_146))
; 
; =  {sc.input.V[9].O} {sc.vadd[5].OUT2_0}
(assert (= sc_112 sc_77))
; 
; =  {of.input.V[9].O} {of.vadd[5].OUT2_0}
(assert (= of_112 of_77))
; 
; =  {sc.input.I[22].O} {sc.switch[14].Kmod}
(assert (= sc_65 sc_6))
; 
; =  {of.input.I[22].O} {of.switch[14].Kmod}
(assert (= of_65 of_6))
; 
; =  {sc.input.V[15].O} {sc.vgain[12].Y}
(assert (= sc_120 sc_1))
; 
; =  {of.input.V[15].O} {of.vgain[12].Y}
(assert (= of_120 of_1))
; 
; =  {sc.igenebind[8].GE} {sc.itov[15].K}
(assert (= sc_96 sc_141))
; 
; =  {of.igenebind[8].GE} {of.itov[15].K}
(assert (= of_96 of_141))
; 
; =  {sc.input.I[26].O} {sc.iadd[11].C}
(assert (= sc_33 sc_162))
; 
; =  {of.input.I[26].O} {of.iadd[11].C}
(assert (= of_33 of_162))
; 
; =  {sc.input.I[18].O} {sc.igenebind[6].TF}
(assert (= sc_61 sc_97))
; 
; =  {of.input.I[18].O} {of.igenebind[6].TF}
(assert (= of_61 of_97))
; 
...
(assert (= of_27 of_158))
; 
; =  {sc.input.V[13].O} {sc.vtoi[0].X}
(assert (= sc_108 sc_87))
; 
; =  {of.input.V[13].O} {of.vtoi[0].X}
(assert (= of_108 of_87))
; 
...
(assert (= of_49 of_171))
; 
; =  {sc.input.I[16].O} {sc.igenebind[6].Vmax}
(assert (= sc_47 sc_99))
; 
; =  {of.input.I[16].O} {of.igenebind[6].Vmax}
(assert (= of_47 of_99))
; 
...
(assert (= of_53 of_172))
; 
; =  {sc.input.V[14].O} {sc.vtoi[11].X}
(assert (= sc_124 sc_90))
; 
; =  {of.input.V[14].O} {of.vtoi[11].X}
(assert (= of_124 of_90))
; 
...
(assert (= of_83 of_66))
; 
; =  {sc.vadd[5].OUT2} {sc.vtoi[12].X}
(assert (= sc_83 sc_84))
; 
; =  {of.vadd[5].OUT2} {of.vtoi[12].X}
(assert (= of_83 of_84))
; 
...
(assert (= of_128 of_80))
; 
; =  {sc.input.V[2].O} {sc.switch[14].n}
(assert (= sc_102 sc_4))
; 
; =  {of.input.V[2].O} {of.switch[14].n}
(assert (= of_102 of_4))
; 
...
(assert (= of_35 of_157))
; 
; =  {sc.igenebind[6].GE} {sc.itov[4].X}
(assert (= sc_100 sc_143))
; 
; =  {of.igenebind[6].GE} {of.itov[4].X}
(assert (= of_100 of_143))
; 
; =  {sc.input.I[12].O} {sc.iadd[10].A}
(assert (= sc_25 sc_168))
; 
; =  {of.input.I[12].O} {of.iadd[10].A}
(assert (= of_25 of_168))
; 
...
(assert (= of_76 of_68))
; 
; =  {sc.vadd[16].OUT2} {sc.switch[1].Vmax}
(assert (= sc_76 sc_12))
; 
; =  {of.vadd[16].OUT2} {of.switch[1].Vmax}
(assert (= of_76 of_12))
; 
; =  {sc.iadd[11].OUT} {sc.igenebind[6].K}
(assert (= sc_165 sc_98))
; 
; =  {of.iadd[11].OUT} {of.igenebind[6].K}
(assert (= of_165 of_98))
; 
; =  {sc.iadd[7].OUT} {sc.switch[14].SUB}
(assert (= sc_155 sc_5))
; 
; =  {of.iadd[7].OUT} {of.switch[14].SUB}
(assert (= of_155 of_5))
; 
; =  {sc.iadd[10].OUT} {sc.iadd[9].B}
(assert (= sc_170 sc_159))
; 
; =  {of.iadd[10].OUT} {of.iadd[9].B}
...
(assert (= of_134 of_0))
; 
; =  {sc.input.I[13].O} {sc.iadd[10].C}
(assert (= sc_23 sc_167))
; 
; =  {of.input.I[13].O} {of.iadd[10].C}
(assert (= of_23 of_167))
; 
...
; 
; =  {sc.input.V[7].O} {sc.itov[4].K}
(assert (= sc_106 sc_144))
; 
; =  {of.input.V[7].O} {of.itov[4].K}
(assert (= of_106 of_144))
; 
...
(assert (= of_45 of_7))
; 
; =  {sc.input.I[27].O} {sc.iadd[11].B}
(assert (= sc_37 sc_164))
; 
; =  {of.input.I[27].O} {of.iadd[11].B}
(assert (= of_37 of_164))
; 
...
(assert (= of_118 of_71))
; 
; =  {sc.input.V[18].O} {sc.vtoi[12].K}
(assert (= sc_136 sc_85))
; 
; =  {of.input.V[18].O} {of.vtoi[12].K}
(assert (= of_136 of_85))
; 
; =  {sc.input.V[16].O} {sc.itov[13].K}
(assert (= sc_126 sc_138))
; 
; =  {of.input.V[16].O} {of.itov[13].K}
(assert (= of_126 of_138))
; 
...
(assert (= of_122 of_73))
; 
; =  {sc.input.I[28].O} {sc.iadd[11].D}
(assert (= sc_55 sc_161))
; 
; =  {of.input.I[28].O} {of.iadd[11].D}
(assert (= of_55 of_161))
; 
; =  {sc.input.I[11].O} {sc.iadd[10].D}
(assert (= sc_31 sc_166))
; 
; =  {of.input.I[11].O} {of.iadd[10].D}
(assert (= of_31 of_166))
(assert (<= (* sc_67 0.001) 0.001))
(assert (<= (* sc_69 0.001) 0.001))
; 
; =  {sc.vadd[5].OUT2} {sc.output.V[0].O} {sc.vadd[16].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_83 sc_67) (= sc_83 sc_76)) (= sc_83 sc_69)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= slbot_175 0.) slbot_175 (- slbot_175))) (ite (>= sltop_149 0.) sltop_149 (- sltop_149))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_150 0.) slbot_150 (- slbot_150))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= sltop_150 0.) sltop_150 (- sltop_150))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= sltop_163 0.) sltop_163 (- sltop_163))) (ite (>= slbot_155 0.) slbot_155 (- slbot_155))) (ite (>= sltop_175 0.) sltop_175 (- sltop_175))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_163 0.) slbot_163 (- slbot_163))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_160 0.) slbot_160 (- slbot_160))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_169 0.) slbot_169 (- slbot_169))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= sltop_155 0.) sltop_155 (- sltop_155))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_169 0.) sltop_169 (- sltop_169))) (ite (>= sltop_160 0.) sltop_160 (- sltop_160))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= slbot_149 0.) slbot_149 (- slbot_149))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170)))))
(check-sat)
