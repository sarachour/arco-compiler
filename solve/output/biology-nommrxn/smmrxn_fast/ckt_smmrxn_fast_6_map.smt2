...
; 
; =  {(((sc.vgain[2].P*0.6)+of.vgain[2].P)+sl.max.vgain[2].P)} {5445000.}
...
; 
; =  {(((sc.vgain[2].Z*0.15)+of.vgain[2].Z)+sl.max.vgain[2].Z)} {3300.}
...
; 
; =  {(((sc.itov[4].X*0.11)+of.itov[4].X)+sl.max.itov[4].X)} {10.}
...
; 
; =  {(((sc.itov[4].Y*0.066)+of.itov[4].Y)+sl.max.itov[4].Y)} {3300.}
...
; 
; =  {(((sc.itov[4].K*0.6)+of.itov[4].K)+sl.max.itov[4].K)} {330.}
...
; 
; =  {(((sc.iadd[0].OUT*0.11)+of.iadd[0].OUT)+sl.max.iadd[0].OUT)} {10.}
...
; 
; >=  {((sc.iadd[0].B*0.11)+of.iadd[0].B)} {5.}
(assert (<= (+ (* sc_53 0.11) of_53) 5.))
; 
; <=  {((sc.iadd[0].B*0.11)+of.iadd[0].B)} {0.}
(assert (>= (+ (* sc_53 0.11) of_53) 0.))
(declare-fun slbot_54 () Real)
(declare-fun sltop_54 () Real)
; 
; =  {(((sc.iadd[0].OUT*0.)+of.iadd[0].OUT)+sl.min.iadd[0].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_55 0.11) of_55) sltop_55) 5.))
; 
