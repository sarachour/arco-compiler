...
(assert (= of_11 of_10))
; 
; >=  {((sc.input.I[4].X*-0.11)+of.input.I[4].X)} {10.}
(assert (<= (+ (* sc_10 -0.11) of_10) 10.))
; 
; <=  {((sc.input.I[4].X*-0.11)+of.input.I[4].X)} {0.}
(assert (>= (+ (* sc_10 -0.11) of_10) 0.))
; 
; >=  {((sc.input.I[4].O*-0.11)+of.input.I[4].O)} {10.}
(assert (<= (+ (* sc_11 -0.11) of_11) 10.))
; 
; <=  {((sc.input.I[4].O*-0.11)+of.input.I[4].O)} {0.}
...
; 
; >=  {((sc.iadd[4].D*-0.11)+of.iadd[4].D)} {5.}
(assert (<= (+ (* sc_55 -0.11) of_55) 5.))
; 
; <=  {((sc.iadd[4].D*-0.11)+of.iadd[4].D)} {0.}
...
; 
; =  {(((sc.iadd[4].C*0.11)+of.iadd[4].C)+sl.max.iadd[4].C)} {5.}
...
; 
; =  {(((sc.iadd[4].OUT*0.11)+of.iadd[4].OUT)+sl.max.iadd[4].OUT)} {10.}
...
(assert (= of_24 of_25))
; 
; =  {sc.iadd[4].OUT} {sc.itov[3].X}
(assert (= sc_59 sc_47))
; 
; =  {of.iadd[4].OUT} {of.itov[3].X}
(assert (= of_59 of_47))
; 
...
(assert (= of_27 of_50))
; 
; =  {sc.vtoi[1].Y} {sc.iadd[4].C}
(assert (= sc_30 sc_56))
; 
; =  {of.vtoi[1].Y} {of.iadd[4].C}
(assert (= of_30 of_56))
; 
...
(assert (= sc_24 sc_17))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_22 0.) slbot_22 (- slbot_22)) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_49 0.) slbot_49 (- slbot_49))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_49 0.) sltop_49 (- sltop_49))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
