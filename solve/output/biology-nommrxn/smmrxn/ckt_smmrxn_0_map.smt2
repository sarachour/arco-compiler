...
; 
; =  {(((sc.vtoi[5].X*0.11)+of.vtoi[5].X)+sl.max.vtoi[5].X)} {3300.}
...
; 
; =  {(((sc.vtoi[5].Y*0.11)+of.vtoi[5].Y)+sl.max.vtoi[5].Y)} {3300.}
...
; 
; =  {(((sc.vtoi[4].Y*-0.11)+of.vtoi[4].Y)+sl.min.vtoi[4].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_30 -0.11) of_30) slbot_30) 0.00030303030303))
; 
; =  {(((sc.vtoi[4].Y*0.)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
(assert (= (+ (+ (* sc_30 0.) of_30) sltop_30) 3300.))
; 
...
(assert (= (+ (+ (* sc_50 0.11) of_50) sltop_50) 5.))
; 
...
(assert (= (+ (+ (* sc_54 0.15) of_54) sltop_54) 10.))
; 
...
(assert (<= (+ (* sc_55 -0.11) of_55) 5.))
; 
; <=  {((sc.iadd[5].D*-0.11)+of.iadd[5].D)} {0.}
(assert (>= (+ (* sc_55 -0.11) of_55) 0.))
; 
...
(assert (= (+ (+ (* sc_59 0.11) of_59) sltop_59) 10.))
; 
...
(assert (= (+ (+ (* sc_58 -0.11) of_58) slbot_58) 0.))
; 
; =  {(((sc.iadd[5].B*0.)+of.iadd[5].B)+sl.max.iadd[5].B)} {5.}
(assert (= (+ (+ (* sc_58 0.) of_58) sltop_58) 5.))
(declare-fun slbot_59 () Real)
(declare-fun sltop_59 () Real)
; 
; =  {(((sc.iadd[5].OUT*0.)+of.iadd[5].OUT)+sl.min.iadd[5].OUT)} {-10.}
...
(assert (= of_7 of_55))
; 
; =  {sc.vadd[2].OUT2} {sc.vtoi[4].X}
(assert (= sc_24 sc_28))
; 
; =  {of.vadd[2].OUT2} {of.vtoi[4].X}
(assert (= of_24 of_28))
; 
...
(assert (= of_46 of_18))
; 
; =  {sc.input.V[7].O} {sc.vtoi[5].K}
(assert (= sc_34 sc_26))
; 
; =  {of.input.V[7].O} {of.vtoi[5].K}
(assert (= of_34 of_26))
; 
...
(assert (= of_44 of_19))
; 
; =  {sc.input.V[4].O} {sc.vtoi[4].K}
(assert (= sc_42 sc_29))
; 
; =  {of.input.V[4].O} {of.vtoi[4].K}
(assert (= of_42 of_29))
; 
...
(assert (= of_38 of_0))
; 
; =  {sc.vtoi[4].Y} {sc.iadd[5].B}
(assert (= sc_30 sc_58))
; 
; =  {of.vtoi[4].Y} {of.iadd[5].B}
(assert (= of_30 of_58))
(assert (<= (* (/ 1. sc_17) 0.001) 0.001))
; 
; =  {sc.vadd[2].OUT2} {sc.output.V[0].O}
(assert (= sc_24 sc_17))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_22 0.) slbot_22 (- slbot_22)) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_49 0.) slbot_49 (- slbot_49))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_49 0.) sltop_49 (- sltop_49))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
