...
; 
; >=  {((sc.switch[4].SUB*1.)+of.switch[4].SUB)} {10.}
(assert (<= (+ (* sc_5 1.) of_5) 10.))
; 
; <=  {((sc.switch[4].SUB*1.)+of.switch[4].SUB)} {0.0001}
(assert (>= (+ (* sc_5 1.) of_5) 0.0001))
; 
; >=  {((sc.switch[4].Kmod*-0.5)+of.switch[4].Kmod)} {10.}
(assert (<= (+ (* sc_6 -0.5) of_6) 10.))
; 
; <=  {((sc.switch[4].Kmod*-0.5)+of.switch[4].Kmod)} {0.0001}
...
; 
; =  {sc.input.I[6].O} {sc.switch[4].Kmod}
(assert (= sc_16 sc_6))
; 
; =  {of.input.I[6].O} {of.switch[4].Kmod}
(assert (= of_16 of_6))
; 
...
(assert (= of_18 of_62))
; 
; =  {sc.input.I[5].O} {sc.iadd[0].B}
(assert (= sc_22 sc_59))
; 
; =  {of.input.I[5].O} {of.iadd[0].B}
(assert (= of_22 of_59))
; 
...
(assert (= of_24 of_58))
; 
; =  {sc.input.I[7].O} {sc.switch[4].SUB}
(assert (= sc_12 sc_5))
; 
; =  {of.input.I[7].O} {of.switch[4].SUB}
(assert (= of_12 of_5))
; 
