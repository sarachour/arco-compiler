...
; 
; =  {(((sc.iadd[0].C*0.11)+of.iadd[0].C)+sl.max.iadd[0].C)} {5.}
(assert (= (+ (+ (* sc_46 0.11) of_46) sltop_46) 5.))
...
; 
; =  {(((sc.iadd[3].D*0.11)+of.iadd[3].D)+sl.max.iadd[3].D)} {5.}
...
; 
; =  {(((sc.iadd[3].OUT*0.15)+of.iadd[3].OUT)+sl.max.iadd[3].OUT)} {10.}
(assert (= (+ (+ (* sc_54 0.15) of_54) sltop_54) 10.))
; 
; >=  {((sc.iadd[3].A*0.15)+of.iadd[3].A)} {5.}
(assert (<= (+ (* sc_52 0.15) of_52) 5.))
; 
; <=  {((sc.iadd[3].A*0.15)+of.iadd[3].A)} {0.}
...
(assert (= of_24 of_25))
; 
; =  {sc.input.I[3].O} {sc.iadd[3].B}
(assert (= sc_9 sc_53))
; 
; =  {of.input.I[3].O} {of.iadd[3].B}
(assert (= of_9 of_53))
; 
...
(assert (= of_54 of_57))
; 
; =  {sc.iadd[3].OUT} {sc.vgain[1].X}
(assert (= sc_54 sc_0))
; 
; =  {of.iadd[3].OUT} {of.vgain[1].X}
(assert (= of_54 of_0))
; 
