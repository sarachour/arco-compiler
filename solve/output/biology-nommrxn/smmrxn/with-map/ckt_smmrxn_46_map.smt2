...
(assert (= (+ (+ (* sc_61 0.11) of_61) sltop_61) 5.))
; 
...
; 
; =  {(((sc.iadd[1].OUT*-0.11)+of.iadd[1].OUT)+sl.min.iadd[1].OUT)} {-10.}
(assert (= (+ (+ (* sc_65 -0.11) of_65) slbot_65) -10.))
; 
; =  {(((sc.iadd[1].OUT*0.)+of.iadd[1].OUT)+sl.max.iadd[1].OUT)} {10.}
(assert (= (+ (+ (* sc_65 0.) of_65) sltop_65) 10.))
; 
...
; 
; =  {sc.vadd[4].OUT2} {sc.vtoi[5].X}
(assert (= sc_30 sc_34))
; 
; =  {of.vadd[4].OUT2} {of.vtoi[5].X}
(assert (= of_30 of_34))
; 
...
(assert (= of_19 of_62))
; 
; =  {sc.input.V[14].O} {sc.vtoi[5].K}
(assert (= sc_44 sc_35))
; 
; =  {of.input.V[14].O} {of.vtoi[5].K}
(assert (= of_44 of_35))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[1].D}
(assert (= sc_33 sc_61))
; 
; =  {of.vtoi[0].Y} {of.iadd[1].D}
(assert (= of_33 of_61))
; 
...
(assert (= of_55 of_66))
; 
; =  {sc.input.I[8].O} {sc.iadd[0].A}
(assert (= sc_7 sc_58))
; 
; =  {of.input.I[8].O} {of.iadd[0].A}
(assert (= of_7 of_58))
; 
...
(assert (= of_42 of_1))
; 
; =  {sc.input.V[4].O} {sc.vadd[4].D}
(assert (= sc_48 sc_25))
; 
; =  {of.input.V[4].O} {of.vadd[4].D}
(assert (= of_48 of_25))
(assert (<= (* (/ 1. sc_23) 0.001) 0.001))
; 
; =  {sc.vadd[4].OUT2} {sc.output.V[0].O}
(assert (= sc_30 sc_23))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_0 0.) slbot_0 (- slbot_0))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= sltop_0 0.) sltop_0 (- sltop_0))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33)))))
(check-sat)
