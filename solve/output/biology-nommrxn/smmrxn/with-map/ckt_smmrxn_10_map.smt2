...
; 
; >=  {((sc.iadd[0].A*0.11)+of.iadd[0].A)} {5.}
(assert (<= (+ (* sc_47 0.11) of_47) 5.))
; 
; <=  {((sc.iadd[0].A*0.11)+of.iadd[0].A)} {0.}
...
(assert (= of_24 of_25))
; 
; =  {sc.vtoi[5].Y} {sc.iadd[3].D}
(assert (= sc_30 sc_50))
; 
; =  {of.vtoi[5].Y} {of.iadd[3].D}
(assert (= of_30 of_50))
; 
