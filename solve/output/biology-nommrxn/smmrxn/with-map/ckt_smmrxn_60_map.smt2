...
; 
; >=  {((sc.switch[0].SUB*-2.)+of.switch[0].SUB)} {10.}
(assert (<= (+ (* sc_5 -2.) of_5) 10.))
; 
; <=  {((sc.switch[0].SUB*-2.)+of.switch[0].SUB)} {0.0001}
(assert (>= (+ (* sc_5 -2.) of_5) 0.0001))
; 
; >=  {((sc.switch[0].Kmod*1.)+of.switch[0].Kmod)} {10.}
(assert (<= (+ (* sc_6 1.) of_6) 10.))
; 
; <=  {((sc.switch[0].Kmod*1.)+of.switch[0].Kmod)} {0.0001}
...
(assert (= of_33 of_34))
; 
; =  {sc.vadd[4].OUT2} {sc.switch[0].Vmax}
(assert (= sc_33 sc_7))
; 
; =  {of.vadd[4].OUT2} {of.switch[0].Vmax}
(assert (= of_33 of_7))
; 
...
(assert (= of_8 of_59))
; 
; =  {sc.input.I[5].O} {sc.switch[0].SUB}
(assert (= sc_22 sc_5))
; 
; =  {of.input.I[5].O} {of.switch[0].SUB}
(assert (= of_22 of_5))
; 
...
(assert (= of_60 of_61))
; 
; =  {sc.input.I[7].O} {sc.switch[0].Kmod}
(assert (= sc_12 sc_6))
; 
; =  {of.input.I[7].O} {of.switch[0].Kmod}
(assert (= of_12 of_6))
; 
