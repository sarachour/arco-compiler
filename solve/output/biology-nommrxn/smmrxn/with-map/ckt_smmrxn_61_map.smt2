...
; 
; =  {(((sc.vtoi[0].Y*-0.11)+of.vtoi[0].Y)+sl.min.vtoi[0].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_27 -0.11) of_27) slbot_27) 0.00030303030303))
; 
...
; 
; =  {(((sc.iadd[2].D*0.11)+of.iadd[2].D)+sl.max.iadd[2].D)} {5.}
...
; 
; =  {(((sc.iadd[2].OUT*0.15)+of.iadd[2].OUT)+sl.max.iadd[2].OUT)} {10.}
...
(assert (= (+ (+ (* sc_53 -0.11) of_53) slbot_53) 0.))
; 
; =  {(((sc.iadd[1].B*0.)+of.iadd[1].B)+sl.max.iadd[1].B)} {5.}
(assert (= (+ (+ (* sc_53 0.) of_53) sltop_53) 5.))
(declare-fun slbot_54 () Real)
(declare-fun sltop_54 () Real)
; 
; =  {(((sc.iadd[1].OUT*0.)+of.iadd[1].OUT)+sl.min.iadd[1].OUT)} {-10.}
...
(assert (= of_15 of_52))
; 
; =  {sc.iadd[1].OUT} {sc.vgain[3].Z}
(assert (= sc_54 sc_2))
; 
; =  {of.iadd[1].OUT} {of.vgain[3].Z}
(assert (= of_54 of_2))
; 
...
(assert (= of_49 of_57))
; 
; =  {sc.iadd[2].OUT} {sc.vgain[3].X}
(assert (= sc_49 sc_0))
; 
; =  {of.iadd[2].OUT} {of.vgain[3].X}
(assert (= of_49 of_0))
; 
...
(assert (= of_34 of_1))
; 
; =  {sc.input.V[4].O} {sc.vtoi[0].K}
(assert (= sc_40 sc_26))
; 
; =  {of.input.V[4].O} {of.vtoi[0].K}
(assert (= of_40 of_26))
; 
