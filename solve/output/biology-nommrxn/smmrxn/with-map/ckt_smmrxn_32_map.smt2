...
; 
; =  {(((sc.vgain[3].X*0.15)+of.vgain[3].X)+sl.max.vgain[3].X)} {3300.}
...
; 
; =  {(((sc.vgain[3].P*0.066)+of.vgain[3].P)+sl.max.vgain[3].P)} {5445000.}
...
; 
; =  {(((sc.vgain[3].Z*0.11)+of.vgain[3].Z)+sl.max.vgain[3].Z)} {3300.}
...
(assert (= of_8 0.))
; 
; >=  {((sc.switch[1].n*-500.)+of.switch[1].n)} {3300.}
(assert (<= (+ (* sc_4 -500.) of_4) 3300.))
; 
; <=  {((sc.switch[1].n*-500.)+of.switch[1].n)} {0.5}
(assert (>= (+ (* sc_4 -500.) of_4) 0.5))
; 
; >=  {((sc.switch[1].SUB*-2.)+of.switch[1].SUB)} {10.}
(assert (<= (+ (* sc_5 -2.) of_5) 10.))
; 
; <=  {((sc.switch[1].SUB*-2.)+of.switch[1].SUB)} {0.0001}
(assert (>= (+ (* sc_5 -2.) of_5) 0.0001))
; 
; >=  {((sc.switch[1].Kmod*1.)+of.switch[1].Kmod)} {10.}
(assert (<= (+ (* sc_6 1.) of_6) 10.))
; 
; <=  {((sc.switch[1].Kmod*1.)+of.switch[1].Kmod)} {0.0001}
(assert (>= (+ (* sc_6 1.) of_6) 0.0001))
(declare-fun slbot_8 () Real)
(declare-fun sltop_8 () Real)
; 
; =  {(((sc.switch[1].PROD*-0.11)+of.switch[1].PROD)+sl.min.switch[1].PROD)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_8 -0.11) of_8) slbot_8) 9.99934002508e-38))
; 
; =  {(((sc.switch[1].PROD*0.)+of.switch[1].PROD)+sl.max.switch[1].PROD)} {9.9999999}
...
; 
; =  {(((sc.switch[1].Vmax*0.11)+of.switch[1].Vmax)+sl.max.switch[1].Vmax)} {10.}
...
; 
; =  {(((sc.vadd[4].OUT2*0.11)+of.vadd[4].OUT2)+sl.max.vadd[4].OUT2)} {3300.}
...
; 
; =  {(((sc.vadd[4].B*0.066)+of.vadd[4].B)+sl.max.vadd[4].B)} {3300.}
...
; 
; =  {(((sc.vadd[4].OUT*0.066)+of.vadd[4].OUT)+sl.max.vadd[4].OUT)} {1650.}
...
; 
; >=  {((sc.iadd[2].D*-0.11)+of.iadd[2].D)} {5.}
(assert (<= (+ (* sc_51 -0.11) of_51) 5.))
; 
; <=  {((sc.iadd[2].D*-0.11)+of.iadd[2].D)} {0.}
(assert (>= (+ (* sc_51 -0.11) of_51) 0.))
; 
...
; 
; =  {(((sc.iadd[2].OUT*0.11)+of.iadd[2].OUT)+sl.max.iadd[2].OUT)} {10.}
...
; 
; =  {(((sc.iadd[2].B*-0.11)+of.iadd[2].B)+sl.min.iadd[2].B)} {0.}
(assert (= (+ (+ (* sc_54 -0.11) of_54) slbot_54) 0.))
; 
; =  {(((sc.iadd[2].B*0.)+of.iadd[2].B)+sl.max.iadd[2].B)} {5.}
(assert (= (+ (+ (* sc_54 0.) of_54) sltop_54) 5.))
(declare-fun slbot_55 () Real)
(declare-fun sltop_55 () Real)
; 
; =  {(((sc.iadd[2].OUT*0.)+of.iadd[2].OUT)+sl.min.iadd[2].OUT)} {-10.}
...
; 
; =  {sc.input.I[6].O} {sc.iadd[0].A}
(assert (= sc_16 sc_58))
; 
; =  {of.input.I[6].O} {of.iadd[0].A}
(assert (= of_16 of_58))
; 
...
(assert (= of_33 of_25))
; 
; =  {sc.vadd[4].OUT2} {sc.switch[1].Vmax}
(assert (= sc_33 sc_7))
; 
; =  {of.vadd[4].OUT2} {of.switch[1].Vmax}
(assert (= of_33 of_7))
; 
...
(assert (= of_33 of_34))
; 
; =  {sc.switch[1].PROD} {sc.iadd[2].B}
(assert (= sc_8 sc_54))
; 
; =  {of.switch[1].PROD} {of.iadd[2].B}
(assert (= of_8 of_54))
; 
...
(assert (= of_18 of_53))
; 
; =  {sc.input.I[5].O} {sc.switch[1].SUB}
(assert (= sc_22 sc_5))
; 
; =  {of.input.I[5].O} {of.switch[1].SUB}
(assert (= of_22 of_5))
; 
...
(assert (= of_10 of_59))
; 
; =  {sc.input.V[2].O} {sc.vadd[4].A}
(assert (= sc_38 sc_30))
; 
; =  {of.input.V[2].O} {of.vadd[4].A}
(assert (= of_38 of_30))
; 
...
(assert (= of_60 of_63))
; 
; =  {sc.iadd[0].OUT} {sc.vgain[3].X}
(assert (= sc_60 sc_0))
; 
; =  {of.iadd[0].OUT} {of.vgain[3].X}
(assert (= of_60 of_0))
; 
...
(assert (= of_24 of_57))
; 
; =  {sc.input.V[1].O} {sc.vadd[4].OUT2_0}
(assert (= sc_50 sc_27))
; 
; =  {of.input.V[1].O} {of.vadd[4].OUT2_0}
(assert (= of_50 of_27))
; 
; =  {sc.input.I[7].O} {sc.switch[1].Kmod}
(assert (= sc_12 sc_6))
; 
; =  {of.input.I[7].O} {of.switch[1].Kmod}
(assert (= of_12 of_6))
; 
...
(assert (= of_55 of_2))
; 
; =  {sc.iadd[2].OUT} {sc.output.I[0].X}
(assert (= sc_55 sc_61))
; 
; =  {of.iadd[2].OUT} {of.output.I[0].X}
(assert (= of_55 of_61))
; 
...
(assert (= of_40 of_1))
; 
; =  {sc.input.V[5].O} {sc.vadd[4].D}
(assert (= sc_48 sc_28))
; 
; =  {of.input.V[5].O} {of.vadd[4].D}
(assert (= of_48 of_28))
; 
; =  {sc.input.V[4].O} {sc.switch[1].n}
(assert (= sc_46 sc_4))
; 
; =  {of.input.V[4].O} {of.switch[1].n}
(assert (= of_46 of_4))
; 
