...
; 
; =  {(((sc.vtoi[2].X*0.11)+of.vtoi[2].X)+sl.max.vtoi[2].X)} {3300.}
...
; 
; =  {(((sc.vtoi[2].Y*0.11)+of.vtoi[2].Y)+sl.max.vtoi[2].Y)} {3300.}
...
; 
; =  {(((sc.vtoi[1].Y*-0.11)+of.vtoi[1].Y)+sl.min.vtoi[1].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_30 -0.11) of_30) slbot_30) 0.00030303030303))
; 
; =  {(((sc.vtoi[1].Y*0.)+of.vtoi[1].Y)+sl.max.vtoi[1].Y)} {3300.}
...
(assert (<= (+ (* sc_45 -0.11) of_45) 5.))
; 
; <=  {((sc.iadd[2].D*-0.11)+of.iadd[2].D)} {0.}
(assert (>= (+ (* sc_45 -0.11) of_45) 0.))
; 
...
(assert (= (+ (+ (* sc_49 0.11) of_49) sltop_49) 10.))
; 
...
(assert (= (+ (+ (* sc_48 -0.11) of_48) slbot_48) 0.))
; 
; =  {(((sc.iadd[2].B*0.)+of.iadd[2].B)+sl.max.iadd[2].B)} {5.}
(assert (= (+ (+ (* sc_48 0.) of_48) sltop_48) 5.))
(declare-fun slbot_49 () Real)
(declare-fun sltop_49 () Real)
; 
; =  {(((sc.iadd[2].OUT*0.)+of.iadd[2].OUT)+sl.min.iadd[2].OUT)} {-10.}
...
; 
; =  {sc.vadd[4].OUT2} {sc.vtoi[2].X}
(assert (= sc_24 sc_25))
; 
; =  {of.vadd[4].OUT2} {of.vtoi[2].X}
(assert (= of_24 of_25))
; 
; =  {sc.vadd[4].OUT2} {sc.vtoi[1].X}
(assert (= sc_24 sc_28))
; 
; =  {of.vadd[4].OUT2} {of.vtoi[1].X}
(assert (= of_24 of_28))
; 
...
(assert (= of_13 of_52))
; 
; =  {sc.vtoi[1].Y} {sc.iadd[2].B}
(assert (= sc_30 sc_48))
; 
; =  {of.vtoi[1].Y} {of.iadd[2].B}
(assert (= of_30 of_48))
; 
...
(assert (= of_34 of_1))
; 
; =  {sc.input.V[4].O} {sc.vtoi[1].K}
(assert (= sc_40 sc_29))
; 
; =  {of.input.V[4].O} {of.vtoi[1].K}
(assert (= of_40 of_29))
; 
