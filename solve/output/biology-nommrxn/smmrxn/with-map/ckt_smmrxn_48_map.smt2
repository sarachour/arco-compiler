...
; 
; =  {(((sc.vtoi[7].X*0.11)+of.vtoi[7].X)+sl.max.vtoi[7].X)} {3300.}
...
; 
; =  {(((sc.vtoi[7].Y*0.11)+of.vtoi[7].Y)+sl.max.vtoi[7].Y)} {3300.}
...
(assert (= of_42 of_35))
; 
; =  {sc.vtoi[7].Y} {sc.iadd[0].D}
(assert (= sc_33 sc_56))
; 
; =  {of.vtoi[7].Y} {of.iadd[0].D}
(assert (= of_33 of_56))
; 
...
(assert (= of_40 of_1))
; 
; =  {sc.input.V[16].O} {sc.vtoi[7].K}
(assert (= sc_44 sc_32))
; 
; =  {of.input.V[16].O} {of.vtoi[7].K}
(assert (= of_44 of_32))
; 
