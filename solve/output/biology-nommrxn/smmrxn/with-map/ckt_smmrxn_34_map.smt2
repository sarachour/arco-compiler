...
(assert (= (+ (+ (* sc_62 0.11) of_62) sltop_62) 5.))
...
(assert (= of_15 of_63))
; 
; =  {sc.input.I[5].O} {sc.iadd[1].B}
(assert (= sc_19 sc_64))
; 
; =  {of.input.I[5].O} {of.iadd[1].B}
(assert (= of_19 of_64))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[1].C}
(assert (= sc_33 sc_62))
; 
; =  {of.vtoi[0].Y} {of.iadd[1].C}
(assert (= of_33 of_62))
; 
...
(assert (= sc_30 sc_23))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_0 0.) slbot_0 (- slbot_0))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= sltop_0 0.) sltop_0 (- sltop_0))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33)))))
(check-sat)
