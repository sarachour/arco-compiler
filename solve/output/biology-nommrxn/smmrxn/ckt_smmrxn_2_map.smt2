...
; 
; =  {(((sc.switch[4].PROD*-0.11)+of.switch[4].PROD)+sl.min.switch[4].PROD)} {9.99934002508e-38}
...
; 
; =  {(((sc.switch[4].Vmax*0.11)+of.switch[4].Vmax)+sl.max.switch[4].Vmax)} {10.}
...
(assert (= of_16 of_15))
; 
; >=  {((sc.input.I[6].X*0.15)+of.input.I[6].X)} {10.}
(assert (<= (+ (* sc_15 0.15) of_15) 10.))
; 
; <=  {((sc.input.I[6].X*0.15)+of.input.I[6].X)} {0.}
(assert (>= (+ (* sc_15 0.15) of_15) 0.))
; 
; >=  {((sc.input.I[6].O*0.15)+of.input.I[6].O)} {10.}
(assert (<= (+ (* sc_16 0.15) of_16) 10.))
; 
; <=  {((sc.input.I[6].O*0.15)+of.input.I[6].O)} {0.}
...
(assert (= of_22 of_21))
; 
; >=  {((sc.input.I[5].X*-2.)+of.input.I[5].X)} {10.}
(assert (<= (+ (* sc_21 -2.) of_21) 10.))
; 
; <=  {((sc.input.I[5].X*-2.)+of.input.I[5].X)} {0.}
(assert (>= (+ (* sc_21 -2.) of_21) 0.))
; 
; >=  {((sc.input.I[5].O*-2.)+of.input.I[5].O)} {10.}
(assert (<= (+ (* sc_22 -2.) of_22) 10.))
; 
; <=  {((sc.input.I[5].O*-2.)+of.input.I[5].O)} {0.}
...
(assert (= (+ (+ (* sc_53 0.11) of_53) sltop_53) 10.))
...
(assert (= (+ (+ (* sc_55 0.066) of_55) sltop_55) 3300.))
...
(assert (= (+ (+ (* sc_54 0.6) of_54) sltop_54) 330.))
(declare-fun slbot_55 () Real)
(declare-fun sltop_55 () Real)
; 
; =  {(((sc.itov[3].Y*0.)+of.itov[3].Y)+sl.min.itov[3].Y)} {0.0001}
...
; 
; >=  {((sc.iadd[0].B*0.15)+of.iadd[0].B)} {5.}
(assert (<= (+ (* sc_59 0.15) of_59) 5.))
; 
; <=  {((sc.iadd[0].B*0.15)+of.iadd[0].B)} {0.}
...
; 
; >=  {((sc.iadd[5].D*-0.11)+of.iadd[5].D)} {5.}
(assert (<= (+ (* sc_61 -0.11) of_61) 5.))
; 
; <=  {((sc.iadd[5].D*-0.11)+of.iadd[5].D)} {0.}
...
; 
; =  {(((sc.iadd[5].OUT*0.11)+of.iadd[5].OUT)+sl.max.iadd[5].OUT)} {10.}
...
; 
; =  {(((sc.iadd[5].B*-0.11)+of.iadd[5].B)+sl.min.iadd[5].B)} {0.}
(assert (= (+ (+ (* sc_64 -0.11) of_64) slbot_64) 0.))
; 
; =  {(((sc.iadd[5].B*0.)+of.iadd[5].B)+sl.max.iadd[5].B)} {5.}
...
(assert (= of_16 of_59))
; 
; =  {sc.input.I[0].O} {sc.iadd[5].D}
(assert (= sc_14 sc_61))
; 
; =  {of.input.I[0].O} {of.iadd[5].D}
(assert (= of_14 of_61))
; 
; =  {sc.vadd[2].OUT2} {sc.switch[4].Vmax}
(assert (= sc_33 sc_7))
; 
; =  {of.vadd[2].OUT2} {of.switch[4].Vmax}
(assert (= of_33 of_7))
; 
...
(assert (= of_20 of_63))
; 
; =  {sc.input.I[5].O} {sc.switch[4].SUB}
(assert (= sc_22 sc_5))
; 
; =  {of.input.I[5].O} {of.switch[4].SUB}
(assert (= of_22 of_5))
; 
...
(assert (= of_36 of_56))
; 
; =  {sc.input.I[2].O} {sc.iadd[0].C}
(assert (= sc_10 sc_57))
; 
; =  {of.input.I[2].O} {of.iadd[0].C}
(assert (= of_10 of_57))
; 
...
(assert (= of_38 of_29))
; 
; =  {sc.iadd[5].OUT} {sc.itov[3].X}
(assert (= sc_65 sc_53))
; 
; =  {of.iadd[5].OUT} {of.itov[3].X}
(assert (= of_65 of_53))
; 
; =  {sc.iadd[5].OUT} {sc.output.I[0].X}
(assert (= sc_65 sc_66))
; 
; =  {of.iadd[5].OUT} {of.output.I[0].X}
(assert (= of_65 of_66))
; 
...
(assert (= of_55 of_31))
; 
; =  {sc.switch[4].PROD} {sc.iadd[5].B}
(assert (= sc_8 sc_64))
; 
; =  {of.switch[4].PROD} {of.iadd[5].B}
(assert (= of_8 of_64))
; 
...
(assert (= of_50 of_28))
; 
; =  {sc.input.V[4].O} {sc.switch[4].n}
(assert (= sc_48 sc_4))
; 
; =  {of.input.V[4].O} {of.switch[4].n}
(assert (= of_48 of_4))
; 
...
(assert (= sc_33 sc_26))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33)))))
(check-sat)
