...
(assert (= (+ (+ (* sc_43 9.26) of_43) sltop_43) 3300.))
...
; 
; =  {(((sc.vadd[3].OUT*9.26)+of.vadd[3].OUT)+sl.max.vadd[3].OUT)} {1649.999975}
(assert (= (+ (+ (* sc_44 9.26) of_44) sltop_44) 1649.999975))
(declare-fun slbot_45 () Real)
(declare-fun sltop_45 () Real)
; 
; =  {(((sc.vadd[3].OUT2*0.)+of.vadd[3].OUT2)+sl.min.vadd[3].OUT2)} {0.}
...
; 
; =  {(((sc.itov[4].Y*9.26)+of.itov[4].Y)+sl.max.itov[4].Y)} {3300.}
(assert (= (+ (+ (* sc_101 9.26) of_101) sltop_101) 3300.))
; 
; >=  {((sc.itov[4].K*9.26)+of.itov[4].K)} {330.}
(assert (<= (+ (* sc_100 9.26) of_100) 330.))
; 
; <=  {((sc.itov[4].K*9.26)+of.itov[4].K)} {1.}
(assert (>= (+ (* sc_100 9.26) of_100) 1.))
(declare-fun slbot_101 () Real)
(declare-fun sltop_101 () Real)
; 
; =  {(((sc.itov[4].Y*0.)+of.itov[4].Y)+sl.min.itov[4].Y)} {0.0001}
...
(assert (= of_72 of_8))
; 
; =  {sc.input.V[13].O} {sc.vadd[6].OUT2_0}
(assert (= sc_60 sc_32))
; 
; =  {of.input.V[13].O} {of.vadd[6].OUT2_0}
(assert (= of_60 of_32))
; 
...
(assert (= of_76 of_9))
; 
; =  {sc.input.V[11].O} {sc.itov[7].K}
(assert (= sc_68 sc_94))
; 
; =  {of.input.V[11].O} {of.itov[7].K}
(assert (= of_68 of_94))
; 
...
(assert (= of_62 of_39))
; 
; =  {sc.input.V[3].O} {sc.vgain[5].Y}
(assert (= sc_80 sc_13))
; 
; =  {of.input.V[3].O} {of.vgain[5].Y}
(assert (= of_80 of_13))
; 
; =  {sc.input.V[2].O} {sc.itov[4].K}
(assert (= sc_54 sc_100))
; 
; =  {of.input.V[2].O} {of.itov[4].K}
(assert (= of_54 of_100))
; 
...
(assert (= of_98 of_22))
; 
; =  {sc.input.V[18].O} {sc.vgain[5].Z}
(assert (= sc_90 sc_14))
; 
; =  {of.input.V[18].O} {of.vgain[5].Z}
(assert (= of_90 of_14))
; 
