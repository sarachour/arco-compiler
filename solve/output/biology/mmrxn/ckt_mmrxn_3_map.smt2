...
(assert (= of_11 0.))
; 
; >=  {((sc.vgain[0].X*3.154)+of.vgain[0].X)} {3300.}
(assert (<= (+ (* sc_8 3.154) of_8) 3300.))
; 
; <=  {((sc.vgain[0].X*3.154)+of.vgain[0].X)} {0.}
...
; 
; =  {(((sc.vgain[0].P*0.807424)+of.vgain[0].P)+sl.max.vgain[0].P.1)} {10890000.}
(assert (= (+ (+ (* sc_11 0.807424) of_11) sltop_11_1) 10890000.))
...
(assert (<= (+ (* sc_12 3.154) of_12) 3300.))
; 
; <=  {((sc.vgain[6].X*3.154)+of.vgain[6].X)} {0.}
(assert (>= (+ (* sc_12 3.154) of_12) 0.))
...
(assert (= (+ (+ (* sc_15 0.391096) of_15) sltop_15_1) 10890000.))
...
(assert (= (+ (+ (* sc_39 0.391096) of_39) sltop_39_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_44 0.256) of_44) sltop_44_1) 3300.))
...
(assert (= (+ (+ (* sc_42 0.28706) of_42) sltop_42_1) 3300.))
...
(assert (= (+ (+ (* sc_43 0.28706) of_43) sltop_43_1) 1650.))
(declare-fun slbot_44_1 () Real)
(assert (<= slbot_44_1 1e-08))
(declare-fun sltop_44_1 () Real)
(assert (>= sltop_44_1 1e-08))
...
(assert (<= (+ (* sc_45 0.124) of_45) 3300.))
; 
; <=  {((sc.vadd[1].OUT2_0*0.124)+of.vadd[1].OUT2_0)} {0.}
(assert (>= (+ (* sc_45 0.124) of_45) 0.))
...
(assert (= (+ (+ (* sc_46 0.807424) of_46) sltop_46_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_51 0.124) of_51) sltop_51_1) 3300.))
...
(assert (= (+ (+ (* sc_49 0.3131) of_49) sltop_49_1) 3300.))
...
(assert (= (+ (+ (* sc_50 0.3131) of_50) sltop_50_1) 1650.))
(declare-fun slbot_51_1 () Real)
(assert (<= slbot_51_1 1e-08))
(declare-fun sltop_51_1 () Real)
(assert (>= sltop_51_1 1e-08))
...
(assert (= (+ (+ (* sc_94 0.3131) of_94) sltop_94_1) 3300.))
; 
; >=  {((sc.itov[2].K*2.525)+of.itov[2].K)} {330.}
(assert (<= (+ (* sc_93 2.525) of_93) 330.))
; 
; <=  {((sc.itov[2].K*2.525)+of.itov[2].K)} {1.}
(assert (>= (+ (* sc_93 2.525) of_93) 1.))
(declare-fun slbot_94_1 () Real)
(assert (<= slbot_94_1 1e-08))
(declare-fun sltop_94_1 () Real)
(assert (>= sltop_94_1 1e-08))
...
(assert (= (+ (+ (* sc_100 0.28706) of_100) sltop_100_1) 3300.))
; 
; >=  {((sc.itov[5].K*2.315)+of.itov[5].K)} {330.}
(assert (<= (+ (* sc_99 2.315) of_99) 330.))
; 
; <=  {((sc.itov[5].K*2.315)+of.itov[5].K)} {1.}
(assert (>= (+ (* sc_99 2.315) of_99) 1.))
(declare-fun slbot_100_1 () Real)
(assert (<= slbot_100_1 1e-08))
(declare-fun sltop_100_1 () Real)
(assert (>= sltop_100_1 1e-08))
...
(assert (= of_69 of_31))
; 
; =  {sc.input.V[0].O} {sc.vgain[0].X}
(assert (= sc_65 sc_8))
; 
; =  {of.input.V[0].O} {of.vgain[0].X}
(assert (= of_65 of_8))
; 
