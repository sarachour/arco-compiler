...
(assert (= of_68 of_67))
; 
; >=  {((sc.input.V[11].X*20.2)+of.input.V[11].X)} {5.}
(assert (<= (+ (* sc_67 20.2) of_67) 5.))
; 
; <=  {((sc.input.V[11].X*20.2)+of.input.V[11].X)} {0.}
(assert (>= (+ (* sc_67 20.2) of_67) 0.))
; 
; >=  {((sc.input.V[11].O*20.2)+of.input.V[11].O)} {5.}
(assert (<= (+ (* sc_68 20.2) of_68) 5.))
; 
; <=  {((sc.input.V[11].O*20.2)+of.input.V[11].O)} {0.}
...
(assert (= of_98 of_22))
; 
; =  {sc.input.V[16].O} {sc.vgain[2].Y}
(assert (= sc_78 sc_1))
; 
; =  {of.input.V[16].O} {of.vgain[2].Y}
(assert (= of_78 of_1))
; 
