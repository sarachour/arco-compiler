...
(assert (<= (+ (* sc_9 0.049504950495) of_9) 3300.))
; 
; <=  {((sc.vgain[6].Y*0.049504950495)+of.vgain[6].Y)} {1.}
(assert (>= (+ (* sc_9 0.049504950495) of_9) 1.))
...
(assert (= of_78 of_44))
; 
; =  {sc.input.V[2].O} {sc.vgain[6].Y}
(assert (= sc_52 sc_9))
; 
; =  {of.input.V[2].O} {of.vgain[6].Y}
(assert (= of_52 of_9))
; 
...
(assert (= of_56 of_40))
; 
; =  {sc.input.V[10].O} {sc.itov[8].K}
(assert (= sc_68 sc_91))
; 
; =  {of.input.V[10].O} {of.itov[8].K}
(assert (= of_68 of_91))
; 
