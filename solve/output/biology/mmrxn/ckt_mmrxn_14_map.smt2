...
(assert (= (+ (+ (* sc_28 0.) of_28) slbot_28) 5e-05))
; 
...
(assert (= (+ (+ (* sc_27 50.464) of_27) sltop_27) 3300.))
(declare-fun slbot_28 () Real)
(declare-fun sltop_28 () Real)
; 
; =  {(((sc.vadd[11].OUT*0.)+of.vadd[11].OUT)+sl.min.vadd[11].OUT)} {5e-05}
...
(assert (= (+ (+ (* sc_34 9.26) of_34) sltop_34) 3300.))
...
(assert (= (+ (+ (* sc_35 9.26) of_35) sltop_35) 1649.999975))
(declare-fun slbot_36 () Real)
(declare-fun sltop_36 () Real)
; 
; =  {(((sc.vadd[6].OUT2*0.)+of.vadd[6].OUT2)+sl.min.vadd[6].OUT2)} {0.}
...
(assert (<= (+ (* sc_44 0.124) of_44) 3300.))
; 
; <=  {((sc.vadd[1].OUT2_0*0.124)+of.vadd[1].OUT2_0)} {0.}
(assert (>= (+ (* sc_44 0.124) of_44) 0.))
...
(assert (= (+ (+ (* sc_45 12.616) of_45) sltop_45) 3300.))
; 
...
(assert (<= (+ (* sc_83 0.00990805326569) of_83) 5.))
; 
; <=  {((sc.input.V[1].X*0.00990805326569)+of.input.V[1].X)} {0.}
(assert (>= (+ (* sc_83 0.00990805326569) of_83) 0.))
; 
; >=  {((sc.input.V[1].O*0.00990805326569)+of.input.V[1].O)} {5.}
(assert (<= (+ (* sc_84 0.00990805326569) of_84) 5.))
; 
; <=  {((sc.input.V[1].O*0.00990805326569)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_84 0.00990805326569) of_84) 0.))
...
(assert (<= (+ (* sc_93 10.1) of_93) 10.))
; 
; <=  {((sc.itov[0].X*10.1)+of.itov[0].X)} {0.0001}
(assert (>= (+ (* sc_93 10.1) of_93) 0.0001))
...
(assert (= of_62 of_19))
; 
; =  {sc.input.V[15].O} {sc.vgain[8].X}
(assert (= sc_70 sc_0))
; 
; =  {of.input.V[15].O} {of.vgain[8].X}
(assert (= of_70 of_0))
; 
...
(assert (= of_74 of_4))
; 
; =  {sc.input.V[11].O} {sc.vadd[6].OUT2_0}
(assert (= sc_66 sc_30))
; 
; =  {of.input.V[11].O} {of.vadd[6].OUT2_0}
(assert (= of_66 of_30))
; 
...
(assert (= of_60 of_44))
; 
; =  {sc.input.V[8].O} {sc.vadd[11].A}
(assert (= sc_54 sc_26))
; 
; =  {of.input.V[8].O} {of.vadd[11].A}
(assert (= of_54 of_26))
; 
...
(assert (and (and (and (= sc_43 sc_15) (= sc_43 sc_36)) (= sc_43 sc_50)) (= sc_43 sc_22)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* (ite (>= sltop_36 0) sltop_36 (- sltop_36)) 1.) (* (ite (>= slbot_92 0) slbot_92 (- slbot_92)) 1.)) (* (ite (>= slbot_14 0) slbot_14 (- slbot_14)) 1.)) (* (ite (>= sltop_96 0) sltop_96 (- sltop_96)) 1.)) (* (ite (>= sltop_14 0) sltop_14 (- sltop_14)) 1.)) (* (ite (>= sltop_87 0) sltop_87 (- sltop_87)) 1.)) (* (ite (>= slbot_10 0) slbot_10 (- slbot_10)) 1.)) (* (ite (>= slbot_35 0) slbot_35 (- slbot_35)) 1.)) (* (ite (>= slbot_49 0) slbot_49 (- slbot_49)) 1.)) (* (ite (>= sltop_90 0) sltop_90 (- sltop_90)) 1.)) (* (ite (>= slbot_20 0) slbot_20 (- slbot_20)) 1.)) (* (ite (>= sltop_27 0) sltop_27 (- sltop_27)) 1.)) (* (ite (>= slbot_3 0) slbot_3 (- slbot_3)) 1.)) (* (ite (>= sltop_42 0) sltop_42 (- sltop_42)) 1.)) (* (ite (>= slbot_2 0) slbot_2 (- slbot_2)) 1.)) (* (ite (>= sltop_10 0) sltop_10 (- sltop_10)) 1.)) (* (ite (>= slbot_36 0) slbot_36 (- slbot_36)) 1.)) (* (ite (>= sltop_22 0) sltop_22 (- sltop_22)) 1.)) (* (ite (>= slbot_96 0) slbot_96 (- slbot_96)) 1.)) (* (ite (>= sltop_2 0) sltop_2 (- sltop_2)) 1.)) (* (ite (>= sltop_15 0) sltop_15 (- sltop_15)) 1.)) (* (ite (>= sltop_31 0) sltop_31 (- sltop_31)) 1.)) (* (ite (>= slbot_95 0) slbot_95 (- slbot_95)) 1.)) (* (ite (>= sltop_94 0) sltop_94 (- sltop_94)) 1.)) (* (ite (>= slbot_28 0) slbot_28 (- slbot_28)) 1.)) (* (ite (>= slbot_98 0) slbot_98 (- slbot_98)) 1.)) (* (ite (>= sltop_34 0) sltop_34 (- sltop_34)) 1.)) (* (ite (>= slbot_45 0) slbot_45 (- slbot_45)) 1.)) (* (ite (>= slbot_87 0) slbot_87 (- slbot_87)) 1.)) (* (ite (>= slbot_6 0) slbot_6 (- slbot_6)) 1.)) (* (ite (>= sltop_45 0) sltop_45 (- sltop_45)) 1.)) (* (ite (>= slbot_42 0) slbot_42 (- slbot_42)) 1.)) (* (ite (>= slbot_34 0) slbot_34 (- slbot_34)) 1.)) (* (ite (>= sltop_3 0) sltop_3 (- sltop_3)) 1.)) (* (ite (>= sltop_35 0) sltop_35 (- sltop_35)) 1.)) (* (ite (>= slbot_27 0) slbot_27 (- slbot_27)) 1.)) (* (ite (>= slbot_7 0) slbot_7 (- slbot_7)) 1.)) (* (ite (>= slbot_89 0) slbot_89 (- slbot_89)) 1.)) (* (ite (>= slbot_22 0) slbot_22 (- slbot_22)) 1.)) (* (ite (>= sltop_41 0) sltop_41 (- sltop_41)) 1.)) (* (ite (>= slbot_11 0) slbot_11 (- slbot_11)) 1.)) (* (ite (>= sltop_11 0) sltop_11 (- sltop_11)) 1.)) (* (ite (>= sltop_28 0) sltop_28 (- sltop_28)) 1.)) (* (ite (>= sltop_7 0) sltop_7 (- sltop_7)) 1.)) (* (ite (>= slbot_15 0) slbot_15 (- slbot_15)) 1.)) (* (ite (>= sltop_49 0) sltop_49 (- sltop_49)) 1.)) (* (ite (>= sltop_89 0) sltop_89 (- sltop_89)) 1.)) (* (ite (>= sltop_92 0) sltop_92 (- sltop_92)) 1.)) (* (ite (>= slbot_31 0) slbot_31 (- slbot_31)) 1.)) (* (ite (>= slbot_90 0) slbot_90 (- slbot_90)) 1.)) (* (ite (>= slbot_41 0) slbot_41 (- slbot_41)) 1.)) (* (ite (>= sltop_20 0) sltop_20 (- sltop_20)) 1.)) (* (ite (>= sltop_98 0) sltop_98 (- sltop_98)) 1.)) (* (ite (>= slbot_21 0) slbot_21 (- slbot_21)) 1.)) (* (ite (>= sltop_95 0) sltop_95 (- sltop_95)) 1.)) (* (ite (>= slbot_48 0) slbot_48 (- slbot_48)) 1.)) (* (ite (>= sltop_97 0) sltop_97 (- sltop_97)) 1.)) (* (ite (>= slbot_43 0) slbot_43 (- slbot_43)) 1.)) (* (ite (>= slbot_50 0) slbot_50 (- slbot_50)) 1.)) (* (ite (>= slbot_94 0) slbot_94 (- slbot_94)) 1.)) (* (ite (>= sltop_50 0) sltop_50 (- sltop_50)) 1.)) (* (ite (>= sltop_48 0) sltop_48 (- sltop_48)) 1.)) (* (ite (>= sltop_6 0) sltop_6 (- sltop_6)) 1.)) (* (ite (>= sltop_43 0) sltop_43 (- sltop_43)) 1.)) (* (ite (>= slbot_97 0) slbot_97 (- slbot_97)) 1.)) (* (ite (>= sltop_21 0) sltop_21 (- sltop_21)) 1.))))
(check-sat)
