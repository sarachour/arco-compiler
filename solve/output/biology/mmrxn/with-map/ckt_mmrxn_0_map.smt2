...
; 
; =  {(((sc.vgain[7].Z*0.)+of.vgain[7].Z)+sl.min.vgain[7].Z.1)} {0.0001}
(assert (= (+ (+ (* sc_6 0.) of_6) slbot_6_1) 0.0001))
; 
; =  {(((sc.vgain[7].Z*0.256)+of.vgain[7].Z)+sl.max.vgain[7].Z.1)} {3300.}
...
(assert (= of_49 of_44))
; 
; =  {sc.vadd[5].OUT2} {sc.vgain[7].Z}
(assert (= sc_40 sc_6))
; 
; =  {of.vadd[5].OUT2} {of.vgain[7].Z}
(assert (= of_40 of_6))
; 
...
(assert (= of_85 of_41))
; 
; =  {sc.input.V[20].O} {sc.vgain[7].X}
(assert (= sc_51 sc_4))
; 
; =  {of.input.V[20].O} {of.vgain[7].X}
(assert (= of_51 of_4))
; 
