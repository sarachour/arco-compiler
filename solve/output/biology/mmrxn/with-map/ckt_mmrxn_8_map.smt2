...
; 
; =  {(((sc.vgain[8].P*1.2524)+of.vgain[8].P)+sl.max.vgain[8].P)} {5445000.}
...
(assert (<= (+ (* sc_4 25.232) of_4) 3300.))
; 
; <=  {((sc.vgain[5].X*25.232)+of.vgain[5].X)} {0.0001}
(assert (>= (+ (* sc_4 25.232) of_4) 0.0001))
; 
...
(assert (= (+ (+ (* sc_21 3.229696) of_21) sltop_21) 3300.))
; 
...
(assert (= (+ (+ (* sc_24 1.2524) of_24) sltop_24) 3300.))
...
(assert (= (+ (+ (* sc_25 3.229696) of_25) sltop_25) 1650.))
(declare-fun slbot_26 () Real)
(declare-fun sltop_26 () Real)
; 
; =  {(((sc.vadd[9].OUT2*0.)+of.vadd[9].OUT2)+sl.min.vadd[9].OUT2)} {0.}
...
(assert (<= (+ (* sc_28 10.1) of_28) 3300.))
; 
; <=  {((sc.vadd[6].D*10.1)+of.vadd[6].D)} {0.}
(assert (>= (+ (* sc_28 10.1) of_28) 0.))
; 
...
(assert (= (+ (+ (* sc_31 0.400482304) of_31) sltop_31) 3300.))
...
(assert (= (+ (+ (* sc_32 0.400482304) of_32) sltop_32) 1650.))
(declare-fun slbot_33 () Real)
(declare-fun sltop_33 () Real)
; 
; =  {(((sc.vadd[6].OUT2*0.)+of.vadd[6].OUT2)+sl.min.vadd[6].OUT2)} {0.}
...
(assert (= of_99 of_21))
; 
; =  {sc.input.V[18].O} {sc.vgain[8].Z}
(assert (= sc_85 sc_2))
; 
; =  {of.input.V[18].O} {of.vgain[8].Z}
(assert (= of_85 of_2))
; 
; =  {sc.input.V[16].O} {sc.vadd[9].OUT2_0}
(assert (= sc_73 sc_20))
; 
; =  {of.input.V[16].O} {of.vadd[9].OUT2_0}
(assert (= of_73 of_20))
; 
...
(assert (and (and (and (and (and (and (= sc_47 sc_15) (= sc_47 sc_40)) (= sc_47 sc_19)) (= sc_47 sc_26)) (= sc_47 sc_13)) (= sc_47 sc_33)) (= sc_47 sc_17)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_0 0.) slbot_0 (- slbot_0))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_0 0.) sltop_0 (- sltop_0))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
