...
; 
; >=  {((sc.vgain[5].Y*0.158528852251)+of.vgain[5].Y)} {3300.}
(assert (<= (+ (* sc_9 0.158528852251) of_9) 3300.))
; 
; <=  {((sc.vgain[5].Y*0.158528852251)+of.vgain[5].Y)} {1.}
(assert (>= (+ (* sc_9 0.158528852251) of_9) 1.))
...
; 
; =  {(((sc.vgain[5].P*0.807424)+of.vgain[5].P)+sl.max.vgain[5].P.1)} {5445000.}
(assert (= (+ (+ (* sc_11 0.807424) of_11) sltop_11_1) 5445000.))
...
; 
; =  {(((sc.vadd[6].D*0.807424)+of.vadd[6].D)+sl.max.vadd[6].D.1)} {3300.}
(assert (= (+ (+ (* sc_28 0.807424) of_28) sltop_28_1) 3300.))
; 
...
; 
; =  {(((sc.vadd[6].B*0.6262)+of.vadd[6].B)+sl.max.vadd[6].B.1)} {3300.}
(assert (= (+ (+ (* sc_31 0.6262) of_31) sltop_31_1) 3300.))
...
; 
; =  {(((sc.vadd[6].OUT*0.6262)+of.vadd[6].OUT)+sl.max.vadd[6].OUT.1)} {1650.}
(assert (= (+ (+ (* sc_32 0.6262) of_32) sltop_32_1) 1650.))
(declare-fun slbot_33_1 () Real)
(declare-fun sltop_33_1 () Real)
; 
; =  {(((sc.vadd[6].OUT2*0.)+of.vadd[6].OUT2)+sl.min.vadd[6].OUT2.1)} {0.}
...
; 
; =  {(((sc.itov[7].Y*0.6262)+of.itov[7].Y)+sl.max.itov[7].Y.1)} {3300.}
(assert (= (+ (+ (* sc_99 0.6262) of_99) sltop_99_1) 3300.))
; 
; >=  {((sc.itov[7].K*5.05)+of.itov[7].K)} {330.}
(assert (<= (+ (* sc_98 5.05) of_98) 330.))
; 
; <=  {((sc.itov[7].K*5.05)+of.itov[7].K)} {1.}
...
(assert (= (+ (+ (* sc_102 0.391096) of_102) sltop_102_1) 3300.))
; 
; >=  {((sc.itov[10].K*3.154)+of.itov[10].K)} {330.}
(assert (<= (+ (* sc_101 3.154) of_101) 330.))
; 
; <=  {((sc.itov[10].K*3.154)+of.itov[10].K)} {1.}
(assert (>= (+ (* sc_101 3.154) of_101) 1.))
(declare-fun slbot_102_1 () Real)
(declare-fun sltop_102_1 () Real)
; 
; =  {(((sc.itov[10].Y*0.)+of.itov[10].Y)+sl.min.itov[10].Y.1)} {0.0001}
...
(assert (= of_91 of_104))
; 
; =  {sc.input.V[22].O} {sc.vgain[5].X}
(assert (= sc_93 sc_8))
; 
; =  {of.input.V[22].O} {of.vgain[5].X}
(assert (= of_93 of_8))
; 
