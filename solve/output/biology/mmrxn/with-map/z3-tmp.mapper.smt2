...
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[7].OUT2} {sc.output.V[1].O} {sc.vadd[9].OUT2} {sc.output.V[2].O} {sc.vadd[4].OUT2} {sc.output.V[3].O}
(assert (and (and (and (and (and (and (= sc_47 sc_15) (= sc_47 sc_26)) (= sc_47 sc_19)) (= sc_47 sc_33)) (= sc_47 sc_13)) (= sc_47 sc_40)) (= sc_47 sc_17)))
...
(assert (< __minima__ 10300027.6496))
(check-sat)
