...
; 
; >=  {((sc.vgain[2].Y*0.158528852251)+of.vgain[2].Y)} {3300.}
(assert (<= (+ (* sc_1 0.158528852251) of_1) 3300.))
; 
; <=  {((sc.vgain[2].Y*0.158528852251)+of.vgain[2].Y)} {1.}
...
; 
; =  {(((sc.vgain[2].P*0.807424)+of.vgain[2].P)+sl.max.vgain[2].P.1)} {5445000.}
...
(assert (<= (+ (* sc_9 0.0792644261256) of_9) 3300.))
; 
; <=  {((sc.vgain[5].Y*0.0792644261256)+of.vgain[5].Y)} {1.}
(assert (>= (+ (* sc_9 0.0792644261256) of_9) 1.))
...
(assert (= (+ (+ (* sc_11 0.200241152) of_11) sltop_11_1) 5445000.))
...
(assert (= (+ (+ (* sc_21 0.391096) of_21) sltop_21_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_26 0.256) of_26) sltop_26_1) 3300.))
...
(assert (= (+ (+ (* sc_26 0.256) of_26) sltop_26_2) 3300.))
...
(assert (= (+ (+ (* sc_24 0.57412) of_24) sltop_24_1) 3300.))
...
(assert (= (+ (+ (* sc_25 0.391096) of_25) sltop_25_1) 1650.))
(declare-fun slbot_26_1 () Real)
(declare-fun sltop_26_1 () Real)
; 
; =  {(((sc.vadd[8].OUT2*0.)+of.vadd[8].OUT2)+sl.min.vadd[8].OUT2.1)} {0.}
...
; 
; =  {(((sc.vadd[3].D*0.)+of.vadd[3].D)+sl.min.vadd[3].D.1)} {0.}
(assert (= (+ (+ (* sc_35 0.) of_35) slbot_35_1) 0.))
; 
; =  {(((sc.vadd[3].D*0.807424)+of.vadd[3].D)+sl.max.vadd[3].D.1)} {3300.}
(assert (= (+ (+ (* sc_35 0.807424) of_35) sltop_35_1) 3300.))
; 
...
; 
; =  {(((sc.vadd[3].B*0.6262)+of.vadd[3].B)+sl.max.vadd[3].B.1)} {3300.}
(assert (= (+ (+ (* sc_38 0.6262) of_38) sltop_38_1) 3300.))
...
; 
; =  {(((sc.vadd[3].OUT*0.6262)+of.vadd[3].OUT)+sl.max.vadd[3].OUT.1)} {1650.}
(assert (= (+ (+ (* sc_39 0.6262) of_39) sltop_39_1) 1650.))
(declare-fun slbot_40_1 () Real)
(declare-fun sltop_40_1 () Real)
; 
; =  {(((sc.vadd[3].OUT2*0.)+of.vadd[3].OUT2)+sl.min.vadd[3].OUT2.1)} {0.}
...
(assert (= of_59 of_58))
; 
; >=  {((sc.input.V[12].X*0.158528852251)+of.input.V[12].X)} {3300.}
(assert (<= (+ (* sc_58 0.158528852251) of_58) 3300.))
; 
; <=  {((sc.input.V[12].X*0.158528852251)+of.input.V[12].X)} {0.}
(assert (>= (+ (* sc_58 0.158528852251) of_58) 0.))
; 
; >=  {((sc.input.V[12].O*0.158528852251)+of.input.V[12].O)} {3300.}
(assert (<= (+ (* sc_59 0.158528852251) of_59) 3300.))
; 
; <=  {((sc.input.V[12].O*0.158528852251)+of.input.V[12].O)} {0.}
(assert (>= (+ (* sc_59 0.158528852251) of_59) 0.))
...
(assert (= (+ (+ (* sc_94 0.391096) of_94) sltop_94_1) 3300.))
; 
...
; 
; =  {(((sc.itov[4].X*0.)+of.itov[4].X)+sl.min.itov[4].X.1)} {0.0001}
(assert (= (+ (+ (* sc_98 0.) of_98) slbot_98_1) 0.0001))
; 
; =  {(((sc.itov[4].X*0.124)+of.itov[4].X)+sl.max.itov[4].X.1)} {10.}
(assert (= (+ (+ (* sc_98 0.124) of_98) sltop_98_1) 10.))
(declare-fun slbot_100_1 () Real)
(declare-fun sltop_100_1 () Real)
; 
; =  {(((sc.itov[4].Y*0.)+of.itov[4].Y)+sl.min.itov[4].Y.1)} {0.0001}
(assert (= (+ (+ (* sc_100 0.) of_100) slbot_100_1) 0.0001))
; 
; =  {(((sc.itov[4].Y*0.6262)+of.itov[4].Y)+sl.max.itov[4].Y.1)} {3300.}
(assert (= (+ (+ (* sc_100 0.6262) of_100) sltop_100_1) 3300.))
; 
; >=  {((sc.itov[4].K*5.05)+of.itov[4].K)} {330.}
(assert (<= (+ (* sc_99 5.05) of_99) 330.))
; 
; <=  {((sc.itov[4].K*5.05)+of.itov[4].K)} {1.}
(assert (>= (+ (* sc_99 5.05) of_99) 1.))
(declare-fun slbot_100_1 () Real)
(declare-fun sltop_100_1 () Real)
; 
; =  {(((sc.itov[4].Y*0.)+of.itov[4].Y)+sl.min.itov[4].Y.1)} {0.0001}
...
(assert (= of_65 of_23))
; 
; =  {sc.input.V[12].O} {sc.vgain[2].Y}
(assert (= sc_59 sc_1))
; 
; =  {of.input.V[12].O} {of.vgain[2].Y}
(assert (= of_59 of_1))
; 
...
(assert (= of_91 of_28))
; 
; =  {sc.vadd[3].OUT2} {sc.vgain[5].X}
(assert (= sc_40 sc_8))
; 
; =  {of.vadd[3].OUT2} {of.vgain[5].X}
(assert (= of_40 of_8))
; 
...
(assert (= of_97 of_45))
; 
; =  {sc.input.V[21].O} {sc.vgain[2].X}
(assert (= sc_75 sc_0))
; 
; =  {of.input.V[21].O} {of.vgain[2].X}
(assert (= of_75 of_0))
; 
