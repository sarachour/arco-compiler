...
; 
; >=  {((sc.vgain[0].Y*0.158528852251)+of.vgain[0].Y)} {3300.}
(assert (<= (+ (* sc_5 0.158528852251) of_5) 3300.))
; 
; <=  {((sc.vgain[0].Y*0.158528852251)+of.vgain[0].Y)} {1.}
...
; 
; =  {(((sc.vgain[0].P*0.807424)+of.vgain[0].P)+sl.max.vgain[0].P.1)} {5445000.}
...
; 
; =  {(((sc.vgain[0].Z*0.256)+of.vgain[0].Z)+sl.max.vgain[0].Z.1)} {3300.}
...
(assert (= (+ (+ (* sc_45 0.6262) of_45) sltop_45_1) 3300.))
...
(assert (= (+ (+ (* sc_46 0.6262) of_46) sltop_46_1) 1650.))
(declare-fun slbot_47_1 () Real)
(declare-fun sltop_47_1 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2.1)} {0.}
...
(assert (= (+ (+ (* sc_100 0.05208) of_100) sltop_100_1) 3300.))
; 
; >=  {((sc.itov[3].K*0.42)+of.itov[3].K)} {330.}
(assert (<= (+ (* sc_99 0.42) of_99) 330.))
; 
; <=  {((sc.itov[3].K*0.42)+of.itov[3].K)} {1.}
(assert (>= (+ (* sc_99 0.42) of_99) 1.))
(declare-fun slbot_100_1 () Real)
(declare-fun sltop_100_1 () Real)
; 
; =  {(((sc.itov[3].Y*0.)+of.itov[3].Y)+sl.min.itov[3].Y.1)} {0.0001}
...
(assert (= of_91 of_28))
; 
; =  {sc.input.V[21].O} {sc.vgain[0].X}
(assert (= sc_75 sc_4))
; 
; =  {of.input.V[21].O} {of.vgain[0].X}
(assert (= of_75 of_4))
; 
...
(assert (= of_85 of_44))
; 
; =  {sc.vgain[0].P} {sc.vadd[1].D}
(assert (= sc_7 sc_42))
; 
; =  {of.vgain[0].P} {of.vadd[1].D}
(assert (= of_7 of_42))
; 
