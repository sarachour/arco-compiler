...
(assert (= of_3 0.))
; 
; >=  {((sc.vgain[2].X*6.308)+of.vgain[2].X)} {3300.}
(assert (<= (+ (* sc_0 6.308) of_0) 3300.))
; 
; <=  {((sc.vgain[2].X*6.308)+of.vgain[2].X)} {0.0001}
(assert (>= (+ (* sc_0 6.308) of_0) 0.0001))
; 
...
(assert (= of_57 of_56))
; 
; >=  {((sc.input.V[13].X*6.308)+of.input.V[13].X)} {3300.}
(assert (<= (+ (* sc_56 6.308) of_56) 3300.))
; 
; <=  {((sc.input.V[13].X*6.308)+of.input.V[13].X)} {0.}
(assert (>= (+ (* sc_56 6.308) of_56) 0.))
; 
; >=  {((sc.input.V[13].O*6.308)+of.input.V[13].O)} {3300.}
(assert (<= (+ (* sc_57 6.308) of_57) 3300.))
; 
; <=  {((sc.input.V[13].O*6.308)+of.input.V[13].O)} {0.}
(assert (>= (+ (* sc_57 6.308) of_57) 0.))
