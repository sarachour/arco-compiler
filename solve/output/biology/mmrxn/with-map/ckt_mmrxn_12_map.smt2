...
(assert (= of_11 0.))
; 
; >=  {((sc.vgain[5].X*6.308)+of.vgain[5].X)} {3300.}
(assert (<= (+ (* sc_8 6.308) of_8) 3300.))
; 
; <=  {((sc.vgain[5].X*6.308)+of.vgain[5].X)} {0.0001}
(assert (>= (+ (* sc_8 6.308) of_8) 0.0001))
; 
...
(assert (<= (+ (* sc_56 0.0792644261256) of_56) 3300.))
; 
; <=  {((sc.input.V[13].X*0.0792644261256)+of.input.V[13].X)} {0.}
(assert (>= (+ (* sc_56 0.0792644261256) of_56) 0.))
; 
; >=  {((sc.input.V[13].O*0.0792644261256)+of.input.V[13].O)} {3300.}
(assert (<= (+ (* sc_57 0.0792644261256) of_57) 3300.))
; 
; <=  {((sc.input.V[13].O*0.0792644261256)+of.input.V[13].O)} {0.}
(assert (>= (+ (* sc_57 0.0792644261256) of_57) 0.))
...
(assert (= of_73 of_72))
; 
; >=  {((sc.input.V[14].X*6.308)+of.input.V[14].X)} {3300.}
(assert (<= (+ (* sc_72 6.308) of_72) 3300.))
; 
; <=  {((sc.input.V[14].X*6.308)+of.input.V[14].X)} {0.}
(assert (>= (+ (* sc_72 6.308) of_72) 0.))
; 
; >=  {((sc.input.V[14].O*6.308)+of.input.V[14].O)} {3300.}
(assert (<= (+ (* sc_73 6.308) of_73) 3300.))
; 
; <=  {((sc.input.V[14].O*6.308)+of.input.V[14].O)} {0.}
(assert (>= (+ (* sc_73 6.308) of_73) 0.))
...
(assert (= of_91 of_104))
; 
; =  {sc.input.V[22].O} {sc.vgain[5].Y}
(assert (= sc_93 sc_9))
; 
; =  {of.input.V[22].O} {of.vgain[5].Y}
(assert (= of_93 of_9))
; 
