...
(assert (<= (+ (* sc_8 20.2) of_8) 3300.))
; 
; <=  {((sc.vgain[6].X*20.2)+of.vgain[6].X)} {0.0001}
(assert (>= (+ (* sc_8 20.2) of_8) 0.0001))
; 
...
(assert (= (+ (+ (* sc_11 10.1) of_11) sltop_11) 5445000.))
...
(assert (= (+ (+ (* sc_20 10.1) of_20) sltop_20) 3300.))
...
(assert (= of_68 of_67))
; 
; >=  {((sc.input.V[10].X*20.2)+of.input.V[10].X)} {5.}
(assert (<= (+ (* sc_67 20.2) of_67) 5.))
; 
; <=  {((sc.input.V[10].X*20.2)+of.input.V[10].X)} {0.}
(assert (>= (+ (* sc_67 20.2) of_67) 0.))
; 
; >=  {((sc.input.V[10].O*20.2)+of.input.V[10].O)} {5.}
(assert (<= (+ (* sc_68 20.2) of_68) 5.))
; 
; <=  {((sc.input.V[10].O*20.2)+of.input.V[10].O)} {0.}
(assert (>= (+ (* sc_68 20.2) of_68) 0.))
...
(assert (= of_89 of_41))
; 
; =  {sc.input.V[17].O} {sc.vgain[9].Y}
(assert (= sc_86 sc_1))
; 
; =  {of.input.V[17].O} {of.vgain[9].Y}
(assert (= of_86 of_1))
; 
...
(assert (= of_95 of_27))
; 
; =  {sc.input.V[15].O} {sc.vgain[9].X}
(assert (= sc_70 sc_0))
; 
; =  {of.input.V[15].O} {of.vgain[9].X}
(assert (= of_70 of_0))
; 
...
(assert (= of_92 of_17))
; 
; =  {sc.input.V[12].O} {sc.vadd[7].OUT2_0}
(assert (= sc_60 sc_16))
; 
; =  {of.input.V[12].O} {of.vadd[7].OUT2_0}
(assert (= of_60 of_16))
; 
...
(assert (= of_36 of_6))
; 
; =  {sc.vadd[3].OUT2} {sc.vgain[6].Z}
(assert (= sc_36 sc_10))
; 
; =  {of.vadd[3].OUT2} {of.vgain[6].Z}
(assert (= of_36 of_10))
; 
...
(assert (= of_64 of_31))
; 
; =  {sc.input.V[10].O} {sc.vgain[6].X}
(assert (= sc_68 sc_8))
; 
; =  {of.input.V[10].O} {of.vgain[6].X}
(assert (= of_68 of_8))
; 
