...
(assert (= of_7 of_6))
; 
; >=  {((sc.input.I[4].X*-0.15)+of.input.I[4].X)} {10.}
(assert (<= (+ (* sc_6 -0.15) of_6) 10.))
; 
; <=  {((sc.input.I[4].X*-0.15)+of.input.I[4].X)} {0.}
(assert (>= (+ (* sc_6 -0.15) of_6) 0.))
; 
; >=  {((sc.input.I[4].O*-0.15)+of.input.I[4].O)} {10.}
(assert (<= (+ (* sc_7 -0.15) of_7) 10.))
; 
; <=  {((sc.input.I[4].O*-0.15)+of.input.I[4].O)} {0.}
...
(assert (= (+ (+ (* sc_31 0.11) of_31) sltop_31) 5.))
...
; 
; =  {sc.input.I[0].O} {sc.iadd[1].B}
(assert (= sc_3 sc_33))
; 
; =  {of.input.I[0].O} {of.iadd[1].B}
(assert (= of_3 of_33))
; 
...
(assert (= of_23 of_12))
; 
; =  {sc.input.I[2].O} {sc.mm[0].kr}
(assert (= sc_1 sc_16))
; 
; =  {of.input.I[2].O} {of.mm[0].kr}
(assert (= of_1 of_16))
; 
...
(assert (= of_29 of_17))
; 
; =  {sc.mm[0].XY} {sc.iadd[1].C}
(assert (= sc_22 sc_31))
; 
; =  {of.mm[0].XY} {of.iadd[1].C}
(assert (= of_22 of_31))
; 
...
(assert (= sc_22 sc_11))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
