...
; 
; =  {(((sc.vgain[0].X*0.15)+of.vgain[0].X)+sl.max.vgain[0].X)} {3300.}
...
; 
; =  {(((sc.vgain[0].P*0.066)+of.vgain[0].P)+sl.max.vgain[0].P)} {5445000.}
...
; 
; =  {(((sc.vgain[0].Z*0.11)+of.vgain[0].Z)+sl.max.vgain[0].Z)} {3300.}
...
; 
; =  {(((sc.iadd[2].C*0.)+of.iadd[2].C)+sl.min.iadd[2].C)} {0.}
(assert (= (+ (+ (* sc_59 0.) of_59) slbot_59) 0.))
; 
; =  {(((sc.iadd[2].C*0.11)+of.iadd[2].C)+sl.max.iadd[2].C)} {5.}
(assert (= (+ (+ (* sc_59 0.11) of_59) sltop_59) 5.))
...
; 
; =  {sc.vadd[1].OUT2} {sc.vtoi[2].X}
(assert (= sc_28 sc_29))
; 
; =  {of.vadd[1].OUT2} {of.vtoi[2].X}
(assert (= of_28 of_29))
; 
...
(assert (= of_5 of_58))
; 
; =  {sc.vtoi[2].Y} {sc.iadd[2].C}
(assert (= sc_31 sc_59))
; 
; =  {of.vtoi[2].Y} {of.iadd[2].C}
(assert (= of_31 of_59))
; 
...
(assert (= of_39 of_16))
; 
; =  {sc.input.I[1].O} {sc.iadd[2].B}
(assert (= sc_13 sc_61))
; 
; =  {of.input.I[1].O} {of.iadd[2].B}
(assert (= of_13 of_61))
; 
...
(assert (= of_62 of_63))
; 
; =  {sc.iadd[2].OUT} {sc.vgain[0].X}
(assert (= sc_62 sc_0))
; 
; =  {of.iadd[2].OUT} {of.vgain[0].X}
(assert (= of_62 of_0))
; 
...
(assert (= of_43 of_23))
; 
; =  {sc.input.V[10].O} {sc.vtoi[2].K}
(assert (= sc_47 sc_30))
; 
; =  {of.input.V[10].O} {of.vtoi[2].K}
(assert (= of_47 of_30))
; 
