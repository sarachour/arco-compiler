...
; 
; =  {(((sc.vadd[1].OUT2*0.11)+of.vadd[1].OUT2)+sl.max.vadd[1].OUT2)} {3300.}
...
(assert (= of_46 of_33))
(assert (<= (* sc_15 0.001) 0.1))
(assert (<= (* sc_19 0.001) 0.1))
; 
; =  {sc.output.V[2].O} {sc.output.V[3].O} {sc.mm[3].XY} {sc.vadd[1].OUT2}
(assert (and (and (= sc_15 sc_19) (= sc_15 sc_35)) (= sc_15 sc_28)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
