...
; 
; =  {(((sc.mm[0].X*0.11)+of.mm[0].X)+sl.max.mm[0].X)} {3300.}
...
; 
; =  {(((sc.mm[0].Y*0.15)+of.mm[0].Y)+sl.max.mm[0].Y)} {3300.}
(assert (= (+ (+ (* sc_30 0.15) of_30) sltop_30) 3300.))
; 
...
(assert (<= (* sc_13 0.001) 0.1))
; 
; =  {sc.output.V[2].O} {sc.output.V[3].O} {sc.vadd[2].OUT2} {sc.mm[0].XY}
(assert (and (and (= sc_9 sc_13) (= sc_9 sc_22)) (= sc_9 sc_29)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_14 0.) slbot_14 (- slbot_14)) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_49 0.) slbot_49 (- slbot_49))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_49 0.) sltop_49 (- sltop_49))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
