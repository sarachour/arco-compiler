...
(assert (= (+ (+ (* sc_54 0.11) of_54) sltop_54) 5.))
...
(assert (= of_52 of_1))
; 
; =  {sc.mm[3].XY} {sc.iadd[2].C}
(assert (= sc_35 sc_54))
; 
; =  {of.mm[3].XY} {of.iadd[2].C}
(assert (= of_35 of_54))
; 
