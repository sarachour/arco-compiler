...
; 
; =  {(((sc.vtoi[2].X*156.25)+of.vtoi[2].X)+sl.max.vtoi[2].X)} {3300.}
...
; 
; =  {(((sc.vtoi[2].Y*156.25)+of.vtoi[2].Y)+sl.max.vtoi[2].Y)} {3300.}
...
(assert (<= (+ (* sc_114 0.125) of_114) 3300.))
; 
; <=  {((sc.input.V[1].X*0.125)+of.input.V[1].X)} {0.}
(assert (>= (+ (* sc_114 0.125) of_114) 0.))
; 
; >=  {((sc.input.V[1].O*0.125)+of.input.V[1].O)} {3300.}
(assert (<= (+ (* sc_115 0.125) of_115) 3300.))
; 
; <=  {((sc.input.V[1].O*0.125)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_115 0.125) of_115) 0.))
...
(assert (= sc_117 sc_119))
; 
; =  {of.input.V[17].O} {of.itov[5].K}
(assert (= of_117 of_119))
; 
...
; 
; =  {sc.input.I[31].O} {sc.iadd[13].C}
(assert (= sc_20 sc_130))
; 
; =  {of.input.I[31].O} {of.iadd[13].C}
(assert (= of_20 of_130))
; 
...
(assert (= of_133 of_86))
; 
; =  {sc.input.I[32].O} {sc.iadd[13].D}
(assert (= sc_50 sc_129))
; 
; =  {of.input.I[32].O} {of.iadd[13].D}
(assert (= of_50 of_129))
; 
...
(assert (= of_10 of_146))
; 
; =  {sc.vtoi[2].Y} {sc.ihill[0].S}
(assert (= sc_81 sc_74))
; 
; =  {of.vtoi[2].Y} {of.ihill[0].S}
(assert (= of_81 of_74))
; 
...
(assert (= of_143 of_82))
; 
; =  {sc.input.I[33].O} {sc.iadd[13].A}
(assert (= sc_34 sc_131))
; 
; =  {of.input.I[33].O} {of.iadd[13].A}
(assert (= of_34 of_131))
; 
...
(assert (= of_103 of_4))
; 
; =  {sc.input.V[16].O} {sc.vtoi[2].K}
(assert (= sc_107 sc_80))
; 
; =  {of.input.V[16].O} {of.vtoi[2].K}
(assert (= of_107 of_80))
; 
...
(assert (and (and (= sc_65 sc_56) (= sc_65 sc_72)) (= sc_65 sc_58)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_128 0.) slbot_128 (- slbot_128)) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= slbot_122 0.) slbot_122 (- slbot_122))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_122 0.) sltop_122 (- sltop_122))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8)))))
(check-sat)
