...
; 
; =  {(((sc.iadd[6].B*15.6)+of.iadd[6].B)+sl.max.iadd[6].B)} {5.}
...
(assert (= of_93 of_63))
; 
; =  {sc.input.I[26].O} {sc.itov[10].X}
(assert (= sc_26 sc_115))
; 
; =  {of.input.I[26].O} {of.itov[10].X}
(assert (= of_26 of_115))
; 
; =  {sc.input.I[25].O} {sc.iadd[6].A}
(assert (= sc_48 sc_125))
; 
; =  {of.input.I[25].O} {of.iadd[6].A}
(assert (= of_48 of_125))
; 
...
(assert (= of_34 of_118))
; 
; =  {sc.switch[3].PROD} {sc.iadd[6].B}
(assert (= sc_8 sc_126))
; 
; =  {of.switch[3].PROD} {of.iadd[6].B}
(assert (= of_8 of_126))
; 
...
; 
; =  {sc.input.I[24].O} {sc.iadd[6].D}
(assert (= sc_36 sc_123))
; 
; =  {of.input.I[24].O} {of.iadd[6].D}
(assert (= of_36 of_123))
; 
...
(assert (= of_61 of_75))
; 
; =  {sc.input.I[23].O} {sc.iadd[6].C}
(assert (= sc_46 sc_124))
; 
; =  {of.input.I[23].O} {of.iadd[6].C}
(assert (= of_46 of_124))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_122 0.) slbot_122 (- slbot_122))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= slbot_131 0.) slbot_131 (- slbot_131))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= sltop_131 0.) sltop_131 (- sltop_131))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_122 0.) sltop_122 (- sltop_122))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
