...
(assert (<= (+ (* sc_121 0.5) of_121) 3300.))
; 
; <=  {((sc.vadd[1].OUT2_0*0.5)+of.vadd[1].OUT2_0)} {0.}
(assert (>= (+ (* sc_121 0.5) of_121) 0.))
; 
...
(assert (<= (+ (* sc_128 0.35) of_128) 3300.))
; 
; <=  {((sc.vadd[28].OUT2_0*0.35)+of.vadd[28].OUT2_0)} {0.}
(assert (>= (+ (* sc_128 0.35) of_128) 0.))
; 
...
(assert (= (+ (+ (* sc_133 0.000362037485643) of_133) slbot_133) -1650.))
; 
; =  {(((sc.vadd[28].OUT*3535.53390593)+of.vadd[28].OUT)+sl.max.vadd[28].OUT)} {1650.}
(assert (= (+ (+ (* sc_133 3535.53390593) of_133) sltop_133) 1650.))
(declare-fun slbot_134 () Real)
(declare-fun sltop_134 () Real)
; 
; =  {(((sc.vadd[28].OUT2*0.)+of.vadd[28].OUT2)+sl.min.vadd[28].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_141 0.) of_141) slbot_141) 1.))
; 
...
(assert (= (+ (+ (* sc_143 156.25) of_143) sltop_143) 3300.))
...
(assert (= (+ (+ (* sc_145 0.176776695297) of_145) slbot_145) 1.))
; 
; =  {(((sc.vtoi[10].K*1.)+of.vtoi[10].K)+sl.max.vtoi[10].K)} {3300.}
(assert (= (+ (+ (* sc_145 1.) of_145) sltop_145) 3300.))
(declare-fun slbot_146 () Real)
(declare-fun sltop_146 () Real)
; 
; =  {(((sc.vtoi[10].Y*1.)+of.vtoi[10].Y)+sl.min.vtoi[10].Y)} {0.00030303030303}
...
(assert (= of_150 0.))
; 
; =  {sc.vtoi[21].Y} {((1./sc.vtoi[21].K)*sc.vtoi[21].X)}
...
; 
; =  {(((sc.vtoi[21].X*0.)+of.vtoi[21].X)+sl.min.vtoi[21].X)} {1.}
(assert (= (+ (+ (* sc_150 0.) of_150) slbot_150) 1.))
; 
; =  {(((sc.vtoi[21].X*156.25)+of.vtoi[21].X)+sl.max.vtoi[21].X)} {3300.}
(assert (= (+ (+ (* sc_150 156.25) of_150) sltop_150) 3300.))
; 
; >=  {((sc.vtoi[21].K*1.)+of.vtoi[21].K)} {3300.}
(assert (<= (+ (* sc_151 1.) of_151) 3300.))
; 
; <=  {((sc.vtoi[21].K*1.)+of.vtoi[21].K)} {1.}
(assert (>= (+ (* sc_151 1.) of_151) 1.))
(declare-fun slbot_152 () Real)
(declare-fun sltop_152 () Real)
; 
; =  {(((sc.vtoi[21].Y*0.)+of.vtoi[21].Y)+sl.min.vtoi[21].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_152 0.) of_152) slbot_152) 0.00030303030303))
; 
; =  {(((sc.vtoi[21].Y*156.25)+of.vtoi[21].Y)+sl.max.vtoi[21].Y)} {3300.}
...
(assert (= (+ (+ (* sc_153 27.6213586401) of_153) slbot_153) 1.))
; 
...
(assert (= (+ (+ (* sc_155 0.000512) of_155) sltop_155) 3300.))
...
(assert (= (+ (+ (* sc_154 305175.78125) of_154) sltop_154) 3300.))
(declare-fun slbot_155 () Real)
(declare-fun sltop_155 () Real)
; 
; =  {(((sc.vtoi[4].Y*0.)+of.vtoi[4].Y)+sl.min.vtoi[4].Y)} {0.00030303030303}
...
(assert (= (+ (+ (* sc_158 305175.78125) of_158) sltop_158) 3300.))
...
(assert (<= (+ (* sc_167 2.5) of_167) 3300.))
; 
; <=  {((sc.input.V[8].X*2.5)+of.input.V[8].X)} {0.}
(assert (>= (+ (* sc_167 2.5) of_167) 0.))
; 
; >=  {((sc.input.V[8].O*2.5)+of.input.V[8].O)} {3300.}
(assert (<= (+ (* sc_168 2.5) of_168) 3300.))
; 
; <=  {((sc.input.V[8].O*2.5)+of.input.V[8].O)} {0.}
(assert (>= (+ (* sc_168 2.5) of_168) 0.))
...
(assert (<= (+ (* sc_171 2.0015) of_171) 3300.))
; 
; <=  {((sc.input.V[7].X*2.0015)+of.input.V[7].X)} {0.}
(assert (>= (+ (* sc_171 2.0015) of_171) 0.))
; 
; >=  {((sc.input.V[7].O*2.0015)+of.input.V[7].O)} {3300.}
(assert (<= (+ (* sc_172 2.0015) of_172) 3300.))
; 
; <=  {((sc.input.V[7].O*2.0015)+of.input.V[7].O)} {0.}
(assert (>= (+ (* sc_172 2.0015) of_172) 0.))
...
(assert (= of_252 0.))
; 
; >=  {((sc.itov[27].X*1.)+of.itov[27].X)} {10.}
(assert (<= (+ (* sc_250 1.) of_250) 10.))
; 
; <=  {((sc.itov[27].X*1.)+of.itov[27].X)} {0.0001}
(assert (>= (+ (* sc_250 1.) of_250) 0.0001))
(declare-fun slbot_251 () Real)
(declare-fun sltop_251 () Real)
; 
; =  {(((sc.itov[27].K*9.05093714108e-05)+of.itov[27].K)+sl.min.itov[27].K)} {1.}
(assert (= (+ (+ (* sc_251 9.05093714108e-05) of_251) slbot_251) 1.))
; 
; =  {(((sc.itov[27].K*883.883476483)+of.itov[27].K)+sl.max.itov[27].K)} {330.}
(assert (= (+ (+ (* sc_251 883.883476483) of_251) sltop_251) 330.))
...
(assert (= sc_149 sc_285))
; 
; =  {of.vtoi[15].Y} {of.iadd[14].B}
(assert (= of_149 of_285))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].X}
(assert (= sc_127 sc_117))
; 
; =  {of.vadd[1].OUT2} {of.output.V[0].X}
(assert (= of_127 of_117))
; 
; =  {sc.vadd[1].OUT2} {sc.vtoi[21].X}
(assert (= sc_127 sc_150))
; 
; =  {of.vadd[1].OUT2} {of.vtoi[21].X}
(assert (= of_127 of_150))
; 
; =  {sc.vadd[1].OUT2} {sc.vtoi[20].X}
(assert (= sc_127 sc_141))
; 
; =  {of.vadd[1].OUT2} {of.vtoi[20].X}
(assert (= of_127 of_141))
; 
...
(assert (= sc_134 sc_119))
; 
; =  {of.vadd[28].OUT2} {of.output.V[1].X}
(assert (= of_134 of_119))
; 
...
(assert (= sc_198 sc_131))
; 
; =  {of.input.V[15].O} {of.vadd[28].A}
(assert (= of_198 of_131))
; 
...
(assert (= sc_116 sc_268))
; 
; =  {of.input.I[22].O} {of.iadd[29].C}
(assert (= of_116 of_268))
; 
; =  {sc.input.I[32].O} {sc.itov[27].X}
(assert (= sc_110 sc_250))
; 
; =  {of.input.I[32].O} {of.itov[27].X}
(assert (= of_110 of_250))
; 
...
(assert (= sc_204 sc_123))
; 
; =  {of.input.V[14].O} {of.vadd[1].C}
(assert (= of_204 of_123))
; 
; =  {sc.vtoi[20].Y} {sc.ihill[3].Km}
(assert (= sc_143 sc_137))
; 
; =  {of.vtoi[20].Y} {of.ihill[3].Km}
(assert (= of_143 of_137))
; 
...
(assert (= sc_210 sc_248))
; 
; =  {of.input.V[37].O} {of.itov[31].K}
(assert (= of_210 of_248))
; 
...
(assert (= sc_218 sc_147))
; 
; =  {of.input.V[30].O} {of.vtoi[15].X}
(assert (= of_218 of_147))
; 
...
(assert (= sc_166 sc_245))
; 
; =  {of.input.V[29].O} {of.itov[12].K}
(assert (= of_166 of_245))
; 
...
(assert (= of_86 of_270))
; 
; =  {sc.vtoi[21].Y} {sc.iadd[2].B}
(assert (= sc_152 sc_265))
; 
; =  {of.vtoi[21].Y} {of.iadd[2].B}
(assert (= of_152 of_265))
; 
; =  {sc.input.V[16].O} {sc.vadd[28].C}
(assert (= sc_212 sc_130))
; 
; =  {of.input.V[16].O} {of.vadd[28].C}
(assert (= of_212 of_130))
; 
...
(assert (= sc_158 sc_290))
; 
; =  {of.vtoi[22].Y} {of.iadd[21].B}
(assert (= of_158 of_290))
; 
...
(assert (= sc_155 sc_138))
; 
; =  {of.vtoi[4].Y} {of.ihill[3].Vmax}
(assert (= of_155 of_138))
; 
...
(assert (= sc_232 sc_121))
; 
; =  {of.input.V[17].O} {of.vadd[1].OUT2_0}
(assert (= of_232 of_121))
; 
...
(assert (= sc_112 sc_289))
; 
; =  {of.input.I[18].O} {of.iadd[21].A}
(assert (= of_112 of_289))
; 
...
(assert (= of_98 of_263))
; 
; =  {sc.ihill[3].REP} {sc.itov[27].K}
(assert (= sc_140 sc_251))
; 
; =  {of.ihill[3].REP} {of.itov[27].K}
(assert (= of_140 of_251))
; 
; =  {sc.input.V[42].O} {sc.vtoi[21].K}
(assert (= sc_188 sc_151))
; 
; =  {of.input.V[42].O} {of.vtoi[21].K}
...
(assert (= sc_168 sc_135))
; 
; =  {of.input.V[8].O} {of.ihill[3].n}
(assert (= of_168 of_135))
; 
...
(assert (= of_216 of_12))
; 
; =  {sc.input.V[43].O} {sc.vtoi[20].K}
(assert (= sc_164 sc_142))
; 
; =  {of.input.V[43].O} {of.vtoi[20].K}
(assert (= of_164 of_142))
; 
; =  {sc.input.V[19].O} {sc.vadd[28].D}
(assert (= sc_236 sc_129))
; 
; =  {of.input.V[19].O} {of.vadd[28].D}
(assert (= of_236 of_129))
; 
...
(assert (= sc_146 sc_280))
; 
; =  {of.vtoi[10].Y} {of.iadd[9].B}
(assert (= of_146 of_280))
; 
; =  {sc.input.I[1].O} {sc.ihill[3].S}
(assert (= sc_104 sc_136))
; 
; =  {of.input.I[1].O} {of.ihill[3].S}
(assert (= of_104 of_136))
; 
...
(assert (= sc_214 sc_254))
; 
; =  {of.input.V[24].O} {of.itov[6].K}
(assert (= of_214 of_254))
; 
...
(assert (and (and (= sc_127 sc_118) (= sc_127 sc_134)) (= sc_127 sc_120)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_158 0.) sltop_158 (- sltop_158))) (ite (>= slbot_300 0.) slbot_300 (- slbot_300))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= sltop_296 0.) sltop_296 (- sltop_296))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_244 0.) sltop_244 (- sltop_244))) (ite (>= slbot_150 0.) slbot_150 (- slbot_150))) (ite (>= slbot_280 0.) slbot_280 (- slbot_280))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_267 0.) slbot_267 (- slbot_267))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_146 0.) sltop_146 (- sltop_146))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= sltop_295 0.) sltop_295 (- sltop_295))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_249 0.) sltop_249 (- sltop_249))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_255 0.) slbot_255 (- slbot_255))) (ite (>= slbot_301 0.) slbot_301 (- slbot_301))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_246 0.) sltop_246 (- sltop_246))) (ite (>= sltop_290 0.) sltop_290 (- sltop_290))) (ite (>= slbot_258 0.) slbot_258 (- slbot_258))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_252 0.) slbot_252 (- slbot_252))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_256 0.) slbot_256 (- slbot_256))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_281 0.) slbot_281 (- slbot_281))) (ite (>= sltop_280 0.) sltop_280 (- sltop_280))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= sltop_247 0.) sltop_247 (- sltop_247))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_290 0.) slbot_290 (- slbot_290))) (ite (>= slbot_297 0.) slbot_297 (- slbot_297))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_259 0.) slbot_259 (- slbot_259))) (ite (>= sltop_267 0.) sltop_267 (- sltop_267))) (ite (>= sltop_281 0.) sltop_281 (- sltop_281))) (ite (>= sltop_256 0.) sltop_256 (- sltop_256))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_241 0.) slbot_241 (- slbot_241))) (ite (>= slbot_246 0.) slbot_246 (- slbot_246))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_247 0.) slbot_247 (- slbot_247))) (ite (>= sltop_276 0.) sltop_276 (- sltop_276))) (ite (>= sltop_300 0.) sltop_300 (- sltop_300))) (ite (>= slbot_276 0.) slbot_276 (- slbot_276))) (ite (>= slbot_244 0.) slbot_244 (- slbot_244))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_286 0.) sltop_286 (- sltop_286))) (ite (>= sltop_271 0.) sltop_271 (- sltop_271))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= slbot_251 0.) slbot_251 (- slbot_251))) (ite (>= slbot_286 0.) slbot_286 (- slbot_286))) (ite (>= slbot_261 0.) slbot_261 (- slbot_261))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_149 0.) sltop_149 (- sltop_149))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= sltop_291 0.) sltop_291 (- sltop_291))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= sltop_255 0.) sltop_255 (- sltop_255))) (ite (>= sltop_261 0.) sltop_261 (- sltop_261))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= sltop_150 0.) sltop_150 (- sltop_150))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_243 0.) sltop_243 (- sltop_243))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= sltop_265 0.) sltop_265 (- sltop_265))) (ite (>= slbot_291 0.) slbot_291 (- slbot_291))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_271 0.) slbot_271 (- slbot_271))) (ite (>= slbot_266 0.) slbot_266 (- slbot_266))) (ite (>= sltop_275 0.) sltop_275 (- sltop_275))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= sltop_241 0.) sltop_241 (- sltop_241))) (ite (>= slbot_253 0.) slbot_253 (- slbot_253))) (ite (>= sltop_258 0.) sltop_258 (- sltop_258))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_285 0.) slbot_285 (- slbot_285))) (ite (>= sltop_251 0.) sltop_251 (- sltop_251))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= slbot_158 0.) slbot_158 (- slbot_158))) (ite (>= slbot_296 0.) slbot_296 (- slbot_296))) (ite (>= slbot_243 0.) slbot_243 (- slbot_243))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= sltop_259 0.) sltop_259 (- sltop_259))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_155 0.) slbot_155 (- slbot_155))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_266 0.) sltop_266 (- sltop_266))) (ite (>= sltop_297 0.) sltop_297 (- sltop_297))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= sltop_285 0.) sltop_285 (- sltop_285))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_265 0.) slbot_265 (- slbot_265))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_249 0.) slbot_249 (- slbot_249))) (ite (>= sltop_155 0.) sltop_155 (- sltop_155))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= slbot_295 0.) slbot_295 (- slbot_295))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_301 0.) sltop_301 (- sltop_301))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_146 0.) slbot_146 (- slbot_146))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_252 0.) sltop_252 (- sltop_252))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_275 0.) slbot_275 (- slbot_275))) (ite (>= slbot_149 0.) slbot_149 (- slbot_149))) (ite (>= sltop_253 0.) sltop_253 (- sltop_253)))))
(check-sat)
