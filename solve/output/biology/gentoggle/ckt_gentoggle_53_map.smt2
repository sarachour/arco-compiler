...
(assert (= of_75 of_54))
; 
; =  {sc.input.I[16].O} {sc.itov[5].X}
(assert (= sc_20 sc_86))
; 
; =  {of.input.I[16].O} {of.itov[5].X}
(assert (= of_20 of_86))
; 
...
(assert (= of_55 of_48))
; 
; =  {sc.input.I[14].O} {sc.iadd[0].D}
(assert (= sc_18 sc_92))
; 
; =  {of.input.I[14].O} {of.iadd[0].D}
(assert (= of_18 of_92))
; 
...
(assert (= of_39 of_53))
; 
; =  {sc.input.I[15].O} {sc.iadd[0].A}
(assert (= sc_16 sc_94))
; 
; =  {of.input.I[15].O} {of.iadd[0].A}
(assert (= of_16 of_94))
; 
...
(assert (= of_28 of_50))
; 
; =  {sc.input.I[13].O} {sc.iadd[0].C}
(assert (= sc_12 sc_93))
; 
; =  {of.input.I[13].O} {of.iadd[0].C}
(assert (= of_12 of_93))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_14 0.) slbot_14 (- slbot_14)) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
