...
(assert (= (+ (+ (* sc_75 -0.6) of_75) slbot_75) 0.00030303030303))
; 
; =  {(((sc.vtoi[2].Y*0.)+of.vtoi[2].Y)+sl.max.vtoi[2].Y)} {3300.}
(assert (= (+ (+ (* sc_75 0.) of_75) sltop_75) 3300.))
; 
...
(assert (= of_98 of_74))
; 
; =  {sc.input.I[26].O} {sc.iadd[8].C}
(assert (= sc_28 sc_124))
; 
; =  {of.input.I[26].O} {of.iadd[8].C}
(assert (= of_28 of_124))
; 
...
(assert (= of_96 of_4))
; 
; =  {sc.input.I[29].O} {sc.itov[12].X}
(assert (= sc_12 sc_117))
; 
; =  {of.input.I[29].O} {of.itov[12].X}
(assert (= of_12 of_117))
; 
...
(assert (= of_75 of_128))
; 
; =  {sc.input.V[19].O} {sc.vtoi[5].K}
(assert (= sc_116 sc_77))
; 
; =  {of.input.V[19].O} {of.vtoi[5].K}
(assert (= of_116 of_77))
; 
...
(assert (= of_92 of_60))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[5].X}
(assert (= sc_59 sc_76))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[5].X}
(assert (= of_59 of_76))
; 
...
(assert (= of_14 of_131))
; 
; =  {sc.input.I[27].O} {sc.iadd[8].B}
(assert (= sc_32 sc_126))
; 
; =  {of.input.I[27].O} {of.iadd[8].B}
(assert (= of_32 of_126))
; 
...
(assert (= of_106 of_63))
; 
; =  {sc.input.I[28].O} {sc.iadd[8].D}
(assert (= sc_46 sc_123))
; 
; =  {of.input.I[28].O} {of.iadd[8].D}
(assert (= of_46 of_123))
; 
