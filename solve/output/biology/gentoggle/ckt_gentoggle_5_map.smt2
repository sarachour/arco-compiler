...
; 
; >=  {((sc.vgain[8].Y*0.125)+of.vgain[8].Y)} {3300.}
(assert (<= (+ (* sc_1 0.125) of_1) 3300.))
; 
; <=  {((sc.vgain[8].Y*0.125)+of.vgain[8].Y)} {1.}
(assert (>= (+ (* sc_1 0.125) of_1) 1.))
(declare-fun slbot_3 () Real)
(declare-fun sltop_3 () Real)
; 
; =  {(((sc.vgain[8].P*3.75903614458)+of.vgain[8].P)+sl.min.vgain[8].P)} {1.51515151515e-12}
(assert (= (+ (+ (* sc_3 3.75903614458) of_3) slbot_3) 1.51515151515e-12))
; 
; =  {(((sc.vgain[8].P*62.4)+of.vgain[8].P)+sl.max.vgain[8].P)} {5445000.}
(assert (= (+ (+ (* sc_3 62.4) of_3) sltop_3) 5445000.))
(declare-fun slbot_2 () Real)
(declare-fun sltop_2 () Real)
; 
; =  {(((sc.vgain[8].Z*0.939759036145)+of.vgain[8].Z)+sl.min.vgain[8].Z)} {0.0001}
(assert (= (+ (+ (* sc_2 0.939759036145) of_2) slbot_2) 0.0001))
; 
; =  {(((sc.vgain[8].Z*15.6)+of.vgain[8].Z)+sl.max.vgain[8].Z)} {3300.}
...
; 
; <=  {((sc.switch[2].n*-500.)+of.switch[2].n)} {0.5}
(assert (>= (+ (* sc_4 -500.) of_4) 0.5))
; 
; >=  {((sc.switch[2].SUB*-2.)+of.switch[2].SUB)} {10.}
(assert (<= (+ (* sc_5 -2.) of_5) 10.))
; 
; <=  {((sc.switch[2].SUB*-2.)+of.switch[2].SUB)} {0.0001}
(assert (>= (+ (* sc_5 -2.) of_5) 0.0001))
; 
...
; 
; =  {(((sc.switch[2].PROD*-0.6)+of.switch[2].PROD)+sl.min.switch[2].PROD)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_8 -0.6) of_8) slbot_8) 9.99934002508e-38))
; 
; =  {(((sc.switch[2].PROD*0.)+of.switch[2].PROD)+sl.max.switch[2].PROD)} {9.9999999}
...
; 
; =  {(((sc.switch[2].Vmax*0.6)+of.switch[2].Vmax)+sl.max.switch[2].Vmax)} {10.}
(assert (= (+ (+ (* sc_7 0.6) of_7) sltop_7) 10.))
(declare-fun slbot_8 () Real)
(declare-fun sltop_8 () Real)
; 
; =  {(((sc.switch[2].PROD*-0.6)+of.switch[2].PROD)+sl.min.switch[2].PROD)} {9.99934002508e-38}
...
(assert (<= (+ (* sc_23 -2.) of_23) 10.))
; 
; <=  {((sc.input.I[12].O*-2.)+of.input.I[12].O)} {0.}
(assert (>= (+ (* sc_23 -2.) of_23) 0.))
...
(assert (>= (+ (* sc_52 156.25) of_52) 0.))
; 
; >=  {((sc.input.I[1].O*156.25)+of.input.I[1].O)} {10.}
(assert (<= (+ (* sc_53 156.25) of_53) 10.))
; 
; <=  {((sc.input.I[1].O*156.25)+of.input.I[1].O)} {0.}
(assert (>= (+ (* sc_53 156.25) of_53) 0.))
...
; 
; >=  {((sc.vadd[9].D*4.)+of.vadd[9].D)} {3300.}
(assert (<= (+ (* sc_63 4.) of_63) 3300.))
; 
; <=  {((sc.vadd[9].D*4.)+of.vadd[9].D)} {0.}
...
; 
; =  {(((sc.vadd[9].OUT2*156.25)+of.vadd[9].OUT2)+sl.max.vadd[9].OUT2)} {3300.}
(assert (= (+ (+ (* sc_68 156.25) of_68) sltop_68) 3300.))
(declare-fun slbot_66 () Real)
(declare-fun sltop_66 () Real)
; 
; =  {(((sc.vadd[9].B*3.75903614458)+of.vadd[9].B)+sl.min.vadd[9].B)} {0.}
(assert (= (+ (+ (* sc_66 3.75903614458) of_66) slbot_66) 0.))
; 
; =  {(((sc.vadd[9].B*62.4)+of.vadd[9].B)+sl.max.vadd[9].B)} {3300.}
(assert (= (+ (+ (* sc_66 62.4) of_66) sltop_66) 3300.))
(declare-fun slbot_67 () Real)
(declare-fun sltop_67 () Real)
; 
; =  {(((sc.vadd[9].OUT*3.75903614458)+of.vadd[9].OUT)+sl.min.vadd[9].OUT)} {-1650.}
(assert (= (+ (+ (* sc_67 3.75903614458) of_67) slbot_67) -1650.))
; 
; =  {(((sc.vadd[9].OUT*62.4)+of.vadd[9].OUT)+sl.max.vadd[9].OUT)} {1650.}
(assert (= (+ (+ (* sc_67 62.4) of_67) sltop_67) 1650.))
(declare-fun slbot_68 () Real)
(declare-fun sltop_68 () Real)
; 
; =  {(((sc.vadd[9].OUT2*0.)+of.vadd[9].OUT2)+sl.min.vadd[9].OUT2)} {0.}
...
(assert (= sc_81 (* sc_79 (/ 1. 1.))))
; 
; =  {of.ihill[0].REP} {0.}
(assert (= of_81 0.))
; 
; >=  {((sc.ihill[0].n*2.5)+of.ihill[0].n)} {5.}
(assert (<= (+ (* sc_76 2.5) of_76) 5.))
; 
; <=  {((sc.ihill[0].n*2.5)+of.ihill[0].n)} {1.}
(assert (>= (+ (* sc_76 2.5) of_76) 1.))
...
(assert (= (+ (+ (* sc_77 156.25) of_77) sltop_77) 10.))
...
(assert (= (+ (+ (* sc_81 0.000511998322284) of_81) slbot_81) 9.999900001e-10))
; 
; =  {(((sc.ihill[0].REP*156.25)+of.ihill[0].REP)+sl.max.ihill[0].REP)} {5.}
(assert (= (+ (+ (* sc_81 156.25) of_81) sltop_81) 5.))
; 
; >=  {((sc.ihill[0].Vmax*156.25)+of.ihill[0].Vmax)} {10.}
(assert (<= (+ (* sc_79 156.25) of_79) 10.))
; 
; <=  {((sc.ihill[0].Vmax*156.25)+of.ihill[0].Vmax)} {0.0001}
(assert (>= (+ (* sc_79 156.25) of_79) 0.0001))
...
(assert (= (+ (+ (* sc_85 -1.) of_85) slbot_85) 0.0001))
; 
; =  {(((sc.igenebind[6].TF*-0.4)+of.igenebind[6].TF)+sl.max.igenebind[6].TF)} {10.}
(assert (= (+ (+ (* sc_85 -0.4) of_85) sltop_85) 10.))
; 
...
(assert (= (+ (+ (* sc_88 0.) of_88) slbot_88) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[6].GE*1.66666666667)+of.igenebind[6].GE)+sl.max.igenebind[6].GE)} {9.9999999}
(assert (= (+ (+ (* sc_88 1.66666666667) of_88) sltop_88) 9.9999999))
; 
...
(assert (<= (+ (* sc_103 2.5) of_103) 3300.))
; 
; <=  {((sc.input.V[0].X*2.5)+of.input.V[0].X)} {0.}
(assert (>= (+ (* sc_103 2.5) of_103) 0.))
; 
; >=  {((sc.input.V[0].O*2.5)+of.input.V[0].O)} {3300.}
(assert (<= (+ (* sc_104 2.5) of_104) 3300.))
; 
; <=  {((sc.input.V[0].O*2.5)+of.input.V[0].O)} {0.}
(assert (>= (+ (* sc_104 2.5) of_104) 0.))
...
(assert (<= (+ (* sc_106 1000.75) of_106) 3300.))
; 
; <=  {((sc.input.V[11].O*1000.75)+of.input.V[11].O)} {0.}
(assert (>= (+ (* sc_106 1000.75) of_106) 0.))
...
; 
; =  {(((sc.itov[12].X*0.939759036145)+of.itov[12].X)+sl.min.itov[12].X)} {0.0001}
(assert (= (+ (+ (* sc_123 0.939759036145) of_123) slbot_123) 0.0001))
; 
; =  {(((sc.itov[12].X*15.6)+of.itov[12].X)+sl.max.itov[12].X)} {10.}
...
; 
; =  {(((sc.itov[12].Y*0.939759036145)+of.itov[12].Y)+sl.min.itov[12].Y)} {0.0001}
(assert (= (+ (+ (* sc_125 0.939759036145) of_125) slbot_125) 0.0001))
; 
; =  {(((sc.itov[12].Y*15.6)+of.itov[12].Y)+sl.max.itov[12].Y)} {3300.}
...
; 
; =  {(((sc.iadd[7].D*-0.6)+of.iadd[7].D)+sl.min.iadd[7].D)} {0.}
(assert (= (+ (+ (* sc_134 -0.6) of_134) slbot_134) 0.))
; 
; =  {(((sc.iadd[7].D*0.)+of.iadd[7].D)+sl.max.iadd[7].D)} {5.}
(assert (= (+ (+ (* sc_134 0.) of_134) sltop_134) 5.))
; 
; >=  {((sc.iadd[7].C*1.)+of.iadd[7].C)} {5.}
(assert (<= (+ (* sc_135 1.) of_135) 5.))
; 
; <=  {((sc.iadd[7].C*1.)+of.iadd[7].C)} {0.}
...
; 
; =  {(((sc.iadd[7].OUT*-0.4)+of.iadd[7].OUT)+sl.max.iadd[7].OUT)} {10.}
(assert (= (+ (+ (* sc_138 -0.4) of_138) sltop_138) 10.))
; 
...
(assert (= (+ (+ (* sc_148 1.66666666667) of_148) sltop_148) 10.))
; 
...
(assert (= (+ (+ (* sc_147 1.66666666667) of_147) sltop_147) 5.))
(declare-fun slbot_148 () Real)
(declare-fun sltop_148 () Real)
; 
; =  {(((sc.iadd[5].OUT*0.)+of.iadd[5].OUT)+sl.min.iadd[5].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_148 1.66666666667) of_148) sltop_148) 10.))
; 
; =  {sc.itov[12].Y} {sc.vgain[8].Z}
(assert (= sc_125 sc_2))
; 
; =  {of.itov[12].Y} {of.vgain[8].Z}
(assert (= of_125 of_2))
; 
; =  {sc.input.I[6].O} {sc.iadd[5].A}
(assert (= sc_35 sc_146))
; 
; =  {of.input.I[6].O} {of.iadd[5].A}
(assert (= of_35 of_146))
; 
...
(assert (= of_3 of_66))
; 
; =  {sc.input.I[0].O} {sc.switch[2].Vmax}
(assert (= sc_27 sc_7))
; 
; =  {of.input.I[0].O} {of.switch[2].Vmax}
(assert (= of_27 of_7))
; 
; =  {sc.input.V[9].O} {sc.vadd[9].D}
(assert (= sc_102 sc_63))
; 
; =  {of.input.V[9].O} {of.vadd[9].D}
(assert (= of_102 of_63))
; 
...
(assert (= of_51 of_130))
; 
; =  {sc.input.I[18].O} {sc.iadd[7].C}
(assert (= sc_57 sc_135))
; 
; =  {of.input.I[18].O} {of.iadd[7].C}
(assert (= of_57 of_135))
; 
; =  {sc.input.I[9].O} {sc.iadd[7].B}
(assert (= sc_25 sc_137))
; 
; =  {of.input.I[9].O} {of.iadd[7].B}
(assert (= of_25 of_137))
; 
...
(assert (= of_41 of_87))
; 
; =  {sc.input.I[5].O} {sc.iadd[5].D}
(assert (= sc_47 sc_144))
; 
; =  {of.input.I[5].O} {of.iadd[5].D}
(assert (= of_47 of_144))
; 
; =  {sc.input.V[14].O} {sc.itov[12].K}
(assert (= sc_114 sc_124))
; 
; =  {of.input.V[14].O} {of.itov[12].K}
(assert (= of_114 of_124))
; 
...
(assert (= of_37 of_90))
; 
; =  {sc.switch[3].PROD} {sc.iadd[8].A}
(assert (= sc_13 sc_131))
; 
; =  {of.switch[3].PROD} {of.iadd[8].A}
(assert (= of_13 of_131))
; 
...
(assert (= of_96 of_4))
; 
; =  {sc.input.I[2].O} {sc.iadd[4].D}
(assert (= sc_15 sc_139))
; 
; =  {of.input.I[2].O} {of.iadd[4].D}
(assert (= of_15 of_139))
; 
; =  {sc.input.V[12].O} {sc.vgain[8].X}
(assert (= sc_100 sc_0))
; 
; =  {of.input.V[12].O} {of.vgain[8].X}
(assert (= of_100 of_0))
; 
; =  {sc.input.V[2].O} {sc.vadd[9].A}
(assert (= sc_94 sc_65))
; 
; =  {of.input.V[2].O} {of.vadd[9].A}
(assert (= of_94 of_65))
; 
; =  {sc.input.V[3].O} {sc.vadd[9].C}
(assert (= sc_116 sc_64))
; 
; =  {of.input.V[3].O} {of.vadd[9].C}
(assert (= of_116 of_64))
; 
; =  {sc.iadd[5].OUT} {sc.iadd[4].B}
(assert (= sc_148 sc_142))
; 
; =  {of.iadd[5].OUT} {of.iadd[4].B}
(assert (= of_148 of_142))
; 
; =  {sc.input.I[24].O} {sc.iadd[8].B}
(assert (= sc_39 sc_132))
; 
; =  {of.input.I[24].O} {of.iadd[8].B}
(assert (= of_39 of_132))
; 
; =  {sc.input.I[15].O} {sc.switch[2].Kmod}
(assert (= sc_33 sc_6))
; 
; =  {of.input.I[15].O} {of.switch[2].Kmod}
(assert (= of_33 of_6))
; 
...
(assert (= of_53 of_79))
; 
; =  {sc.input.I[12].O} {sc.switch[2].SUB}
(assert (= sc_23 sc_5))
; 
; =  {of.input.I[12].O} {of.switch[2].SUB}
(assert (= of_23 of_5))
; 
...
(assert (= of_75 of_60))
; 
; =  {sc.vadd[11].OUT2} {sc.switch[3].Vmax}
(assert (= sc_75 sc_12))
; 
; =  {of.vadd[11].OUT2} {of.switch[3].Vmax}
(assert (= of_75 of_12))
; 
...
(assert (= of_138 of_85))
; 
; =  {sc.input.I[13].O} {sc.itov[10].X}
(assert (= sc_21 sc_126))
; 
; =  {of.input.I[13].O} {of.itov[10].X}
(assert (= of_21 of_126))
; 
...
(assert (= of_122 of_1))
; 
; =  {sc.input.I[7].O} {sc.iadd[5].C}
(assert (= sc_19 sc_145))
; 
; =  {of.input.I[7].O} {of.iadd[5].C}
(assert (= of_19 of_145))
; 
; =  {sc.input.I[17].O} {sc.igenebind[6].K}
(assert (= sc_55 sc_86))
; 
; =  {of.input.I[17].O} {of.igenebind[6].K}
(assert (= of_55 of_86))
; 
...
(assert (= of_98 of_62))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[1].X}
(assert (= sc_68 sc_82))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[1].X}
(assert (= of_68 of_82))
; 
...
(assert (= of_68 of_58))
; 
; =  {sc.igenebind[1].GE} {sc.itov[12].X}
(assert (= sc_92 sc_123))
; 
; =  {of.igenebind[1].GE} {of.itov[12].X}
(assert (= of_92 of_123))
; 
...
(assert (= of_17 of_136))
; 
; =  {sc.input.I[23].O} {sc.iadd[8].D}
(assert (= sc_49 sc_129))
; 
; =  {of.input.I[23].O} {of.iadd[8].D}
(assert (= of_49 of_129))
; 
...
(assert (= of_128 of_73))
; 
; =  {sc.iadd[8].OUT} {sc.igenebind[1].TF}
(assert (= sc_133 sc_89))
; 
; =  {of.iadd[8].OUT} {of.igenebind[1].TF}
(assert (= of_133 of_89))
; 
; =  {sc.switch[2].PROD} {sc.iadd[7].D}
(assert (= sc_8 sc_134))
; 
; =  {of.switch[2].PROD} {of.iadd[7].D}
(assert (= of_8 of_134))
; 
...
(assert (= of_29 of_91))
(assert (<= (* (/ 1. sc_59) 0.001) 0.001))
(assert (<= (* (/ 1. sc_61) 0.001) 0.001))
; 
; =  {sc.vadd[9].OUT2} {sc.output.V[0].O} {sc.vadd[11].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_68 sc_59) (= sc_68 sc_75)) (= sc_68 sc_61)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_131 0.) slbot_131 (- slbot_131))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= sltop_131 0.) sltop_131 (- sltop_131))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
