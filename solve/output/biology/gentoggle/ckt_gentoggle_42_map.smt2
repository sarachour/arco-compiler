...
(assert (<= (+ (* sc_19 337.632520764) of_19) 10.))
; 
; <=  {((sc.input.I[9].X*337.632520764)+of.input.I[9].X)} {0.}
(assert (>= (+ (* sc_19 337.632520764) of_19) 0.))
; 
; >=  {((sc.input.I[9].O*337.632520764)+of.input.I[9].O)} {10.}
(assert (<= (+ (* sc_20 337.632520764) of_20) 10.))
; 
; <=  {((sc.input.I[9].O*337.632520764)+of.input.I[9].O)} {0.}
(assert (>= (+ (* sc_20 337.632520764) of_20) 0.))
...
; 
; =  {(((sc.vtoi[2].X*0.6)+of.vtoi[2].X)+sl.max.vtoi[2].X)} {3300.}
(assert (= (+ (+ (* sc_71 0.6) of_71) sltop_71) 3300.))
(declare-fun slbot_73 () Real)
(declare-fun sltop_73 () Real)
; 
; =  {(((sc.vtoi[2].Y*-0.6)+of.vtoi[2].Y)+sl.min.vtoi[2].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_73 -0.6) of_73) slbot_73) 0.00030303030303))
; 
; =  {(((sc.vtoi[2].Y*0.)+of.vtoi[2].Y)+sl.max.vtoi[2].Y)} {3300.}
(assert (= (+ (+ (* sc_73 0.) of_73) sltop_73) 3300.))
; 
...
; 
; =  {(((sc.vtoi[6].X*156.25)+of.vtoi[6].X)+sl.max.vtoi[6].X)} {3300.}
(assert (= (+ (+ (* sc_74 156.25) of_74) sltop_74) 3300.))
; 
...
; 
; =  {(((sc.vtoi[6].Y*156.25)+of.vtoi[6].Y)+sl.max.vtoi[6].Y)} {3300.}
(assert (= (+ (+ (* sc_76 156.25) of_76) sltop_76) 3300.))
...
(assert (<= (+ (* sc_115 2.5) of_115) 3300.))
; 
; <=  {((sc.input.V[1].X*2.5)+of.input.V[1].X)} {0.}
(assert (>= (+ (* sc_115 2.5) of_115) 0.))
; 
; >=  {((sc.input.V[1].O*2.5)+of.input.V[1].O)} {3300.}
(assert (<= (+ (* sc_116 2.5) of_116) 3300.))
; 
; <=  {((sc.input.V[1].O*2.5)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_116 2.5) of_116) 0.))
...
(assert (= (+ (+ (* sc_128 -0.6) of_128) slbot_128) 0.))
; 
; =  {(((sc.iadd[7].D*0.)+of.iadd[7].D)+sl.max.iadd[7].D)} {5.}
(assert (= (+ (+ (* sc_128 0.) of_128) sltop_128) 5.))
; 
; >=  {((sc.iadd[7].C*1.)+of.iadd[7].C)} {5.}
(assert (<= (+ (* sc_129 1.) of_129) 5.))
; 
...
(assert (= (+ (+ (* sc_132 -1.) of_132) slbot_132) -10.))
; 
; =  {(((sc.iadd[7].OUT*-0.4)+of.iadd[7].OUT)+sl.max.iadd[7].OUT)} {10.}
(assert (= (+ (+ (* sc_132 -0.4) of_132) sltop_132) 10.))
; 
...
(assert (= (+ (+ (* sc_142 0.) of_142) slbot_142) -10.))
; 
; =  {(((sc.iadd[5].OUT*1.66666666667)+of.iadd[5].OUT)+sl.max.iadd[5].OUT)} {10.}
(assert (= (+ (+ (* sc_142 1.66666666667) of_142) sltop_142) 10.))
; 
...
(assert (= (+ (+ (* sc_141 0.) of_141) slbot_141) 0.))
; 
; =  {(((sc.iadd[5].B*1.66666666667)+of.iadd[5].B)+sl.max.iadd[5].B)} {5.}
(assert (= (+ (+ (* sc_141 1.66666666667) of_141) sltop_141) 5.))
(declare-fun slbot_142 () Real)
(declare-fun sltop_142 () Real)
; 
; =  {(((sc.iadd[5].OUT*0.)+of.iadd[5].OUT)+sl.min.iadd[5].OUT)} {-10.}
...
(assert (= of_70 of_121))
; 
; =  {sc.input.V[9].O} {sc.vtoi[2].K}
(assert (= sc_96 sc_72))
; 
; =  {of.input.V[9].O} {of.vtoi[2].K}
(assert (= of_96 of_72))
; 
; =  {sc.input.V[15].O} {sc.itov[12].K}
(assert (= sc_104 sc_118))
; 
; =  {of.input.V[15].O} {of.itov[12].K}
(assert (= of_104 of_118))
; 
; =  {sc.input.I[18].O} {sc.iadd[8].D}
(assert (= sc_46 sc_123))
; 
; =  {of.input.I[18].O} {of.iadd[8].D}
(assert (= of_46 of_123))
; 
; =  {sc.input.I[9].O} {sc.switch[3].SUB}
(assert (= sc_20 sc_5))
; 
; =  {of.input.I[9].O} {of.switch[3].SUB}
(assert (= of_20 of_5))
; 
...
(assert (= of_137 of_6))
; 
; =  {sc.input.I[16].O} {sc.iadd[8].C}
(assert (= sc_34 sc_124))
; 
; =  {of.input.I[16].O} {of.iadd[8].C}
(assert (= of_34 of_124))
; 
...
(assert (= of_38 of_138))
; 
; =  {sc.input.V[13].O} {sc.vgain[8].X}
(assert (= sc_92 sc_0))
; 
; =  {of.input.V[13].O} {of.vgain[8].X}
(assert (= of_92 of_0))
; 
; =  {sc.vtoi[6].Y} {sc.ihill[0].S}
(assert (= sc_76 sc_66))
; 
; =  {of.vtoi[6].Y} {of.ihill[0].S}
(assert (= of_76 of_66))
; 
...
(assert (= of_108 of_75))
; 
; =  {sc.input.V[11].O} {sc.vadd[11].D}
(assert (= sc_100 sc_59))
; 
; =  {of.input.V[11].O} {of.vadd[11].D}
(assert (= of_100 of_59))
; 
...
(assert (= of_88 of_51))
; 
; =  {sc.input.V[12].O} {sc.switch[3].n}
(assert (= sc_94 sc_4))
; 
; =  {of.input.V[12].O} {of.switch[3].n}
(assert (= of_94 of_4))
; 
...
(assert (= of_86 of_1))
; 
; =  {sc.input.V[3].O} {sc.vadd[9].A}
(assert (= sc_110 sc_54))
; 
; =  {of.input.V[3].O} {of.vadd[9].A}
(assert (= of_110 of_54))
; 
; =  {sc.vtoi[2].Y} {sc.iadd[7].D}
(assert (= sc_73 sc_128))
; 
; =  {of.vtoi[2].Y} {of.iadd[7].D}
(assert (= of_73 of_128))
; 
; =  {sc.iadd[5].OUT} {sc.iadd[4].B}
(assert (= sc_142 sc_136))
; 
; =  {of.iadd[5].OUT} {of.iadd[4].B}
(assert (= of_142 of_136))
; 
; =  {sc.input.I[15].O} {sc.iadd[7].C}
(assert (= sc_28 sc_129))
; 
; =  {of.input.I[15].O} {of.iadd[7].C}
(assert (= of_28 of_129))
; 
...
(assert (= of_18 of_82))
; 
; =  {sc.input.I[1].O} {sc.iadd[4].D}
(assert (= sc_42 sc_133))
; 
; =  {of.input.I[1].O} {of.iadd[4].D}
(assert (= of_42 of_133))
; 
...
(assert (= of_132 of_77))
; 
; =  {sc.input.I[7].O} {sc.iadd[7].A}
(assert (= sc_14 sc_130))
; 
; =  {of.input.I[7].O} {of.iadd[7].A}
(assert (= of_14 of_130))
; 
...
(assert (= of_116 of_65))
; 
; =  {sc.input.I[13].O} {sc.igenebind[6].Vmax}
(assert (= sc_16 sc_79))
; 
; =  {of.input.I[13].O} {of.igenebind[6].Vmax}
(assert (= of_16 of_79))
; 
; =  {sc.input.I[17].O} {sc.iadd[8].B}
(assert (= sc_44 sc_126))
; 
; =  {of.input.I[17].O} {of.iadd[8].B}
(assert (= of_44 of_126))
; 
; =  {sc.input.V[7].O} {sc.vadd[11].OUT2_0}
(assert (= sc_90 sc_58))
; 
; =  {of.input.V[7].O} {of.vadd[11].OUT2_0}
(assert (= of_90 of_58))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[6].X}
(assert (= sc_57 sc_74))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[6].X}
(assert (= of_57 of_74))
; 
...
(assert (= of_84 of_117))
; 
; =  {sc.input.I[8].O} {sc.iadd[7].B}
(assert (= sc_12 sc_131))
; 
; =  {of.input.I[8].O} {of.iadd[7].B}
(assert (= of_12 of_131))
; 
; =  {sc.input.V[0].O} {sc.vtoi[2].X}
(assert (= sc_98 sc_71))
; 
; =  {of.input.V[0].O} {of.vtoi[2].X}
(assert (= of_98 of_71))
; 
...
(assert (= of_127 of_81))
; 
; =  {sc.input.V[5].O} {sc.vadd[11].C}
(assert (= sc_114 sc_60))
; 
; =  {of.input.V[5].O} {of.vadd[11].C}
(assert (= of_114 of_60))
; 
; =  {sc.input.V[4].O} {sc.vadd[9].C}
(assert (= sc_112 sc_53))
; 
; =  {of.input.V[4].O} {of.vadd[9].C}
(assert (= of_112 of_53))
; 
; =  {sc.input.V[6].O} {sc.vadd[11].A}
(assert (= sc_106 sc_61))
; 
; =  {of.input.V[6].O} {of.vadd[11].A}
(assert (= of_106 of_61))
; 
; =  {sc.input.I[11].O} {sc.itov[10].X}
(assert (= sc_24 sc_120))
; 
; =  {of.input.I[11].O} {of.itov[10].X}
(assert (= of_24 of_120))
