...
; 
; =  {(((sc.iadd[6].D*0.6)+of.iadd[6].D)+sl.max.iadd[6].D)} {5.}
(assert (= (+ (+ (* sc_144 0.6) of_144) sltop_144) 5.))
; 
...
; 
; =  {sc.input.I[0].O} {sc.iadd[6].D}
(assert (= sc_24 sc_144))
; 
; =  {of.input.I[0].O} {of.iadd[6].D}
(assert (= of_24 of_144))
; 
...
(assert (= of_78 of_122))
; 
; =  {sc.input.I[22].O} {sc.iadd[13].D}
(assert (= sc_54 sc_129))
; 
; =  {of.input.I[22].O} {of.iadd[13].D}
(assert (= of_54 of_129))
; 
...
(assert (= of_97 of_80))
; 
; =  {sc.input.I[3].O} {sc.iadd[6].B}
(assert (= sc_40 sc_147))
; 
; =  {of.input.I[3].O} {of.iadd[6].B}
(assert (= of_40 of_147))
; 
...
(assert (= of_93 of_60))
; 
; =  {sc.input.I[20].O} {sc.iadd[13].C}
(assert (= sc_10 sc_130))
; 
; =  {of.input.I[20].O} {of.iadd[13].C}
(assert (= of_10 of_130))
; 
...
; 
; =  {sc.input.I[21].O} {sc.iadd[13].B}
(assert (= sc_34 sc_132))
; 
; =  {of.input.I[21].O} {of.iadd[13].B}
(assert (= of_34 of_132))
; 
