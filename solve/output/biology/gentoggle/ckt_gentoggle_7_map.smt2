...
(assert (= of_125 0.))
; 
; >=  {((sc.itov[12].X*1.)+of.itov[12].X)} {10.}
(assert (<= (+ (* sc_123 1.) of_123) 10.))
; 
; <=  {((sc.itov[12].X*1.)+of.itov[12].X)} {0.0001}
(assert (>= (+ (* sc_123 1.) of_123) 0.0001))
(declare-fun slbot_124 () Real)
(declare-fun sltop_124 () Real)
; 
; =  {(((sc.itov[12].K*0.939759036145)+of.itov[12].K)+sl.min.itov[12].K)} {1.}
(assert (= (+ (+ (* sc_124 0.939759036145) of_124) slbot_124) 1.))
; 
; =  {(((sc.itov[12].K*15.6)+of.itov[12].K)+sl.max.itov[12].K)} {330.}
...
(assert (= of_143 of_11))
; 
; =  {sc.input.V[13].O} {sc.vtoi[1].K}
(assert (= sc_102 sc_85))
; 
; =  {of.input.V[13].O} {of.vtoi[1].K}
(assert (= of_102 of_85))
; 
...
(assert (= of_104 of_0))
; 
; =  {sc.input.I[20].O} {sc.iadd[8].B}
(assert (= sc_15 sc_132))
; 
; =  {of.input.I[20].O} {of.iadd[8].B}
(assert (= of_15 of_132))
; 
...
(assert (= of_70 of_60))
; 
; =  {sc.igenebind[1].GE} {sc.itov[12].K}
(assert (= sc_94 sc_124))
; 
; =  {of.igenebind[1].GE} {of.itov[12].K}
(assert (= of_94 of_124))
; 
...
(assert (= of_8 of_134))
; 
; =  {sc.input.I[19].O} {sc.iadd[8].C}
(assert (= sc_55 sc_130))
; 
; =  {of.input.I[19].O} {of.iadd[8].C}
(assert (= of_55 of_130))
; 
