...
; 
; =  {(((sc.iadd[9].B*15.6)+of.iadd[9].B)+sl.max.iadd[9].B)} {5.}
(assert (= (+ (+ (* sc_111 15.6) of_111) sltop_111) 5.))
...
(assert (= of_14 of_54))
; 
; =  {sc.switch[7].PROD} {sc.iadd[9].B}
(assert (= sc_8 sc_111))
; 
; =  {of.switch[7].PROD} {of.iadd[9].B}
(assert (= of_8 of_111))
; 
...
(assert (= of_56 of_101))
; 
; =  {sc.input.I[16].O} {sc.iadd[9].C}
(assert (= sc_22 sc_109))
; 
; =  {of.input.I[16].O} {of.iadd[9].C}
(assert (= of_22 of_109))
; 
...
(assert (= of_62 of_106))
; 
; =  {sc.input.I[14].O} {sc.iadd[9].A}
(assert (= sc_20 sc_110))
; 
; =  {of.input.I[14].O} {of.iadd[9].A}
(assert (= of_20 of_110))
; 
...
(assert (= of_43 of_57))
; 
; =  {sc.input.I[15].O} {sc.iadd[9].D}
(assert (= sc_16 sc_108))
; 
; =  {of.input.I[15].O} {of.iadd[9].D}
(assert (= of_16 of_108))
; 
...
(assert (= of_84 of_45))
; 
; =  {sc.input.V[18].O} {sc.vtoi[7].K}
(assert (= sc_96 sc_58))
; 
; =  {of.input.V[18].O} {of.vtoi[7].K}
(assert (= of_96 of_58))
; 
