...
; 
; =  {(((sc.iadd[1].B*0.)+of.iadd[1].B)+sl.min.iadd[1].B)} {0.}
(assert (= (+ (+ (* sc_95 0.) of_95) slbot_95) 0.))
; 
; =  {(((sc.iadd[1].B*15.6)+of.iadd[1].B)+sl.max.iadd[1].B)} {5.}
...
(assert (= of_65 of_39))
; 
; =  {sc.input.I[18].O} {sc.iadd[1].D}
(assert (= sc_24 sc_92))
; 
; =  {of.input.I[18].O} {of.iadd[1].D}
(assert (= of_24 of_92))
; 
...
(assert (= of_44 of_7))
; 
; =  {sc.switch[6].PROD} {sc.iadd[1].B}
(assert (= sc_8 sc_95))
; 
; =  {of.switch[6].PROD} {of.iadd[1].B}
(assert (= of_8 of_95))
; 
...
(assert (= of_83 of_1))
; 
; =  {sc.input.I[17].O} {sc.iadd[1].C}
(assert (= sc_22 sc_93))
; 
; =  {of.input.I[17].O} {of.iadd[1].C}
(assert (= of_22 of_93))
; 
...
(assert (= of_91 of_42))
; 
; =  {sc.input.I[19].O} {sc.iadd[1].A}
(assert (= sc_26 sc_94))
; 
; =  {of.input.I[19].O} {of.iadd[1].A}
(assert (= of_26 of_94))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12)))))
(check-sat)
