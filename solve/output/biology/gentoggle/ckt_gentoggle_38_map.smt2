...
(assert (= of_48 of_129))
; 
; =  {sc.input.I[25].O} {sc.itov[5].X}
(assert (= sc_44 sc_117))
; 
; =  {of.input.I[25].O} {of.itov[5].X}
(assert (= of_44 of_117))
; 
...
(assert (= of_59 of_73))
; 
; =  {sc.input.I[24].O} {sc.iadd[12].A}
(assert (= sc_34 sc_130))
; 
; =  {of.input.I[24].O} {of.iadd[12].A}
(assert (= of_34 of_130))
; 
