...
(assert (<= (+ (* sc_119 0.35) of_119) 3300.))
; 
; <=  {((sc.vadd[4].OUT2_0*0.35)+of.vadd[4].OUT2_0)} {0.}
(assert (>= (+ (* sc_119 0.35) of_119) 0.))
; 
...
(assert (<= (+ (* sc_126 0.5) of_126) 3300.))
; 
; <=  {((sc.vadd[1].OUT2_0*0.5)+of.vadd[1].OUT2_0)} {0.}
(assert (>= (+ (* sc_126 0.5) of_126) 0.))
; 
...
; 
; =  {(((sc.itov[30].X*9.05093714108e-05)+of.itov[30].X)+sl.min.itov[30].X)} {0.0001}
(assert (= (+ (+ (* sc_256 9.05093714108e-05) of_256) slbot_256) 0.0001))
; 
; =  {(((sc.itov[30].X*883.883476483)+of.itov[30].X)+sl.max.itov[30].X)} {10.}
(assert (= (+ (+ (* sc_256 883.883476483) of_256) sltop_256) 10.))
; 
; >=  {((sc.itov[30].K*1.)+of.itov[30].K)} {330.}
(assert (<= (+ (* sc_257 1.) of_257) 330.))
; 
; <=  {((sc.itov[30].K*1.)+of.itov[30].K)} {1.}
...
(assert (= (+ (+ (* sc_301 305175.78125) of_301) sltop_301) 10.))
; 
; =  {sc.ihill[10].REP} {sc.itov[30].X}
(assert (= sc_138 sc_256))
; 
; =  {of.ihill[10].REP} {of.itov[30].X}
(assert (= of_138 of_256))
; 
; =  {sc.vtoi[29].Y} {sc.iadd[28].B}
(assert (= sc_141 sc_300))
; 
; =  {of.vtoi[29].Y} {of.iadd[28].B}
(assert (= of_141 of_300))
; 
; =  {sc.vadd[4].OUT2} {sc.output.V[1].X}
(assert (= sc_125 sc_117))
; 
; =  {of.vadd[4].OUT2} {of.output.V[1].X}
(assert (= of_125 of_117))
; 
...
(assert (= of_31 of_155))
; 
; =  {sc.input.V[41].O} {sc.itov[30].K}
(assert (= sc_194 sc_257))
; 
; =  {of.input.V[41].O} {of.itov[30].K}
(assert (= of_194 of_257))
; 
...
(assert (= sc_202 sc_128))
; 
; =  {of.input.V[14].O} {of.vadd[1].C}
(assert (= of_202 of_128))
; 
...
(assert (= sc_200 sc_251))
; 
; =  {of.input.V[36].O} {of.itov[27].K}
(assert (= of_200 of_251))
; 
...
(assert (= sc_153 sc_290))
; 
; =  {of.vtoi[17].Y} {of.iadd[16].B}
(assert (= of_153 of_290))
; 
...
(assert (= sc_208 sc_139))
; 
; =  {of.input.V[37].O} {of.vtoi[29].X}
(assert (= of_208 of_139))
; 
...
(assert (= sc_166 sc_254))
; 
; =  {of.input.V[35].O} {of.itov[24].K}
(assert (= of_166 of_254))
; 
...
(assert (= sc_204 sc_127))
; 
; =  {of.input.V[21].O} {of.vadd[1].D}
(assert (= of_204 of_127))
; 
...
(assert (= sc_216 sc_151))
; 
; =  {of.input.V[30].O} {of.vtoi[17].X}
(assert (= of_216 of_151))
; 
...
(assert (= sc_147 sc_136))
; 
; =  {of.vtoi[11].Y} {of.ihill[10].Vmax}
(assert (= of_147 of_136))
; 
...
(assert (= sc_144 sc_282))
; 
; =  {of.vtoi[9].Y} {of.iadd[33].D}
(assert (= of_144 of_282))
; 
; =  {sc.vtoi[22].Y} {sc.iadd[21].B}
(assert (= sc_156 sc_280))
; 
; =  {of.vtoi[22].Y} {of.iadd[21].B}
(assert (= of_156 of_280))
; 
...
(assert (= sc_232 sc_126))
; 
; =  {of.input.V[17].O} {of.vadd[1].OUT2_0}
(assert (= of_232 of_126))
; 
...
(assert (= of_68 of_49))
; 
; =  {sc.vtoi[26].Y} {sc.ihill[10].Km}
(assert (= sc_150 sc_135))
; 
; =  {of.vtoi[26].Y} {of.ihill[10].Km}
(assert (= of_150 of_135))
; 
...
(assert (= sc_110 sc_274))
; 
; =  {of.input.I[18].O} {of.iadd[26].A}
(assert (= of_110 of_274))
; 
...
(assert (= sc_236 sc_119))
; 
; =  {of.input.V[19].O} {of.vadd[4].OUT2_0}
(assert (= of_236 of_119))
; 
...
(assert (= of_45 of_253))
; 
; =  {sc.input.V[40].O} {sc.vtoi[26].K}
(assert (= sc_222 sc_149))
; 
; =  {of.input.V[40].O} {of.vtoi[26].K}
(assert (= of_222 of_149))
; 
...
(assert (= sc_234 sc_143))
; 
; =  {of.input.V[18].O} {of.vtoi[9].K}
(assert (= of_234 of_143))
; 
...
(assert (= sc_112 sc_273))
; 
; =  {of.input.I[19].O} {of.iadd[26].C}
(assert (= of_112 of_273))
; 
...
(assert (and (and (= sc_132 sc_116) (= sc_132 sc_125)) (= sc_132 sc_118)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= sltop_130 0.) sltop_130 (- sltop_130))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= slbot_300 0.) slbot_300 (- slbot_300))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= slbot_282 0.) slbot_282 (- slbot_282))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= sltop_296 0.) sltop_296 (- sltop_296))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_244 0.) sltop_244 (- sltop_244))) (ite (>= slbot_150 0.) slbot_150 (- slbot_150))) (ite (>= slbot_280 0.) slbot_280 (- slbot_280))) (ite (>= slbot_267 0.) slbot_267 (- slbot_267))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_146 0.) sltop_146 (- sltop_146))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_131 0.) sltop_131 (- sltop_131))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= slbot_156 0.) slbot_156 (- slbot_156))) (ite (>= sltop_250 0.) sltop_250 (- sltop_250))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_249 0.) sltop_249 (- sltop_249))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_255 0.) slbot_255 (- slbot_255))) (ite (>= slbot_301 0.) slbot_301 (- slbot_301))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_246 0.) sltop_246 (- sltop_246))) (ite (>= sltop_290 0.) sltop_290 (- sltop_290))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_258 0.) slbot_258 (- slbot_258))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_252 0.) slbot_252 (- slbot_252))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_256 0.) slbot_256 (- slbot_256))) (ite (>= slbot_281 0.) slbot_281 (- slbot_281))) (ite (>= sltop_280 0.) sltop_280 (- sltop_280))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_247 0.) sltop_247 (- sltop_247))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_290 0.) slbot_290 (- slbot_290))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= slbot_259 0.) slbot_259 (- slbot_259))) (ite (>= sltop_267 0.) sltop_267 (- sltop_267))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_281 0.) sltop_281 (- sltop_281))) (ite (>= sltop_256 0.) sltop_256 (- sltop_256))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_241 0.) slbot_241 (- slbot_241))) (ite (>= slbot_246 0.) slbot_246 (- slbot_246))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_247 0.) slbot_247 (- slbot_247))) (ite (>= sltop_276 0.) sltop_276 (- sltop_276))) (ite (>= sltop_300 0.) sltop_300 (- sltop_300))) (ite (>= sltop_156 0.) sltop_156 (- sltop_156))) (ite (>= slbot_276 0.) slbot_276 (- slbot_276))) (ite (>= slbot_244 0.) slbot_244 (- slbot_244))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_286 0.) sltop_286 (- sltop_286))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= sltop_271 0.) sltop_271 (- sltop_271))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144))) (ite (>= slbot_286 0.) slbot_286 (- slbot_286))) (ite (>= slbot_261 0.) slbot_261 (- slbot_261))) (ite (>= sltop_282 0.) sltop_282 (- sltop_282))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= slbot_250 0.) slbot_250 (- slbot_250))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= sltop_291 0.) sltop_291 (- sltop_291))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= sltop_255 0.) sltop_255 (- sltop_255))) (ite (>= sltop_261 0.) sltop_261 (- sltop_261))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= sltop_150 0.) sltop_150 (- sltop_150))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_131 0.) slbot_131 (- slbot_131))) (ite (>= sltop_243 0.) sltop_243 (- sltop_243))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_265 0.) sltop_265 (- sltop_265))) (ite (>= slbot_291 0.) slbot_291 (- slbot_291))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_271 0.) slbot_271 (- slbot_271))) (ite (>= slbot_266 0.) slbot_266 (- slbot_266))) (ite (>= sltop_275 0.) sltop_275 (- sltop_275))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= sltop_241 0.) sltop_241 (- sltop_241))) (ite (>= slbot_253 0.) slbot_253 (- slbot_253))) (ite (>= sltop_258 0.) sltop_258 (- sltop_258))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= slbot_296 0.) slbot_296 (- slbot_296))) (ite (>= sltop_135 0.) sltop_135 (- sltop_135))) (ite (>= sltop_181 0.) sltop_181 (- sltop_181))) (ite (>= slbot_243 0.) slbot_243 (- slbot_243))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= sltop_292 0.) sltop_292 (- sltop_292))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_135 0.) slbot_135 (- slbot_135))) (ite (>= sltop_259 0.) sltop_259 (- sltop_259))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_155 0.) slbot_155 (- slbot_155))) (ite (>= slbot_270 0.) slbot_270 (- slbot_270))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= sltop_266 0.) sltop_266 (- sltop_266))) (ite (>= sltop_270 0.) sltop_270 (- sltop_270))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= slbot_292 0.) slbot_292 (- slbot_292))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_265 0.) slbot_265 (- slbot_265))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_249 0.) slbot_249 (- slbot_249))) (ite (>= sltop_155 0.) sltop_155 (- sltop_155))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_301 0.) sltop_301 (- sltop_301))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_146 0.) slbot_146 (- slbot_146))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_252 0.) sltop_252 (- sltop_252))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_275 0.) slbot_275 (- slbot_275))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_181 0.) slbot_181 (- slbot_181))) (ite (>= sltop_253 0.) sltop_253 (- sltop_253)))))
(check-sat)
