...
(assert (= (+ (+ (* sc_35 0.5) of_35) slbot_35) 0.))
; 
...
(assert (<= (+ (* sc_41 0.35) of_41) 3300.))
; 
; <=  {((sc.vadd[5].OUT2_0*0.35)+of.vadd[5].OUT2_0)} {0.}
(assert (>= (+ (* sc_41 0.35) of_41) 0.))
; 
; >=  {((sc.vadd[5].D*0.004)+of.vadd[5].D)} {3300.}
(assert (<= (+ (* sc_42 0.004) of_42) 3300.))
; 
; <=  {((sc.vadd[5].D*0.004)+of.vadd[5].D)} {0.}
(assert (>= (+ (* sc_42 0.004) of_42) 0.))
; 
...
(assert (<= (+ (* sc_48 0.5) of_48) 3300.))
; 
; <=  {((sc.vadd[1].OUT2_0*0.5)+of.vadd[1].OUT2_0)} {0.}
(assert (>= (+ (* sc_48 0.5) of_48) 0.))
; 
; >=  {((sc.vadd[1].D*0.004)+of.vadd[1].D)} {3300.}
(assert (<= (+ (* sc_49 0.004) of_49) 3300.))
; 
; <=  {((sc.vadd[1].D*0.004)+of.vadd[1].D)} {0.}
(assert (>= (+ (* sc_49 0.004) of_49) 0.))
; 
...
(assert (= (+ (+ (* sc_59 1.) of_59) slbot_59) 9.999900001e-15))
; 
; =  {(((sc.ihill[2].STIM*5.65685424949)+of.ihill[2].STIM)+sl.max.ihill[2].STIM)} {999990.0001}
(assert (= (+ (+ (* sc_59 5.65685424949) of_59) sltop_59) 999990.0001))
(declare-fun slbot_60 () Real)
(declare-fun sltop_60 () Real)
; 
; =  {(((sc.ihill[2].REP*9.05093714108e-05)+of.ihill[2].REP)+sl.min.ihill[2].REP)} {5e-10}
...
; 
; =  {(((sc.itov[9].X*9.05093714108e-05)+of.itov[9].X)+sl.min.itov[9].X)} {0.0001}
(assert (= (+ (+ (* sc_105 9.05093714108e-05) of_105) slbot_105) 0.0001))
; 
; =  {(((sc.itov[9].X*883.883476483)+of.itov[9].X)+sl.max.itov[9].X)} {10.}
(assert (= (+ (+ (* sc_105 883.883476483) of_105) sltop_105) 10.))
; 
...
(assert (= (+ (+ (* sc_117 0.) of_117) sltop_117) 10.))
; 
; =  {sc.input.V[17].O} {sc.vtoi[1].K}
(assert (= sc_99 sc_62))
; 
; =  {of.input.V[17].O} {of.vtoi[1].K}
(assert (= of_99 of_62))
; 
...
(assert (= of_87 of_4))
; 
; =  {sc.vtoi[1].Y} {sc.ihill[2].S}
(assert (= sc_63 sc_56))
; 
; =  {of.vtoi[1].Y} {of.ihill[2].S}
(assert (= of_63 of_56))
; 
...
(assert (= of_18 of_111))
; 
; =  {sc.ihill[2].REP} {sc.itov[9].X}
(assert (= sc_60 sc_105))
; 
; =  {of.ihill[2].REP} {of.itov[9].X}
(assert (= of_60 of_105))
; 
...
(assert (= of_77 of_2))
; 
; =  {sc.input.V[18].O} {sc.itov[9].K}
(assert (= sc_101 sc_106))
; 
; =  {of.input.V[18].O} {of.itov[9].K}
(assert (= of_101 of_106))
; 
...
(assert (= of_85 of_51))
(assert (<= (* sc_38 0.001) 0.001))
(assert (<= (* sc_40 0.001) 0.001))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[5].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_54 sc_38) (= sc_54 sc_47)) (= sc_54 sc_40)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= sltop_77 0.) sltop_77 (- sltop_77))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
