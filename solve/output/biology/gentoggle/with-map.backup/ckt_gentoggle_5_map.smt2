...
(assert (= (+ (+ (* sc_113 0.5) of_113) slbot_113) 0.))
; 
...
(assert (= (+ (+ (* sc_114 0.5) of_114) slbot_114) 0.))
; 
...
(assert (= (+ (+ (* sc_127 0.) of_127) slbot_127) 0.0001))
; 
; =  {(((sc.output.V[0].X*156.25)+of.output.V[0].X)+sl.max.output.V[0].X)} {3300.}
(assert (= (+ (+ (* sc_127 156.25) of_127) sltop_127) 3300.))
...
(assert (= (+ (+ (* sc_128 156.25) of_128) sltop_128) 3300.))
...
(assert (= (+ (+ (* sc_129 15.6) of_129) sltop_129) 3300.))
...
(assert (= (+ (+ (* sc_130 15.6) of_130) sltop_130) 3300.))
...
(assert (= sc_134 (* 1. sc_135)))
; 
; =  {sc.vadd[4].A} {(1.*sc.vadd[4].C)} {(1.*sc.vadd[4].D)}
(assert (and (= sc_134 (* 1. sc_133)) (= sc_134 (* 1. sc_132))))
; no offset
(assert (= (- (+ of_134 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[4].OUT} {(sc.vadd[4].A*1.)}
(assert (= sc_136 (* sc_134 1.)))
; 
; =  {of.vadd[4].OUT} {0.}
(assert (= of_136 0.))
; no scale
...
(assert (and (= sc_134 (* 1. sc_133)) (= sc_134 (* (* 1. sc_132) sc_137))))
; no offset
(assert (= (- (+ of_134 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= sc_141 (* 1. sc_142)))
; 
; =  {sc.vadd[1].A} {(1.*sc.vadd[1].C)} {(1.*sc.vadd[1].D)}
(assert (and (= sc_141 (* 1. sc_140)) (= sc_141 (* 1. sc_139))))
; no offset
(assert (= (- (+ of_141 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[1].OUT} {(sc.vadd[1].A*1.)}
(assert (= sc_143 (* sc_141 1.)))
; 
; =  {of.vadd[1].OUT} {0.}
(assert (= of_143 0.))
; no scale
...
(assert (and (= sc_141 (* 1. sc_140)) (= sc_141 (* (* 1. sc_139) sc_144))))
; no offset
(assert (= (- (+ of_141 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= (+ (+ (* sc_144 0.) of_144) slbot_144) 0.))
; 
...
(assert (= (+ (+ (* sc_149 1.) of_149) slbot_149) 9.999900001e-15))
; 
; =  {(((sc.ihill[10].STIM*5.65685424949)+of.ihill[10].STIM)+sl.max.ihill[10].STIM)} {999990.0001}
(assert (= (+ (+ (* sc_149 5.65685424949) of_149) sltop_149) 999990.0001))
(declare-fun slbot_150 () Real)
(declare-fun sltop_150 () Real)
; 
; =  {(((sc.ihill[10].REP*9.05093714108e-05)+of.ihill[10].REP)+sl.min.ihill[10].REP)} {5e-10}
...
(assert (= (+ (+ (* sc_154 27.6213586401) of_154) slbot_154) 1.))
; 
; =  {(((sc.vtoi[11].X*156.25)+of.vtoi[11].X)+sl.max.vtoi[11].X)} {3300.}
(assert (= (+ (+ (* sc_154 156.25) of_154) sltop_154) 3300.))
...
(assert (= (+ (+ (* sc_156 0.000512) of_156) sltop_156) 3300.))
...
(assert (= (+ (+ (* sc_160 0.) of_160) slbot_160) 1.))
; 
; =  {(((sc.vtoi[25].X*156.25)+of.vtoi[25].X)+sl.max.vtoi[25].X)} {3300.}
(assert (= (+ (+ (* sc_160 156.25) of_160) sltop_160) 3300.))
; 
...
(assert (= (+ (+ (* sc_162 0.) of_162) slbot_162) 0.00030303030303))
; 
...
(assert (<= (+ (* sc_169 2.) of_169) 3300.))
; 
; <=  {((sc.input.V[2].X*2.)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_169 2.) of_169) 0.))
; 
...
; 
; =  {sc.input.V[43].O} {sc.input.V[43].X}
(assert (= sc_174 sc_173))
; 
; =  {of.input.V[43].O} {of.input.V[43].X}
(assert (= of_174 of_173))
; 
; >=  {((sc.input.V[43].X*1.)+of.input.V[43].X)} {3300.}
(assert (<= (+ (* sc_173 1.) of_173) 3300.))
; 
; <=  {((sc.input.V[43].X*1.)+of.input.V[43].X)} {0.}
(assert (>= (+ (* sc_173 1.) of_173) 0.))
; 
; >=  {((sc.input.V[43].O*1.)+of.input.V[43].O)} {3300.}
(assert (<= (+ (* sc_174 1.) of_174) 3300.))
; 
; <=  {((sc.input.V[43].O*1.)+of.input.V[43].O)} {0.}
...
(assert (<= (+ (* sc_211 31.2) of_211) 3300.))
; 
; <=  {((sc.input.V[6].X*31.2)+of.input.V[6].X)} {0.}
(assert (>= (+ (* sc_211 31.2) of_211) 0.))
; 
; >=  {((sc.input.V[6].O*31.2)+of.input.V[6].O)} {3300.}
(assert (<= (+ (* sc_212 31.2) of_212) 3300.))
; 
; <=  {((sc.input.V[6].O*31.2)+of.input.V[6].O)} {0.}
(assert (>= (+ (* sc_212 31.2) of_212) 0.))
...
(assert (<= (+ (* sc_215 0.) of_215) 3300.))
; 
; <=  {((sc.input.V[14].X*0.)+of.input.V[14].X)} {0.}
(assert (>= (+ (* sc_215 0.) of_215) 0.))
; 
; >=  {((sc.input.V[14].O*0.)+of.input.V[14].O)} {3300.}
(assert (<= (+ (* sc_216 0.) of_216) 3300.))
; 
...
(assert (<= (+ (* sc_233 2.) of_233) 3300.))
; 
; <=  {((sc.input.V[5].X*2.)+of.input.V[5].X)} {0.}
(assert (>= (+ (* sc_233 2.) of_233) 0.))
; 
; >=  {((sc.input.V[5].O*2.)+of.input.V[5].O)} {3300.}
(assert (<= (+ (* sc_234 2.) of_234) 3300.))
; 
; <=  {((sc.input.V[5].O*2.)+of.input.V[5].O)} {0.}
(assert (>= (+ (* sc_234 2.) of_234) 0.))
...
; =  {of.itov[32].Y} {0.}
(assert (= of_270 0.))
(declare-fun slbot_268 () Real)
(declare-fun sltop_268 () Real)
; 
; =  {(((sc.itov[32].X*9.05093714108e-05)+of.itov[32].X)+sl.min.itov[32].X)} {0.0001}
(assert (= (+ (+ (* sc_268 9.05093714108e-05) of_268) slbot_268) 0.0001))
; 
; =  {(((sc.itov[32].X*883.883476483)+of.itov[32].X)+sl.max.itov[32].X)} {10.}
(assert (= (+ (+ (* sc_268 883.883476483) of_268) sltop_268) 10.))
; 
; >=  {((sc.itov[32].K*1.)+of.itov[32].K)} {330.}
(assert (<= (+ (* sc_269 1.) of_269) 330.))
; 
; <=  {((sc.itov[32].K*1.)+of.itov[32].K)} {1.}
(assert (>= (+ (* sc_269 1.) of_269) 1.))
...
(assert (= (+ (+ (* sc_323 305175.78125) of_323) sltop_323) 10.))
; 
; =  {sc.ihill[10].REP} {sc.itov[32].X}
(assert (= sc_150 sc_268))
; 
; =  {of.ihill[10].REP} {of.itov[32].X}
(assert (= of_150 of_268))
; 
; =  {sc.vtoi[29].Y} {sc.iadd[28].B}
(assert (= sc_153 sc_322))
; 
; =  {of.vtoi[29].Y} {of.iadd[28].B}
(assert (= of_153 of_322))
; 
; =  {sc.vadd[4].OUT2} {sc.output.V[1].X}
(assert (= sc_137 sc_129))
; 
; =  {of.vadd[4].OUT2} {of.output.V[1].X}
(assert (= of_137 of_129))
; 
...
; 
; =  {sc.input.V[41].O} {sc.itov[32].K}
(assert (= sc_208 sc_269))
; 
; =  {of.input.V[41].O} {of.itov[32].K}
(assert (= of_208 of_269))
; 
...
(assert (= sc_112 sc_320))
; 
; =  {of.input.I[25].O} {of.iadd[28].C}
(assert (= of_112 of_320))
; 
...
(assert (= sc_250 sc_166))
; 
; =  {of.input.V[32].O} {of.vtoi[22].X}
(assert (= of_250 of_166))
; 
...
(assert (= sc_186 sc_141))
; 
; =  {of.input.V[13].O} {of.vadd[1].A}
(assert (= of_186 of_141))
; 
...
(assert (= sc_216 sc_140))
; 
; =  {of.input.V[14].O} {of.vadd[1].C}
(assert (= of_216 of_140))
; 
...
(assert (= sc_104 sc_286))
; 
; =  {of.input.I[30].O} {of.iadd[34].A}
(assert (= of_104 of_286))
; 
...
(assert (= sc_214 sc_151))
; 
; =  {of.input.V[36].O} {of.vtoi[29].X}
(assert (= of_214 of_151))
; 
...
(assert (= sc_165 sc_312))
; 
; =  {of.vtoi[17].Y} {of.iadd[16].B}
(assert (= of_165 of_312))
; 
...
(assert (= sc_100 sc_321))
; 
; =  {of.input.I[24].O} {of.iadd[28].A}
(assert (= of_100 of_321))
; 
...
(assert (= sc_172 sc_139))
; 
; =  {of.input.V[20].O} {of.vadd[1].D}
(assert (= of_172 of_139))
; 
...
(assert (= sc_176 sc_163))
; 
; =  {of.input.V[29].O} {of.vtoi[17].X}
(assert (= of_176 of_163))
; 
...
(assert (= sc_156 sc_148))
; 
; =  {of.vtoi[11].Y} {of.ihill[10].Vmax}
(assert (= of_156 of_148))
; 
...
(assert (= sc_110 sc_319))
; 
; =  {of.input.I[23].O} {of.iadd[28].D}
(assert (= of_110 of_319))
; 
...
(assert (= sc_224 sc_133))
; 
; =  {of.input.V[16].O} {of.vadd[4].C}
(assert (= of_224 of_133))
; 
...
(assert (= sc_168 sc_302))
; 
; =  {of.vtoi[22].Y} {of.iadd[21].B}
(assert (= of_168 of_302))
; 
...
(assert (= sc_116 sc_284))
; 
; =  {of.input.I[28].O} {of.iadd[34].D}
(assert (= of_116 of_284))
; 
...
(assert (= sc_244 sc_138))
; 
; =  {of.input.V[17].O} {of.vadd[1].OUT2_0}
(assert (= of_244 of_138))
; 
...
(assert (= sc_159 sc_289))
; 
; =  {of.vtoi[26].Y} {of.iadd[9].D}
(assert (= of_159 of_289))
; 
...
(assert (= sc_192 sc_272))
; 
; =  {of.input.V[31].O} {of.itov[19].K}
(assert (= of_192 of_272))
; 
...
(assert (= sc_120 sc_299))
; 
; =  {of.input.I[18].O} {of.iadd[21].D}
(assert (= of_120 of_299))
; 
...
(assert (= sc_102 sc_146))
; 
; =  {of.input.I[3].O} {of.ihill[10].S}
(assert (= of_102 of_146))
; 
...
(assert (= sc_106 sc_316))
; 
; =  {of.input.I[4].O} {of.iadd[5].A}
(assert (= of_106 of_316))
; 
...
(assert (= sc_178 sc_145))
; 
; =  {of.input.V[8].O} {of.ihill[10].n}
(assert (= of_178 of_145))
; 
...
(assert (= of_50 of_259))
; 
; =  {sc.input.V[43].O} {sc.vtoi[26].K}
(assert (= sc_174 sc_158))
; 
; =  {of.input.V[43].O} {of.vtoi[26].K}
(assert (= of_174 of_158))
; 
; =  {sc.input.V[19].O} {sc.vadd[4].D}
(assert (= sc_248 sc_132))
; 
; =  {of.input.V[19].O} {of.vadd[4].D}
(assert (= of_248 of_132))
; 
...
(assert (= sc_162 sc_147))
; 
; =  {of.vtoi[25].Y} {of.ihill[10].Km}
(assert (= of_162 of_147))
; 
...
(assert (= sc_114 sc_282))
; 
; =  {of.input.I[1].O} {of.iadd[8].B}
(assert (= of_114 of_282))
; 
...
(assert (= sc_118 sc_275))
; 
; =  {of.input.I[17].O} {of.iadd[20].C}
(assert (= of_118 of_275))
; 
...
(assert (= sc_226 sc_254))
; 
; =  {of.input.V[24].O} {of.itov[7].K}
(assert (= of_226 of_254))
; 
...
(assert (= sc_246 sc_131))
; 
; =  {of.input.V[18].O} {of.vadd[4].OUT2_0}
(assert (= of_246 of_131))
; 
...
(assert (= sc_122 sc_301))
; 
; =  {of.input.I[19].O} {of.iadd[21].A}
(assert (= of_122 of_301))
; 
...
(assert (<= (* sc_128 0.001) 0.001))
(assert (<= (* sc_130 0.001) 0.001))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[4].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_144 sc_128) (= sc_144 sc_137)) (= sc_144 sc_130)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_130 0.) sltop_130 (- sltop_130)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= slbot_282 0.) slbot_282 (- slbot_282))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_289 0.) slbot_289 (- slbot_289))) (ite (>= slbot_150 0.) slbot_150 (- slbot_150))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_267 0.) slbot_267 (- slbot_267))) (ite (>= slbot_279 0.) slbot_279 (- slbot_279))) (ite (>= slbot_287 0.) slbot_287 (- slbot_287))) (ite (>= slbot_322 0.) slbot_322 (- slbot_322))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= sltop_146 0.) sltop_146 (- sltop_146))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_156 0.) slbot_156 (- slbot_156))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_255 0.) slbot_255 (- slbot_255))) (ite (>= slbot_278 0.) slbot_278 (- slbot_278))) (ite (>= sltop_193 0.) sltop_193 (- sltop_193))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_273 0.) slbot_273 (- slbot_273))) (ite (>= slbot_288 0.) slbot_288 (- slbot_288))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= slbot_258 0.) slbot_258 (- slbot_258))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= sltop_262 0.) sltop_262 (- sltop_262))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_256 0.) slbot_256 (- slbot_256))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= sltop_279 0.) sltop_279 (- sltop_279))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_298 0.) slbot_298 (- slbot_298))) (ite (>= slbot_297 0.) slbot_297 (- slbot_297))) (ite (>= sltop_304 0.) sltop_304 (- sltop_304))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= slbot_168 0.) slbot_168 (- slbot_168))) (ite (>= slbot_259 0.) slbot_259 (- slbot_259))) (ite (>= sltop_267 0.) sltop_267 (- sltop_267))) (ite (>= sltop_168 0.) sltop_168 (- sltop_168))) (ite (>= slbot_160 0.) slbot_160 (- slbot_160))) (ite (>= sltop_322 0.) sltop_322 (- sltop_322))) (ite (>= sltop_256 0.) sltop_256 (- sltop_256))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_156 0.) sltop_156 (- sltop_156))) (ite (>= sltop_268 0.) sltop_268 (- sltop_268))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= sltop_167 0.) sltop_167 (- sltop_167))) (ite (>= sltop_302 0.) sltop_302 (- sltop_302))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= slbot_302 0.) slbot_302 (- slbot_302))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_264 0.) slbot_264 (- slbot_264))) (ite (>= sltop_312 0.) sltop_312 (- sltop_312))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_167 0.) slbot_167 (- slbot_167))) (ite (>= sltop_271 0.) sltop_271 (- sltop_271))) (ite (>= sltop_278 0.) sltop_278 (- sltop_278))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= slbot_313 0.) slbot_313 (- slbot_313))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_289 0.) sltop_289 (- sltop_289))) (ite (>= sltop_313 0.) sltop_313 (- sltop_313))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= sltop_303 0.) sltop_303 (- sltop_303))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144))) (ite (>= slbot_261 0.) slbot_261 (- slbot_261))) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= slbot_283 0.) slbot_283 (- slbot_283))) (ite (>= sltop_314 0.) sltop_314 (- sltop_314))) (ite (>= slbot_193 0.) slbot_193 (- slbot_193))) (ite (>= sltop_282 0.) sltop_282 (- sltop_282))) (ite (>= sltop_293 0.) sltop_293 (- sltop_293))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_149 0.) sltop_149 (- sltop_149))) (ite (>= sltop_273 0.) sltop_273 (- sltop_273))) (ite (>= slbot_314 0.) slbot_314 (- slbot_314))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= sltop_287 0.) sltop_287 (- sltop_287))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= sltop_255 0.) sltop_255 (- sltop_255))) (ite (>= sltop_261 0.) sltop_261 (- sltop_261))) (ite (>= sltop_150 0.) sltop_150 (- sltop_150))) (ite (>= sltop_277 0.) sltop_277 (- sltop_277))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_268 0.) slbot_268 (- slbot_268))) (ite (>= slbot_323 0.) slbot_323 (- slbot_323))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= sltop_265 0.) sltop_265 (- sltop_265))) (ite (>= sltop_298 0.) sltop_298 (- sltop_298))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_271 0.) slbot_271 (- slbot_271))) (ite (>= slbot_318 0.) slbot_318 (- slbot_318))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_253 0.) slbot_253 (- slbot_253))) (ite (>= sltop_258 0.) sltop_258 (- sltop_258))) (ite (>= sltop_264 0.) sltop_264 (- sltop_264))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_135 0.) sltop_135 (- sltop_135))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_323 0.) sltop_323 (- sltop_323))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_135 0.) slbot_135 (- slbot_135))) (ite (>= sltop_259 0.) sltop_259 (- sltop_259))) (ite (>= slbot_312 0.) slbot_312 (- slbot_312))) (ite (>= slbot_155 0.) slbot_155 (- slbot_155))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_293 0.) slbot_293 (- slbot_293))) (ite (>= slbot_270 0.) slbot_270 (- slbot_270))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= sltop_270 0.) sltop_270 (- sltop_270))) (ite (>= sltop_297 0.) sltop_297 (- sltop_297))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_283 0.) sltop_283 (- sltop_283))) (ite (>= slbot_303 0.) slbot_303 (- slbot_303))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_265 0.) slbot_265 (- slbot_265))) (ite (>= slbot_304 0.) slbot_304 (- slbot_304))) (ite (>= sltop_155 0.) sltop_155 (- sltop_155))) (ite (>= slbot_262 0.) slbot_262 (- slbot_262))) (ite (>= sltop_318 0.) sltop_318 (- sltop_318))) (ite (>= slbot_308 0.) slbot_308 (- slbot_308))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_146 0.) slbot_146 (- slbot_146))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= sltop_160 0.) sltop_160 (- sltop_160))) (ite (>= slbot_277 0.) slbot_277 (- slbot_277))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_288 0.) sltop_288 (- sltop_288))) (ite (>= slbot_149 0.) slbot_149 (- slbot_149))) (ite (>= sltop_253 0.) sltop_253 (- sltop_253))) (ite (>= sltop_308 0.) sltop_308 (- sltop_308)))))
(check-sat)
