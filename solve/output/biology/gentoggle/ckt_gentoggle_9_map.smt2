...
(assert (<= (+ (* sc_31 4.) of_31) 10.))
; 
; <=  {((sc.input.I[15].X*4.)+of.input.I[15].X)} {0.}
(assert (>= (+ (* sc_31 4.) of_31) 0.))
; 
...
(assert (= of_133 of_88))
; 
; =  {sc.input.I[30].O} {sc.itov[5].X}
(assert (= sc_40 sc_118))
; 
; =  {of.input.I[30].O} {of.itov[5].X}
(assert (= of_40 of_118))
; 
