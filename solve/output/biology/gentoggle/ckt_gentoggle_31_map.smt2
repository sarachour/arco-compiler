...
; 
; =  {(((sc.iadd[11].B*15.6)+of.iadd[11].B)+sl.max.iadd[11].B)} {5.}
...
(assert (= of_78 of_122))
; 
; =  {sc.input.I[22].O} {sc.iadd[11].A}
(assert (= sc_54 sc_136))
; 
; =  {of.input.I[22].O} {of.iadd[11].A}
(assert (= of_54 of_136))
; 
...
(assert (= of_133 of_82))
; 
; =  {sc.input.I[21].O} {sc.iadd[11].D}
(assert (= sc_34 sc_134))
; 
; =  {of.input.I[21].O} {of.iadd[11].D}
(assert (= of_34 of_134))
; 
; =  {sc.switch[5].PROD} {sc.iadd[11].B}
(assert (= sc_8 sc_137))
; 
; =  {of.switch[5].PROD} {of.iadd[11].B}
(assert (= of_8 of_137))
; 
