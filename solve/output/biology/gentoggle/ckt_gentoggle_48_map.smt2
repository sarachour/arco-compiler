...
(assert (= of_60 of_107))
; 
; =  {sc.input.I[22].O} {sc.iadd[11].C}
(assert (= sc_36 sc_120))
; 
; =  {of.input.I[22].O} {of.iadd[11].C}
(assert (= of_36 of_120))
; 
...
(assert (= sc_102 sc_104))
; 
; =  {of.input.V[19].O} {of.itov[5].K}
(assert (= of_102 of_104))
; 
...
(assert (= of_47 of_61))
; 
; =  {sc.input.I[24].O} {sc.iadd[11].A}
(assert (= sc_24 sc_121))
; 
; =  {of.input.I[24].O} {of.iadd[11].A}
(assert (= of_24 of_121))
; 
...
; 
; =  {sc.input.I[23].O} {sc.iadd[11].D}
(assert (= sc_32 sc_119))
; 
; =  {of.input.I[23].O} {of.iadd[11].D}
(assert (= of_32 of_119))
; 
