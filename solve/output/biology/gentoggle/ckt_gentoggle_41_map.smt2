...
(assert (= (+ (+ (* sc_126 15.6) of_126) sltop_126) 5.))
...
(assert (= of_48 of_125))
; 
; =  {sc.input.I[25].O} {sc.itov[11].X}
(assert (= sc_44 sc_117))
; 
; =  {of.input.I[25].O} {of.itov[11].X}
(assert (= of_44 of_117))
; 
...
(assert (= of_92 of_60))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[3].X}
(assert (= sc_59 sc_76))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[3].X}
(assert (= of_59 of_76))
; 
...
(assert (= of_122 of_64))
; 
; =  {sc.input.V[18].O} {sc.vtoi[3].K}
(assert (= sc_116 sc_77))
; 
; =  {of.input.V[18].O} {of.vtoi[3].K}
(assert (= of_116 of_77))
; 
