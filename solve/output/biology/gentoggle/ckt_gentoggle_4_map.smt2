...
(assert (<= (+ (* sc_118 0.125) of_118) 3300.))
; 
; <=  {((sc.input.V[1].O*0.125)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_118 0.125) of_118) 0.))
...
(assert (= (+ (+ (* sc_132 15.6) of_132) sltop_132) 5.))
...
(assert (= (+ (+ (* sc_148 1.66666666667) of_148) sltop_148) 10.))
; 
; =  {sc.input.V[17].O} {sc.itov[11].K}
(assert (= sc_120 sc_124))
; 
; =  {of.input.V[17].O} {of.itov[11].K}
(assert (= of_120 of_124))
; 
...
(assert (= of_37 of_146))
; 
; =  {sc.input.I[31].O} {sc.iadd[8].D}
(assert (= sc_25 sc_129))
; 
; =  {of.input.I[31].O} {of.iadd[8].D}
(assert (= of_25 of_129))
; 
...
(assert (= of_29 of_7))
; 
; =  {sc.itov[11].Y} {sc.vgain[8].Z}
(assert (= sc_125 sc_2))
; 
; =  {of.itov[11].Y} {of.vgain[8].Z}
(assert (= of_125 of_2))
; 
...
(assert (= of_81 of_127))
; 
; =  {sc.input.I[32].O} {sc.iadd[8].C}
(assert (= sc_55 sc_130))
; 
; =  {of.input.I[32].O} {of.iadd[8].C}
(assert (= of_55 of_130))
; 
...
(assert (= of_84 of_77))
; 
; =  {sc.input.I[30].O} {sc.iadd[8].A}
(assert (= sc_43 sc_131))
; 
; =  {of.input.I[30].O} {of.iadd[8].A}
(assert (= of_43 of_131))
; 
...
(assert (= of_39 of_90))
; 
; =  {sc.switch[3].PROD} {sc.iadd[8].B}
(assert (= sc_13 sc_132))
; 
; =  {of.switch[3].PROD} {of.iadd[8].B}
(assert (= of_13 of_132))
; 
...
(assert (= of_68 of_58))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[0].X}
(assert (= sc_68 sc_82))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[0].X}
(assert (= of_68 of_82))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
