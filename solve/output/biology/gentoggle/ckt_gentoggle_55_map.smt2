...
(assert (= of_39 of_29))
; 
; =  {sc.input.I[10].O} {sc.iadd[0].B}
(assert (= sc_20 sc_95))
; 
; =  {of.input.I[10].O} {of.iadd[0].B}
(assert (= of_20 of_95))
; 
; =  {sc.input.I[12].O} {sc.itov[5].X}
(assert (= sc_12 sc_86))
; 
; =  {of.input.I[12].O} {of.itov[5].X}
(assert (= of_12 of_86))
; 
