...
(assert (<= (+ (* sc_86 2.5) of_86) 3300.))
; 
; <=  {((sc.input.V[1].O*2.5)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_86 2.5) of_86) 0.))
...
; 
; =  {(((sc.itov[7].X*0.939759036145)+of.itov[7].X)+sl.min.itov[7].X)} {0.0001}
(assert (= (+ (+ (* sc_91 0.939759036145) of_91) slbot_91) 0.0001))
; 
; =  {(((sc.itov[7].X*15.6)+of.itov[7].X)+sl.max.itov[7].X)} {10.}
...
(assert (= of_70 of_37))
; 
; =  {sc.input.I[18].O} {sc.iadd[0].C}
(assert (= sc_24 sc_98))
; 
; =  {of.input.I[18].O} {of.iadd[0].C}
(assert (= of_24 of_98))
; 
...
(assert (= of_51 of_6))
; 
; =  {sc.input.V[19].O} {sc.vtoi[3].K}
(assert (= sc_90 sc_53))
; 
; =  {of.input.V[19].O} {of.vtoi[3].K}
(assert (= of_90 of_53))
; 
...
(assert (= of_86 of_43))
; 
; =  {sc.input.I[17].O} {sc.iadd[0].D}
(assert (= sc_22 sc_97))
; 
; =  {of.input.I[17].O} {of.iadd[0].D}
(assert (= of_22 of_97))
; 
...
(assert (= of_64 of_29))
; 
; =  {sc.igenebind[1].GE} {sc.itov[7].X}
(assert (= sc_58 sc_91))
; 
; =  {of.igenebind[1].GE} {of.itov[7].X}
(assert (= of_58 of_91))
; 
