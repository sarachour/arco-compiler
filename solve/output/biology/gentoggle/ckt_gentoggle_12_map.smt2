...
; 
; =  {(((sc.vtoi[9].Y*156.25)+of.vtoi[9].Y)+sl.max.vtoi[9].Y)} {3300.}
...
(assert (= (+ (+ (* sc_62 0.) of_62) slbot_62) 0.00030303030303))
; 
; =  {(((sc.vtoi[6].Y*1.66666666667)+of.vtoi[6].Y)+sl.max.vtoi[6].Y)} {3300.}
(assert (= (+ (+ (* sc_62 1.66666666667) of_62) sltop_62) 3300.))
...
(assert (= (+ (+ (* sc_61 0.6) of_61) sltop_61) 3300.))
...
(assert (= of_99 0.))
; 
; >=  {((sc.itov[6].X*1.)+of.itov[6].X)} {10.}
(assert (<= (+ (* sc_97 1.) of_97) 10.))
; 
; <=  {((sc.itov[6].X*1.)+of.itov[6].X)} {0.0001}
(assert (>= (+ (* sc_97 1.) of_97) 0.0001))
(declare-fun slbot_98 () Real)
(declare-fun sltop_98 () Real)
; 
; =  {(((sc.itov[6].K*0.939759036145)+of.itov[6].K)+sl.min.itov[6].K)} {1.}
(assert (= (+ (+ (* sc_98 0.939759036145) of_98) slbot_98) 1.))
; 
; =  {(((sc.itov[6].K*15.6)+of.itov[6].K)+sl.max.itov[6].K)} {330.}
(assert (= (+ (+ (* sc_98 15.6) of_98) sltop_98) 330.))
...
(assert (= of_12 of_104))
; 
; =  {sc.input.I[20].O} {sc.iadd[9].D}
(assert (= sc_10 sc_108))
; 
; =  {of.input.I[20].O} {of.iadd[9].D}
(assert (= of_10 of_108))
; 
...
(assert (= of_68 of_1))
; 
; =  {sc.input.V[19].O} {sc.vtoi[9].K}
(assert (= sc_96 sc_58))
; 
; =  {of.input.V[19].O} {of.vtoi[9].K}
(assert (= of_96 of_58))
; 
...
(assert (= of_43 of_33))
; 
; =  {sc.vadd[3].OUT2} {sc.vtoi[9].X}
(assert (= sc_43 sc_57))
; 
; =  {of.vadd[3].OUT2} {of.vtoi[9].X}
(assert (= of_43 of_57))
; 
...
(assert (= of_72 of_44))
; 
; =  {sc.igenebind[1].GE} {sc.itov[6].K}
(assert (= sc_66 sc_98))
; 
; =  {of.igenebind[1].GE} {of.itov[6].K}
(assert (= of_66 of_98))
; 
...
(assert (= of_99 of_2))
; 
; =  {sc.input.I[21].O} {sc.itov[6].X}
(assert (= sc_20 sc_97))
; 
; =  {of.input.I[21].O} {of.itov[6].X}
(assert (= of_20 of_97))
; 
...
(assert (= of_107 of_6))
; 
; =  {sc.input.I[19].O} {sc.iadd[9].B}
(assert (= sc_32 sc_111))
; 
; =  {of.input.I[19].O} {of.iadd[9].B}
(assert (= of_32 of_111))
; 
; =  {sc.vtoi[9].Y} {sc.ihill[0].S}
(assert (= sc_59 sc_52))
; 
; =  {of.vtoi[9].Y} {of.ihill[0].S}
(assert (= of_59 of_52))
; 
...
(assert (and (and (= sc_43 sc_34) (= sc_43 sc_50)) (= sc_43 sc_36)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_49 0.) slbot_49 (- slbot_49))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= sltop_41 0.) sltop_41 (- sltop_41))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_49 0.) sltop_49 (- sltop_49))) (ite (>= slbot_41 0.) slbot_41 (- slbot_41))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
