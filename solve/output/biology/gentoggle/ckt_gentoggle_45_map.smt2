...
(assert (<= (+ (* sc_119 0.125) of_119) 3300.))
; 
; <=  {((sc.input.V[1].X*0.125)+of.input.V[1].X)} {0.}
(assert (>= (+ (* sc_119 0.125) of_119) 0.))
; 
; >=  {((sc.input.V[1].O*0.125)+of.input.V[1].O)} {3300.}
(assert (<= (+ (* sc_120 0.125) of_120) 3300.))
; 
; <=  {((sc.input.V[1].O*0.125)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_120 0.125) of_120) 0.))
...
(assert (= of_104 of_65))
; 
; =  {sc.input.I[26].O} {sc.iadd[12].D}
(assert (= sc_31 sc_134))
; 
; =  {of.input.I[26].O} {of.iadd[12].D}
(assert (= of_31 of_134))
; 
; =  {sc.input.I[25].O} {sc.iadd[12].C}
(assert (= sc_51 sc_135))
; 
; =  {of.input.I[25].O} {of.iadd[12].C}
(assert (= of_51 of_135))
; 
...
; 
; =  {sc.input.I[27].O} {sc.iadd[12].A}
(assert (= sc_35 sc_136))
; 
; =  {of.input.I[27].O} {of.iadd[12].A}
(assert (= of_35 of_136))
; 
...
(assert (= of_3 of_68))
; 
; =  {sc.input.I[28].O} {sc.itov[5].X}
(assert (= sc_53 sc_123))
; 
; =  {of.input.I[28].O} {of.itov[5].X}
(assert (= of_53 of_123))
; 
