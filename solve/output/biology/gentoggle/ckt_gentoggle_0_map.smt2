...
(assert (<= (+ (* sc_97 1000.75) of_97) 3300.))
; 
; <=  {((sc.input.V[10].O*1000.75)+of.input.V[10].O)} {0.}
(assert (>= (+ (* sc_97 1000.75) of_97) 0.))
...
; 
; =  {(((sc.iadd[7].B*15.6)+of.iadd[7].B)+sl.max.iadd[7].B)} {5.}
...
(assert (= of_99 of_116))
; 
; =  {sc.input.I[22].O} {sc.iadd[7].A}
(assert (= sc_48 sc_125))
; 
; =  {of.input.I[22].O} {of.iadd[7].A}
(assert (= of_48 of_125))
; 
...
(assert (= of_12 of_120))
; 
; =  {sc.input.I[20].O} {sc.iadd[7].C}
(assert (= sc_10 sc_124))
; 
; =  {of.input.I[20].O} {of.iadd[7].C}
(assert (= of_10 of_124))
; 
...
(assert (= of_59 of_73))
; 
; =  {sc.input.I[21].O} {sc.iadd[7].D}
(assert (= sc_34 sc_123))
; 
; =  {of.input.I[21].O} {of.iadd[7].D}
(assert (= of_34 of_123))
; 
