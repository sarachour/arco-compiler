...
; 
; =  {(((sc.iadd[17].A*0.)+of.iadd[17].A)+sl.min.iadd[17].A)} {0.}
(assert (= (+ (+ (* sc_218 0.) of_218) slbot_218) 0.))
; 
; =  {(((sc.iadd[17].A*0.0156)+of.iadd[17].A)+sl.max.iadd[17].A)} {5.}
...
; 
; =  {sc.input.V[28].O} {sc.vtoi[11].K}
(assert (= sc_170 sc_119))
; 
; =  {of.input.V[28].O} {of.vtoi[11].K}
(assert (= of_170 of_119))
; 
...
(assert (= sc_148 sc_122))
; 
; =  {of.input.V[27].O} {of.vtoi[10].K}
(assert (= of_148 of_122))
; 
...
(assert (= sc_168 sc_191))
; 
; =  {of.input.V[23].O} {of.itov[11].K}
(assert (= of_168 of_191))
; 
...
(assert (= of_20 of_190))
; 
; =  {sc.input.I[28].O} {sc.iadd[17].B}
(assert (= sc_74 sc_219))
; 
; =  {of.input.I[28].O} {of.iadd[17].B}
(assert (= of_74 of_219))
; 
...
(assert (= of_50 of_203))
; 
; =  {sc.switch[19].PROD} {sc.iadd[17].A}
(assert (= sc_30 sc_218))
; 
; =  {of.switch[19].PROD} {of.iadd[17].A}
(assert (= of_30 of_218))
; 
...
(assert (= of_32 of_104))
; 
; =  {sc.input.I[29].O} {sc.iadd[17].D}
(assert (= sc_36 sc_216))
; 
; =  {of.input.I[29].O} {of.iadd[17].D}
(assert (= of_36 of_216))
; 
