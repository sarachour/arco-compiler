...
; 
; =  {(((sc.iadd[9].B*0.0156)+of.iadd[9].B)+sl.max.iadd[9].B)} {5.}
(assert (= (+ (+ (* sc_147 0.0156) of_147) sltop_147) 5.))
...
(assert (= of_108 of_1))
; 
; =  {sc.input.I[18].O} {sc.iadd[9].D}
(assert (= sc_51 sc_144))
; 
; =  {of.input.I[18].O} {of.iadd[9].D}
(assert (= of_51 of_144))
; 
...
(assert (= of_74 of_139))
; 
; =  {sc.switch[15].PROD} {sc.iadd[9].B}
(assert (= sc_13 sc_147))
; 
; =  {of.switch[15].PROD} {of.iadd[9].B}
(assert (= of_13 of_147))
; 
...
(assert (= of_127 of_69))
; 
; =  {sc.input.I[19].O} {sc.iadd[9].A}
(assert (= sc_53 sc_146))
; 
; =  {of.input.I[19].O} {of.iadd[9].A}
(assert (= of_53 of_146))
; 
