...
(assert (= of_147 0.))
; 
; >=  {((sc.itov[14].X*1.)+of.itov[14].X)} {10.}
(assert (<= (+ (* sc_145 1.) of_145) 10.))
; 
; <=  {((sc.itov[14].X*1.)+of.itov[14].X)} {0.0001}
(assert (>= (+ (* sc_145 1.) of_145) 0.0001))
(declare-fun slbot_146 () Real)
(declare-fun sltop_146 () Real)
; 
; =  {(((sc.itov[14].K*0.154756521331)+of.itov[14].K)+sl.min.itov[14].K)} {1.}
(assert (= (+ (+ (* sc_146 0.154756521331) of_146) slbot_146) 1.))
; 
; =  {(((sc.itov[14].K*0.15625)+of.itov[14].K)+sl.max.itov[14].K)} {330.}
(assert (= (+ (+ (* sc_146 0.15625) of_146) sltop_146) 330.))
...
(assert (= of_3 of_81))
; 
; =  {sc.input.I[22].O} {sc.iadd[12].D}
(assert (= sc_65 sc_158))
; 
; =  {of.input.I[22].O} {of.iadd[12].D}
(assert (= of_65 of_158))
; 
...
(assert (= of_110 of_13))
; 
; =  {sc.input.I[20].O} {sc.iadd[12].C}
(assert (= sc_19 sc_159))
; 
; =  {of.input.I[20].O} {of.iadd[12].C}
(assert (= of_19 of_159))
; 
...
(assert (= of_152 of_97))
; 
; =  {sc.igenebind[1].GE} {sc.itov[14].K}
(assert (= sc_100 sc_146))
; 
; =  {of.igenebind[1].GE} {of.itov[14].K}
(assert (= of_100 of_146))
; 
...
(assert (= of_144 of_6))
; 
; =  {sc.input.I[23].O} {sc.itov[14].X}
(assert (= sc_55 sc_145))
; 
; =  {of.input.I[23].O} {of.itov[14].X}
(assert (= of_55 of_145))
; 
; =  {sc.input.I[21].O} {sc.iadd[12].B}
(assert (= sc_43 sc_161))
; 
; =  {of.input.I[21].O} {of.iadd[12].B}
(assert (= of_43 of_161))
; 
...
(assert (= sc_126 sc_143))
; 
; =  {of.input.V[16].O} {of.itov[6].K}
(assert (= of_126 of_143))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= sltop_172 0.) sltop_172 (- sltop_172))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_151 0.) slbot_151 (- slbot_151))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_166 0.) sltop_166 (- sltop_166))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_146 0.) sltop_146 (- sltop_146))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_166 0.) slbot_166 (- slbot_166))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_151 0.) sltop_151 (- sltop_151))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= slbot_171 0.) slbot_171 (- slbot_171))) (ite (>= slbot_160 0.) slbot_160 (- slbot_160))) (ite (>= slbot_172 0.) slbot_172 (- slbot_172))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= sltop_167 0.) sltop_167 (- sltop_167))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_167 0.) slbot_167 (- slbot_167))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= sltop_171 0.) sltop_171 (- sltop_171))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= slbot_146 0.) slbot_146 (- slbot_146))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_160 0.) sltop_160 (- sltop_160))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144)))))
(check-sat)
