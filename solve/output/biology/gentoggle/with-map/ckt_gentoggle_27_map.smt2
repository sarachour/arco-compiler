...
(assert (= (+ (+ (* sc_65 0.15625) of_65) sltop_65) 3300.))
...
(assert (= (+ (+ (* sc_66 0.0156) of_66) sltop_66) 3300.))
...
(assert (= (+ (+ (* sc_67 0.0156) of_67) sltop_67) 3300.))
...
(assert (= sc_78 (* 1. sc_79)))
; 
; =  {sc.vadd[16].A} {(1.*sc.vadd[16].C)} {(1.*sc.vadd[16].D)}
(assert (and (= sc_78 (* 1. sc_77)) (= sc_78 (* 1. sc_76))))
; no offset
(assert (= (- (+ of_78 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[16].OUT} {(sc.vadd[16].A*1.)}
(assert (= sc_80 (* sc_78 1.)))
; 
; =  {of.vadd[16].OUT} {0.}
(assert (= of_80 0.))
; no scale
...
(assert (and (= sc_78 (* 1. sc_77)) (= sc_78 (* (* 1. sc_76) sc_81))))
; no offset
(assert (= (- (+ of_78 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= (+ (+ (* sc_84 1.66666666667) of_84) sltop_84) 3300.))
...
(assert (= (+ (+ (* sc_87 -0.15625) of_87) slbot_87) 0.00030303030303))
; 
; =  {(((sc.vtoi[0].Y*0.)+of.vtoi[0].Y)+sl.max.vtoi[0].Y)} {3300.}
(assert (= (+ (+ (* sc_87 0.) of_87) sltop_87) 3300.))
; 
...
(assert (= (+ (+ (* sc_90 0.) of_90) slbot_90) 0.00030303030303))
; 
; =  {(((sc.vtoi[4].Y*0.00965050555471)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
(assert (= (+ (+ (* sc_90 0.00965050555471) of_90) sltop_90) 3300.))
...
(assert (= (+ (+ (* sc_89 103.621514368) of_89) sltop_89) 3300.))
(declare-fun slbot_90 () Real)
(declare-fun sltop_90 () Real)
; 
; =  {(((sc.vtoi[4].Y*0.)+of.vtoi[4].Y)+sl.min.vtoi[4].Y)} {0.00030303030303}
...
(assert (= (+ (+ (* sc_91 0.0156) of_91) sltop_91) 10.))
; 
...
(assert (<= (+ (* sc_105 0.000125) of_105) 3300.))
; 
; <=  {((sc.input.V[13].X*0.000125)+of.input.V[13].X)} {0.}
(assert (>= (+ (* sc_105 0.000125) of_105) 0.))
; 
; >=  {((sc.input.V[13].O*0.000125)+of.input.V[13].O)} {3300.}
(assert (<= (+ (* sc_106 0.000125) of_106) 3300.))
; 
; <=  {((sc.input.V[13].O*0.000125)+of.input.V[13].O)} {0.}
(assert (>= (+ (* sc_106 0.000125) of_106) 0.))
...
(assert (= (+ (+ (* sc_111 0.) of_111) slbot_111) 0.))
; 
; =  {(((sc.input.V[0].X*0.6)+of.input.V[0].X)+sl.max.input.V[0].X)} {3300.}
(assert (= (+ (+ (* sc_111 0.6) of_111) sltop_111) 3300.))
...
(assert (= (+ (+ (* sc_112 0.6) of_112) sltop_112) 3300.))
...
; 
; =  {(((sc.itov[14].X*0.154756521331)+of.itov[14].X)+sl.min.itov[14].X)} {0.0001}
(assert (= (+ (+ (* sc_145 0.154756521331) of_145) slbot_145) 0.0001))
; 
; =  {(((sc.itov[14].X*0.15625)+of.itov[14].X)+sl.max.itov[14].X)} {10.}
(assert (= (+ (+ (* sc_145 0.15625) of_145) sltop_145) 10.))
; 
...
; 
; =  {(((sc.itov[14].Y*0.154756521331)+of.itov[14].Y)+sl.min.itov[14].Y)} {0.0001}
(assert (= (+ (+ (* sc_147 0.154756521331) of_147) slbot_147) 0.0001))
; 
; =  {(((sc.itov[14].Y*0.15625)+of.itov[14].Y)+sl.max.itov[14].Y)} {3300.}
(assert (= (+ (+ (* sc_147 0.15625) of_147) sltop_147) 3300.))
...
(assert (= (+ (+ (* sc_160 0.) of_160) slbot_160) 0.))
; 
; =  {(((sc.iadd[12].A*0.0156)+of.iadd[12].A)+sl.max.iadd[12].A)} {5.}
(assert (= (+ (+ (* sc_160 0.0156) of_160) sltop_160) 5.))
; 
...
(assert (= of_3 of_79))
; 
; =  {sc.itov[14].Y} {sc.vgain[15].Z}
(assert (= sc_147 sc_2))
; 
; =  {of.itov[14].Y} {of.vgain[15].Z}
(assert (= of_147 of_2))
; 
...
(assert (= of_35 of_159))
; 
; =  {sc.input.I[25].O} {sc.iadd[12].B}
(assert (= sc_55 sc_161))
; 
; =  {of.input.I[25].O} {of.iadd[12].B}
(assert (= of_55 of_161))
; 
...
(assert (= of_100 of_8))
; 
; =  {sc.input.V[19].O} {sc.itov[14].K}
(assert (= sc_136 sc_146))
; 
; =  {of.input.V[19].O} {of.itov[14].K}
(assert (= of_136 of_146))
; 
...
(assert (= of_152 of_95))
; 
; =  {sc.igenebind[1].GE} {sc.itov[14].X}
(assert (= sc_98 sc_145))
; 
; =  {of.igenebind[1].GE} {of.itov[14].X}
(assert (= of_98 of_145))
; 
...
(assert (= sc_124 sc_143))
; 
; =  {of.input.V[16].O} {of.itov[6].K}
(assert (= of_124 of_143))
; 
...
(assert (= of_157 of_9))
; 
; =  {sc.switch[10].PROD} {sc.iadd[12].A}
(assert (= sc_17 sc_160))
; 
; =  {of.switch[10].PROD} {of.iadd[12].A}
(assert (= of_17 of_160))
; 
...
(assert (= of_90 of_171))
(assert (<= (* sc_65 0.001) 0.001))
(assert (<= (* sc_67 0.001) 0.001))
; 
; =  {sc.vadd[13].OUT2} {sc.output.V[0].O} {sc.vadd[16].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_74 sc_65) (= sc_74 sc_81)) (= sc_74 sc_67)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_172 0.) sltop_172 (- sltop_172)) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_151 0.) slbot_151 (- slbot_151))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_166 0.) sltop_166 (- sltop_166))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_166 0.) slbot_166 (- slbot_166))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= sltop_151 0.) sltop_151 (- sltop_151))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= slbot_171 0.) slbot_171 (- slbot_171))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= slbot_160 0.) slbot_160 (- slbot_160))) (ite (>= slbot_172 0.) slbot_172 (- slbot_172))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= sltop_167 0.) sltop_167 (- sltop_167))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_167 0.) slbot_167 (- slbot_167))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_171 0.) sltop_171 (- sltop_171))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= sltop_160 0.) sltop_160 (- sltop_160))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144)))))
(check-sat)
