...
(assert (<= (+ (* sc_18 -0.5) of_18) 10.))
; 
; <=  {((sc.switch[6].Kmod*-0.5)+of.switch[6].Kmod)} {0.0001}
(assert (>= (+ (* sc_18 -0.5) of_18) 0.0001))
...
; 
; =  {sc.vtoi[15].Y} {sc.iadd[20].B}
(assert (= sc_123 sc_204))
; 
; =  {of.vtoi[15].Y} {of.iadd[20].B}
(assert (= of_123 of_204))
; 
...
(assert (= of_15 of_125))
; 
; =  {sc.input.V[28].O} {sc.vtoi[16].K}
(assert (= sc_175 sc_128))
; 
; =  {of.input.V[28].O} {of.vtoi[16].K}
(assert (= of_175 of_128))
; 
...
(assert (= of_87 of_201))
; 
; =  {sc.input.I[26].O} {sc.iadd[22].C}
(assert (= sc_55 sc_217))
; 
; =  {of.input.I[26].O} {of.iadd[22].C}
(assert (= of_55 of_217))
; 
...
(assert (= sc_126 sc_209))
; 
; =  {of.vtoi[14].Y} {of.iadd[13].B}
(assert (= of_126 of_209))
; 
...
(assert (= sc_159 sc_187))
; 
; =  {of.input.V[21].O} {of.itov[12].K}
(assert (= of_159 of_187))
; 
...
(assert (= of_43 of_207))
; 
; =  {sc.input.V[29].O} {sc.vtoi[15].K}
(assert (= sc_135 sc_122))
; 
; =  {of.input.V[29].O} {of.vtoi[15].K}
...
(assert (= sc_155 sc_106))
; 
; =  {of.input.V[6].O} {of.ihill[7].n}
(assert (= of_155 of_106))
; 
; =  {sc.input.I[28].O} {sc.iadd[22].A}
(assert (= sc_77 sc_218))
; 
; =  {of.input.I[28].O} {of.iadd[22].A}
(assert (= of_77 of_218))
; 
...
(assert (= sc_145 sc_102))
; 
; =  {of.input.V[9].O} {of.vadd[5].A}
(assert (= of_145 of_102))
; 
...
(assert (= of_30 of_189))
; 
; =  {sc.vtoi[16].Y} {sc.ihill[7].Km}
(assert (= sc_129 sc_108))
; 
; =  {of.vtoi[16].Y} {of.ihill[7].Km}
(assert (= of_129 of_108))
; 
...
(assert (= sc_173 sc_199))
; 
; =  {of.input.V[25].O} {of.itov[18].K}
(assert (= of_173 of_199))
; 
...
; 
; =  {sc.input.I[27].O} {sc.iadd[22].D}
(assert (= sc_59 sc_216))
; 
; =  {of.input.I[27].O} {of.iadd[22].D}
(assert (= of_59 of_216))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_219 0.) slbot_219 (- slbot_219))) (ite (>= slbot_196 0.) slbot_196 (- slbot_196))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= slbot_209 0.) slbot_209 (- slbot_209))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_220 0.) sltop_220 (- sltop_220))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_193 0.) sltop_193 (- sltop_193))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_215 0.) slbot_215 (- slbot_215))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= sltop_196 0.) sltop_196 (- sltop_196))) (ite (>= slbot_210 0.) slbot_210 (- slbot_210))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= slbot_220 0.) slbot_220 (- slbot_220))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_193 0.) slbot_193 (- slbot_193))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_197 0.) slbot_197 (- slbot_197))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= sltop_197 0.) sltop_197 (- sltop_197))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= slbot_211 0.) slbot_211 (- slbot_211))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= sltop_209 0.) sltop_209 (- sltop_209))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_210 0.) sltop_210 (- sltop_210))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_215 0.) sltop_215 (- sltop_215))) (ite (>= sltop_219 0.) sltop_219 (- sltop_219))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= sltop_211 0.) sltop_211 (- sltop_211)))))
(check-sat)
