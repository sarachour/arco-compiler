...
(assert (= of_120 of_62))
; 
; =  {sc.input.I[22].O} {sc.iadd[10].C}
(assert (= sc_53 sc_132))
; 
; =  {of.input.I[22].O} {of.iadd[10].C}
(assert (= of_53 of_132))
; 
...
(assert (= of_108 of_67))
; 
; =  {sc.input.I[24].O} {sc.iadd[10].A}
(assert (= sc_35 sc_133))
; 
; =  {of.input.I[24].O} {of.iadd[10].A}
(assert (= of_35 of_133))
; 
...
(assert (= of_130 of_81))
; 
; =  {sc.input.I[23].O} {sc.iadd[10].D}
(assert (= sc_45 sc_131))
; 
; =  {of.input.I[23].O} {of.iadd[10].D}
(assert (= of_45 of_131))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= sltop_130 0.) sltop_130 (- sltop_130))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_135 0.) sltop_135 (- sltop_135))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_135 0.) slbot_135 (- slbot_135))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8)))))
(check-sat)
