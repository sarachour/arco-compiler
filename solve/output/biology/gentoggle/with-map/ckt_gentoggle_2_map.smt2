...
(assert (= of_75 of_54))
; 
; =  {sc.input.I[16].O} {sc.itov[3].X}
(assert (= sc_20 sc_89))
; 
; =  {of.input.I[16].O} {of.itov[3].X}
(assert (= of_20 of_89))
; 
...
(assert (= of_65 of_33))
; 
; =  {sc.igenebind[1].GE} {sc.itov[3].K}
(assert (= sc_59 sc_90))
; 
; =  {of.igenebind[1].GE} {of.itov[3].K}
(assert (= of_59 of_90))
; 
