...
; 
; =  {(((sc.itov[13].X*0.154756521331)+of.itov[13].X)+sl.min.itov[13].X)} {0.0001}
(assert (= (+ (+ (* sc_139 0.154756521331) of_139) slbot_139) 0.0001))
; 
; =  {(((sc.itov[13].X*0.15625)+of.itov[13].X)+sl.max.itov[13].X)} {10.}
(assert (= (+ (+ (* sc_139 0.15625) of_139) sltop_139) 10.))
; 
; >=  {((sc.itov[13].K*1.)+of.itov[13].K)} {330.}
(assert (<= (+ (* sc_140 1.) of_140) 330.))
; 
...
(assert (= of_110 of_13))
; 
; =  {sc.input.I[29].O} {sc.iadd[12].A}
(assert (= sc_21 sc_160))
; 
; =  {of.input.I[29].O} {of.iadd[12].A}
(assert (= of_21 of_160))
; 
...
(assert (= of_167 of_15))
; 
; =  {sc.input.V[20].O} {sc.itov[13].K}
(assert (= sc_100 sc_140))
; 
; =  {of.input.V[20].O} {of.itov[13].K}
...
(assert (= of_152 of_95))
; 
; =  {sc.igenebind[1].GE} {sc.itov[13].X}
(assert (= sc_98 sc_139))
; 
; =  {of.igenebind[1].GE} {of.itov[13].X}
(assert (= of_98 of_139))
; 
...
(assert (= of_147 of_6))
; 
; =  {sc.input.I[27].O} {sc.iadd[12].C}
(assert (= sc_39 sc_159))
; 
; =  {of.input.I[27].O} {of.iadd[12].C}
(assert (= of_39 of_159))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_172 0.) sltop_172 (- sltop_172)) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_141 0.) sltop_141 (- sltop_141))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_151 0.) slbot_151 (- slbot_151))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_166 0.) sltop_166 (- sltop_166))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_166 0.) slbot_166 (- slbot_166))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= slbot_141 0.) slbot_141 (- slbot_141))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= sltop_161 0.) sltop_161 (- sltop_161))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_151 0.) sltop_151 (- sltop_151))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_161 0.) slbot_161 (- slbot_161))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= slbot_171 0.) slbot_171 (- slbot_171))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= slbot_172 0.) slbot_172 (- slbot_172))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= sltop_167 0.) sltop_167 (- sltop_167))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_167 0.) slbot_167 (- slbot_167))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_171 0.) sltop_171 (- sltop_171))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144)))))
(check-sat)
