...
(assert (= of_105 of_88))
; 
; =  {sc.vtoi[17].Y} {sc.iadd[20].B}
(assert (= sc_126 sc_204))
; 
; =  {of.vtoi[17].Y} {of.iadd[20].B}
...
; 
; =  {sc.vtoi[18].Y} {sc.ihill[7].Km}
(assert (= sc_129 sc_108))
; 
; =  {of.vtoi[18].Y} {of.ihill[7].Km}
