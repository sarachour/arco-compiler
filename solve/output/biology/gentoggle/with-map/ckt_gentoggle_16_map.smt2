...
; 
; =  {(((sc.vgain[10].P*0.176776695297)+of.vgain[10].P)+sl.min.vgain[10].P)} {1.51515151515e-12}
(assert (= (+ (+ (* sc_3 0.176776695297) of_3) slbot_3) 1.51515151515e-12))
; 
; =  {(((sc.vgain[10].P*1.)+of.vgain[10].P)+sl.max.vgain[10].P)} {5445000.}
(assert (= (+ (+ (* sc_3 1.) of_3) sltop_3) 5445000.))
(declare-fun slbot_2 () Real)
(declare-fun sltop_2 () Real)
; 
; =  {(((sc.vgain[10].Z*0.176776695297)+of.vgain[10].Z)+sl.min.vgain[10].Z)} {0.0001}
(assert (= (+ (+ (* sc_2 0.176776695297) of_2) slbot_2) 0.0001))
; 
; =  {(((sc.vgain[10].Z*1.)+of.vgain[10].Z)+sl.max.vgain[10].Z)} {3300.}
...
; 
; =  {(((sc.vgain[6].Y*0.)+of.vgain[6].Y)+sl.min.vgain[6].Y)} {1.}
(assert (= (+ (+ (* sc_5 0.) of_5) slbot_5) 1.))
; 
; =  {(((sc.vgain[6].Y*0.00965050555471)+of.vgain[6].Y)+sl.max.vgain[6].Y)} {3300.}
...
; 
; =  {(((sc.vgain[6].P*103.621514368)+of.vgain[6].P)+sl.max.vgain[6].P)} {5445000.}
(assert (= (+ (+ (* sc_7 103.621514368) of_7) sltop_7) 5445000.))
; 
; >=  {((sc.vgain[6].Z*2.)+of.vgain[6].Z)} {3300.}
(assert (<= (+ (* sc_6 2.) of_6) 3300.))
; 
; <=  {((sc.vgain[6].Z*2.)+of.vgain[6].Z)} {0.0001}
...
; 
; =  {(((sc.vgain[4].Y*1.)+of.vgain[4].Y)+sl.min.vgain[4].Y)} {1.}
(assert (= (+ (+ (* sc_9 1.) of_9) slbot_9) 1.))
; 
; =  {(((sc.vgain[4].Y*5.65685424949)+of.vgain[4].Y)+sl.max.vgain[4].Y)} {3300.}
(assert (= (+ (+ (* sc_9 5.65685424949) of_9) sltop_9) 3300.))
(declare-fun slbot_11 () Real)
(declare-fun sltop_11 () Real)
; 
; =  {(((sc.vgain[4].P*0.0276213586401)+of.vgain[4].P)+sl.min.vgain[4].P)} {1.51515151515e-12}
(assert (= (+ (+ (* sc_11 0.0276213586401) of_11) slbot_11) 1.51515151515e-12))
; 
; =  {(((sc.vgain[4].P*0.15625)+of.vgain[4].P)+sl.max.vgain[4].P)} {5445000.}
(assert (= (+ (+ (* sc_11 0.15625) of_11) sltop_11) 5445000.))
; 
; >=  {((sc.vgain[4].Z*0.3125)+of.vgain[4].Z)} {3300.}
(assert (<= (+ (* sc_10 0.3125) of_10) 3300.))
; 
; <=  {((sc.vgain[4].Z*0.3125)+of.vgain[4].Z)} {0.0001}
(assert (>= (+ (* sc_10 0.3125) of_10) 0.0001))
(declare-fun slbot_11 () Real)
(declare-fun sltop_11 () Real)
; 
; =  {(((sc.vgain[4].P*0.0276213586401)+of.vgain[4].P)+sl.min.vgain[4].P)} {1.51515151515e-12}
...
; 
; =  {(((sc.vgain[5].Y*103.621514368)+of.vgain[5].Y)+sl.max.vgain[5].Y)} {3300.}
(assert (= (+ (+ (* sc_13 103.621514368) of_13) sltop_13) 3300.))
...
; 
; =  {(((sc.vgain[5].P*0.00965050555471)+of.vgain[5].P)+sl.max.vgain[5].P)} {5445000.}
(assert (= (+ (+ (* sc_15 0.00965050555471) of_15) sltop_15) 5445000.))
; 
...
; 
; =  {(((sc.switch[12].SUB*-0.5)+of.switch[12].SUB)+sl.min.switch[12].SUB)} {0.0001}
(assert (= (+ (+ (* sc_17 -0.5) of_17) slbot_17) 0.0001))
; 
; =  {(((sc.switch[12].SUB*0.)+of.switch[12].SUB)+sl.max.switch[12].SUB)} {10.}
...
; 
; =  {(((sc.switch[12].PROD*0.176776695297)+of.switch[12].PROD)+sl.min.switch[12].PROD)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_20 0.176776695297) of_20) slbot_20) 9.99934002508e-38))
; 
; =  {(((sc.switch[12].PROD*1.)+of.switch[12].PROD)+sl.max.switch[12].PROD)} {9.9999999}
...
; 
; =  {(((sc.switch[14].SUB*-1.)+of.switch[14].SUB)+sl.min.switch[14].SUB)} {0.0001}
(assert (= (+ (+ (* sc_22 -1.) of_22) slbot_22) 0.0001))
; 
; =  {(((sc.switch[14].SUB*-0.84375)+of.switch[14].SUB)+sl.max.switch[14].SUB)} {10.}
...
; 
; =  {(((sc.switch[14].PROD*0.00965050555471)+of.switch[14].PROD)+sl.max.switch[14].PROD)} {9.9999999}
...
; 
; =  {(((sc.ihill[2].S*0.5)+of.ihill[2].S)+sl.min.ihill[2].S)} {1.}
(assert (= (+ (+ (* sc_104 0.5) of_104) slbot_104) 1.))
; 
; =  {(((sc.ihill[2].S*1.)+of.ihill[2].S)+sl.max.ihill[2].S)} {10.}
(assert (= (+ (+ (* sc_104 1.) of_104) sltop_104) 10.))
(declare-fun slbot_108 () Real)
(declare-fun sltop_108 () Real)
; 
; =  {(((sc.ihill[2].REP*0.0273573464165)+of.ihill[2].REP)+sl.min.ihill[2].REP)} {5e-10}
(assert (= (+ (+ (* sc_108 0.0273573464165) of_108) slbot_108) 5e-10))
; 
; =  {(((sc.ihill[2].REP*0.883883476483)+of.ihill[2].REP)+sl.max.ihill[2].REP)} {500000.}
(assert (= (+ (+ (* sc_108 0.883883476483) of_108) sltop_108) 500000.))
(declare-fun slbot_105 () Real)
(declare-fun sltop_105 () Real)
; 
; =  {(((sc.ihill[2].Km*0.)+of.ihill[2].Km)+sl.min.ihill[2].Km)} {1.}
(assert (= (+ (+ (* sc_105 0.) of_105) slbot_105) 1.))
; 
; =  {(((sc.ihill[2].Km*0.15625)+of.ihill[2].Km)+sl.max.ihill[2].Km)} {10.}
(assert (= (+ (+ (* sc_105 0.15625) of_105) sltop_105) 10.))
(declare-fun slbot_106 () Real)
(declare-fun sltop_106 () Real)
; 
; =  {(((sc.ihill[2].Vmax*0.)+of.ihill[2].Vmax)+sl.min.ihill[2].Vmax)} {0.0001}
(assert (= (+ (+ (* sc_106 0.) of_106) slbot_106) 0.0001))
; 
; =  {(((sc.ihill[2].Vmax*16.1908616201)+of.ihill[2].Vmax)+sl.max.ihill[2].Vmax)} {10.}
...
(assert (= (+ (+ (* sc_110 0.0156) of_110) sltop_110) 10.))
...
(assert (>= (+ (* sc_115 1.) of_115) 1.))
(declare-fun slbot_117 () Real)
(declare-fun sltop_117 () Real)
; 
; =  {(((sc.vtoi[9].Y*1.)+of.vtoi[9].Y)+sl.min.vtoi[9].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_117 1.) of_117) slbot_117) 0.00030303030303))
; 
; =  {(((sc.vtoi[9].Y*5.65685424949)+of.vtoi[9].Y)+sl.max.vtoi[9].Y)} {3300.}
(assert (= (+ (+ (* sc_117 5.65685424949) of_117) sltop_117) 3300.))
(declare-fun slbot_116 () Real)
(declare-fun sltop_116 () Real)
; 
; =  {(((sc.vtoi[9].K*0.176776695297)+of.vtoi[9].K)+sl.min.vtoi[9].K)} {1.}
(assert (= (+ (+ (* sc_116 0.176776695297) of_116) slbot_116) 1.))
; 
; =  {(((sc.vtoi[9].K*1.)+of.vtoi[9].K)+sl.max.vtoi[9].K)} {3300.}
...
; 
; =  {(((sc.vtoi[3].X*0.0276213586401)+of.vtoi[3].X)+sl.min.vtoi[3].X)} {1.}
(assert (= (+ (+ (* sc_124 0.0276213586401) of_124) slbot_124) 1.))
; 
; =  {(((sc.vtoi[3].X*0.15625)+of.vtoi[3].X)+sl.max.vtoi[3].X)} {3300.}
...
; 
; =  {(((sc.vtoi[3].Y*16.1908616201)+of.vtoi[3].Y)+sl.max.vtoi[3].Y)} {3300.}
(assert (= (+ (+ (* sc_126 16.1908616201) of_126) sltop_126) 3300.))
(declare-fun slbot_125 () Real)
(declare-fun sltop_125 () Real)
; 
; =  {(((sc.vtoi[3].K*0.)+of.vtoi[3].K)+sl.min.vtoi[3].K)} {1.}
(assert (= (+ (+ (* sc_125 0.) of_125) slbot_125) 1.))
; 
; =  {(((sc.vtoi[3].K*0.00965050555471)+of.vtoi[3].K)+sl.max.vtoi[3].K)} {3300.}
(assert (= (+ (+ (* sc_125 0.00965050555471) of_125) sltop_125) 3300.))
(declare-fun slbot_126 () Real)
(declare-fun sltop_126 () Real)
; 
; =  {(((sc.vtoi[3].Y*0.)+of.vtoi[3].Y)+sl.min.vtoi[3].Y)} {0.00030303030303}
...
; 
; =  {(((sc.itov[7].X*1.)+of.itov[7].X)+sl.min.itov[7].X)} {0.0001}
(assert (= (+ (+ (* sc_184 1.) of_184) slbot_184) 0.0001))
; 
; =  {(((sc.itov[7].X*5.65685424949)+of.itov[7].X)+sl.max.itov[7].X)} {10.}
(assert (= (+ (+ (* sc_184 5.65685424949) of_184) sltop_184) 10.))
(declare-fun slbot_186 () Real)
(declare-fun sltop_186 () Real)
; 
; =  {(((sc.itov[7].Y*1.)+of.itov[7].Y)+sl.min.itov[7].Y)} {0.0001}
(assert (= (+ (+ (* sc_186 1.) of_186) slbot_186) 0.0001))
; 
; =  {(((sc.itov[7].Y*5.65685424949)+of.itov[7].Y)+sl.max.itov[7].Y)} {3300.}
...
; 
; =  {(((sc.itov[13].X*0.)+of.itov[13].X)+sl.min.itov[13].X)} {0.0001}
(assert (= (+ (+ (* sc_187 0.) of_187) slbot_187) 0.0001))
; 
; =  {(((sc.itov[13].X*0.00965050555471)+of.itov[13].X)+sl.max.itov[13].X)} {10.}
(assert (= (+ (+ (* sc_187 0.00965050555471) of_187) sltop_187) 10.))
(declare-fun slbot_189 () Real)
(declare-fun sltop_189 () Real)
; 
; =  {(((sc.itov[13].Y*0.)+of.itov[13].Y)+sl.min.itov[13].Y)} {0.0001}
(assert (= (+ (+ (* sc_189 0.) of_189) slbot_189) 0.0001))
; 
; =  {(((sc.itov[13].Y*0.00965050555471)+of.itov[13].Y)+sl.max.itov[13].Y)} {3300.}
(assert (= (+ (+ (* sc_189 0.00965050555471) of_189) sltop_189) 3300.))
; 
...
; 
; =  {(((sc.itov[11].X*0.176776695297)+of.itov[11].X)+sl.min.itov[11].X)} {0.0001}
(assert (= (+ (+ (* sc_190 0.176776695297) of_190) slbot_190) 0.0001))
; 
; =  {(((sc.itov[11].X*1.)+of.itov[11].X)+sl.max.itov[11].X)} {10.}
(assert (= (+ (+ (* sc_190 1.) of_190) sltop_190) 10.))
(declare-fun slbot_192 () Real)
(declare-fun sltop_192 () Real)
; 
; =  {(((sc.itov[11].Y*0.176776695297)+of.itov[11].Y)+sl.min.itov[11].Y)} {0.0001}
(assert (= (+ (+ (* sc_192 0.176776695297) of_192) slbot_192) 0.0001))
; 
; =  {(((sc.itov[11].Y*1.)+of.itov[11].Y)+sl.max.itov[11].Y)} {3300.}
(assert (= (+ (+ (* sc_192 1.) of_192) sltop_192) 3300.))
; 
...
; 
; =  {(((sc.iadd[8].OUT*5.65685424949)+of.iadd[8].OUT)+sl.max.iadd[8].OUT)} {10.}
(assert (= (+ (+ (* sc_200 5.65685424949) of_200) sltop_200) 10.))
; 
...
; 
; =  {(((sc.iadd[8].B*1.)+of.iadd[8].B)+sl.min.iadd[8].B)} {0.}
(assert (= (+ (+ (* sc_199 1.) of_199) slbot_199) 0.))
; 
; =  {(((sc.iadd[8].B*5.65685424949)+of.iadd[8].B)+sl.max.iadd[8].B)} {5.}
(assert (= (+ (+ (* sc_199 5.65685424949) of_199) sltop_199) 5.))
(declare-fun slbot_200 () Real)
(declare-fun sltop_200 () Real)
; 
; =  {(((sc.iadd[8].OUT*1.)+of.iadd[8].OUT)+sl.min.iadd[8].OUT)} {-10.}
...
; 
; >=  {((sc.iadd[15].D*1.)+of.iadd[15].D)} {5.}
(assert (<= (+ (* sc_201 1.) of_201) 5.))
; 
; <=  {((sc.iadd[15].D*1.)+of.iadd[15].D)} {0.}
...
; 
; =  {(((sc.iadd[15].OUT*-1.)+of.iadd[15].OUT)+sl.min.iadd[15].OUT)} {-10.}
(assert (= (+ (+ (* sc_205 -1.) of_205) slbot_205) -10.))
; 
; =  {(((sc.iadd[15].OUT*-0.84375)+of.iadd[15].OUT)+sl.max.iadd[15].OUT)} {10.}
...
; 
; =  {(((sc.iadd[15].B*0.15625)+of.iadd[15].B)+sl.max.iadd[15].B)} {5.}
...
; 
; =  {(((sc.iadd[16].D*-1.)+of.iadd[16].D)+sl.min.iadd[16].D)} {0.}
(assert (= (+ (+ (* sc_206 -1.) of_206) slbot_206) 0.))
; 
; =  {(((sc.iadd[16].D*-0.5)+of.iadd[16].D)+sl.max.iadd[16].D)} {5.}
(assert (= (+ (+ (* sc_206 -0.5) of_206) sltop_206) 5.))
; 
; >=  {((sc.iadd[16].C*1.)+of.iadd[16].C)} {5.}
(assert (<= (+ (* sc_207 1.) of_207) 5.))
; 
...
; 
; =  {(((sc.iadd[16].OUT*-0.5)+of.iadd[16].OUT)+sl.min.iadd[16].OUT)} {-10.}
(assert (= (+ (+ (* sc_210 -0.5) of_210) slbot_210) -10.))
; 
; =  {(((sc.iadd[16].OUT*0.)+of.iadd[16].OUT)+sl.max.iadd[16].OUT)} {10.}
(assert (= (+ (+ (* sc_210 0.) of_210) sltop_210) 10.))
; 
...
; 
; =  {(((sc.iadd[1].C*0.5)+of.iadd[1].C)+sl.min.iadd[1].C)} {0.}
(assert (= (+ (+ (* sc_212 0.5) of_212) slbot_212) 0.))
; 
; =  {(((sc.iadd[1].C*1.)+of.iadd[1].C)+sl.max.iadd[1].C)} {5.}
(assert (= (+ (+ (* sc_212 1.) of_212) sltop_212) 5.))
...
; 
; =  {(((sc.iadd[1].OUT*-0.5)+of.iadd[1].OUT)+sl.max.iadd[1].OUT)} {10.}
(assert (= (+ (+ (* sc_215 -0.5) of_215) sltop_215) 10.))
; 
...
(declare-fun slbot_219 () Real)
(declare-fun sltop_219 () Real)
; 
; =  {(((sc.iadd[17].B*0.)+of.iadd[17].B)+sl.min.iadd[17].B)} {0.}
(assert (= (+ (+ (* sc_219 0.) of_219) slbot_219) 0.))
; 
; =  {(((sc.iadd[17].B*0.0156)+of.iadd[17].B)+sl.max.iadd[17].B)} {5.}
(assert (= (+ (+ (* sc_219 0.0156) of_219) sltop_219) 5.))
...
(assert (= of_46 of_27))
; 
; =  {sc.vtoi[3].Y} {sc.ihill[2].Vmax}
(assert (= sc_126 sc_106))
; 
; =  {of.vtoi[3].Y} {of.ihill[2].Vmax}
(assert (= of_126 of_106))
; 
; =  {sc.iadd[15].OUT} {sc.switch[14].SUB}
(assert (= sc_205 sc_22))
; 
; =  {of.iadd[15].OUT} {of.switch[14].SUB}
(assert (= of_205 of_22))
; 
; =  {sc.ihill[0].REP} {sc.itov[20].K}
(assert (= sc_114 sc_182))
; 
; =  {of.ihill[0].REP} {of.itov[20].K}
(assert (= of_114 of_182))
; 
; =  {sc.input.V[15].O} {sc.switch[19].n}
(assert (= sc_150 sc_26))
; 
; =  {of.input.V[15].O} {of.switch[19].n}
(assert (= of_150 of_26))
; 
; =  {sc.input.I[22].O} {sc.iadd[16].C}
(assert (= sc_84 sc_207))
; 
; =  {of.input.I[22].O} {of.iadd[16].C}
(assert (= of_84 of_207))
; 
; =  {sc.input.I[25].O} {sc.iadd[17].D}
(assert (= sc_72 sc_216))
; 
; =  {of.input.I[25].O} {of.iadd[17].D}
(assert (= of_72 of_216))
; 
; =  {sc.input.I[26].O} {sc.iadd[17].A}
(assert (= sc_50 sc_218))
; 
; =  {of.input.I[26].O} {of.iadd[17].A}
(assert (= of_50 of_218))
; 
...
(assert (= of_136 of_90))
; 
; =  {sc.input.V[14].O} {sc.vadd[18].D}
(assert (= sc_154 sc_97))
; 
; =  {of.input.V[14].O} {of.vadd[18].D}
(assert (= of_154 of_97))
; 
; =  {sc.input.I[14].O} {sc.iadd[16].B}
(assert (= sc_58 sc_209))
; 
; =  {of.input.I[14].O} {of.iadd[16].B}
(assert (= of_58 of_209))
; 
...
(assert (= of_144 of_89))
; 
; =  {sc.ihill[2].REP} {sc.itov[17].K}
(assert (= sc_108 sc_194))
; 
; =  {of.ihill[2].REP} {of.itov[17].K}
(assert (= of_108 of_194))
; 
; =  {sc.input.I[24].O} {sc.iadd[17].C}
(assert (= sc_62 sc_217))
; 
; =  {of.input.I[24].O} {of.iadd[17].C}
(assert (= of_62 of_217))
; 
; =  {sc.input.V[22].O} {sc.vgain[10].Y}
(assert (= sc_180 sc_1))
; 
; =  {of.input.V[22].O} {of.vgain[10].Y}
(assert (= of_180 of_1))
; 
; =  {sc.input.I[10].O} {sc.iadd[8].C}
(assert (= sc_52 sc_197))
; 
; =  {of.input.I[10].O} {of.iadd[8].C}
(assert (= of_52 of_197))
; 
; =  {sc.input.I[12].O} {sc.iadd[15].C}
(assert (= sc_42 sc_202))
; 
; =  {of.input.I[12].O} {of.iadd[15].C}
(assert (= of_42 of_202))
; 
; =  {sc.iadd[1].OUT} {sc.iadd[16].D}
(assert (= sc_215 sc_206))
; 
; =  {of.iadd[1].OUT} {of.iadd[16].D}
(assert (= of_215 of_206))
; 
; =  {sc.input.V[21].O} {sc.vtoi[9].X}
(assert (= sc_156 sc_115))
; 
; =  {of.input.V[21].O} {of.vtoi[9].X}
(assert (= of_156 of_115))
; 
; =  {sc.input.V[23].O} {sc.itov[11].K}
(assert (= sc_170 sc_191))
; 
; =  {of.input.V[23].O} {of.itov[11].K}
(assert (= of_170 of_191))
; 
...
(assert (= of_38 of_214))
; 
; =  {sc.input.V[20].O} {sc.itov[7].K}
(assert (= sc_130 sc_185))
; 
; =  {of.input.V[20].O} {of.itov[7].K}
(assert (= of_130 of_185))
; 
; =  {sc.iadd[17].OUT} {sc.ihill[0].S}
(assert (= sc_220 sc_110))
; 
; =  {of.iadd[17].OUT} {of.ihill[0].S}
(assert (= of_220 of_110))
; 
; =  {sc.vtoi[11].Y} {sc.iadd[15].B}
(assert (= sc_120 sc_204))
; 
; =  {of.vtoi[11].Y} {of.iadd[15].B}
(assert (= of_120 of_204))
; 
; =  {sc.input.I[8].O} {sc.iadd[8].D}
(assert (= sc_36 sc_196))
; 
; =  {of.input.I[8].O} {of.iadd[8].D}
(assert (= of_36 of_196))
; 
...
(assert (= of_74 of_201))
; 
; =  {sc.input.I[21].O} {sc.switch[14].Vmax}
(assert (= sc_60 sc_24))
; 
; =  {of.input.I[21].O} {of.switch[14].Vmax}
(assert (= of_60 of_24))
; 
; =  {sc.input.V[16].O} {sc.ihill[0].n}
(assert (= sc_158 sc_109))
; 
; =  {of.input.V[16].O} {of.ihill[0].n}
(assert (= of_158 of_109))
; 
; =  {sc.iadd[8].OUT} {sc.itov[7].X}
(assert (= sc_200 sc_184))
; 
; =  {of.iadd[8].OUT} {of.itov[7].X}
(assert (= of_200 of_184))
; 
; =  {sc.input.V[5].O} {sc.switch[12].n}
(assert (= sc_166 sc_16))
; 
; =  {of.input.V[5].O} {of.switch[12].n}
(assert (= of_166 of_16))
; 
...
; 
; =  {sc.input.V[6].O} {sc.ihill[2].n}
(assert (= sc_152 sc_103))
; 
; =  {of.input.V[6].O} {of.ihill[2].n}
(assert (= of_152 of_103))
; 
...
(assert (= of_20 of_190))
; 
; =  {sc.input.I[11].O} {sc.iadd[15].A}
(assert (= sc_48 sc_203))
; 
; =  {of.input.I[11].O} {of.iadd[15].A}
(assert (= of_48 of_203))
; 
; =  {sc.switch[19].PROD} {sc.iadd[17].B}
(assert (= sc_30 sc_219))
; 
; =  {of.switch[19].PROD} {of.iadd[17].B}
(assert (= of_30 of_219))
; 
...
(assert (= of_174 of_8))
; 
; =  {sc.input.I[6].O} {sc.iadd[1].D}
(assert (= sc_56 sc_211))
; 
; =  {of.input.I[6].O} {of.iadd[1].D}
(assert (= of_56 of_211))
; 
; =  {sc.itov[13].Y} {sc.vgain[6].Y}
(assert (= sc_189 sc_5))
; 
; =  {of.itov[13].Y} {of.vgain[6].Y}
(assert (= of_189 of_5))
; 
; =  {sc.itov[17].Y} {sc.vadd[18].B}
(assert (= sc_195 sc_100))
; 
; =  {of.itov[17].Y} {of.vadd[18].B}
(assert (= of_195 of_100))
; 
...
(assert (= of_102 of_29))
; 
; =  {sc.input.I[18].O} {sc.switch[12].Kmod}
(assert (= sc_80 sc_18))
; 
; =  {of.input.I[18].O} {of.switch[12].Kmod}
(assert (= of_80 of_18))
; 
...
(assert (= of_66 of_212))
; 
; =  {sc.input.I[16].O} {sc.itov[17].X}
(assert (= sc_64 sc_193))
; 
; =  {of.input.I[16].O} {of.itov[17].X}
(assert (= of_64 of_193))
; 
...
(assert (= of_68 of_112))
; 
; =  {sc.vgain[6].P} {sc.vgain[5].Y}
(assert (= sc_7 sc_13))
; 
; =  {of.vgain[6].P} {of.vgain[5].Y}
(assert (= of_7 of_13))
; 
...
(assert (= of_183 of_93))
; 
; =  {sc.input.V[8].O} {sc.vadd[18].C}
(assert (= sc_132 sc_98))
; 
; =  {of.input.V[8].O} {of.vadd[18].C}
(assert (= of_132 of_98))
; 
; =  {sc.input.V[12].O} {sc.vadd[18].OUT2_0}
(assert (= sc_138 sc_96))
; 
; =  {of.input.V[12].O} {of.vadd[18].OUT2_0}
(assert (= of_138 of_96))
; 
; =  {sc.input.I[2].O} {sc.ihill[2].S}
(assert (= sc_32 sc_104))
; 
; =  {of.input.I[2].O} {of.ihill[2].S}
(assert (= of_32 of_104))
; 
; =  {sc.input.V[2].O} {sc.vgain[6].Z}
(assert (= sc_128 sc_6))
; 
; =  {of.input.V[2].O} {of.vgain[6].Z}
(assert (= of_128 of_6))
; 
; =  {sc.input.V[3].O} {sc.vgain[4].Z}
(assert (= sc_162 sc_10))
; 
; =  {of.input.V[3].O} {of.vgain[4].Z}
(assert (= of_162 of_10))
; 
...
(assert (= of_34 of_23))
; 
; =  {sc.itov[7].Y} {sc.vgain[4].Y}
(assert (= sc_186 sc_9))
; 
; =  {of.itov[7].Y} {of.vgain[4].Y}
(assert (= of_186 of_9))
; 
; =  {sc.input.V[19].O} {sc.vgain[6].X}
(assert (= sc_178 sc_4))
; 
; =  {of.input.V[19].O} {of.vgain[6].X}
(assert (= of_178 of_4))
; 
; =  {sc.vtoi[10].Y} {sc.ihill[2].Km}
(assert (= sc_123 sc_105))
; 
; =  {of.vtoi[10].Y} {of.ihill[2].Km}
(assert (= of_123 of_105))
; 
...
(assert (= of_172 of_0))
; 
; =  {sc.input.I[17].O} {sc.switch[19].Kmod}
(assert (= sc_78 sc_28))
; 
; =  {of.input.I[17].O} {of.switch[19].Kmod}
(assert (= of_78 of_28))
; 
; =  {sc.input.V[7].O} {sc.vadd[18].A}
(assert (= sc_134 sc_99))
; 
; =  {of.input.V[7].O} {of.vadd[18].A}
(assert (= of_134 of_99))
; 
; =  {sc.input.V[25].O} {sc.vtoi[11].K}
(assert (= sc_168 sc_119))
; 
; =  {of.input.V[25].O} {of.vtoi[11].K}
(assert (= of_168 of_119))
; 
...
(assert (= sc_160 sc_188))
; 
; =  {of.input.V[24].O} {of.itov[13].K}
(assert (= of_160 of_188))
; 
; =  {sc.vgain[4].P} {sc.vtoi[3].X}
(assert (= sc_11 sc_124))
; 
; =  {of.vgain[4].P} {of.vtoi[3].X}
(assert (= of_11 of_124))
; 
...
(assert (= of_148 of_92))
; 
; =  {sc.input.V[0].O} {sc.vgain[5].Z}
(assert (= sc_142 sc_14))
; 
; =  {of.input.V[0].O} {of.vgain[5].Z}
(assert (= of_142 of_14))
; 
...
(assert (= of_176 of_12))
; 
; =  {sc.input.V[26].O} {sc.vtoi[10].K}
(assert (= sc_146 sc_122))
; 
; =  {of.input.V[26].O} {of.vtoi[10].K}
(assert (= of_146 of_122))
; 
; =  {sc.input.I[19].O} {sc.switch[12].Vmax}
(assert (= sc_82 sc_19))
; 
; =  {of.input.I[19].O} {of.switch[12].Vmax}
(assert (= of_82 of_19))
; 
; =  {sc.input.V[4].O} {sc.switch[14].n}
(assert (= sc_164 sc_21))
; 
; =  {of.input.V[4].O} {of.switch[14].n}
(assert (= of_164 of_21))
; 
; =  {sc.iadd[16].OUT} {sc.switch[12].SUB}
(assert (= sc_210 sc_17))
; 
; =  {of.iadd[16].OUT} {of.switch[12].SUB}
(assert (= of_210 of_17))
; 
; =  {sc.vgain[5].P} {sc.vtoi[3].K}
(assert (= sc_15 sc_125))
; 
; =  {of.vgain[5].P} {of.vtoi[3].K}
(assert (= of_15 of_125))
(assert (<= (* sc_86 0.001) 0.001))
(assert (<= (* sc_88 0.001) 0.001))
; 
; =  {sc.vadd[21].OUT2} {sc.output.V[0].O} {sc.vadd[18].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_95 sc_86) (= sc_95 sc_102)) (= sc_95 sc_88)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_199 0.) sltop_199 (- sltop_199)) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_219 0.) slbot_219 (- slbot_219))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_206 0.) slbot_206 (- slbot_206))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= sltop_206 0.) sltop_206 (- sltop_206))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_220 0.) sltop_220 (- sltop_220))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= sltop_212 0.) sltop_212 (- sltop_212))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_215 0.) slbot_215 (- slbot_215))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= slbot_210 0.) slbot_210 (- slbot_210))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187))) (ite (>= sltop_192 0.) sltop_192 (- sltop_192))) (ite (>= slbot_220 0.) slbot_220 (- slbot_220))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_212 0.) slbot_212 (- slbot_212))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_192 0.) slbot_192 (- slbot_192))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_210 0.) sltop_210 (- sltop_210))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= sltop_215 0.) sltop_215 (- sltop_215))) (ite (>= sltop_219 0.) sltop_219 (- sltop_219)))))
(check-sat)
