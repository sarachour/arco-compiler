...
(assert (= of_13 0.))
; 
; >=  {((sc.switch[13].n*-500.)+of.switch[13].n)} {3300.}
(assert (<= (+ (* sc_9 -500.) of_9) 3300.))
; 
; <=  {((sc.switch[13].n*-500.)+of.switch[13].n)} {0.5}
(assert (>= (+ (* sc_9 -500.) of_9) 0.5))
; 
; >=  {((sc.switch[13].SUB*-2.)+of.switch[13].SUB)} {10.}
(assert (<= (+ (* sc_10 -2.) of_10) 10.))
; 
; <=  {((sc.switch[13].SUB*-2.)+of.switch[13].SUB)} {0.0001}
...
; 
; =  {(((sc.switch[13].PROD*-0.6)+of.switch[13].PROD)+sl.min.switch[13].PROD)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_13 -0.6) of_13) slbot_13) 9.99934002508e-38))
; 
; =  {(((sc.switch[13].PROD*0.)+of.switch[13].PROD)+sl.max.switch[13].PROD)} {9.9999999}
...
; 
; =  {(((sc.switch[13].Vmax*0.6)+of.switch[13].Vmax)+sl.max.switch[13].Vmax)} {10.}
...
(assert (<= (+ (* sc_14 1000.75) of_14) 3300.))
; 
; <=  {((sc.switch[14].n*1000.75)+of.switch[14].n)} {0.5}
(assert (>= (+ (* sc_14 1000.75) of_14) 0.5))
; 
; >=  {((sc.switch[14].SUB*337.632520764)+of.switch[14].SUB)} {10.}
(assert (<= (+ (* sc_15 337.632520764) of_15) 10.))
; 
; <=  {((sc.switch[14].SUB*337.632520764)+of.switch[14].SUB)} {0.0001}
(assert (>= (+ (* sc_15 337.632520764) of_15) 0.0001))
(declare-fun slbot_16 () Real)
(declare-fun sltop_16 () Real)
; 
; =  {(((sc.switch[14].Kmod*0.)+of.switch[14].Kmod)+sl.min.switch[14].Kmod)} {0.0001}
(assert (= (+ (+ (* sc_16 0.) of_16) slbot_16) 0.0001))
; 
; =  {(((sc.switch[14].Kmod*1.66666666667)+of.switch[14].Kmod)+sl.max.switch[14].Kmod)} {10.}
(assert (= (+ (+ (* sc_16 1.66666666667) of_16) sltop_16) 10.))
...
; 
; =  {(((sc.switch[14].PROD*0.0156)+of.switch[14].PROD)+sl.max.switch[14].PROD)} {9.9999999}
(assert (= (+ (+ (* sc_18 0.0156) of_18) sltop_18) 9.9999999))
...
; 
; =  {(((sc.switch[14].Vmax*0.0156)+of.switch[14].Vmax)+sl.max.switch[14].Vmax)} {10.}
(assert (= (+ (+ (* sc_17 0.0156) of_17) sltop_17) 10.))
(declare-fun slbot_18 () Real)
(declare-fun sltop_18 () Real)
; 
; =  {(((sc.switch[14].PROD*0.)+of.switch[14].PROD)+sl.min.switch[14].PROD)} {9.99934002508e-38}
...
(assert (= (+ (+ (* sc_111 0.00965050555471) of_111) sltop_111) 10.))
; 
...
; 
; =  {(((sc.igenebind[17].TF*-1.)+of.igenebind[17].TF)+sl.min.igenebind[17].TF)} {0.0001}
(assert (= (+ (+ (* sc_115 -1.) of_115) slbot_115) 0.0001))
; 
; =  {(((sc.igenebind[17].TF*-0.4)+of.igenebind[17].TF)+sl.max.igenebind[17].TF)} {10.}
(assert (= (+ (+ (* sc_115 -0.4) of_115) sltop_115) 10.))
; 
; >=  {((sc.igenebind[17].K*1.)+of.igenebind[17].K)} {10.}
(assert (<= (+ (* sc_116 1.) of_116) 10.))
; 
; <=  {((sc.igenebind[17].K*1.)+of.igenebind[17].K)} {0.0001}
(assert (>= (+ (* sc_116 1.) of_116) 0.0001))
(declare-fun slbot_118 () Real)
(declare-fun sltop_118 () Real)
; 
; =  {(((sc.igenebind[17].GE*0.)+of.igenebind[17].GE)+sl.min.igenebind[17].GE)} {9.90099009901e-07}
(assert (= (+ (+ (* sc_118 0.) of_118) slbot_118) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[17].GE*1.66666666667)+of.igenebind[17].GE)+sl.max.igenebind[17].GE)} {9.9999999}
(assert (= (+ (+ (* sc_118 1.66666666667) of_118) sltop_118) 9.9999999))
; 
; >=  {((sc.igenebind[17].Vmax*1.)+of.igenebind[17].Vmax)} {10.}
(assert (<= (+ (* sc_117 1.) of_117) 10.))
; 
; <=  {((sc.igenebind[17].Vmax*1.)+of.igenebind[17].Vmax)} {0.0001}
...
(assert (= (+ (+ (* sc_194 0.0156) of_194) sltop_194) 5.))
...
(assert (= (+ (+ (* sc_195 0.0156) of_195) sltop_195) 10.))
...
; 
; =  {(((sc.iadd[18].D*-0.6)+of.iadd[18].D)+sl.min.iadd[18].D)} {0.}
(assert (= (+ (+ (* sc_196 -0.6) of_196) slbot_196) 0.))
; 
; =  {(((sc.iadd[18].D*0.)+of.iadd[18].D)+sl.max.iadd[18].D)} {5.}
...
; 
; =  {(((sc.iadd[18].OUT*-0.4)+of.iadd[18].OUT)+sl.max.iadd[18].OUT)} {10.}
...
(assert (= (+ (+ (* sc_200 -0.4) of_200) sltop_200) 10.))
; 
; =  {sc.input.I[0].O} {sc.switch[13].Vmax}
(assert (= sc_38 sc_12))
; 
; =  {of.input.I[0].O} {of.switch[13].Vmax}
(assert (= of_38 of_12))
; 
; =  {sc.iadd[15].OUT} {sc.switch[14].Kmod}
(assert (= sc_180 sc_16))
; 
; =  {of.iadd[15].OUT} {of.switch[14].Kmod}
(assert (= of_180 of_16))
; 
...
(assert (= of_86 of_112))
; 
; =  {sc.input.I[32].O} {sc.iadd[19].D}
(assert (= sc_80 sc_191))
; 
; =  {of.input.I[32].O} {of.iadd[19].D}
(assert (= of_80 of_191))
; 
; =  {sc.input.I[26].O} {sc.switch[13].Kmod}
(assert (= sc_44 sc_11))
; 
; =  {of.input.I[26].O} {of.switch[13].Kmod}
(assert (= of_44 of_11))
; 
...
(assert (= of_72 of_172))
; 
; =  {sc.input.V[13].O} {sc.switch[14].n}
(assert (= sc_130 sc_14))
; 
; =  {of.input.V[13].O} {of.switch[14].n}
(assert (= of_130 of_14))
; 
...
(assert (= of_138 of_92))
; 
; =  {sc.input.I[30].O} {sc.iadd[18].C}
(assert (= sc_64 sc_197))
; 
; =  {of.input.I[30].O} {of.iadd[18].C}
(assert (= of_64 of_197))
; 
...
(assert (= of_60 of_7))
; 
; =  {sc.input.I[10].O} {sc.iadd[15].A}
(assert (= sc_42 sc_178))
; 
; =  {of.input.I[10].O} {of.iadd[15].A}
(assert (= of_42 of_178))
; 
...
(assert (= sc_170 sc_111))
; 
; =  {of.iadd[2].OUT} {of.igenebind[1].TF}
(assert (= of_170 of_111))
; 
; =  {sc.iadd[18].OUT} {sc.igenebind[17].TF}
(assert (= sc_200 sc_115))
; 
; =  {of.iadd[18].OUT} {of.igenebind[17].TF}
(assert (= of_200 of_115))
; 
...
(assert (= of_26 of_174))
; 
; =  {sc.switch[14].PROD} {sc.iadd[19].B}
(assert (= sc_18 sc_194))
; 
; =  {of.switch[14].PROD} {of.iadd[19].B}
(assert (= of_18 of_194))
; 
...
; 
; =  {sc.input.I[11].O} {sc.iadd[15].C}
(assert (= sc_40 sc_177))
; 
; =  {of.input.I[11].O} {of.iadd[15].C}
(assert (= of_40 of_177))
; 
; =  {sc.input.I[28].O} {sc.igenebind[17].K}
(assert (= sc_76 sc_116))
; 
; =  {of.input.I[28].O} {of.igenebind[17].K}
(assert (= of_76 of_116))
; 
...
(assert (= of_34 of_192))
; 
; =  {sc.input.V[9].O} {sc.switch[13].n}
(assert (= sc_134 sc_9))
; 
; =  {of.input.V[9].O} {of.switch[13].n}
(assert (= of_134 of_9))
; 
...
(assert (= of_162 of_95))
; 
; =  {sc.iadd[19].OUT} {sc.igenebind[19].K}
(assert (= sc_195 sc_120))
; 
; =  {of.iadd[19].OUT} {of.igenebind[19].K}
(assert (= of_195 of_120))
; 
; =  {sc.input.I[18].O} {sc.switch[14].SUB}
(assert (= sc_82 sc_15))
; 
; =  {of.input.I[18].O} {of.switch[14].SUB}
(assert (= of_82 of_15))
; 
; =  {sc.igenebind[19].GE} {sc.itov[11].K}
(assert (= sc_122 sc_161))
; 
; =  {of.igenebind[19].GE} {of.itov[11].K}
(assert (= of_122 of_161))
; 
; =  {sc.input.I[9].O} {sc.iadd[15].D}
(assert (= sc_36 sc_176))
; 
; =  {of.input.I[9].O} {of.iadd[15].D}
(assert (= of_36 of_176))
; 
...
(assert (= of_66 of_186))
; 
; =  {sc.input.I[16].O} {sc.iadd[18].A}
(assert (= sc_58 sc_198))
; 
; =  {of.input.I[16].O} {of.iadd[18].A}
(assert (= of_58 of_198))
; 
...
; 
; =  {sc.input.I[15].O} {sc.iadd[18].B}
(assert (= sc_48 sc_199))
; 
; =  {of.input.I[15].O} {of.iadd[18].B}
(assert (= of_48 of_199))
; 
...
(assert (= of_74 of_166))
; 
; =  {sc.input.I[33].O} {sc.iadd[19].A}
(assert (= sc_52 sc_193))
; 
; =  {of.input.I[33].O} {of.iadd[19].A}
(assert (= of_52 of_193))
; 
...
(assert (= of_104 of_89))
; 
; =  {sc.vadd[10].OUT2} {sc.switch[14].Vmax}
(assert (= sc_104 sc_17))
; 
; =  {of.vadd[10].OUT2} {of.switch[14].Vmax}
(assert (= of_104 of_17))
; 
...
(assert (= of_78 of_160))
; 
; =  {sc.switch[13].PROD} {sc.iadd[18].D}
(assert (= sc_13 sc_196))
; 
; =  {of.switch[13].PROD} {of.iadd[18].D}
(assert (= of_13 of_196))
; 
; =  {sc.igenebind[1].GE} {sc.itov[9].X}
(assert (= sc_114 sc_157))
; 
; =  {of.igenebind[1].GE} {of.itov[9].X}
(assert (= of_114 of_157))
; 
...
; 
; =  {sc.input.I[27].O} {sc.igenebind[17].Vmax}
(assert (= sc_46 sc_117))
; 
; =  {of.input.I[27].O} {of.igenebind[17].Vmax}
(assert (= of_46 of_117))
; 
...
(assert (= of_136 of_0))
; 
; =  {sc.igenebind[17].GE} {sc.iadd[16].B}
(assert (= sc_118 sc_184))
; 
; =  {of.igenebind[17].GE} {of.iadd[16].B}
(assert (= of_118 of_184))
; 
...
(assert (= of_152 of_94))
; 
; =  {sc.input.I[19].O} {sc.switch[13].SUB}
(assert (= sc_84 sc_10))
; 
; =  {of.input.I[19].O} {of.switch[13].SUB}
(assert (= of_84 of_10))
; 
; =  {sc.iadd[16].OUT} {sc.iadd[15].B}
(assert (= sc_185 sc_179))
; 
; =  {of.iadd[16].OUT} {of.iadd[15].B}
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_96 0.) sltop_96 (- sltop_96)) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_175 0.) slbot_175 (- slbot_175))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= slbot_196 0.) slbot_196 (- slbot_196))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_122 0.) slbot_122 (- slbot_122))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_180 0.) sltop_180 (- sltop_180))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_161 0.) sltop_161 (- sltop_161))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= slbot_161 0.) slbot_161 (- slbot_161))) (ite (>= sltop_163 0.) sltop_163 (- sltop_163))) (ite (>= sltop_175 0.) sltop_175 (- sltop_175))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_163 0.) slbot_163 (- slbot_163))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_171 0.) slbot_171 (- slbot_171))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_169 0.) slbot_169 (- slbot_169))) (ite (>= slbot_180 0.) slbot_180 (- slbot_180))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_171 0.) sltop_171 (- sltop_171))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_122 0.) sltop_122 (- sltop_122))) (ite (>= sltop_169 0.) sltop_169 (- sltop_169))) (ite (>= sltop_196 0.) sltop_196 (- sltop_196))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170)))))
(check-sat)
