...
(assert (= (+ (+ (* sc_15 0.06) of_15) sltop_15) 10.))
...
(assert (= (+ (+ (* sc_16 0.06) of_16) sltop_16) 10.))
...
(assert (= (+ (+ (* sc_93 0.0156) of_93) sltop_93) 5.))
...
(assert (= of_24 of_87))
; 
; =  {sc.vtoi[0].Y} {sc.ihill[1].S}
(assert (= sc_59 sc_52))
; 
; =  {of.vtoi[0].Y} {of.ihill[1].S}
(assert (= of_59 of_52))
; 
...
(assert (= of_44 of_29))
; 
; =  {sc.input.I[12].O} {sc.iadd[0].D}
(assert (= sc_12 sc_90))
; 
; =  {of.input.I[12].O} {of.iadd[0].D}
(assert (= of_12 of_90))
; 
...
(assert (= of_26 of_53))
; 
; =  {sc.input.I[13].O} {sc.iadd[0].A}
(assert (= sc_10 sc_92))
; 
; =  {of.input.I[13].O} {of.iadd[0].A}
(assert (= of_10 of_92))
; 
...
(assert (= of_65 of_32))
; 
; =  {sc.switch[4].PROD} {sc.iadd[0].B}
(assert (= sc_4 sc_93))
; 
; =  {of.switch[4].PROD} {of.iadd[0].B}
(assert (= of_4 of_93))
; 
...
(assert (= of_75 of_38))
; 
; =  {sc.input.I[11].O} {sc.iadd[0].C}
(assert (= sc_14 sc_91))
; 
; =  {of.input.I[11].O} {of.iadd[0].C}
(assert (= of_14 of_91))
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
