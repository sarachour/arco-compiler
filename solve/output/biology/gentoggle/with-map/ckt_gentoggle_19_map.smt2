...
(assert (= of_96 of_170))
; 
; =  {sc.input.I[30].O} {sc.iadd[20].A}
(assert (= sc_53 sc_162))
; 
; =  {of.input.I[30].O} {of.iadd[20].A}
(assert (= of_53 of_162))
; 
...
(assert (= of_136 of_82))
; 
; =  {sc.input.I[28].O} {sc.iadd[20].C}
(assert (= sc_65 sc_161))
; 
; =  {of.input.I[28].O} {of.iadd[20].C}
(assert (= of_65 of_161))
; 
...
(assert (= of_118 of_80))
; 
; =  {sc.input.I[29].O} {sc.iadd[20].D}
(assert (= sc_19 sc_160))
; 
; =  {of.input.I[29].O} {of.iadd[20].D}
(assert (= of_19 of_160))
; 
