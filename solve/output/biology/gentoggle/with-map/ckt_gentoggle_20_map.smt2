...
(assert (= of_51 of_50))
; 
; >=  {((sc.input.I[16].X*400.)+of.input.I[16].X)} {10.}
(assert (<= (+ (* sc_50 400.) of_50) 10.))
; 
; <=  {((sc.input.I[16].X*400.)+of.input.I[16].X)} {0.}
(assert (>= (+ (* sc_50 400.) of_50) 0.))
; 
; >=  {((sc.input.I[16].O*400.)+of.input.I[16].O)} {10.}
(assert (<= (+ (* sc_51 400.) of_51) 10.))
; 
; <=  {((sc.input.I[16].O*400.)+of.input.I[16].O)} {0.}
(assert (>= (+ (* sc_51 400.) of_51) 0.))
...
(assert (= of_71 of_70))
; 
; >=  {((sc.input.I[18].X*0.156)+of.input.I[18].X)} {10.}
(assert (<= (+ (* sc_70 0.156) of_70) 10.))
; 
; <=  {((sc.input.I[18].X*0.156)+of.input.I[18].X)} {0.}
(assert (>= (+ (* sc_70 0.156) of_70) 0.))
; 
; >=  {((sc.input.I[18].O*0.156)+of.input.I[18].O)} {10.}
(assert (<= (+ (* sc_71 0.156) of_71) 10.))
; 
; <=  {((sc.input.I[18].O*0.156)+of.input.I[18].O)} {0.}
(assert (>= (+ (* sc_71 0.156) of_71) 0.))
...
(assert (= of_73 of_72))
; 
; >=  {((sc.input.I[19].X*1.5625)+of.input.I[19].X)} {10.}
(assert (<= (+ (* sc_72 1.5625) of_72) 10.))
; 
; <=  {((sc.input.I[19].X*1.5625)+of.input.I[19].X)} {0.}
(assert (>= (+ (* sc_72 1.5625) of_72) 0.))
; 
; >=  {((sc.input.I[19].O*1.5625)+of.input.I[19].O)} {10.}
(assert (<= (+ (* sc_73 1.5625) of_73) 10.))
; 
; <=  {((sc.input.I[19].O*1.5625)+of.input.I[19].O)} {0.}
(assert (>= (+ (* sc_73 1.5625) of_73) 0.))
...
(assert (= (+ (+ (* sc_78 0.0156) of_78) sltop_78) 3300.))
...
(assert (= sc_83 (* 1. sc_84)))
; 
; =  {sc.vadd[12].A} {(1.*sc.vadd[12].C)} {(1.*sc.vadd[12].D)}
(assert (and (= sc_83 (* 1. sc_82)) (= sc_83 (* 1. sc_81))))
; no offset
(assert (= (- (+ of_83 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[12].OUT} {(sc.vadd[12].A*1.)}
(assert (= sc_85 (* sc_83 1.)))
; 
; =  {of.vadd[12].OUT} {0.}
(assert (= of_85 0.))
; no scale
...
(assert (and (= sc_83 (* 1. sc_82)) (= sc_83 (* (* 1. sc_81) sc_86))))
; no offset
(assert (= (- (+ of_83 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= sc_90 (* 1. sc_91)))
; 
; =  {sc.vadd[10].A} {(1.*sc.vadd[10].C)} {(1.*sc.vadd[10].D)}
(assert (and (= sc_90 (* 1. sc_89)) (= sc_90 (* 1. sc_88))))
; no offset
(assert (= (- (+ of_90 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[10].OUT} {(sc.vadd[10].A*1.)}
(assert (= sc_92 (* sc_90 1.)))
; 
; =  {of.vadd[10].OUT} {0.}
(assert (= of_92 0.))
; no scale
...
(assert (and (= sc_90 (* 1. sc_89)) (= sc_90 (* (* 1. sc_88) sc_93))))
; no offset
(assert (= (- (+ of_90 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= (+ (+ (* sc_92 619.026085325) of_92) slbot_92) -1650.))
; 
; =  {(((sc.vadd[10].OUT*625.)+of.vadd[10].OUT)+sl.max.vadd[10].OUT)} {1650.}
(assert (= (+ (+ (* sc_92 625.) of_92) sltop_92) 1650.))
(declare-fun slbot_93 () Real)
(declare-fun sltop_93 () Real)
; 
; =  {(((sc.vadd[10].OUT2*0.)+of.vadd[10].OUT2)+sl.min.vadd[10].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_96 -0.15625) of_96) slbot_96) 0.00030303030303))
; 
; =  {(((sc.vtoi[0].Y*0.)+of.vtoi[0].Y)+sl.max.vtoi[0].Y)} {3300.}
(assert (= (+ (+ (* sc_96 0.) of_96) sltop_96) 3300.))
; 
...
; 
; =  {(((sc.vtoi[14].X*0.6)+of.vtoi[14].X)+sl.max.vtoi[14].X)} {3300.}
(assert (= (+ (+ (* sc_97 0.6) of_97) sltop_97) 3300.))
(declare-fun slbot_99 () Real)
(declare-fun sltop_99 () Real)
; 
; =  {(((sc.vtoi[14].Y*-0.6)+of.vtoi[14].Y)+sl.min.vtoi[14].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_99 -0.6) of_99) slbot_99) 0.00030303030303))
; 
; =  {(((sc.vtoi[14].Y*0.)+of.vtoi[14].Y)+sl.max.vtoi[14].Y)} {3300.}
(assert (= (+ (+ (* sc_99 0.) of_99) sltop_99) 3300.))
; 
...
(assert (= (+ (+ (* sc_102 0.) of_102) slbot_102) 0.00030303030303))
; 
; =  {(((sc.vtoi[4].Y*0.00965050555471)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
(assert (= (+ (+ (* sc_102 0.00965050555471) of_102) sltop_102) 3300.))
...
(assert (= (+ (+ (* sc_101 103.621514368) of_101) sltop_101) 3300.))
(declare-fun slbot_102 () Real)
(declare-fun sltop_102 () Real)
; 
; =  {(((sc.vtoi[4].Y*0.)+of.vtoi[4].Y)+sl.min.vtoi[4].Y)} {0.00030303030303}
...
(assert (= (+ (+ (* sc_107 0.) of_107) slbot_107) 0.0001))
; 
; =  {(((sc.igenebind[1].TF*0.00965050555471)+of.igenebind[1].TF)+sl.max.igenebind[1].TF)} {10.}
(assert (= (+ (+ (* sc_107 0.00965050555471) of_107) sltop_107) 10.))
; 
...
(assert (<= (+ (* sc_115 1250.) of_115) 3300.))
; 
; <=  {((sc.input.V[2].X*1250.)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_115 1250.) of_115) 0.))
; 
; >=  {((sc.input.V[2].O*1250.)+of.input.V[2].O)} {3300.}
(assert (<= (+ (* sc_116 1250.) of_116) 3300.))
; 
; <=  {((sc.input.V[2].O*1250.)+of.input.V[2].O)} {0.}
(assert (>= (+ (* sc_116 1250.) of_116) 0.))
...
(assert (<= (+ (* sc_119 400.) of_119) 3300.))
; 
; <=  {((sc.input.V[7].X*400.)+of.input.V[7].X)} {0.}
(assert (>= (+ (* sc_119 400.) of_119) 0.))
; 
; >=  {((sc.input.V[7].O*400.)+of.input.V[7].O)} {3300.}
(assert (<= (+ (* sc_120 400.) of_120) 3300.))
; 
; <=  {((sc.input.V[7].O*400.)+of.input.V[7].O)} {0.}
(assert (>= (+ (* sc_120 400.) of_120) 0.))
...
; 
; >=  {((sc.input.V[13].X*4.)+of.input.V[13].X)} {3300.}
(assert (<= (+ (* sc_121 4.) of_121) 3300.))
; 
; <=  {((sc.input.V[13].X*4.)+of.input.V[13].X)} {0.}
(assert (>= (+ (* sc_121 4.) of_121) 0.))
; 
; >=  {((sc.input.V[13].O*4.)+of.input.V[13].O)} {3300.}
(assert (<= (+ (* sc_122 4.) of_122) 3300.))
; 
; <=  {((sc.input.V[13].O*4.)+of.input.V[13].O)} {0.}
...
(assert (= (+ (+ (* sc_127 0.6) of_127) sltop_127) 3300.))
...
(assert (= (+ (+ (* sc_128 0.6) of_128) sltop_128) 3300.))
...
; 
; >=  {((sc.input.V[14].X*1000.75)+of.input.V[14].X)} {3300.}
(assert (<= (+ (* sc_137 1000.75) of_137) 3300.))
; 
; <=  {((sc.input.V[14].X*1000.75)+of.input.V[14].X)} {0.}
(assert (>= (+ (* sc_137 1000.75) of_137) 0.))
; 
; >=  {((sc.input.V[14].O*1000.75)+of.input.V[14].O)} {3300.}
(assert (<= (+ (* sc_138 1000.75) of_138) 3300.))
; 
; <=  {((sc.input.V[14].O*1000.75)+of.input.V[14].O)} {0.}
(assert (>= (+ (* sc_138 1000.75) of_138) 0.))
...
(assert (<= (+ (* sc_148 2.) of_148) 3300.))
; 
; <=  {((sc.input.V[1].O*2.)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_148 2.) of_148) 0.))
...
(assert (= (+ (+ (* sc_151 1.54756521331) of_151) slbot_151) 0.0001))
; 
; =  {(((sc.itov[9].X*1.5625)+of.itov[9].X)+sl.max.itov[9].X)} {10.}
(assert (= (+ (+ (* sc_151 1.5625) of_151) sltop_151) 10.))
...
(assert (<= (+ (* sc_152 400.) of_152) 330.))
; 
; <=  {((sc.itov[9].K*400.)+of.itov[9].K)} {1.}
(assert (>= (+ (* sc_152 400.) of_152) 1.))
(declare-fun slbot_153 () Real)
(declare-fun sltop_153 () Real)
; 
; =  {(((sc.itov[9].Y*619.026085325)+of.itov[9].Y)+sl.min.itov[9].Y)} {0.0001}
...
(assert (<= (+ (* sc_154 400.) of_154) 10.))
; 
; <=  {((sc.itov[11].X*400.)+of.itov[11].X)} {0.0001}
(assert (>= (+ (* sc_154 400.) of_154) 0.0001))
...
(assert (= (+ (+ (* sc_155 0.153603781016) of_155) slbot_155) 1.))
; 
; =  {(((sc.itov[11].K*0.156)+of.itov[11].K)+sl.max.itov[11].K)} {330.}
(assert (= (+ (+ (* sc_155 0.156) of_155) sltop_155) 330.))
(declare-fun slbot_156 () Real)
(declare-fun sltop_156 () Real)
; 
; =  {(((sc.itov[11].Y*61.4415124065)+of.itov[11].Y)+sl.min.itov[11].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_162 0.0156) of_162) sltop_162) 5.))
; 
...
(assert (= (+ (+ (* sc_169 0.00965050555471) of_169) sltop_169) 10.))
; 
...
(assert (= (+ (+ (* sc_168 0.00965050555471) of_168) sltop_168) 5.))
(declare-fun slbot_169 () Real)
(declare-fun sltop_169 () Real)
; 
; =  {(((sc.iadd[2].OUT*0.)+of.iadd[2].OUT)+sl.min.iadd[2].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_170 -0.15625) of_170) slbot_170) 0.))
; 
...
(assert (= (+ (+ (* sc_174 -0.84375) of_174) sltop_174) 10.))
; 
...
(assert (= (+ (+ (* sc_183 0.00965050555471) of_183) sltop_183) 5.))
(declare-fun slbot_184 () Real)
(declare-fun sltop_184 () Real)
; 
; =  {(((sc.iadd[3].OUT*0.)+of.iadd[3].OUT)+sl.min.iadd[3].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_189 1.66666666667) of_189) sltop_189) 10.))
; 
...
(assert (= (+ (+ (* sc_188 1.66666666667) of_188) sltop_188) 5.))
(declare-fun slbot_189 () Real)
(declare-fun sltop_189 () Real)
; 
; =  {(((sc.iadd[17].OUT*0.)+of.iadd[17].OUT)+sl.min.iadd[17].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_190 -0.6) of_190) slbot_190) 0.))
; 
; =  {(((sc.iadd[19].D*0.)+of.iadd[19].D)+sl.max.iadd[19].D)} {5.}
(assert (= (+ (+ (* sc_190 0.) of_190) sltop_190) 5.))
; 
; >=  {((sc.iadd[19].C*1.)+of.iadd[19].C)} {5.}
(assert (<= (+ (* sc_191 1.) of_191) 5.))
; 
...
(assert (= (+ (+ (* sc_194 -0.4) of_194) sltop_194) 10.))
; 
...
(assert (= of_31 of_165))
; 
; =  {sc.input.V[15].O} {sc.vtoi[4].X}
(assert (= sc_134 sc_100))
; 
; =  {of.input.V[15].O} {of.vtoi[4].X}
(assert (= of_134 of_100))
; 
; =  {sc.input.I[22].O} {sc.switch[7].Vmax}
(assert (= sc_75 sc_7))
; 
; =  {of.input.I[22].O} {of.switch[7].Vmax}
(assert (= of_75 of_7))
; 
; =  {sc.input.I[32].O} {sc.iadd[20].B}
(assert (= sc_69 sc_163))
; 
; =  {of.input.I[32].O} {of.iadd[20].B}
(assert (= of_69 of_163))
; 
...
(assert (= of_37 of_191))
; 
; =  {sc.input.I[25].O} {sc.igenebind[18].Vmax}
(assert (= sc_63 sc_113))
; 
; =  {of.input.I[25].O} {of.igenebind[18].Vmax}
(assert (= of_63 of_113))
; 
; =  {sc.input.V[13].O} {sc.vadd[10].D}
(assert (= sc_122 sc_88))
; 
; =  {of.input.V[13].O} {of.vadd[10].D}
(assert (= of_122 of_88))
; 
; =  {sc.igenebind[18].GE} {sc.iadd[17].B}
(assert (= sc_114 sc_188))
; 
; =  {of.igenebind[18].GE} {of.iadd[17].B}
(assert (= of_114 of_188))
; 
; =  {sc.input.V[14].O} {sc.switch[15].n}
(assert (= sc_138 sc_9))
; 
; =  {of.input.V[14].O} {of.switch[15].n}
(assert (= of_138 of_9))
; 
...
(assert (= of_130 of_95))
; 
; =  {sc.vtoi[14].Y} {sc.iadd[19].D}
(assert (= sc_99 sc_190))
; 
; =  {of.vtoi[14].Y} {of.iadd[19].D}
(assert (= of_99 of_190))
; 
; =  {sc.input.I[24].O} {sc.igenebind[13].TF}
(assert (= sc_53 sc_103))
; 
; =  {of.input.I[24].O} {of.igenebind[13].TF}
(assert (= of_53 of_103))
; 
; =  {sc.input.I[12].O} {sc.iadd[17].A}
(assert (= sc_25 sc_187))
; 
; =  {of.input.I[12].O} {of.iadd[17].A}
(assert (= of_25 of_187))
; 
; =  {sc.input.I[10].O} {sc.iadd[16].C}
(assert (= sc_35 sc_176))
; 
; =  {of.input.I[10].O} {of.iadd[16].C}
(assert (= of_35 of_176))
; 
...
(assert (= of_159 of_2))
; 
; =  {sc.input.I[23].O} {sc.iadd[8].C}
(assert (= sc_61 sc_171))
; 
; =  {of.input.I[23].O} {of.iadd[8].C}
(assert (= of_61 of_171))
; 
; =  {sc.input.I[21].O} {sc.switch[7].Kmod}
(assert (= sc_49 sc_6))
; 
; =  {of.input.I[21].O} {of.switch[7].Kmod}
(assert (= of_49 of_6))
; 
...
(assert (= of_136 of_82))
; 
; =  {sc.input.I[11].O} {sc.iadd[17].D}
(assert (= sc_33 sc_185))
; 
; =  {of.input.I[11].O} {of.iadd[17].D}
(assert (= of_33 of_185))
; 
; =  {sc.vtoi[4].Y} {sc.iadd[3].B}
(assert (= sc_102 sc_183))
; 
; =  {of.vtoi[4].Y} {of.iadd[3].B}
(assert (= of_102 of_183))
; 
...
(assert (= sc_150 sc_158))
; 
; =  {of.input.V[17].O} {of.itov[6].K}
(assert (= of_150 of_158))
; 
; =  {sc.input.I[31].O} {sc.iadd[20].C}
(assert (= sc_27 sc_161))
; 
; =  {of.input.I[31].O} {of.iadd[20].C}
(assert (= of_27 of_161))
; 
...
(assert (= sc_194 sc_111))
; 
; =  {of.iadd[19].OUT} {of.igenebind[18].TF}
(assert (= of_194 of_111))
; 
; =  {sc.input.I[18].O} {sc.igenebind[13].Vmax}
(assert (= sc_71 sc_105))
; 
; =  {of.input.I[18].O} {of.igenebind[13].Vmax}
(assert (= of_71 of_105))
; 
; =  {sc.input.I[9].O} {sc.iadd[16].A}
(assert (= sc_29 sc_177))
; 
; =  {of.input.I[9].O} {of.iadd[16].A}
(assert (= of_29 of_177))
; 
...
(assert (= of_57 of_182))
; 
; =  {sc.input.I[16].O} {sc.itov[11].X}
(assert (= sc_51 sc_154))
; 
; =  {of.input.I[16].O} {of.itov[11].X}
(assert (= of_51 of_154))
; 
...
(assert (= sc_164 sc_104))
; 
; =  {of.iadd[20].OUT} {of.igenebind[13].K}
(assert (= of_164 of_104))
; 
...
(assert (= of_116 of_4))
; 
; =  {sc.input.I[20].O} {sc.igenebind[1].K}
(assert (= sc_17 sc_108))
; 
; =  {of.input.I[20].O} {of.igenebind[1].K}
(assert (= of_17 of_108))
; 
...
(assert (= sc_120 sc_152))
; 
; =  {of.input.V[7].O} {of.itov[9].K}
(assert (= of_120 of_152))
; 
; =  {sc.input.I[17].O} {sc.switch[15].SUB}
(assert (= sc_67 sc_10))
; 
; =  {of.input.I[17].O} {of.switch[15].SUB}
(assert (= of_67 of_10))
; 
; =  {sc.igenebind[13].GE} {sc.itov[11].K}
(assert (= sc_106 sc_155))
; 
; =  {of.igenebind[13].GE} {of.itov[11].K}
(assert (= of_106 of_155))
; 
; =  {sc.igenebind[1].GE} {sc.itov[9].X}
(assert (= sc_110 sc_151))
; 
; =  {of.igenebind[1].GE} {of.itov[9].X}
(assert (= of_110 of_151))
; 
...
(assert (= of_39 of_112))
; 
; =  {sc.input.V[10].O} {sc.vtoi[14].K}
(assert (= sc_132 sc_98))
; 
; =  {of.input.V[10].O} {of.vtoi[14].K}
(assert (= of_132 of_98))
; 
; =  {sc.input.V[0].O} {sc.vtoi[14].X}
(assert (= sc_128 sc_97))
; 
; =  {of.input.V[0].O} {of.vtoi[14].X}
(assert (= of_128 of_97))
; 
...
(assert (= of_144 of_89))
; 
; =  {sc.input.I[19].O} {sc.igenebind[1].Vmax}
(assert (= sc_73 sc_109))
; 
; =  {of.input.I[19].O} {of.igenebind[1].Vmax}
(assert (= of_73 of_109))
; 
...
(assert (= of_3 of_101))
(assert (<= (* (/ 1. sc_77) 0.001) 0.001))
(assert (<= (* (/ 1. sc_79) 0.001) 0.001))
; 
; =  {sc.vadd[12].OUT2} {sc.output.V[0].O} {sc.vadd[10].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_86 sc_77) (= sc_86 sc_93)) (= sc_86 sc_79)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_151 0.) slbot_151 (- slbot_151))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= slbot_156 0.) slbot_156 (- slbot_156))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_151 0.) sltop_151 (- sltop_151))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_155 0.) slbot_155 (- slbot_155))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= slbot_168 0.) slbot_168 (- slbot_168))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_168 0.) sltop_168 (- sltop_168))) (ite (>= sltop_178 0.) sltop_178 (- sltop_178))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_169 0.) slbot_169 (- slbot_169))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_178 0.) slbot_178 (- slbot_178))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= sltop_156 0.) sltop_156 (- sltop_156))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_155 0.) sltop_155 (- sltop_155))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_169 0.) sltop_169 (- sltop_169))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170)))))
(check-sat)
