...
(assert (<= (+ (* sc_62 0.0156) of_62) 10.))
; 
; <=  {((sc.input.I[3].O*0.0156)+of.input.I[3].O)} {0.}
(assert (>= (+ (* sc_62 0.0156) of_62) 0.))
...
(assert (= (+ (+ (* sc_67 0.5) of_67) slbot_67) 0.))
; 
...
; 
; >=  {((sc.vadd[18].D*4e-06)+of.vadd[18].D)} {3300.}
(assert (<= (+ (* sc_89 4e-06) of_89) 3300.))
; 
; <=  {((sc.vadd[18].D*4e-06)+of.vadd[18].D)} {0.}
...
; 
; =  {(((sc.vadd[18].OUT2*0.0156)+of.vadd[18].OUT2)+sl.max.vadd[18].OUT2)} {3300.}
(assert (= (+ (+ (* sc_94 0.0156) of_94) sltop_94) 3300.))
(declare-fun slbot_92 () Real)
(declare-fun sltop_92 () Real)
; 
; =  {(((sc.vadd[18].B*0.109429385666)+of.vadd[18].B)+sl.min.vadd[18].B)} {0.}
(assert (= (+ (+ (* sc_92 0.109429385666) of_92) slbot_92) 0.))
; 
; =  {(((sc.vadd[18].B*3.53553390593)+of.vadd[18].B)+sl.max.vadd[18].B)} {3300.}
(assert (= (+ (+ (* sc_92 3.53553390593) of_92) sltop_92) 3300.))
(declare-fun slbot_93 () Real)
(declare-fun sltop_93 () Real)
; 
; =  {(((sc.vadd[18].OUT*0.109429385666)+of.vadd[18].OUT)+sl.min.vadd[18].OUT)} {-1650.}
(assert (= (+ (+ (* sc_93 0.109429385666) of_93) slbot_93) -1650.))
; 
; =  {(((sc.vadd[18].OUT*3.53553390593)+of.vadd[18].OUT)+sl.max.vadd[18].OUT)} {1650.}
(assert (= (+ (+ (* sc_93 3.53553390593) of_93) sltop_93) 1650.))
(declare-fun slbot_94 () Real)
(declare-fun sltop_94 () Real)
; 
; =  {(((sc.vadd[18].OUT2*0.)+of.vadd[18].OUT2)+sl.min.vadd[18].OUT2)} {0.}
...
(assert (= 0. 0.))
; 
; =  {sc.ihill[16].STIM} {(sc.ihill[16].Vmax*(1./1.))}
...
(assert (= 0. 0.))
; 
; =  {sc.ihill[16].REP} {(sc.ihill[16].Vmax*(1./1.))}
(assert (= sc_100 (* sc_98 (/ 1. 1.))))
; 
; =  {of.ihill[16].REP} {0.}
(assert (= of_100 0.))
; 
; >=  {((sc.ihill[16].n*1.)+of.ihill[16].n)} {5.}
(assert (<= (+ (* sc_95 1.) of_95) 5.))
; 
; <=  {((sc.ihill[16].n*1.)+of.ihill[16].n)} {1.}
(assert (>= (+ (* sc_95 1.) of_95) 1.))
(declare-fun slbot_96 () Real)
(declare-fun sltop_96 () Real)
; 
; =  {(((sc.ihill[16].S*0.)+of.ihill[16].S)+sl.min.ihill[16].S)} {1.}
(assert (= (+ (+ (* sc_96 0.) of_96) slbot_96) 1.))
; 
; =  {(((sc.ihill[16].S*0.0156)+of.ihill[16].S)+sl.max.ihill[16].S)} {10.}
(assert (= (+ (+ (* sc_96 0.0156) of_96) sltop_96) 10.))
(declare-fun slbot_100 () Real)
(declare-fun sltop_100 () Real)
; 
; =  {(((sc.ihill[16].REP*0.00768018905081)+of.ihill[16].REP)+sl.min.ihill[16].REP)} {5e-10}
(assert (= (+ (+ (* sc_100 0.00768018905081) of_100) slbot_100) 5e-10))
; 
; =  {(((sc.ihill[16].REP*0.0312)+of.ihill[16].REP)+sl.max.ihill[16].REP)} {500000.}
(assert (= (+ (+ (* sc_100 0.0312) of_100) sltop_100) 500000.))
(declare-fun slbot_97 () Real)
(declare-fun sltop_97 () Real)
; 
; =  {(((sc.ihill[16].Km*0.5)+of.ihill[16].Km)+sl.min.ihill[16].Km)} {1.}
(assert (= (+ (+ (* sc_97 0.5) of_97) slbot_97) 1.))
; 
; =  {(((sc.ihill[16].Km*1.)+of.ihill[16].Km)+sl.max.ihill[16].Km)} {10.}
(assert (= (+ (+ (* sc_97 1.) of_97) sltop_97) 10.))
; 
; >=  {((sc.ihill[16].Vmax*0.0156)+of.ihill[16].Vmax)} {10.}
(assert (<= (+ (* sc_98 0.0156) of_98) 10.))
; 
; <=  {((sc.ihill[16].Vmax*0.0156)+of.ihill[16].Vmax)} {0.0001}
(assert (>= (+ (* sc_98 0.0156) of_98) 0.0001))
...
(assert (= (+ (+ (* sc_105 1.) of_105) slbot_105) 9.999900001e-15))
; 
; =  {(((sc.ihill[1].STIM*5.65685424949)+of.ihill[1].STIM)+sl.max.ihill[1].STIM)} {999990.0001}
(assert (= (+ (+ (* sc_105 5.65685424949) of_105) sltop_105) 999990.0001))
(declare-fun slbot_106 () Real)
(declare-fun sltop_106 () Real)
; 
; =  {(((sc.ihill[1].REP*0.0273573464165)+of.ihill[1].REP)+sl.min.ihill[1].REP)} {5e-10}
...
(assert (= (+ (+ (* sc_113 0.15625) of_113) sltop_113) 3300.))
; 
...
(assert (= (+ (+ (* sc_115 0.) of_115) slbot_115) 0.00030303030303))
; 
...
; 
; =  {(((sc.vtoi[0].X*0.5)+of.vtoi[0].X)+sl.min.vtoi[0].X)} {1.}
(assert (= (+ (+ (* sc_119 0.5) of_119) slbot_119) 1.))
; 
...
; 
; =  {(((sc.vtoi[0].Y*-1.)+of.vtoi[0].Y)+sl.min.vtoi[0].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_121 -1.) of_121) slbot_121) 0.00030303030303))
; 
; =  {(((sc.vtoi[0].Y*-0.5)+of.vtoi[0].Y)+sl.max.vtoi[0].Y)} {3300.}
(assert (= (+ (+ (* sc_121 -0.5) of_121) sltop_121) 3300.))
; 
...
(assert (<= (+ (* sc_128 2.5) of_128) 3300.))
; 
; <=  {((sc.input.V[7].X*2.5)+of.input.V[7].X)} {0.}
(assert (>= (+ (* sc_128 2.5) of_128) 0.))
; 
; >=  {((sc.input.V[7].O*2.5)+of.input.V[7].O)} {3300.}
(assert (<= (+ (* sc_129 2.5) of_129) 3300.))
; 
; <=  {((sc.input.V[7].O*2.5)+of.input.V[7].O)} {0.}
(assert (>= (+ (* sc_129 2.5) of_129) 0.))
...
(assert (<= (+ (* sc_160 0.3125) of_160) 3300.))
; 
; <=  {((sc.input.V[4].X*0.3125)+of.input.V[4].X)} {0.}
(assert (>= (+ (* sc_160 0.3125) of_160) 0.))
; 
...
(assert (<= (+ (* sc_162 -1250.) of_162) 3300.))
; 
; <=  {((sc.input.V[5].X*-1250.)+of.input.V[5].X)} {0.}
(assert (>= (+ (* sc_162 -1250.) of_162) 0.))
; 
...
; 
; =  {(((sc.itov[17].Y*0.109429385666)+of.itov[17].Y)+sl.min.itov[17].Y)} {0.0001}
(assert (= (+ (+ (* sc_194 0.109429385666) of_194) slbot_194) 0.0001))
; 
; =  {(((sc.itov[17].Y*3.53553390593)+of.itov[17].Y)+sl.max.itov[17].Y)} {3300.}
(assert (= (+ (+ (* sc_194 3.53553390593) of_194) sltop_194) 3300.))
(declare-fun slbot_193 () Real)
(declare-fun sltop_193 () Real)
; 
; =  {(((sc.itov[17].K*0.0273573464165)+of.itov[17].K)+sl.min.itov[17].K)} {1.}
(assert (= (+ (+ (* sc_193 0.0273573464165) of_193) slbot_193) 1.))
; 
; =  {(((sc.itov[17].K*0.883883476483)+of.itov[17].K)+sl.max.itov[17].K)} {330.}
(assert (= (+ (+ (* sc_193 0.883883476483) of_193) sltop_193) 330.))
(declare-fun slbot_194 () Real)
(declare-fun sltop_194 () Real)
; 
; =  {(((sc.itov[17].Y*0.109429385666)+of.itov[17].Y)+sl.min.itov[17].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_199 5.65685424949) of_199) sltop_199) 10.))
; 
...
(assert (= (+ (+ (* sc_198 1.) of_198) slbot_198) 0.))
; 
; =  {(((sc.iadd[7].B*5.65685424949)+of.iadd[7].B)+sl.max.iadd[7].B)} {5.}
(assert (= (+ (+ (* sc_198 5.65685424949) of_198) sltop_198) 5.))
(declare-fun slbot_199 () Real)
(declare-fun sltop_199 () Real)
; 
; =  {(((sc.iadd[7].OUT*1.)+of.iadd[7].OUT)+sl.min.iadd[7].OUT)} {-10.}
...
; 
; =  {(((sc.iadd[15].D*-1.)+of.iadd[15].D)+sl.min.iadd[15].D)} {0.}
(assert (= (+ (+ (* sc_200 -1.) of_200) slbot_200) 0.))
; 
; =  {(((sc.iadd[15].D*-0.5)+of.iadd[15].D)+sl.max.iadd[15].D)} {5.}
(assert (= (+ (+ (* sc_200 -0.5) of_200) sltop_200) 5.))
; 
; >=  {((sc.iadd[15].C*1.)+of.iadd[15].C)} {5.}
(assert (<= (+ (* sc_201 1.) of_201) 5.))
; 
; <=  {((sc.iadd[15].C*1.)+of.iadd[15].C)} {0.}
(assert (>= (+ (* sc_201 1.) of_201) 0.))
(declare-fun slbot_204 () Real)
(declare-fun sltop_204 () Real)
; 
; =  {(((sc.iadd[15].OUT*-0.5)+of.iadd[15].OUT)+sl.min.iadd[15].OUT)} {-10.}
(assert (= (+ (+ (* sc_204 -0.5) of_204) slbot_204) -10.))
; 
; =  {(((sc.iadd[15].OUT*0.)+of.iadd[15].OUT)+sl.max.iadd[15].OUT)} {10.}
(assert (= (+ (+ (* sc_204 0.) of_204) sltop_204) 10.))
; 
...
(declare-fun slbot_212 () Real)
(declare-fun sltop_212 () Real)
; 
; =  {(((sc.iadd[16].A*0.)+of.iadd[16].A)+sl.min.iadd[16].A)} {0.}
(assert (= (+ (+ (* sc_212 0.) of_212) slbot_212) 0.))
; 
; =  {(((sc.iadd[16].A*0.0156)+of.iadd[16].A)+sl.max.iadd[16].A)} {5.}
(assert (= (+ (+ (* sc_212 0.0156) of_212) sltop_212) 5.))
; 
...
; 
; =  {(((sc.iadd[16].OUT*0.0156)+of.iadd[16].OUT)+sl.max.iadd[16].OUT)} {10.}
...
(assert (= of_46 of_27))
; 
; =  {sc.iadd[15].OUT} {sc.switch[11].SUB}
(assert (= sc_204 sc_22))
; 
; =  {of.iadd[15].OUT} {of.switch[11].SUB}
(assert (= of_204 of_22))
; 
; =  {sc.input.I[22].O} {sc.iadd[16].D}
(assert (= sc_76 sc_210))
; 
; =  {of.input.I[22].O} {of.iadd[16].D}
(assert (= of_76 of_210))
; 
; =  {sc.input.V[28].O} {sc.vtoi[9].K}
(assert (= sc_169 sc_114))
; 
; =  {of.input.V[28].O} {of.vtoi[9].K}
(assert (= of_169 of_114))
; 
; =  {sc.input.V[15].O} {sc.vadd[21].D}
(assert (= sc_147 sc_82))
; 
; =  {of.input.V[15].O} {of.vadd[21].D}
(assert (= of_147 of_82))
; 
; =  {sc.input.V[27].O} {sc.vtoi[11].K}
(assert (= sc_145 sc_117))
; 
; =  {of.input.V[27].O} {of.vtoi[11].K}
(assert (= of_145 of_117))
; 
; =  {sc.input.V[13].O} {sc.vadd[18].OUT2_0}
(assert (= sc_131 sc_88))
; 
; =  {of.input.V[13].O} {of.vadd[18].OUT2_0}
(assert (= of_131 of_88))
; 
; =  {sc.input.V[14].O} {sc.vtoi[0].K}
(assert (= sc_151 sc_120))
; 
; =  {of.input.V[14].O} {of.vtoi[0].K}
(assert (= of_151 of_120))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[15].D}
(assert (= sc_121 sc_200))
; 
; =  {of.vtoi[0].Y} {of.iadd[15].D}
(assert (= of_121 of_200))
; 
; =  {sc.input.V[11].O} {sc.vadd[21].A}
(assert (= sc_139 sc_84))
; 
; =  {of.input.V[11].O} {of.vadd[21].A}
(assert (= of_139 of_84))
; 
; =  {sc.ihill[16].REP} {sc.itov[20].K}
(assert (= sc_100 sc_181))
; 
; =  {of.ihill[16].REP} {of.itov[20].K}
(assert (= of_100 of_181))
; 
; =  {sc.input.I[14].O} {sc.switch[11].Kmod}
(assert (= sc_58 sc_23))
; 
; =  {of.input.I[14].O} {of.switch[11].Kmod}
(assert (= of_58 of_23))
; 
; =  {sc.vtoi[2].Y} {sc.ihill[1].Vmax}
(assert (= sc_109 sc_104))
; 
; =  {of.vtoi[2].Y} {of.ihill[1].Vmax}
(assert (= of_109 of_104))
; 
; =  {sc.input.V[22].O} {sc.vtoi[8].X}
(assert (= sc_179 sc_110))
; 
; =  {of.input.V[22].O} {of.vtoi[8].X}
(assert (= of_179 of_110))
; 
; =  {sc.input.I[10].O} {sc.iadd[15].B}
(assert (= sc_50 sc_203))
; 
; =  {of.input.I[10].O} {of.iadd[15].B}
(assert (= of_50 of_203))
; 
; =  {sc.input.I[12].O} {sc.itov[17].X}
(assert (= sc_42 sc_192))
; 
; =  {of.input.I[12].O} {of.itov[17].X}
(assert (= of_42 of_192))
; 
; =  {sc.input.V[21].O} {sc.itov[6].K}
(assert (= sc_153 sc_190))
; 
; =  {of.input.V[21].O} {of.itov[6].K}
(assert (= of_153 of_190))
; 
; =  {sc.input.V[23].O} {sc.vgain[9].Y}
(assert (= sc_165 sc_1))
; 
; =  {of.input.V[23].O} {of.vgain[9].Y}
(assert (= of_165 of_1))
; 
; =  {sc.iadd[7].OUT} {sc.itov[6].X}
(assert (= sc_199 sc_189))
; 
; =  {of.iadd[7].OUT} {of.itov[6].X}
(assert (= of_199 of_189))
; 
...
(assert (= of_125 of_12))
; 
; =  {sc.input.I[7].O} {sc.iadd[14].A}
(assert (= sc_38 sc_207))
; 
; =  {of.input.I[7].O} {of.iadd[14].A}
(assert (= of_38 of_207))
; 
; =  {sc.vtoi[11].Y} {sc.iadd[14].B}
(assert (= sc_118 sc_208))
; 
; =  {of.vtoi[11].Y} {of.iadd[14].B}
(assert (= of_118 of_208))
; 
; =  {sc.input.I[8].O} {sc.iadd[14].C}
(assert (= sc_36 sc_206))
; 
; =  {of.input.I[8].O} {of.iadd[14].C}
(assert (= of_36 of_206))
; 
...
(assert (= of_191 of_5))
; 
; =  {sc.input.I[21].O} {sc.iadd[16].B}
(assert (= sc_56 sc_213))
; 
; =  {of.input.I[21].O} {of.iadd[16].B}
(assert (= of_56 of_213))
; 
...
(assert (= of_188 of_2))
; 
; =  {sc.input.V[16].O} {sc.vadd[18].D}
(assert (= sc_155 sc_89))
; 
; =  {of.input.V[16].O} {of.vadd[18].D}
(assert (= of_155 of_89))
; 
; =  {sc.vtoi[9].Y} {sc.ihill[1].Km}
(assert (= sc_115 sc_103))
; 
; =  {of.vtoi[9].Y} {of.ihill[1].Km}
(assert (= of_115 of_103))
; 
; =  {sc.input.V[5].O} {sc.switch[13].n}
(assert (= sc_163 sc_16))
; 
; =  {of.input.V[5].O} {of.switch[13].n}
(assert (= of_163 of_16))
; 
; =  {sc.input.V[6].O} {sc.switch[11].n}
(assert (= sc_149 sc_21))
; 
; =  {of.input.V[6].O} {of.switch[11].n}
(assert (= of_149 of_21))
; 
...
(assert (= of_209 of_17))
; 
; =  {sc.input.I[11].O} {sc.itov[20].X}
(assert (= sc_48 sc_180))
; 
; =  {of.input.I[11].O} {of.itov[20].X}
(assert (= of_48 of_180))
; 
; =  {sc.switch[19].PROD} {sc.iadd[16].A}
(assert (= sc_30 sc_212))
; 
; =  {of.switch[19].PROD} {of.iadd[16].A}
(assert (= of_30 of_212))
; 
...
(assert (= of_54 of_196))
; 
; =  {sc.input.V[17].O} {sc.switch[19].n}
(assert (= sc_173 sc_26))
; 
; =  {of.input.V[17].O} {of.switch[19].n}
(assert (= of_173 of_26))
; 
...
(assert (= of_194 of_92))
; 
; =  {sc.input.V[9].O} {sc.vadd[18].C}
(assert (= sc_135 sc_90))
; 
; =  {of.input.V[9].O} {of.vadd[18].C}
(assert (= of_135 of_90))
; 
...
(assert (= of_94 of_79))
; 
; =  {sc.vadd[18].OUT2} {sc.switch[19].Vmax}
(assert (= sc_94 sc_29))
; 
; =  {of.vadd[18].OUT2} {of.switch[19].Vmax}
(assert (= of_94 of_29))
; 
; =  {sc.input.I[18].O} {sc.iadd[14].D}
(assert (= sc_72 sc_205))
; 
; =  {of.input.I[18].O} {of.iadd[14].D}
(assert (= of_72 of_205))
; 
...
(assert (= of_87 of_77))
; 
; =  {sc.vadd[21].OUT2} {sc.vtoi[11].X}
(assert (= sc_87 sc_116))
; 
; =  {of.vadd[21].OUT2} {of.vtoi[11].X}
(assert (= of_87 of_116))
; 
; =  {sc.vadd[21].OUT2} {sc.vtoi[9].X}
(assert (= sc_87 sc_113))
; 
; =  {of.vadd[21].OUT2} {of.vtoi[9].X}
(assert (= of_87 of_113))
; 
; =  {sc.input.I[9].O} {sc.iadd[15].A}
(assert (= sc_44 sc_202))
; 
; =  {of.input.I[9].O} {of.iadd[15].A}
(assert (= of_44 of_202))
; 
; =  {sc.input.I[3].O} {sc.ihill[16].Vmax}
(assert (= sc_62 sc_98))
; 
; =  {of.input.I[3].O} {of.ihill[16].Vmax}
(assert (= of_62 of_98))
; 
; =  {sc.input.I[16].O} {sc.switch[13].Kmod}
(assert (= sc_60 sc_18))
; 
; =  {of.input.I[16].O} {of.switch[13].Kmod}
(assert (= of_60 of_18))
; 
...
(assert (= of_182 of_85))
; 
; =  {sc.input.V[12].O} {sc.vadd[21].OUT2_0}
(assert (= sc_133 sc_81))
; 
; =  {of.input.V[12].O} {of.vadd[21].OUT2_0}
(assert (= of_133 of_81))
; 
; =  {sc.input.V[8].O} {sc.vadd[18].A}
(assert (= sc_127 sc_91))
; 
; =  {of.input.V[8].O} {of.vadd[18].A}
(assert (= of_127 of_91))
; 
; =  {sc.input.I[2].O} {sc.ihill[1].S}
(assert (= sc_34 sc_102))
; 
; =  {of.input.I[2].O} {of.ihill[1].S}
(assert (= of_34 of_102))
; 
; =  {sc.input.I[20].O} {sc.iadd[16].C}
(assert (= sc_32 sc_211))
; 
; =  {of.input.I[20].O} {of.iadd[16].C}
(assert (= of_32 of_211))
; 
; =  {sc.input.V[3].O} {sc.vgain[5].Z}
(assert (= sc_159 sc_14))
; 
; =  {of.input.V[3].O} {of.vgain[5].Z}
(assert (= of_159 of_14))
; 
; =  {sc.input.V[2].O} {sc.vgain[9].X}
(assert (= sc_123 sc_0))
; 
; =  {of.input.V[2].O} {of.vgain[9].X}
(assert (= of_123 of_0))
; 
...
(assert (= of_177 of_8))
; 
; =  {sc.input.I[15].O} {sc.switch[11].Vmax}
(assert (= sc_52 sc_24))
; 
; =  {of.input.I[15].O} {of.switch[11].Vmax}
(assert (= of_52 of_24))
; 
; =  {sc.input.I[1].O} {sc.ihill[16].Km}
(assert (= sc_68 sc_97))
; 
; =  {of.input.I[1].O} {of.ihill[16].Km}
(assert (= of_68 of_97))
; 
; =  {sc.input.V[1].O} {sc.vgain[4].Z}
(assert (= sc_171 sc_10))
; 
; =  {of.input.V[1].O} {of.vgain[4].Z}
(assert (= of_171 of_10))
; 
; =  {sc.input.I[13].O} {sc.switch[19].Kmod}
(assert (= sc_40 sc_28))
; 
; =  {of.input.I[13].O} {of.switch[19].Kmod}
(assert (= of_40 of_28))
; 
; =  {sc.input.V[7].O} {sc.ihill[1].n}
(assert (= sc_129 sc_101))
; 
; =  {of.input.V[7].O} {of.ihill[1].n}
(assert (= of_129 of_101))
; 
; =  {sc.input.I[17].O} {sc.switch[13].Vmax}
(assert (= sc_70 sc_19))
; 
; =  {of.input.I[17].O} {of.switch[13].Vmax}
(assert (= of_70 of_19))
; 
...
(assert (= of_20 of_183))
; 
; =  {sc.input.V[25].O} {sc.itov[12].K}
(assert (= sc_167 sc_184))
; 
; =  {of.input.V[25].O} {of.itov[12].K}
(assert (= of_167 of_184))
; 
; =  {sc.input.V[24].O} {sc.itov[10].K}
(assert (= sc_157 sc_187))
; 
; =  {of.input.V[24].O} {of.itov[10].K}
(assert (= of_157 of_187))
; 
; =  {sc.ihill[1].REP} {sc.itov[17].K}
(assert (= sc_106 sc_193))
; 
; =  {of.ihill[1].REP} {of.itov[17].K}
(assert (= of_106 of_193))
; 
...
(assert (= sc_112 sc_198))
; 
; =  {of.vtoi[8].Y} {of.iadd[7].B}
(assert (= of_112 of_198))
; 
; =  {sc.input.V[0].O} {sc.vtoi[0].X}
(assert (= sc_137 sc_119))
; 
; =  {of.input.V[0].O} {of.vtoi[0].X}
(assert (= of_137 of_119))
; 
; =  {sc.input.V[10].O} {sc.vadd[21].C}
(assert (= sc_141 sc_83))
; 
; =  {of.input.V[10].O} {of.vadd[21].C}
(assert (= of_141 of_83))
; 
...
(assert (= of_175 of_4))
; 
; =  {sc.iadd[16].OUT} {sc.ihill[16].S}
(assert (= sc_214 sc_96))
; 
; =  {of.iadd[16].OUT} {of.ihill[16].S}
(assert (= of_214 of_96))
; 
; =  {sc.input.I[19].O} {sc.iadd[15].C}
(assert (= sc_74 sc_201))
; 
; =  {of.input.I[19].O} {of.iadd[15].C}
(assert (= of_74 of_201))
; 
; =  {sc.input.V[26].O} {sc.ihill[16].n}
(assert (= sc_143 sc_95))
; 
; =  {of.input.V[26].O} {of.ihill[16].n}
(assert (= of_143 of_95))
; 
; =  {sc.input.V[4].O} {sc.vgain[3].Z}
(assert (= sc_161 sc_6))
; 
; =  {of.input.V[4].O} {of.vgain[3].Z}
(assert (= of_161 of_6))
; 
...
; 
; =  {sc.vadd[21].OUT2} {sc.output.V[0].O} {sc.vadd[18].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_87 sc_78) (= sc_87 sc_94)) (= sc_87 sc_80)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= sltop_199 0.) sltop_199 (- sltop_199))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= slbot_209 0.) slbot_209 (- slbot_209))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_193 0.) sltop_193 (- sltop_193))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_212 0.) sltop_212 (- sltop_212))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= slbot_193 0.) slbot_193 (- slbot_193))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= slbot_212 0.) slbot_212 (- slbot_212))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= sltop_208 0.) sltop_208 (- sltop_208))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_214 0.) slbot_214 (- slbot_214))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_181 0.) sltop_181 (- sltop_181))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_208 0.) slbot_208 (- slbot_208))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= sltop_209 0.) sltop_209 (- sltop_209))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_181 0.) slbot_181 (- slbot_181))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= sltop_214 0.) sltop_214 (- sltop_214))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97)))))
(check-sat)
