...
(assert (= (+ (+ (* sc_116 0.5) of_116) slbot_116) 1.))
; 
; =  {(((sc.vtoi[0].X*1.)+of.vtoi[0].X)+sl.max.vtoi[0].X)} {3300.}
(assert (= (+ (+ (* sc_116 1.) of_116) sltop_116) 3300.))
...
(assert (= (+ (+ (* sc_118 -0.5) of_118) sltop_118) 3300.))
; 
...
; 
; =  {(((sc.iadd[16].B*0.0156)+of.iadd[16].B)+sl.max.iadd[16].B)} {5.}
...
(assert (= of_147 of_82))
; 
; =  {sc.input.I[25].O} {sc.iadd[16].A}
(assert (= sc_68 sc_212))
; 
; =  {of.input.I[25].O} {of.iadd[16].A}
(assert (= of_68 of_212))
; 
...
(assert (= sc_151 sc_117))
; 
; =  {of.input.V[14].O} {of.vtoi[0].K}
(assert (= of_151 of_117))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[15].D}
(assert (= sc_118 sc_200))
; 
; =  {of.vtoi[0].Y} {of.iadd[15].D}
(assert (= of_118 of_200))
; 
...
; 
; =  {sc.input.I[24].O} {sc.iadd[16].D}
(assert (= sc_56 sc_210))
; 
; =  {of.input.I[24].O} {of.iadd[16].D}
(assert (= of_56 of_210))
; 
...
; 
; =  {sc.input.V[30].O} {sc.vtoi[9].K}
(assert (= sc_159 sc_114))
; 
; =  {of.input.V[30].O} {of.vtoi[9].K}
(assert (= of_159 of_114))
; 
...
(assert (= of_36 of_207))
; 
; =  {sc.input.V[29].O} {sc.vtoi[10].K}
(assert (= sc_127 sc_120))
; 
; =  {of.input.V[29].O} {of.vtoi[10].K}
...
(assert (= of_191 of_5))
; 
; =  {sc.input.I[23].O} {sc.iadd[16].C}
(assert (= sc_66 sc_211))
; 
; =  {of.input.I[23].O} {of.iadd[16].C}
(assert (= of_66 of_211))
; 
...
(assert (= of_46 of_180))
; 
; =  {sc.switch[19].PROD} {sc.iadd[16].B}
(assert (= sc_30 sc_213))
; 
; =  {of.switch[19].PROD} {of.iadd[16].B}
(assert (= of_30 of_213))
; 
...
(assert (= of_74 of_205))
; 
; =  {sc.vadd[21].OUT2} {sc.vtoi[10].X}
(assert (= sc_87 sc_119))
; 
; =  {of.vadd[21].OUT2} {of.vtoi[10].X}
(assert (= of_87 of_119))
; 
...
(assert (= of_177 of_8))
; 
; =  {sc.vtoi[10].Y} {sc.iadd[14].B}
(assert (= sc_121 sc_208))
; 
; =  {of.vtoi[10].Y} {of.iadd[14].B}
(assert (= of_121 of_208))
; 
...
(assert (= sc_131 sc_101))
; 
; =  {of.input.V[7].O} {of.ihill[1].n}
(assert (= of_131 of_101))
; 
...
(assert (= sc_139 sc_116))
; 
; =  {of.input.V[0].O} {of.vtoi[0].X}
(assert (= of_139 of_116))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= sltop_199 0.) sltop_199 (- sltop_199))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= slbot_209 0.) slbot_209 (- slbot_209))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_193 0.) sltop_193 (- sltop_193))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= sltop_213 0.) sltop_213 (- sltop_213))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= slbot_193 0.) slbot_193 (- slbot_193))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= sltop_208 0.) sltop_208 (- sltop_208))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_214 0.) slbot_214 (- slbot_214))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_181 0.) sltop_181 (- sltop_181))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_208 0.) slbot_208 (- slbot_208))) (ite (>= slbot_213 0.) slbot_213 (- slbot_213))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= sltop_209 0.) sltop_209 (- sltop_209))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_181 0.) slbot_181 (- slbot_181))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= sltop_214 0.) sltop_214 (- sltop_214))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97)))))
(check-sat)
