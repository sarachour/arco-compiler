...
(assert (<= (+ (* sc_20 0.156) of_20) 10.))
; 
; <=  {((sc.input.I[13].X*0.156)+of.input.I[13].X)} {0.}
(assert (>= (+ (* sc_20 0.156) of_20) 0.))
; 
...
(assert (= of_83 of_153))
; 
; =  {sc.input.I[24].O} {sc.iadd[17].B}
(assert (= sc_39 sc_163))
; 
; =  {of.input.I[24].O} {of.iadd[17].B}
(assert (= of_39 of_163))
; 
...
(assert (= of_139 of_2))
; 
; =  {sc.input.I[23].O} {sc.iadd[17].C}
(assert (= sc_49 sc_161))
; 
; =  {of.input.I[23].O} {of.iadd[17].C}
(assert (= of_49 of_161))
; 
