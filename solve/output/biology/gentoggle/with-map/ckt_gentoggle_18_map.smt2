...
(assert (= (+ (+ (* sc_110 1.) of_110) sltop_110) 3300.))
...
(assert (= (+ (+ (* sc_112 -0.5) of_112) sltop_112) 3300.))
; 
...
(assert (= of_15 of_114))
; 
; =  {sc.input.V[28].O} {sc.vtoi[17].K}
(assert (= sc_169 sc_117))
; 
; =  {of.input.V[28].O} {of.vtoi[17].K}
(assert (= of_169 of_117))
; 
; =  {sc.input.I[22].O} {sc.iadd[22].D}
(assert (= sc_76 sc_210))
; 
; =  {of.input.I[22].O} {of.iadd[22].D}
(assert (= of_76 of_210))
; 
...
(assert (= of_147 of_89))
; 
; =  {sc.input.V[27].O} {sc.vtoi[18].K}
(assert (= sc_145 sc_120))
; 
; =  {of.input.V[27].O} {of.vtoi[18].K}
(assert (= of_145 of_120))
; 
...
(assert (= sc_151 sc_111))
; 
; =  {of.input.V[14].O} {of.vtoi[6].K}
(assert (= of_151 of_111))
; 
...
(assert (= sc_115 sc_203))
; 
; =  {of.vtoi[14].Y} {of.iadd[13].B}
(assert (= of_115 of_203))
; 
...
(assert (= sc_165 sc_113))
; 
; =  {of.input.V[23].O} {of.vtoi[14].X}
(assert (= of_165 of_113))
; 
...
(assert (= of_36 of_196))
; 
; =  {sc.input.I[21].O} {sc.iadd[22].B}
(assert (= sc_56 sc_213))
; 
; =  {of.input.I[21].O} {of.iadd[22].B}
(assert (= of_56 of_213))
; 
...
(assert (= sc_112 sc_205))
; 
; =  {of.vtoi[6].Y} {of.iadd[21].D}
(assert (= of_112 of_205))
; 
...
(assert (= of_199 of_27))
; 
; =  {sc.input.I[20].O} {sc.iadd[22].C}
(assert (= sc_32 sc_211))
; 
; =  {of.input.I[20].O} {of.iadd[22].C}
(assert (= of_32 of_211))
; 
...
(assert (= sc_137 sc_110))
; 
; =  {of.input.V[0].O} {of.vtoi[6].X}
(assert (= of_137 of_110))
; 
...
(assert (= sc_143 sc_193))
; 
; =  {of.input.V[26].O} {of.itov[18].K}
(assert (= of_143 of_193))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= sltop_199 0.) sltop_199 (- sltop_199))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_137 0.) sltop_137 (- sltop_137))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= slbot_203 0.) slbot_203 (- slbot_203))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_209 0.) slbot_209 (- slbot_209))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_180 0.) sltop_180 (- sltop_180))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= sltop_212 0.) sltop_212 (- sltop_212))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= slbot_137 0.) slbot_137 (- slbot_137))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187))) (ite (>= sltop_192 0.) sltop_192 (- sltop_192))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= slbot_212 0.) slbot_212 (- slbot_212))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_192 0.) slbot_192 (- slbot_192))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_214 0.) slbot_214 (- slbot_214))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= sltop_209 0.) sltop_209 (- sltop_209))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_180 0.) slbot_180 (- slbot_180))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= sltop_203 0.) sltop_203 (- sltop_203))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= sltop_214 0.) sltop_214 (- sltop_214))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97)))))
(check-sat)
