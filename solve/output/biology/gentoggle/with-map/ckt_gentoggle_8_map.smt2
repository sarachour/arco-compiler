...
(assert (= (+ (+ (* sc_115 0.0276213586401) of_115) slbot_115) 1.))
; 
...
(assert (= (+ (+ (* sc_117 16.1908616201) of_117) sltop_117) 3300.))
...
(assert (= (+ (+ (* sc_116 0.00965050555471) of_116) sltop_116) 3300.))
(declare-fun slbot_117 () Real)
(declare-fun sltop_117 () Real)
; 
; =  {(((sc.vtoi[2].Y*0.)+of.vtoi[2].Y)+sl.min.vtoi[2].Y)} {0.00030303030303}
...
(assert (= (+ (+ (* sc_190 1.) of_190) slbot_190) 0.0001))
; 
; =  {(((sc.itov[6].X*5.65685424949)+of.itov[6].X)+sl.max.itov[6].X)} {10.}
(assert (= (+ (+ (* sc_190 5.65685424949) of_190) sltop_190) 10.))
...
(assert (= (+ (+ (* sc_192 5.65685424949) of_192) sltop_192) 3300.))
; 
...
; 
; =  {(((sc.iadd[0].C*0.5)+of.iadd[0].C)+sl.min.iadd[0].C)} {0.}
(assert (= (+ (+ (* sc_202 0.5) of_202) slbot_202) 0.))
; 
; =  {(((sc.iadd[0].C*1.)+of.iadd[0].C)+sl.max.iadd[0].C)} {5.}
(assert (= (+ (+ (* sc_202 1.) of_202) sltop_202) 5.))
...
; 
; =  {(((sc.iadd[0].OUT*-0.5)+of.iadd[0].OUT)+sl.max.iadd[0].OUT)} {10.}
(assert (= (+ (+ (* sc_205 -0.5) of_205) sltop_205) 10.))
; 
...
(assert (= of_186 of_13))
; 
; =  {sc.vtoi[12].Y} {sc.iadd[14].B}
(assert (= sc_123 sc_214))
; 
; =  {of.vtoi[12].Y} {of.iadd[14].B}
(assert (= of_123 of_214))
; 
...
(assert (= of_150 of_26))
; 
; =  {sc.input.I[22].O} {sc.iadd[14].D}
(assert (= sc_84 sc_211))
; 
; =  {of.input.I[22].O} {of.iadd[14].D}
(assert (= of_84 of_211))
; 
; =  {sc.input.I[26].O} {sc.iadd[16].D}
(assert (= sc_50 sc_216))
; 
; =  {of.input.I[26].O} {of.iadd[16].D}
(assert (= of_50 of_216))
; 
; =  {sc.input.I[25].O} {sc.iadd[16].B}
(assert (= sc_72 sc_219))
; 
; =  {of.input.I[25].O} {of.iadd[16].B}
(assert (= of_72 of_219))
; 
...
(assert (= of_144 of_89))
; 
; =  {sc.input.I[14].O} {sc.iadd[15].B}
(assert (= sc_58 sc_209))
; 
; =  {of.input.I[14].O} {of.iadd[15].B}
(assert (= of_58 of_209))
; 
...
(assert (= sc_117 sc_112))
; 
; =  {of.vtoi[2].Y} {of.ihill[1].Vmax}
(assert (= of_117 of_112))
; 
; =  {sc.input.I[24].O} {sc.iadd[16].C}
(assert (= sc_62 sc_217))
; 
; =  {of.input.I[24].O} {of.iadd[16].C}
(assert (= of_62 of_217))
; 
; =  {sc.input.V[22].O} {sc.itov[10].K}
(assert (= sc_180 sc_188))
; 
; =  {of.input.V[22].O} {of.itov[10].K}
(assert (= of_180 of_188))
; 
...
(assert (= sc_170 sc_185))
; 
; =  {of.input.V[23].O} {of.itov[12].K}
(assert (= of_170 of_185))
; 
...
(assert (= sc_200 sc_190))
; 
; =  {of.iadd[7].OUT} {of.itov[6].X}
(assert (= of_200 of_190))
; 
...
(assert (= sc_130 sc_118))
; 
; =  {of.input.V[20].O} {of.vtoi[8].X}
(assert (= of_130 of_118))
; 
; =  {sc.vtoi[11].Y} {sc.ihill[1].Km}
(assert (= sc_126 sc_111))
; 
; =  {of.vtoi[11].Y} {of.ihill[1].Km}
(assert (= of_126 of_111))
; 
...
(assert (= of_192 of_5))
; 
; =  {sc.input.I[23].O} {sc.iadd[15].C}
(assert (= sc_74 sc_207))
; 
; =  {of.input.I[23].O} {of.iadd[15].C}
(assert (= of_74 of_207))
; 
; =  {sc.input.I[21].O} {sc.switch[13].Vmax}
(assert (= sc_60 sc_19))
; 
; =  {of.input.I[21].O} {of.switch[13].Vmax}
(assert (= of_60 of_19))
; 
...
(assert (= of_30 of_218))
; 
; =  {sc.input.I[6].O} {sc.iadd[0].D}
(assert (= sc_56 sc_201))
; 
; =  {of.input.I[6].O} {of.iadd[0].D}
(assert (= of_56 of_201))
; 
...
(assert (= of_102 of_29))
; 
; =  {sc.input.I[18].O} {sc.switch[11].Kmod}
(assert (= sc_80 sc_23))
; 
; =  {of.input.I[18].O} {of.switch[11].Kmod}
(assert (= of_80 of_23))
; 
...
(assert (= of_66 of_110))
; 
; =  {sc.input.I[4].O} {sc.ihill[16].Vmax}
(assert (= sc_68 sc_106))
; 
; =  {of.input.I[4].O} {of.ihill[16].Vmax}
(assert (= of_68 of_106))
; 
...
(assert (= of_138 of_96))
; 
; =  {sc.input.I[2].O} {sc.ihill[16].Km}
(assert (= sc_32 sc_105))
; 
; =  {of.input.I[2].O} {of.ihill[16].Km}
(assert (= of_32 of_105))
; 
...
(assert (= of_162 of_6))
; 
; =  {sc.input.I[20].O} {sc.switch[13].Kmod}
(assert (= sc_34 sc_18))
; 
; =  {of.input.I[20].O} {of.switch[13].Kmod}
(assert (= of_34 of_18))
; 
...
(assert (= sc_178 sc_191))
; 
; =  {of.input.V[19].O} {of.itov[6].K}
(assert (= of_178 of_191))
; 
; =  {sc.iadd[0].OUT} {sc.iadd[15].D}
(assert (= sc_205 sc_206))
; 
; =  {of.iadd[0].OUT} {of.iadd[15].D}
(assert (= of_205 of_206))
; 
...
(assert (= of_20 of_184))
; 
; =  {sc.input.V[25].O} {sc.vtoi[12].K}
(assert (= sc_168 sc_122))
; 
; =  {of.input.V[25].O} {of.vtoi[12].K}
(assert (= of_168 of_122))
; 
; =  {sc.input.V[24].O} {sc.ihill[16].n}
(assert (= sc_160 sc_103))
; 
; =  {of.input.V[24].O} {of.ihill[16].n}
(assert (= of_160 of_103))
; 
...
(assert (= sc_120 sc_199))
; 
; =  {of.vtoi[8].Y} {of.iadd[7].B}
(assert (= of_120 of_199))
; 
...
(assert (= of_176 of_12))
; 
; =  {sc.input.V[26].O} {sc.vtoi[11].K}
(assert (= sc_146 sc_125))
; 
; =  {of.input.V[26].O} {of.vtoi[11].K}
(assert (= of_146 of_125))
; 
; =  {sc.iadd[16].OUT} {sc.ihill[16].S}
(assert (= sc_220 sc_104))
; 
; =  {of.iadd[16].OUT} {of.ihill[16].S}
(assert (= of_220 of_104))
; 
; =  {sc.input.I[19].O} {sc.switch[11].Vmax}
(assert (= sc_82 sc_24))
; 
; =  {of.input.I[19].O} {of.switch[11].Vmax}
(assert (= of_82 of_24))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_199 0.) sltop_199 (- sltop_199)) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_206 0.) slbot_206 (- slbot_206))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= sltop_206 0.) sltop_206 (- sltop_206))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_220 0.) sltop_220 (- sltop_220))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_218 0.) sltop_218 (- sltop_218))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_202 0.) slbot_202 (- slbot_202))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_215 0.) slbot_215 (- slbot_215))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= slbot_210 0.) slbot_210 (- slbot_210))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187))) (ite (>= sltop_192 0.) sltop_192 (- sltop_192))) (ite (>= slbot_220 0.) slbot_220 (- slbot_220))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_192 0.) slbot_192 (- slbot_192))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_214 0.) slbot_214 (- slbot_214))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= slbot_218 0.) slbot_218 (- slbot_218))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_202 0.) sltop_202 (- sltop_202))) (ite (>= sltop_210 0.) sltop_210 (- sltop_210))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_215 0.) sltop_215 (- sltop_215))) (ite (>= sltop_214 0.) sltop_214 (- sltop_214)))))
(check-sat)
