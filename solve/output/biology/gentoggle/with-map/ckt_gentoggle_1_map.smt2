...
(assert (= of_75 of_118))
; 
; =  {sc.input.I[18].O} {sc.iadd[8].B}
(assert (= sc_42 sc_113))
; 
; =  {of.input.I[18].O} {of.iadd[8].B}
(assert (= of_42 of_113))
; 
...
(assert (= of_10 of_115))
; 
; =  {sc.input.I[17].O} {sc.iadd[8].C}
(assert (= sc_40 sc_111))
; 
; =  {of.input.I[17].O} {of.iadd[8].C}
(assert (= of_40 of_111))
; 
...
(assert (= of_106 of_60))
; 
; =  {sc.input.I[19].O} {sc.iadd[8].D}
(assert (= sc_44 sc_110))
; 
; =  {of.input.I[19].O} {of.iadd[8].D}
(assert (= of_44 of_110))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108)))))
(check-sat)
