...
; 
; =  {(((sc.iadd[13].A*0.0156)+of.iadd[13].A)+sl.max.iadd[13].A)} {5.}
(assert (= (+ (+ (* sc_158 0.0156) of_158) sltop_158) 5.))
; 
...
(assert (= (+ (+ (* sc_175 1.66666666667) of_175) sltop_175) 10.))
; 
; =  {sc.switch[1].PROD} {sc.iadd[13].A}
(assert (= sc_13 sc_158))
; 
; =  {of.switch[1].PROD} {of.iadd[13].A}
(assert (= of_13 of_158))
; 
...
(assert (= of_120 of_84))
; 
; =  {sc.input.I[26].O} {sc.iadd[13].C}
(assert (= sc_33 sc_157))
; 
; =  {of.input.I[26].O} {of.iadd[13].C}
(assert (= of_33 of_157))
; 
...
(assert (= of_86 of_154))
; 
; =  {sc.input.I[27].O} {sc.iadd[13].B}
(assert (= sc_37 sc_159))
; 
; =  {of.input.I[27].O} {of.iadd[13].B}
(assert (= of_37 of_159))
; 
...
(assert (= of_122 of_80))
; 
; =  {sc.input.I[28].O} {sc.iadd[13].D}
(assert (= sc_55 sc_156))
; 
; =  {of.input.I[28].O} {of.iadd[13].D}
(assert (= of_55 of_156))
; 
