...
(assert (= (+ (+ (* sc_11 0.6) of_11) sltop_11) 10.))
...
(assert (<= (+ (* sc_70 1000.75) of_70) 3300.))
; 
; <=  {((sc.input.V[10].X*1000.75)+of.input.V[10].X)} {0.}
(assert (>= (+ (* sc_70 1000.75) of_70) 0.))
; 
...
; 
; =  {(((sc.itov[3].X*0.939759036145)+of.itov[3].X)+sl.min.itov[3].X)} {0.0001}
(assert (= (+ (+ (* sc_89 0.939759036145) of_89) slbot_89) 0.0001))
; 
; =  {(((sc.itov[3].X*15.6)+of.itov[3].X)+sl.max.itov[3].X)} {10.}
(assert (= (+ (+ (* sc_89 15.6) of_89) sltop_89) 10.))
; 
; >=  {((sc.itov[3].K*1.)+of.itov[3].K)} {330.}
(assert (<= (+ (* sc_90 1.) of_90) 330.))
; 
; <=  {((sc.itov[3].K*1.)+of.itov[3].K)} {1.}
...
(assert (= (+ (+ (* sc_95 15.6) of_95) sltop_95) 5.))
...
(assert (= of_83 of_1))
; 
; =  {sc.input.I[17].O} {sc.iadd[0].A}
(assert (= sc_22 sc_94))
; 
; =  {of.input.I[17].O} {of.iadd[0].A}
(assert (= of_22 of_94))
; 
...
(assert (= of_63 of_31))
; 
; =  {sc.igenebind[1].GE} {sc.itov[3].X}
(assert (= sc_57 sc_89))
; 
; =  {of.igenebind[1].GE} {of.itov[3].X}
(assert (= of_57 of_89))
; 
...
(assert (= of_75 of_90))
; 
; =  {sc.input.I[19].O} {sc.iadd[0].C}
(assert (= sc_26 sc_93))
; 
; =  {of.input.I[19].O} {of.iadd[0].C}
(assert (= of_26 of_93))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12)))))
(check-sat)
