...
; 
; =  {(((sc.iadd[19].A*0.)+of.iadd[19].A)+sl.min.iadd[19].A)} {0.}
(assert (= (+ (+ (* sc_213 0.) of_213) slbot_213) 0.))
; 
; =  {(((sc.iadd[19].A*0.0156)+of.iadd[19].A)+sl.max.iadd[19].A)} {5.}
...
(assert (= sc_120 sc_209))
; 
; =  {of.vtoi[12].Y} {of.iadd[17].B}
(assert (= of_120 of_209))
; 
...
(assert (= of_87 of_206))
; 
; =  {sc.input.V[27].O} {sc.vtoi[12].K}
(assert (= sc_153 sc_119))
; 
; =  {of.input.V[27].O} {of.vtoi[12].K}
(assert (= of_153 of_119))
; 
; =  {sc.input.I[25].O} {sc.iadd[19].D}
(assert (= sc_77 sc_211))
; 
; =  {of.input.I[25].O} {of.iadd[19].D}
(assert (= of_77 of_211))
; 
...
(assert (= of_25 of_195))
; 
; =  {sc.vtoi[14].Y} {sc.ihill[4].Km}
(assert (= sc_126 sc_114))
; 
; =  {of.vtoi[14].Y} {of.ihill[4].Km}
(assert (= of_126 of_114))
; 
; =  {sc.input.I[24].O} {sc.iadd[19].B}
(assert (= sc_65 sc_214))
; 
; =  {of.input.I[24].O} {of.iadd[19].B}
(assert (= of_65 of_214))
; 
...
(assert (= sc_161 sc_193))
; 
; =  {of.input.V[21].O} {of.itov[9].K}
(assert (= of_161 of_193))
; 
...
(assert (= of_20 of_189))
; 
; =  {sc.input.I[23].O} {sc.iadd[19].C}
(assert (= sc_75 sc_212))
; 
; =  {of.input.I[23].O} {of.iadd[19].C}
(assert (= of_75 of_212))
; 
...
(assert (= sc_157 sc_112))
; 
; =  {of.input.V[6].O} {of.ihill[4].n}
(assert (= of_157 of_112))
; 
...
(assert (= of_53 of_219))
; 
; =  {sc.switch[19].PROD} {sc.iadd[19].A}
(assert (= sc_35 sc_213))
; 
; =  {of.switch[19].PROD} {of.iadd[19].A}
(assert (= of_35 of_213))
; 
...
(assert (= sc_143 sc_101))
; 
; =  {of.input.V[9].O} {of.vadd[21].C}
(assert (= of_143 of_101))
; 
...
(assert (= sc_175 sc_196))
; 
; =  {of.input.V[25].O} {of.itov[15].K}
(assert (= of_175 of_196))
; 
...
(assert (= of_194 of_13))
; 
; =  {sc.input.V[26].O} {sc.vtoi[14].K}
(assert (= sc_149 sc_125))
; 
; =  {of.input.V[26].O} {of.vtoi[14].K}
(assert (= of_149 of_125))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= sltop_1 0.) sltop_1 (- sltop_1))) (ite (>= sltop_199 0.) sltop_199 (- sltop_199))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= sltop_216 0.) sltop_216 (- sltop_216))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_216 0.) slbot_216 (- slbot_216))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= slbot_209 0.) slbot_209 (- slbot_209))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= sltop_220 0.) sltop_220 (- sltop_220))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= sltop_213 0.) sltop_213 (- sltop_213))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= slbot_215 0.) slbot_215 (- slbot_215))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_122 0.) sltop_122 (- sltop_122))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= slbot_210 0.) slbot_210 (- slbot_210))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187))) (ite (>= sltop_192 0.) sltop_192 (- sltop_192))) (ite (>= slbot_220 0.) slbot_220 (- slbot_220))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_128 0.) slbot_128 (- slbot_128))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_122 0.) slbot_122 (- slbot_122))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_197 0.) slbot_197 (- slbot_197))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_192 0.) slbot_192 (- slbot_192))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_197 0.) sltop_197 (- sltop_197))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_213 0.) slbot_213 (- slbot_213))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= sltop_209 0.) sltop_209 (- sltop_209))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_210 0.) sltop_210 (- sltop_210))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_215 0.) sltop_215 (- sltop_215))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97)))))
(check-sat)
