...
(assert (= sc_153 sc_122))
; 
; =  {of.input.V[27].O} {of.vtoi[12].K}
(assert (= of_153 of_122))
; 
; =  {sc.input.I[25].O} {sc.iadd[19].A}
(assert (= sc_77 sc_213))
; 
; =  {of.input.I[25].O} {of.iadd[19].A}
(assert (= of_77 of_213))
; 
...
(assert (= of_25 of_195))
; 
; =  {sc.input.I[24].O} {sc.iadd[19].D}
(assert (= sc_65 sc_211))
; 
; =  {of.input.I[24].O} {of.iadd[19].D}
(assert (= of_65 of_211))
; 
...
(assert (= sc_149 sc_119))
; 
; =  {of.input.V[26].O} {of.vtoi[13].K}
(assert (= of_149 of_119))
; 
