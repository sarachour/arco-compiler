...
(assert (= (+ (+ (* sc_198 0.0156) of_198) sltop_198) 5.))
; 
...
(assert (= (+ (+ (* sc_220 0.) of_220) sltop_220) 10.))
; 
; =  {sc.vtoi[15].Y} {sc.iadd[18].B}
(assert (= sc_123 sc_214))
; 
; =  {of.vtoi[15].Y} {of.iadd[18].B}
...
(assert (= of_189 of_10))
; 
; =  {sc.input.I[26].O} {sc.iadd[20].D}
(assert (= sc_50 sc_196))
; 
; =  {of.input.I[26].O} {of.iadd[20].D}
(assert (= of_50 of_196))
; 
; =  {sc.input.I[25].O} {sc.iadd[20].B}
(assert (= sc_72 sc_199))
; 
; =  {of.input.I[25].O} {of.iadd[20].B}
(assert (= of_72 of_199))
; 
...
(assert (= of_144 of_96))
; 
; =  {sc.input.I[24].O} {sc.iadd[20].C}
(assert (= sc_62 sc_197))
; 
; =  {of.input.I[24].O} {of.iadd[20].C}
(assert (= of_62 of_197))
; 
...
(assert (= sc_170 sc_188))
; 
; =  {of.input.V[23].O} {of.itov[14].K}
(assert (= of_170 of_188))
; 
...
(assert (= of_102 of_85))
; 
; =  {sc.vadd[21].OUT2} {sc.vtoi[15].X}
(assert (= sc_102 sc_121))
; 
; =  {of.vadd[21].OUT2} {of.vtoi[15].X}
(assert (= of_102 of_121))
; 
...
(assert (= sc_126 sc_112))
; 
; =  {of.vtoi[6].Y} {of.ihill[5].Vmax}
(assert (= of_126 of_112))
; 
...
; 
; =  {sc.switch[3].PROD} {sc.iadd[20].A}
(assert (= sc_25 sc_198))
; 
; =  {of.switch[3].PROD} {of.iadd[20].A}
(assert (= of_25 of_198))
; 
...
(assert (= of_134 of_92))
; 
; =  {sc.input.V[25].O} {sc.vtoi[15].K}
(assert (= sc_168 sc_122))
; 
; =  {of.input.V[25].O} {of.vtoi[15].K}
...
(assert (= of_176 of_0))
; 
; =  {sc.input.V[26].O} {sc.vtoi[13].K}
(assert (= sc_146 sc_116))
; 
; =  {of.input.V[26].O} {of.vtoi[13].K}
(assert (= of_146 of_116))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_1 0.) sltop_1 (- sltop_1)) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= sltop_216 0.) sltop_216 (- sltop_216))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_206 0.) slbot_206 (- slbot_206))) (ite (>= slbot_216 0.) slbot_216 (- slbot_216))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= sltop_206 0.) sltop_206 (- sltop_206))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_220 0.) sltop_220 (- sltop_220))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= slbot_186 0.) slbot_186 (- slbot_186))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_215 0.) slbot_215 (- slbot_215))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_205 0.) slbot_205 (- slbot_205))) (ite (>= slbot_210 0.) slbot_210 (- slbot_210))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187))) (ite (>= sltop_192 0.) sltop_192 (- sltop_192))) (ite (>= slbot_220 0.) slbot_220 (- slbot_220))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_192 0.) slbot_192 (- slbot_192))) (ite (>= slbot_214 0.) slbot_214 (- slbot_214))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= sltop_204 0.) sltop_204 (- sltop_204))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= slbot_182 0.) slbot_182 (- slbot_182))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= sltop_186 0.) sltop_186 (- sltop_186))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_210 0.) sltop_210 (- sltop_210))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_205 0.) sltop_205 (- sltop_205))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_182 0.) sltop_182 (- sltop_182))) (ite (>= slbot_204 0.) slbot_204 (- slbot_204))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_215 0.) sltop_215 (- sltop_215))) (ite (>= sltop_214 0.) sltop_214 (- sltop_214)))))
(check-sat)
