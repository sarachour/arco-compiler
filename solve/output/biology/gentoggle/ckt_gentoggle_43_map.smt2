...
; 
; =  {(((sc.vtoi[4].Y*156.25)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
...
(assert (= sc_116 sc_118))
; 
; =  {of.input.V[17].O} {of.itov[11].K}
(assert (= of_116 of_118))
; 
...
(assert (= of_90 of_58))
; 
; =  {sc.vadd[9].OUT2} {sc.vtoi[4].X}
(assert (= sc_57 sc_74))
; 
; =  {of.vadd[9].OUT2} {of.vtoi[4].X}
(assert (= of_57 of_74))
; 
...
(assert (= of_14 of_131))
; 
; =  {sc.input.I[21].O} {sc.iadd[8].A}
(assert (= sc_34 sc_125))
; 
; =  {of.input.I[21].O} {of.iadd[8].A}
(assert (= of_34 of_125))
; 
...
(assert (= of_122 of_62))
; 
; =  {sc.input.V[16].O} {sc.vtoi[4].K}
(assert (= sc_106 sc_75))
; 
; =  {of.input.V[16].O} {of.vtoi[4].K}
(assert (= of_106 of_75))
; 
...
(assert (= of_104 of_61))
; 
; =  {sc.vtoi[4].Y} {sc.ihill[0].S}
(assert (= sc_76 sc_66))
; 
; =  {of.vtoi[4].Y} {of.ihill[0].S}
(assert (= of_76 of_66))
; 
