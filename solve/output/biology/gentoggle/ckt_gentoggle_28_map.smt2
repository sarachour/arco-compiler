...
(assert (= (+ (+ (* sc_72 3.75903614458) of_72) slbot_72) 0.))
; 
...
(assert (= (+ (+ (* sc_73 3.75903614458) of_73) slbot_73) -1650.))
; 
...
(assert (= of_143 of_6))
; 
; =  {sc.input.I[31].O} {sc.iadd[10].B}
(assert (= sc_20 sc_137))
; 
; =  {of.input.I[31].O} {of.iadd[10].B}
(assert (= of_20 of_137))
; 
...
(assert (= of_87 of_127))
; 
; =  {sc.input.I[32].O} {sc.iadd[10].D}
(assert (= sc_52 sc_134))
; 
; =  {of.input.I[32].O} {of.iadd[10].D}
(assert (= of_52 of_134))
; 
...
(assert (= of_83 of_76))
; 
; =  {sc.input.I[30].O} {sc.iadd[10].C}
(assert (= sc_40 sc_135))
; 
; =  {of.input.I[30].O} {of.iadd[10].C}
(assert (= of_40 of_135))
; 
...
; 
; =  {sc.input.I[33].O} {sc.itov[11].X}
(assert (= sc_34 sc_118))
; 
; =  {of.input.I[33].O} {of.itov[11].X}
(assert (= of_34 of_118))
; 
...
(assert (and (and (= sc_74 sc_58) (= sc_74 sc_67)) (= sc_74 sc_60)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_128 0.) slbot_128 (- slbot_128)) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= slbot_122 0.) slbot_122 (- slbot_122))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= slbot_143 0.) slbot_143 (- slbot_143))) (ite (>= slbot_127 0.) slbot_127 (- slbot_127))) (ite (>= sltop_128 0.) sltop_128 (- sltop_128))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_143 0.) sltop_143 (- sltop_143))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= sltop_127 0.) sltop_127 (- sltop_127))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_67 0.) sltop_67 (- sltop_67))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_67 0.) slbot_67 (- slbot_67))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_142 0.) slbot_142 (- slbot_142))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= sltop_142 0.) sltop_142 (- sltop_142))) (ite (>= sltop_145 0.) sltop_145 (- sltop_145))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= slbot_145 0.) slbot_145 (- slbot_145))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_122 0.) sltop_122 (- sltop_122))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
