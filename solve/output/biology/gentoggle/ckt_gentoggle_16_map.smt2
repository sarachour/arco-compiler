...
(assert (= (+ (+ (* sc_100 15.6) of_100) sltop_100) 5.))
...
(assert (= of_37 of_7))
; 
; =  {sc.input.V[17].O} {sc.vtoi[3].K}
(assert (= sc_90 sc_55))
; 
; =  {of.input.V[17].O} {of.vtoi[3].K}
(assert (= of_90 of_55))
; 
...
(assert (= of_24 of_58))
; 
; =  {sc.input.I[14].O} {sc.iadd[0].A}
(assert (= sc_20 sc_99))
; 
; =  {of.input.I[14].O} {of.iadd[0].A}
(assert (= of_20 of_99))
; 
...
(assert (= of_76 of_4))
; 
; =  {sc.switch[3].PROD} {sc.iadd[0].B}
(assert (= sc_8 sc_100))
; 
; =  {of.switch[3].PROD} {of.iadd[0].B}
(assert (= of_8 of_100))
; 
...
(assert (= of_70 of_0))
; 
; =  {sc.itov[7].Y} {sc.vgain[4].Z}
(assert (= sc_93 sc_2))
; 
; =  {of.itov[7].Y} {of.vgain[4].Z}
(assert (= of_93 of_2))
; 
...
(assert (= of_101 of_57))
; 
; =  {sc.input.I[15].O} {sc.itov[7].X}
(assert (= sc_18 sc_91))
; 
; =  {of.input.I[15].O} {of.itov[7].X}
(assert (= of_18 of_91))
; 
...
(assert (= of_26 of_5))
; 
; =  {sc.input.I[13].O} {sc.iadd[0].D}
(assert (= sc_12 sc_97))
; 
; =  {of.input.I[13].O} {of.iadd[0].D}
(assert (= of_12 of_97))
; 
...
(assert (= of_66 of_31))
; 
; =  {sc.igenebind[1].GE} {sc.itov[7].K}
(assert (= sc_60 sc_92))
; 
; =  {of.igenebind[1].GE} {of.itov[7].K}
(assert (= of_60 of_92))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_60 0.) slbot_60 (- slbot_60))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_74 0.) sltop_74 (- sltop_74))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_60 0.) sltop_60 (- sltop_60))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= slbot_74 0.) slbot_74 (- slbot_74))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7)))))
(check-sat)
