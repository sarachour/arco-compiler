...
(assert (= of_125 0.))
; 
; >=  {((sc.itov[11].X*1.)+of.itov[11].X)} {10.}
(assert (<= (+ (* sc_123 1.) of_123) 10.))
; 
; <=  {((sc.itov[11].X*1.)+of.itov[11].X)} {0.0001}
(assert (>= (+ (* sc_123 1.) of_123) 0.0001))
(declare-fun slbot_124 () Real)
(declare-fun sltop_124 () Real)
; 
; =  {(((sc.itov[11].K*0.939759036145)+of.itov[11].K)+sl.min.itov[11].K)} {1.}
(assert (= (+ (+ (* sc_124 0.939759036145) of_124) slbot_124) 1.))
; 
; =  {(((sc.itov[11].K*15.6)+of.itov[11].K)+sl.max.itov[11].K)} {330.}
...
(assert (= of_102 of_0))
; 
; =  {sc.input.I[29].O} {sc.itov[11].X}
(assert (= sc_17 sc_123))
; 
; =  {of.input.I[29].O} {of.itov[11].X}
(assert (= of_17 of_123))
; 
...
(assert (= of_70 of_84))
; 
; =  {sc.igenebind[1].GE} {sc.itov[11].K}
(assert (= sc_94 sc_124))
; 
; =  {of.igenebind[1].GE} {of.itov[11].K}
(assert (= of_94 of_124))
; 
...
(assert (= of_19 of_136))
; 
; =  {sc.input.I[27].O} {sc.iadd[8].D}
(assert (= sc_37 sc_129))
; 
; =  {of.input.I[27].O} {of.iadd[8].D}
(assert (= of_37 of_129))
; 
...
(assert (= of_112 of_71))
; 
; =  {sc.input.I[28].O} {sc.iadd[8].A}
(assert (= sc_53 sc_131))
; 
; =  {of.input.I[28].O} {of.iadd[8].A}
(assert (= of_53 of_131))
; 
