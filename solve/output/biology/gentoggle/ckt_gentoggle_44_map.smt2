...
; 
; =  {(((sc.iadd[13].B*15.6)+of.iadd[13].B)+sl.max.iadd[13].B)} {5.}
...
(assert (= of_27 of_12))
; 
; =  {sc.switch[7].PROD} {sc.iadd[13].B}
(assert (= sc_8 sc_137))
; 
; =  {of.switch[7].PROD} {of.iadd[13].B}
(assert (= of_8 of_137))
; 
...
(assert (= of_102 of_63))
; 
; =  {sc.input.I[22].O} {sc.iadd[13].C}
(assert (= sc_57 sc_135))
; 
; =  {of.input.I[22].O} {of.iadd[13].C}
(assert (= of_57 of_135))
; 
; =  {sc.input.V[15].O} {sc.vtoi[0].K}
(assert (= sc_110 sc_83))
; 
; =  {of.input.V[15].O} {of.vtoi[0].K}
(assert (= of_110 of_83))
; 
...
(assert (= of_13 of_144))
; 
; =  {sc.input.I[24].O} {sc.iadd[13].A}
(assert (= sc_39 sc_136))
; 
; =  {of.input.I[24].O} {of.iadd[13].A}
(assert (= of_39 of_136))
; 
; =  {sc.input.I[15].O} {sc.switch[6].Kmod}
(assert (= sc_33 sc_11))
; 
; =  {of.input.I[15].O} {of.switch[6].Kmod}
(assert (= of_33 of_11))
; 
...
; 
; =  {sc.input.I[23].O} {sc.iadd[13].D}
(assert (= sc_49 sc_134))
; 
; =  {of.input.I[23].O} {of.iadd[13].D}
(assert (= of_49 of_134))
; 
