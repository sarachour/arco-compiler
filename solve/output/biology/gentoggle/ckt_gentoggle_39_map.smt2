...
(assert (= of_132 of_81))
; 
; =  {sc.input.I[18].O} {sc.iadd[13].A}
(assert (= sc_46 sc_130))
; 
; =  {of.input.I[18].O} {of.iadd[13].A}
(assert (= of_46 of_130))
; 
...
(assert (= of_76 of_138))
; 
; =  {sc.input.V[14].O} {sc.vtoi[8].K}
(assert (= sc_108 sc_72))
; 
; =  {of.input.V[14].O} {of.vtoi[8].K}
(assert (= of_108 of_72))
; 
...
(assert (= of_116 of_65))
; 
; =  {sc.input.I[17].O} {sc.iadd[13].D}
(assert (= sc_44 sc_128))
; 
; =  {of.input.I[17].O} {of.iadd[13].D}
(assert (= of_44 of_128))
; 
