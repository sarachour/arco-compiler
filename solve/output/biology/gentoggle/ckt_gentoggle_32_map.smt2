...
(assert (= of_104 of_65))
; 
; =  {sc.input.I[32].O} {sc.itov[5].X}
(assert (= sc_57 sc_123))
; 
; =  {of.input.I[32].O} {of.itov[5].X}
(assert (= of_57 of_123))
; 
...
(assert (= of_138 of_91))
; 
; =  {sc.input.I[30].O} {sc.iadd[12].B}
(assert (= sc_45 sc_137))
; 
; =  {of.input.I[30].O} {of.iadd[12].B}
(assert (= of_45 of_137))
; 
...
(assert (= of_15 of_129))
; 
; =  {sc.input.I[29].O} {sc.iadd[12].C}
(assert (= sc_17 sc_135))
; 
; =  {of.input.I[29].O} {of.iadd[12].C}
(assert (= of_17 of_135))
; 
