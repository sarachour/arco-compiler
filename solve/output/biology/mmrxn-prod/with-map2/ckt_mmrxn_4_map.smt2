...
(assert (= (+ (+ (* sc_88 1.14824) of_88) sltop_88) 3300.))
; 
; >=  {((sc.itov[7].K*9.26)+of.itov[7].K)} {330.}
(assert (<= (+ (* sc_87 9.26) of_87) 330.))
; 
; <=  {((sc.itov[7].K*9.26)+of.itov[7].K)} {1.}
(assert (>= (+ (* sc_87 9.26) of_87) 1.))
(declare-fun slbot_88 () Real)
(declare-fun sltop_88 () Real)
; 
; =  {(((sc.itov[7].Y*0.)+of.itov[7].Y)+sl.min.itov[7].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_91 1.564384) of_91) sltop_91) 3300.))
; 
...
(assert (= of_22 of_10))
; 
; =  {sc.vadd[8].OUT2} {sc.itov[4].X}
(assert (= sc_22 sc_95))
; 
; =  {of.vadd[8].OUT2} {of.itov[4].X}
(assert (= of_22 of_95))
; 
...
(assert (and (and (and (and (and (and (= sc_22 sc_11) (= sc_22 sc_43)) (= sc_22 sc_15)) (= sc_22 sc_36)) (= sc_22 sc_9)) (= sc_22 sc_29)) (= sc_22 sc_13)))
