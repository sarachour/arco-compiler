...
(assert (= of_3 0.))
; 
; >=  {((sc.vgain[8].X*25.232)+of.vgain[8].X)} {3300.}
(assert (<= (+ (* sc_0 25.232) of_0) 3300.))
; 
; <=  {((sc.vgain[8].X*25.232)+of.vgain[8].X)} {0.0001}
...
; 
; =  {(((sc.vgain[8].Z*0.124)+of.vgain[8].Z)+sl.max.vgain[8].Z)} {3300.}
...
; 
; =  {(((sc.vadd[7].B*0.10416)+of.vadd[7].B)+sl.max.vadd[7].B)} {3300.}
...
; 
; =  {(((sc.vadd[7].OUT*0.10416)+of.vadd[7].OUT)+sl.max.vadd[7].OUT)} {1650.}
...
(assert (= (+ (+ (* sc_29 0.400482304) of_29) sltop_29) 3300.))
...
(assert (= (+ (+ (* sc_30 0.400482304) of_30) sltop_30) 1650.))
(declare-fun slbot_31 () Real)
(declare-fun sltop_31 () Real)
; 
; =  {(((sc.vadd[9].OUT2*0.)+of.vadd[9].OUT2)+sl.min.vadd[9].OUT2)} {0.}
...
; 
; =  {(((sc.vadd[4].D*1.564384)+of.vadd[4].D)+sl.max.vadd[4].D)} {3300.}
(assert (= (+ (+ (* sc_33 1.564384) of_33) sltop_33) 3300.))
; 
...
; 
; =  {(((sc.vadd[4].OUT2*0.256)+of.vadd[4].OUT2)+sl.max.vadd[4].OUT2)} {3300.}
(assert (= (+ (+ (* sc_38 0.256) of_38) sltop_38) 3300.))
...
; 
; =  {(((sc.vadd[4].B*1.14824)+of.vadd[4].B)+sl.max.vadd[4].B)} {3300.}
(assert (= (+ (+ (* sc_36 1.14824) of_36) sltop_36) 3300.))
...
; 
; =  {(((sc.vadd[4].OUT*1.564384)+of.vadd[4].OUT)+sl.max.vadd[4].OUT)} {1650.}
...
(assert (= (+ (+ (* sc_40 3.229696) of_40) sltop_40) 3300.))
; 
...
(assert (= (+ (+ (* sc_43 1.2524) of_43) sltop_43) 3300.))
...
(assert (= (+ (+ (* sc_44 3.229696) of_44) sltop_44) 1650.))
(declare-fun slbot_45 () Real)
(declare-fun sltop_45 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2)} {0.}
...
(assert (= of_71 of_70))
; 
; >=  {((sc.input.V[16].X*25.232)+of.input.V[16].X)} {3300.}
(assert (<= (+ (* sc_70 25.232) of_70) 3300.))
; 
; <=  {((sc.input.V[16].X*25.232)+of.input.V[16].X)} {0.}
(assert (>= (+ (* sc_70 25.232) of_70) 0.))
; 
; >=  {((sc.input.V[16].O*25.232)+of.input.V[16].O)} {3300.}
(assert (<= (+ (* sc_71 25.232) of_71) 3300.))
; 
; <=  {((sc.input.V[16].O*25.232)+of.input.V[16].O)} {0.}
(assert (>= (+ (* sc_71 25.232) of_71) 0.))
...
(assert (<= (+ (* sc_85 10.1) of_85) 10.))
; 
; <=  {((sc.itov[0].X*10.1)+of.itov[0].X)} {0.0001}
(assert (>= (+ (* sc_85 10.1) of_85) 0.0001))
...
(assert (= (+ (+ (* sc_87 1.2524) of_87) sltop_87) 3300.))
...
(assert (= (+ (+ (* sc_86 0.124) of_86) sltop_86) 330.))
(declare-fun slbot_87 () Real)
(declare-fun sltop_87 () Real)
; 
; =  {(((sc.itov[0].Y*0.)+of.itov[0].Y)+sl.min.itov[0].Y)} {0.0001}
...
(assert (= of_93 0.))
; 
; >=  {((sc.itov[6].X*0.84)+of.itov[6].X)} {10.}
(assert (<= (+ (* sc_91 0.84) of_91) 10.))
; 
; <=  {((sc.itov[6].X*0.84)+of.itov[6].X)} {0.0001}
(assert (>= (+ (* sc_91 0.84) of_91) 0.0001))
...
; 
; =  {(((sc.itov[6].Y*0.10416)+of.itov[6].Y)+sl.max.itov[6].Y)} {3300.}
...
(assert (= of_96 0.))
; 
; >=  {((sc.itov[3].X*9.26)+of.itov[3].X)} {10.}
(assert (<= (+ (* sc_94 9.26) of_94) 10.))
; 
; <=  {((sc.itov[3].X*9.26)+of.itov[3].X)} {0.0001}
(assert (>= (+ (* sc_94 9.26) of_94) 0.0001))
...
; 
; =  {(((sc.itov[3].Y*1.14824)+of.itov[3].Y)+sl.max.itov[3].Y)} {3300.}
(assert (= (+ (+ (* sc_96 1.14824) of_96) sltop_96) 3300.))
...
; 
; =  {(((sc.itov[5].Y*1.564384)+of.itov[5].Y)+sl.max.itov[5].Y)} {3300.}
...
(assert (= of_38 of_82))
; 
; =  {sc.vadd[4].OUT2} {sc.itov[10].X}
(assert (= sc_38 sc_88))
; 
; =  {of.vadd[4].OUT2} {of.itov[10].X}
(assert (= of_38 of_88))
; 
...
(assert (= of_7 of_85))
; 
; =  {sc.input.V[9].O} {sc.vadd[9].OUT2_0}
(assert (= sc_57 sc_25))
; 
; =  {of.input.V[9].O} {of.vadd[9].OUT2_0}
(assert (= of_57 of_25))
; 
...
(assert (= of_5 of_91))
; 
; =  {sc.input.V[8].O} {sc.vadd[7].D}
(assert (= sc_49 sc_19))
; 
; =  {of.input.V[8].O} {of.vadd[7].D}
(assert (= of_49 of_19))
; 
...
(assert (= of_47 of_42))
; 
; =  {sc.input.V[3].O} {sc.vadd[4].A}
(assert (= sc_73 sc_35))
; 
; =  {of.input.V[3].O} {of.vadd[4].A}
(assert (= of_73 of_35))
; 
...
(assert (= of_9 of_94))
; 
; =  {sc.input.V[1].O} {sc.vadd[1].C}
(assert (= sc_79 sc_41))
; 
; =  {of.input.V[1].O} {of.vadd[1].C}
(assert (= of_79 of_41))
; 
...
(assert (= of_51 of_20))
; 
; =  {sc.vadd[9].OUT2} {sc.itov[3].K}
(assert (= sc_31 sc_95))
; 
; =  {of.vadd[9].OUT2} {of.itov[3].K}
(assert (= of_31 of_95))
; 
; =  {sc.vadd[9].OUT2} {sc.itov[6].K}
(assert (= sc_31 sc_92))
; 
; =  {of.vadd[9].OUT2} {of.itov[6].K}
(assert (= of_31 of_92))
; 
...
; 
; =  {sc.vadd[4].OUT2} {sc.output.V[0].O} {sc.vadd[7].OUT2} {sc.output.V[1].O} {sc.vadd[1].OUT2} {sc.output.V[2].O} {sc.vadd[9].OUT2} {sc.output.V[3].O}
(assert (and (and (and (and (and (and (= sc_38 sc_13) (= sc_38 sc_24)) (= sc_38 sc_17)) (= sc_38 sc_45)) (= sc_38 sc_11)) (= sc_38 sc_31)) (= sc_38 sc_15)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97)))))
(check-sat)
