...
; 
; =  {(((sc.vgain[7].Z*0.)+of.vgain[7].Z)+sl.min.vgain[7].Z)} {0.0001}
(assert (= (+ (+ (* sc_2 0.) of_2) slbot_2) 0.0001))
; 
; =  {(((sc.vgain[7].Z*0.124)+of.vgain[7].Z)+sl.max.vgain[7].Z)} {3300.}
...
(assert (= of_83 of_0))
; 
; =  {sc.vadd[4].OUT2} {sc.vgain[7].Z}
(assert (= sc_40 sc_2))
; 
; =  {of.vadd[4].OUT2} {of.vgain[7].Z}
(assert (= of_40 of_2))
; 
