...
(assert (= (+ (+ (* sc_10 1100.) of_10) sltop_10) 3300.))
...
(assert (= (+ (+ (* sc_11 1100.) of_11) sltop_11) 3300.))
...
(assert (= (+ (+ (* sc_12 1100.) of_12) sltop_12) 3300.))
...
(assert (= (+ (+ (* sc_13 1100.) of_13) sltop_13) 3300.))
...
(assert (= (+ (+ (* sc_14 1500.) of_14) sltop_14) 3300.))
...
(assert (= (+ (+ (* sc_15 1500.) of_15) sltop_15) 3300.))
...
; 
; =  {(((sc.mm[0].X*1500.)+of.mm[0].X)+sl.max.mm[0].X)} {3300.}
...
; 
; =  {(((sc.mm[0].XY*1100.)+of.mm[0].XY)+sl.max.mm[0].XY)} {1.}
(assert (= (+ (+ (* sc_22 1100.) of_22) sltop_22) 1.))
...
; 
; =  {(((sc.mm[0].Y*1100.)+of.mm[0].Y)+sl.max.mm[0].Y)} {3300.}
(assert (= (+ (+ (* sc_23 1100.) of_23) sltop_23) 3300.))
; 
...
; 
; >=  {((sc.mm[0].Ytot*1100.)+of.mm[0].Ytot)} {3300.}
(assert (<= (+ (* sc_18 1100.) of_18) 3300.))
; 
; <=  {((sc.mm[0].Ytot*1100.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_18 1100.) of_18) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*1500.)+of.mm[0].Xtot)} {3300.}
(assert (<= (+ (* sc_20 1500.) of_20) 3300.))
; 
; <=  {((sc.mm[0].Xtot*1500.)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_20 1500.) of_20) 0.0001))
; 
...
(assert (= of_25 of_24))
; 
; >=  {((sc.input.V[2].X*1100.)+of.input.V[2].X)} {3300.}
(assert (<= (+ (* sc_24 1100.) of_24) 3300.))
; 
; <=  {((sc.input.V[2].X*1100.)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_24 1100.) of_24) 0.))
; 
; >=  {((sc.input.V[2].O*1100.)+of.input.V[2].O)} {3300.}
(assert (<= (+ (* sc_25 1100.) of_25) 3300.))
; 
; <=  {((sc.input.V[2].O*1100.)+of.input.V[2].O)} {0.}
(assert (>= (+ (* sc_25 1100.) of_25) 0.))
...
(assert (= of_27 of_26))
; 
; >=  {((sc.input.V[0].X*0.)+of.input.V[0].X)} {3300.}
(assert (<= (+ (* sc_26 0.) of_26) 3300.))
; 
; <=  {((sc.input.V[0].X*0.)+of.input.V[0].X)} {0.}
(assert (>= (+ (* sc_26 0.) of_26) 0.))
; 
; >=  {((sc.input.V[0].O*0.)+of.input.V[0].O)} {3300.}
(assert (<= (+ (* sc_27 0.) of_27) 3300.))
; 
; <=  {((sc.input.V[0].O*0.)+of.input.V[0].O)} {0.}
...
(assert (= of_29 of_28))
; 
; >=  {((sc.input.V[1].X*1500.)+of.input.V[1].X)} {3300.}
(assert (<= (+ (* sc_28 1500.) of_28) 3300.))
; 
; <=  {((sc.input.V[1].X*1500.)+of.input.V[1].X)} {0.}
(assert (>= (+ (* sc_28 1500.) of_28) 0.))
; 
; >=  {((sc.input.V[1].O*1500.)+of.input.V[1].O)} {3300.}
(assert (<= (+ (* sc_29 1500.) of_29) 3300.))
; 
; <=  {((sc.input.V[1].O*1500.)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_29 1500.) of_29) 0.))
...
; 
; =  {(((sc.iadd[1].D*1100.)+of.iadd[1].D)+sl.max.iadd[1].D)} {5.}
(assert (= (+ (+ (* sc_30 1100.) of_30) sltop_30) 5.))
; 
; >=  {((sc.iadd[1].C*-1500.)+of.iadd[1].C)} {5.}
(assert (<= (+ (* sc_31 -1500.) of_31) 5.))
; 
; <=  {((sc.iadd[1].C*-1500.)+of.iadd[1].C)} {0.}
(assert (>= (+ (* sc_31 -1500.) of_31) 0.))
...
; 
; =  {(((sc.iadd[1].OUT*1500.)+of.iadd[1].OUT)+sl.max.iadd[1].OUT)} {10.}
(assert (= (+ (+ (* sc_34 1500.) of_34) sltop_34) 10.))
; 
...
(assert (= (+ (+ (* sc_35 1500.) of_35) sltop_35) 10.))
...
(assert (= (+ (+ (* sc_36 1500.) of_36) sltop_36) 10.))
; 
...
(assert (= of_23 of_12))
; 
; =  {sc.input.I[2].O} {sc.iadd[1].A}
(assert (= sc_1 sc_32))
; 
; =  {of.input.I[2].O} {of.iadd[1].A}
(assert (= of_1 of_32))
; 
; =  {sc.input.V[2].O} {sc.mm[0].Ytot}
(assert (= sc_25 sc_18))
; 
; =  {of.input.V[2].O} {of.mm[0].Ytot}
(assert (= of_25 of_18))
; 
...
(assert (= of_34 of_35))
; 
; =  {sc.input.V[1].O} {sc.mm[0].Xtot}
(assert (= sc_29 sc_20))
; 
; =  {of.input.V[1].O} {of.mm[0].Xtot}
(assert (= of_29 of_20))
; 
...
(assert (= of_22 of_10))
; 
; =  {sc.input.V[0].O} {sc.mm[0].XY0}
(assert (= sc_27 sc_17))
; 
; =  {of.input.V[0].O} {of.mm[0].XY0}
(assert (= of_27 of_17))
