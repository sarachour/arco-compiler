...
; 
; =  {(((sc.vgain[1].P*70400000.)+of.vgain[1].P)+sl.max.vgain[1].P)} {5445000.}
...
; 
; =  {(((sc.vadd[2].B*70400000.)+of.vadd[2].B)+sl.max.vadd[2].B)} {3300.}
...
; 
; =  {(((sc.vadd[2].OUT*70400000.)+of.vadd[2].OUT)+sl.max.vadd[2].OUT)} {1650.}
