...
; 
; =  {(((sc.vadd[3].OUT*0.)+of.vadd[3].OUT)+sl.min.vadd[3].OUT.1)} {0.}
(assert (= (+ (+ (* sc_17 0.) of_17) slbot_17_1) 0.))
; 
; =  {(((sc.vadd[3].OUT*136.)+of.vadd[3].OUT)+sl.max.vadd[3].OUT.1)} {1650.}
(assert (= (+ (+ (* sc_17 136.) of_17) sltop_17_1) 1650.))
(declare-fun slbot_15_1 () Real)
(assert (<= slbot_15_1 1e-08))
(declare-fun sltop_15_1 () Real)
(assert (>= sltop_15_1 1e-08))
; 
; =  {(((sc.vadd[3].A*0.)+of.vadd[3].A)+sl.min.vadd[3].A.1)} {0.}
(assert (= (+ (+ (* sc_15 0.) of_15) slbot_15_1) 0.))
; 
; =  {(((sc.vadd[3].A*544.)+of.vadd[3].A)+sl.max.vadd[3].A.1)} {3300.}
(assert (= (+ (+ (* sc_15 544.) of_15) sltop_15_1) 3300.))
; 
...
; 
; >=  {((sc.vadd[1].D*0.01)+of.vadd[1].D)} {3300.}
(assert (<= (+ (* sc_20 0.01) of_20) 3300.))
; 
; <=  {((sc.vadd[1].D*0.01)+of.vadd[1].D)} {0.}
(assert (>= (+ (* sc_20 0.01) of_20) 0.))
; 
...
; 
; =  {(((sc.vadd[1].OUT2*4400.)+of.vadd[1].OUT2)+sl.max.vadd[1].OUT2.1)} {3300.}
(assert (= (+ (+ (* sc_25 4400.) of_25) sltop_25_1) 3300.))
...
; 
; =  {(((sc.vadd[1].B*598400.)+of.vadd[1].B)+sl.max.vadd[1].B.1)} {3300.}
(assert (= (+ (+ (* sc_23 598400.) of_23) sltop_23_1) 3300.))
...
(assert (= (+ (+ (* sc_24 0.) of_24) slbot_24_1) -1650.))
; 
; =  {(((sc.vadd[1].OUT*598400.)+of.vadd[1].OUT)+sl.max.vadd[1].OUT.1)} {1650.}
(assert (= (+ (+ (* sc_24 598400.) of_24) sltop_24_1) 1650.))
(declare-fun slbot_25_1 () Real)
(assert (<= slbot_25_1 1e-08))
(declare-fun sltop_25_1 () Real)
(assert (>= sltop_25_1 1e-08))
...
(assert (= of_33 0.))
; 
; =  {(sc.mm[4].kf*sc.mm[4].X*sc.mm[4].Y)} {(sc.mm[4].kr*sc.mm[4].XY)}
...
; 
; >=  {((sc.mm[4].kr*0.01)+of.mm[4].kr)} {10.}
(assert (<= (+ (* sc_26 0.01) of_26) 10.))
; 
; <=  {((sc.mm[4].kr*0.01)+of.mm[4].kr)} {0.0001}
...
; 
; =  {(((sc.mm[4].X*0.)+of.mm[4].X)+sl.min.mm[4].X.1)} {-65999.9999}
(assert (= (+ (+ (* sc_31 0.) of_31) slbot_31_1) -65999.9999))
; 
; =  {(((sc.mm[4].X*4400.)+of.mm[4].X)+sl.max.mm[4].X.1)} {3300.}
(assert (= (+ (+ (* sc_31 4400.) of_31) sltop_31_1) 3300.))
(declare-fun slbot_32_1 () Real)
(assert (<= slbot_32_1 1e-08))
(declare-fun sltop_32_1 () Real)
(assert (>= sltop_32_1 1e-08))
; 
; =  {(((sc.mm[4].XY*0.)+of.mm[4].XY)+sl.min.mm[4].XY.1)} {0.}
(assert (= (+ (+ (* sc_32 0.) of_32) slbot_32_1) 0.))
; 
; =  {(((sc.mm[4].XY*4400.)+of.mm[4].XY)+sl.max.mm[4].XY.1)} {66000.}
...
; 
; =  {(((sc.mm[4].Y*0.)+of.mm[4].Y)+sl.min.mm[4].Y.1)} {-65999.9999}
(assert (= (+ (+ (* sc_33 0.) of_33) slbot_33_1) -65999.9999))
; 
; =  {(((sc.mm[4].Y*6800.)+of.mm[4].Y)+sl.max.mm[4].Y.1)} {3300.}
(assert (= (+ (+ (* sc_33 6800.) of_33) sltop_33_1) 3300.))
; 
; >=  {((sc.mm[4].Ytot*6800.)+of.mm[4].Ytot)} {3300.}
(assert (<= (+ (* sc_28 6800.) of_28) 3300.))
; 
; <=  {((sc.mm[4].Ytot*6800.)+of.mm[4].Ytot)} {0.0001}
(assert (>= (+ (* sc_28 6800.) of_28) 0.0001))
; 
; >=  {((sc.mm[4].Xtot*4400.)+of.mm[4].Xtot)} {3300.}
(assert (<= (+ (* sc_30 4400.) of_30) 3300.))
; 
; <=  {((sc.mm[4].Xtot*4400.)+of.mm[4].Xtot)} {0.0001}
(assert (>= (+ (* sc_30 4400.) of_30) 0.0001))
; 
; >=  {((sc.mm[4].kf*0.01)+of.mm[4].kf)} {10.}
(assert (<= (+ (* sc_29 0.01) of_29) 10.))
; 
; <=  {((sc.mm[4].kf*0.01)+of.mm[4].kf)} {0.0001}
...
; 
; =  {(((sc.itov[2].X*4400.)+of.itov[2].X)+sl.max.itov[2].X.1)} {10.}
...
; 
; =  {(((sc.itov[2].Y*598400.)+of.itov[2].Y)+sl.max.itov[2].Y.1)} {3300.}
...
; 
; =  {(((sc.itov[2].K*136.)+of.itov[2].K)+sl.max.itov[2].K.1)} {330.}
...
; 
; =  {(((sc.itov[0].X*6800.)+of.itov[0].X)+sl.max.itov[0].X.1)} {10.}
...
; 
; =  {(((sc.itov[0].Y*544.)+of.itov[0].Y)+sl.max.itov[0].Y.1)} {3300.}
(assert (= (+ (+ (* sc_55 544.) of_55) sltop_55_1) 3300.))
; 
; >=  {((sc.itov[0].K*0.08)+of.itov[0].K)} {330.}
(assert (<= (+ (* sc_54 0.08) of_54) 330.))
; 
; <=  {((sc.itov[0].K*0.08)+of.itov[0].K)} {1.}
...
(assert (= of_25 of_8))
; 
; =  {sc.input.I[0].O} {sc.mm[4].kr}
(assert (= sc_1 sc_26))
; 
; =  {of.input.I[0].O} {of.mm[4].kr}
(assert (= of_1 of_26))
; 
; =  {sc.mm[4].Y} {sc.output.V[1].X}
(assert (= sc_33 sc_10))
; 
; =  {of.mm[4].Y} {of.output.V[1].X}
(assert (= of_33 of_10))
; 
; =  {sc.mm[4].Y} {sc.itov[0].X}
(assert (= sc_33 sc_53))
; 
; =  {of.mm[4].Y} {of.itov[0].X}
(assert (= of_33 of_53))
; 
...
(assert (= of_32 of_4))
; 
; =  {sc.input.V[3].O} {sc.vadd[3].B}
(assert (= sc_43 sc_16))
; 
; =  {of.input.V[3].O} {of.vadd[3].B}
(assert (= of_43 of_16))
; 
...
(assert (= of_55 of_15))
; 
; =  {sc.input.I[1].O} {sc.mm[4].kf}
(assert (= sc_3 sc_29))
; 
; =  {of.input.I[1].O} {of.mm[4].kf}
(assert (= of_3 of_29))
; 
...
(assert (= of_49 of_19))
; 
; =  {sc.input.V[7].O} {sc.mm[4].Ytot}
(assert (= sc_37 sc_28))
; 
; =  {of.input.V[7].O} {of.mm[4].Ytot}
(assert (= of_37 of_28))
; 
; =  {sc.mm[4].X} {sc.itov[2].X}
(assert (= sc_31 sc_50))
; 
; =  {of.mm[4].X} {of.itov[2].X}
(assert (= of_31 of_50))
; 
; =  {sc.mm[4].X} {sc.output.V[0].X}
(assert (= sc_31 sc_6))
; 
; =  {of.mm[4].X} {of.output.V[0].X}
(assert (= of_31 of_6))
; 
; =  {sc.input.V[0].O} {sc.mm[4].Xtot}
(assert (= sc_39 sc_30))
; 
; =  {of.input.V[0].O} {of.mm[4].Xtot}
(assert (= of_39 of_30))
; 
...
(assert (= of_45 of_21))
; 
; =  {sc.input.V[5].O} {sc.itov[0].K}
(assert (= sc_47 sc_54))
; 
; =  {of.input.V[5].O} {of.itov[0].K}
(assert (= of_47 of_54))
; 
...
; 
; =  {sc.output.V[2].O} {sc.output.V[3].O} {sc.mm[4].XY} {sc.vadd[1].OUT2}
(assert (and (and (= sc_5 sc_9) (= sc_5 sc_32)) (= sc_5 sc_25)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_10_1 0.) sltop_10_1 (- sltop_10_1)) (ite (>= slbot_11_1 0.) slbot_11_1 (- slbot_11_1))) (ite (>= sltop_33_1 0.) sltop_33_1 (- sltop_33_1))) (ite (>= sltop_17_1 0.) sltop_17_1 (- sltop_17_1))) (ite (>= slbot_52_1 0.) slbot_52_1 (- slbot_52_1))) (ite (>= slbot_7_1 0.) slbot_7_1 (- slbot_7_1))) (ite (>= slbot_53_1 0.) slbot_53_1 (- slbot_53_1))) (ite (>= slbot_6_1 0.) slbot_6_1 (- slbot_6_1))) (ite (>= sltop_31_1 0.) sltop_31_1 (- sltop_31_1))) (ite (>= sltop_53_1 0.) sltop_53_1 (- sltop_53_1))) (ite (>= slbot_17_1 0.) slbot_17_1 (- slbot_17_1))) (ite (>= slbot_15_1 0.) slbot_15_1 (- slbot_15_1))) (ite (>= sltop_52_1 0.) sltop_52_1 (- sltop_52_1))) (ite (>= slbot_32_1 0.) slbot_32_1 (- slbot_32_1))) (ite (>= slbot_4_1 0.) slbot_4_1 (- slbot_4_1))) (ite (>= sltop_6_1 0.) sltop_6_1 (- sltop_6_1))) (ite (>= sltop_25_1 0.) sltop_25_1 (- sltop_25_1))) (ite (>= slbot_24_1 0.) slbot_24_1 (- slbot_24_1))) (ite (>= slbot_50_1 0.) slbot_50_1 (- slbot_50_1))) (ite (>= sltop_51_1 0.) sltop_51_1 (- sltop_51_1))) (ite (>= sltop_8_1 0.) sltop_8_1 (- sltop_8_1))) (ite (>= slbot_25_1 0.) slbot_25_1 (- slbot_25_1))) (ite (>= sltop_15_1 0.) sltop_15_1 (- sltop_15_1))) (ite (>= slbot_51_1 0.) slbot_51_1 (- slbot_51_1))) (ite (>= sltop_55_1 0.) sltop_55_1 (- sltop_55_1))) (ite (>= sltop_4_1 0.) sltop_4_1 (- sltop_4_1))) (ite (>= slbot_10_1 0.) slbot_10_1 (- slbot_10_1))) (ite (>= sltop_23_1 0.) sltop_23_1 (- sltop_23_1))) (ite (>= slbot_8_1 0.) slbot_8_1 (- slbot_8_1))) (ite (>= slbot_9_1 0.) slbot_9_1 (- slbot_9_1))) (ite (>= slbot_33_1 0.) slbot_33_1 (- slbot_33_1))) (ite (>= sltop_7_1 0.) sltop_7_1 (- sltop_7_1))) (ite (>= sltop_50_1 0.) sltop_50_1 (- sltop_50_1))) (ite (>= slbot_31_1 0.) slbot_31_1 (- slbot_31_1))) (ite (>= slbot_5_1 0.) slbot_5_1 (- slbot_5_1))) (ite (>= sltop_9_1 0.) sltop_9_1 (- sltop_9_1))) (ite (>= slbot_23_1 0.) slbot_23_1 (- slbot_23_1))) (ite (>= sltop_5_1 0.) sltop_5_1 (- sltop_5_1))) (ite (>= slbot_55_1 0.) slbot_55_1 (- slbot_55_1))) (ite (>= sltop_11_1 0.) sltop_11_1 (- sltop_11_1))) (ite (>= sltop_24_1 0.) sltop_24_1 (- sltop_24_1))) (ite (>= sltop_32_1 0.) sltop_32_1 (- sltop_32_1)))))
(check-sat)
