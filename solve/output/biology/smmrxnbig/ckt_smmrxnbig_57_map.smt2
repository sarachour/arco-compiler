...
; 
; =  {(((sc.vadd[2].OUT*6600000.)+of.vadd[2].OUT)+sl.max.vadd[2].OUT)} {1649.999975}
(assert (= (+ (+ (* sc_23 6600000.) of_23) sltop_23) 1649.999975))
(declare-fun slbot_24 () Real)
(declare-fun sltop_24 () Real)
; 
; =  {(((sc.vadd[2].OUT2*0.)+of.vadd[2].OUT2)+sl.min.vadd[2].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_45 1100.) of_45) sltop_45) 10.))
...
(assert (= (+ (+ (* sc_47 6600000.) of_47) sltop_47) 3300.))
...
(assert (= (+ (+ (* sc_46 6000.) of_46) sltop_46) 330.))
(declare-fun slbot_47 () Real)
(declare-fun sltop_47 () Real)
; 
; =  {(((sc.itov[3].Y*0.)+of.itov[3].Y)+sl.min.itov[3].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_48 1100.) of_48) sltop_48) 5.))
; 
...
(assert (= (+ (+ (* sc_52 1100.) of_52) sltop_52) 10.))
; 
...
(assert (= (+ (+ (* sc_53 1100.) of_53) sltop_53) 5.))
; 
...
(assert (= (+ (+ (* sc_57 1500.) of_57) sltop_57) 10.))
; 
; >=  {((sc.iadd[4].A*1500.)+of.iadd[4].A)} {5.}
(assert (<= (+ (* sc_55 1500.) of_55) 5.))
; 
; <=  {((sc.iadd[4].A*1500.)+of.iadd[4].A)} {0.}
(assert (>= (+ (* sc_55 1500.) of_55) 0.))
; 
...
(assert (= (+ (+ (* sc_58 1100.) of_58) sltop_58) 10.))
...
(assert (= (+ (+ (* sc_60 1500.) of_60) sltop_60) 10.))
...
(assert (= (+ (+ (* sc_61 1500.) of_61) sltop_61) 10.))
; 
...
(assert (= of_5 of_56))
; 
; =  {sc.input.V[3].O} {sc.vadd[2].D}
(assert (= sc_40 sc_19))
; 
; =  {of.input.V[3].O} {of.vadd[2].D}
(assert (= of_40 of_19))
; 
...
(assert (= of_38 of_29))
; 
; =  {sc.input.V[4].O} {sc.vgain[1].X}
(assert (= sc_42 sc_0))
; 
; =  {of.input.V[4].O} {of.vgain[1].X}
(assert (= of_42 of_0))
