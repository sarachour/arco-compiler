...
(assert (= (+ (+ (* sc_34 5500.) of_34) sltop_34) 3300.))
...
(assert (= (+ (+ (* sc_35 3200.) of_35) sltop_35) 3300.))
...
(assert (= (+ (+ (* sc_36 3200.) of_36) sltop_36) 3300.))
; 
...
(assert (= (+ (+ (* sc_53 3200.) of_53) sltop_53) 5.))
; 
...
(assert (= (+ (+ (* sc_57 5500.) of_57) sltop_57) 10.))
; 
...
(assert (<= (+ (* sc_56 5499.) of_56) 5.))
; 
; <=  {((sc.iadd[3].B*5499.)+of.iadd[3].B)} {0.}
(assert (>= (+ (* sc_56 5499.) of_56) 0.))
...
(assert (= (+ (+ (* sc_58 5500.) of_58) sltop_58) 10.))
...
(assert (= (+ (+ (* sc_59 5500.) of_59) sltop_59) 10.))
; 
...
(assert (= of_9 of_55))
; 
; =  {sc.mm[2].XY} {sc.iadd[3].D}
(assert (= sc_35 sc_53))
; 
; =  {of.mm[2].XY} {of.iadd[3].D}
(assert (= of_35 of_53))
; 
...
(assert (= of_57 of_58))
; 
; =  {sc.iadd[3].OUT} {sc.vgain[0].X}
(assert (= sc_57 sc_0))
; 
; =  {of.iadd[3].OUT} {of.vgain[0].X}
(assert (= of_57 of_0))
; 
