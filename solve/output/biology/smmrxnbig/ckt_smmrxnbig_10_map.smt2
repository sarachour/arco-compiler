...
(assert (= (+ (+ (* sc_34 1500.) of_34) sltop_34) 3300.))
...
(assert (= (+ (+ (* sc_35 1100.) of_35) sltop_35) 1.))
...
(assert (= (+ (+ (* sc_36 1100.) of_36) sltop_36) 3300.))
; 
...
(assert (<= (+ (* sc_31 1100.) of_31) 3300.))
; 
; <=  {((sc.mm[4].Ytot*1100.)+of.mm[4].Ytot)} {0.0001}
(assert (>= (+ (* sc_31 1100.) of_31) 0.0001))
; 
; >=  {((sc.mm[4].Xtot*1500.)+of.mm[4].Xtot)} {3300.}
(assert (<= (+ (* sc_33 1500.) of_33) 3300.))
; 
; <=  {((sc.mm[4].Xtot*1500.)+of.mm[4].Xtot)} {0.0001}
(assert (>= (+ (* sc_33 1500.) of_33) 0.0001))
; 
...
(assert (= (+ (+ (* sc_55 1100.) of_55) sltop_55) 10.))
...
(assert (= (+ (+ (* sc_57 6600000.) of_57) sltop_57) 3300.))
...
(assert (= (+ (+ (* sc_56 6000.) of_56) sltop_56) 330.))
(declare-fun slbot_57 () Real)
(declare-fun sltop_57 () Real)
; 
; =  {(((sc.itov[3].Y*0.)+of.itov[3].Y)+sl.min.itov[3].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_58 1100.) of_58) sltop_58) 5.))
; 
; >=  {((sc.iadd[0].C*-1500.)+of.iadd[0].C)} {5.}
(assert (<= (+ (* sc_59 -1500.) of_59) 5.))
; 
; <=  {((sc.iadd[0].C*-1500.)+of.iadd[0].C)} {0.}
(assert (>= (+ (* sc_59 -1500.) of_59) 0.))
...
(assert (= (+ (+ (* sc_64 1500.) of_64) sltop_64) 10.))
; 
...
(assert (= of_9 of_29))
; 
; =  {sc.mm[4].XY} {sc.iadd[0].D}
(assert (= sc_35 sc_58))
; 
; =  {of.mm[4].XY} {of.iadd[0].D}
(assert (= of_35 of_58))
; 
