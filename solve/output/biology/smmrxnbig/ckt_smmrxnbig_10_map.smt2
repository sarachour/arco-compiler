...
; 
; >=  {((sc.iadd[1].B*1099.)+of.iadd[1].B)} {5.}
(assert (<= (+ (* sc_58 1099.) of_58) 5.))
; 
; <=  {((sc.iadd[1].B*1099.)+of.iadd[1].B)} {0.}
(assert (>= (+ (* sc_58 1099.) of_58) 0.))
...
(assert (= of_11 of_58))
; 
; =  {sc.input.I[3].O} {sc.iadd[0].B}
(assert (= sc_9 sc_53))
; 
; =  {of.input.I[3].O} {of.iadd[0].B}
(assert (= of_9 of_53))
; 
