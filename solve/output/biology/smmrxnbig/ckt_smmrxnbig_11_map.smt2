...
; 
; =  {sc.mm[4].Xtot} {sc.mm[4].XY}
(assert (= sc_36 sc_38))
; 
; =  {sc.mm[4].X} {sc.mm[4].Xtot}
(assert (= sc_37 sc_36))
; 
; =  {of.mm[4].X} {(of.mm[4].Xtot-of.mm[4].XY)}
...
(assert (= of_39 0.))
; 
; =  {(sc.mm[4].kf*sc.mm[4].X*sc.mm[4].Y)} {(sc.mm[4].kr*1.)}
(assert (= (* (* sc_35 sc_37) sc_39) (* sc_32 1.)))
; 
; =  {sc.mm[4].XY} {(sc.mm[4].kf*sc.mm[4].X*sc.mm[4].Y)}
...
(assert (= 0. 0.))
; 
; =  {sc.mm[4].XY0} {(sc.mm[4].kf*sc.mm[4].X*sc.mm[4].Y)}
(assert (= sc_33 (* (* sc_35 sc_37) sc_39)))
; 
; =  {of.mm[4].XY0} {(0.-0.)}
(assert (= of_33 0.))
; 
; =  {sc.mm[4].Ytot} {sc.mm[4].XY}
(assert (= sc_34 sc_38))
; 
; =  {sc.mm[4].Y} {sc.mm[4].Ytot}
(assert (= sc_39 sc_34))
; 
; =  {of.mm[4].Y} {(of.mm[4].Ytot-of.mm[4].XY)}
(assert (= of_39 (- of_34 of_38)))
; 
; >=  {((sc.mm[4].kr*1.)+of.mm[4].kr)} {10.}
(assert (<= (+ (* sc_32 1.) of_32) 10.))
; 
; <=  {((sc.mm[4].kr*1.)+of.mm[4].kr)} {0.0001}
(assert (>= (+ (* sc_32 1.) of_32) 0.0001))
(declare-fun slbot_37 () Real)
(declare-fun sltop_37 () Real)
; 
; =  {(((sc.mm[4].X*0.)+of.mm[4].X)+sl.min.mm[4].X)} {-0.9999}
(assert (= (+ (+ (* sc_37 0.) of_37) slbot_37) -0.9999))
; 
; =  {(((sc.mm[4].X*1500.)+of.mm[4].X)+sl.max.mm[4].X)} {3300.}
(assert (= (+ (+ (* sc_37 1500.) of_37) sltop_37) 3300.))
(declare-fun slbot_38 () Real)
(declare-fun sltop_38 () Real)
; 
; =  {(((sc.mm[4].XY*0.)+of.mm[4].XY)+sl.min.mm[4].XY)} {0.}
(assert (= (+ (+ (* sc_38 0.) of_38) slbot_38) 0.))
; 
; =  {(((sc.mm[4].XY*1100.)+of.mm[4].XY)+sl.max.mm[4].XY)} {1.}
(assert (= (+ (+ (* sc_38 1100.) of_38) sltop_38) 1.))
(declare-fun slbot_39 () Real)
(declare-fun sltop_39 () Real)
; 
; =  {(((sc.mm[4].Y*0.)+of.mm[4].Y)+sl.min.mm[4].Y)} {-0.9999}
(assert (= (+ (+ (* sc_39 0.) of_39) slbot_39) -0.9999))
; 
; =  {(((sc.mm[4].Y*1100.)+of.mm[4].Y)+sl.max.mm[4].Y)} {3300.}
(assert (= (+ (+ (* sc_39 1100.) of_39) sltop_39) 3300.))
; 
; >=  {((sc.mm[4].XY0*0.)+of.mm[4].XY0)} {3300.}
(assert (<= (+ (* sc_33 0.) of_33) 3300.))
; 
; <=  {((sc.mm[4].XY0*0.)+of.mm[4].XY0)} {0.}
(assert (>= (+ (* sc_33 0.) of_33) 0.))
; 
; >=  {((sc.mm[4].Ytot*1100.)+of.mm[4].Ytot)} {3300.}
(assert (<= (+ (* sc_34 1100.) of_34) 3300.))
; 
; <=  {((sc.mm[4].Ytot*1100.)+of.mm[4].Ytot)} {0.0001}
(assert (>= (+ (* sc_34 1100.) of_34) 0.0001))
; 
; >=  {((sc.mm[4].Xtot*1500.)+of.mm[4].Xtot)} {3300.}
(assert (<= (+ (* sc_36 1500.) of_36) 3300.))
; 
; <=  {((sc.mm[4].Xtot*1500.)+of.mm[4].Xtot)} {0.0001}
(assert (>= (+ (* sc_36 1500.) of_36) 0.0001))
; 
; >=  {((sc.mm[4].kf*1.)+of.mm[4].kf)} {10.}
(assert (<= (+ (* sc_35 1.) of_35) 10.))
; 
; <=  {((sc.mm[4].kf*1.)+of.mm[4].kf)} {0.0001}
...
(assert (= of_7 of_64))
; 
; =  {sc.vadd[2].OUT2} {sc.vtoi[2].X}
(assert (= sc_28 sc_29))
; 
; =  {of.vadd[2].OUT2} {of.vtoi[2].X}
(assert (= of_28 of_29))
; 
...
(assert (= of_28 of_18))
; 
; =  {sc.mm[4].Y} {sc.itov[3].X}
(assert (= sc_39 sc_60))
; 
; =  {of.mm[4].Y} {of.itov[3].X}
(assert (= of_39 of_60))
; 
; =  {sc.mm[4].Y} {sc.output.V[0].X}
(assert (= sc_39 sc_16))
; 
; =  {of.mm[4].Y} {of.output.V[0].X}
(assert (= of_39 of_16))
; 
; =  {sc.input.I[4].O} {sc.mm[4].kf}
(assert (= sc_11 sc_35))
; 
; =  {of.input.I[4].O} {of.mm[4].kf}
(assert (= of_11 of_35))
; 
; =  {sc.input.I[3].O} {sc.mm[4].kr}
(assert (= sc_9 sc_32))
; 
; =  {of.input.I[3].O} {of.mm[4].kr}
(assert (= of_9 of_32))
; 
; =  {sc.mm[4].XY} {sc.output.V[2].X}
(assert (= sc_38 sc_14))
; 
; =  {of.mm[4].XY} {of.output.V[2].X}
(assert (= of_38 of_14))
; 
...
(assert (= of_31 of_63))
; 
; =  {sc.input.V[3].O} {sc.mm[4].XY0}
(assert (= sc_53 sc_33))
; 
; =  {of.input.V[3].O} {of.mm[4].XY0}
(assert (= of_53 of_33))
; 
...
(assert (= of_67 of_68))
; 
; =  {sc.iadd[0].OUT} {sc.vgain[1].Z}
(assert (= sc_67 sc_2))
; 
; =  {of.iadd[0].OUT} {of.vgain[1].Z}
(assert (= of_67 of_2))
; 
...
(assert (= of_45 of_23))
; 
; =  {sc.mm[4].X} {sc.output.V[1].X}
(assert (= sc_37 sc_20))
; 
; =  {of.mm[4].X} {of.output.V[1].X}
(assert (= of_37 of_20))
; 
...
(assert (= of_55 of_25))
; 
; =  {sc.input.V[5].O} {sc.mm[4].Xtot}
(assert (= sc_57 sc_36))
; 
; =  {of.input.V[5].O} {of.mm[4].Xtot}
(assert (= of_57 of_36))
; 
; =  {sc.input.V[6].O} {sc.mm[4].Ytot}
(assert (= sc_51 sc_34))
; 
; =  {of.input.V[6].O} {of.mm[4].Ytot}
(assert (= of_51 of_34))
(assert (<= (* sc_15 0.001) 0.001))
(assert (<= (* sc_19 0.001) 0.001))
; 
; =  {sc.output.V[2].O} {sc.output.V[3].O} {sc.mm[4].XY} {sc.vadd[2].OUT2}
