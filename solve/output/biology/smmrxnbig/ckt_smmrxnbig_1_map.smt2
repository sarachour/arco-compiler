...
(assert (= (+ (+ (* sc_8 1100.) of_8) sltop_8) 3300.))
...
(assert (= (+ (+ (* sc_9 1100.) of_9) sltop_9) 3300.))
...
(assert (= (+ (+ (* sc_22 1100.) of_22) sltop_22) 5.))
...
(assert (= (+ (+ (* sc_20 6600000.) of_20) sltop_20) 3300.))
...
(assert (= (+ (+ (* sc_21 6600000.) of_21) sltop_21) 1650.))
(declare-fun slbot_22 () Real)
(declare-fun sltop_22 () Real)
; 
; =  {(((sc.vadd[2].OUT2*0.)+of.vadd[2].OUT2)+sl.min.vadd[2].OUT2)} {0.}
...
; 
; =  {(((sc.mm[0].X*1100.)+of.mm[0].X)+sl.max.mm[0].X)} {3300.}
...
(assert (= (+ (+ (* sc_29 1100.) of_29) sltop_29) 1.))
...
; 
; =  {(((sc.mm[0].Y*1500.)+of.mm[0].Y)+sl.max.mm[0].Y)} {3300.}
(assert (= (+ (+ (* sc_30 1500.) of_30) sltop_30) 3300.))
; 
; >=  {((sc.mm[0].Ytot*1500.)+of.mm[0].Ytot)} {3300.}
(assert (<= (+ (* sc_25 1500.) of_25) 3300.))
; 
; <=  {((sc.mm[0].Ytot*1500.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_25 1500.) of_25) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*1100.)+of.mm[0].Xtot)} {3300.}
(assert (<= (+ (* sc_27 1100.) of_27) 3300.))
; 
; <=  {((sc.mm[0].Xtot*1100.)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_27 1100.) of_27) 0.0001))
; 
...
(assert (= of_42 of_41))
; 
; >=  {((sc.input.V[4].X*1500.)+of.input.V[4].X)} {3300.}
(assert (<= (+ (* sc_41 1500.) of_41) 3300.))
; 
; <=  {((sc.input.V[4].X*1500.)+of.input.V[4].X)} {0.}
(assert (>= (+ (* sc_41 1500.) of_41) 0.))
; 
; >=  {((sc.input.V[4].O*1500.)+of.input.V[4].O)} {3300.}
(assert (<= (+ (* sc_42 1500.) of_42) 3300.))
; 
; <=  {((sc.input.V[4].O*1500.)+of.input.V[4].O)} {0.}
(assert (>= (+ (* sc_42 1500.) of_42) 0.))
...
(assert (= of_44 of_43))
; 
; >=  {((sc.input.V[5].X*1100.)+of.input.V[5].X)} {3300.}
(assert (<= (+ (* sc_43 1100.) of_43) 3300.))
; 
; <=  {((sc.input.V[5].X*1100.)+of.input.V[5].X)} {0.}
(assert (>= (+ (* sc_43 1100.) of_43) 0.))
; 
; >=  {((sc.input.V[5].O*1100.)+of.input.V[5].O)} {3300.}
(assert (<= (+ (* sc_44 1100.) of_44) 3300.))
; 
; <=  {((sc.input.V[5].O*1100.)+of.input.V[5].O)} {0.}
(assert (>= (+ (* sc_44 1100.) of_44) 0.))
