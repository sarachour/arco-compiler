...
; 
; =  {(((sc.mm[2].X*3200.)+of.mm[2].X)+sl.max.mm[2].X)} {3300.}
...
; 
; =  {(((sc.mm[2].Y*5500.)+of.mm[2].Y)+sl.max.mm[2].Y)} {3300.}
(assert (= (+ (+ (* sc_30 5500.) of_30) sltop_30) 3300.))
; 
; >=  {((sc.mm[2].Ytot*5500.)+of.mm[2].Ytot)} {3300.}
(assert (<= (+ (* sc_25 5500.) of_25) 3300.))
; 
; <=  {((sc.mm[2].Ytot*5500.)+of.mm[2].Ytot)} {0.0001}
(assert (>= (+ (* sc_25 5500.) of_25) 0.0001))
; 
; >=  {((sc.mm[2].Xtot*3200.)+of.mm[2].Xtot)} {3300.}
(assert (<= (+ (* sc_27 3200.) of_27) 3300.))
; 
; <=  {((sc.mm[2].Xtot*3200.)+of.mm[2].Xtot)} {0.0001}
(assert (>= (+ (* sc_27 3200.) of_27) 0.0001))
; 
...
(assert (= of_30 of_0))
; 
; =  {sc.input.V[5].O} {sc.mm[2].Xtot}
(assert (= sc_42 sc_27))
; 
; =  {of.input.V[5].O} {of.mm[2].Xtot}
(assert (= of_42 of_27))
; 
