...
; 
; =  {(((sc.mm[0].X*4400.)+of.mm[0].X)+sl.max.mm[0].X.1)} {3300.}
...
; 
; =  {(((sc.mm[0].Y*6800.)+of.mm[0].Y)+sl.max.mm[0].Y.1)} {3300.}
(assert (= (+ (+ (* sc_33 6800.) of_33) sltop_33_1) 3300.))
; 
; >=  {((sc.mm[0].Ytot*6800.)+of.mm[0].Ytot)} {3300.}
(assert (<= (+ (* sc_28 6800.) of_28) 3300.))
; 
; <=  {((sc.mm[0].Ytot*6800.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_28 6800.) of_28) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*4400.)+of.mm[0].Xtot)} {3300.}
(assert (<= (+ (* sc_30 4400.) of_30) 3300.))
; 
; <=  {((sc.mm[0].Xtot*4400.)+of.mm[0].Xtot)} {0.0001}
...
(assert (= of_33 of_10))
; 
; =  {sc.mm[0].Y} {sc.itov[1].X}
(assert (= sc_33 sc_53))
; 
; =  {of.mm[0].Y} {of.itov[1].X}
(assert (= of_33 of_53))
; 
...
(assert (= of_32 of_8))
; 
; =  {sc.input.V[7].O} {sc.mm[0].Ytot}
(assert (= sc_37 sc_28))
; 
; =  {of.input.V[7].O} {of.mm[0].Ytot}
(assert (= of_37 of_28))
; 
