...
; 
; =  {(((sc.mm[2].X*6800.)+of.mm[2].X)+sl.max.mm[2].X)} {3300.}
...
; 
; =  {(((sc.mm[2].Y*4400.)+of.mm[2].Y)+sl.max.mm[2].Y)} {3300.}
(assert (= (+ (+ (* sc_30 4400.) of_30) sltop_30) 3300.))
; 
; >=  {((sc.mm[2].Ytot*4400.)+of.mm[2].Ytot)} {3300.}
(assert (<= (+ (* sc_25 4400.) of_25) 3300.))
; 
; <=  {((sc.mm[2].Ytot*4400.)+of.mm[2].Ytot)} {0.0001}
...
; 
; >=  {((sc.mm[2].Xtot*6800.)+of.mm[2].Xtot)} {3300.}
(assert (<= (+ (* sc_27 6800.) of_27) 3300.))
; 
; <=  {((sc.mm[2].Xtot*6800.)+of.mm[2].Xtot)} {0.0001}
...
(assert (= of_40 of_19))
; 
; =  {sc.input.V[6].O} {sc.mm[2].Xtot}
(assert (= sc_36 sc_27))
; 
; =  {of.input.V[6].O} {of.mm[2].Xtot}
(assert (= of_36 of_27))
; 
