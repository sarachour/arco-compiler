...
; 
; =  {(((sc.vgain[0].P*6000.)+of.vgain[0].P)+sl.max.vgain[0].P)} {5445000.}
...
; 
; =  {(((sc.vgain[0].Z*1500.)+of.vgain[0].Z)+sl.max.vgain[0].Z)} {3300.}
...
; 
; =  {(((sc.vadd[1].OUT2*1100.)+of.vadd[1].OUT2)+sl.max.vadd[1].OUT2)} {5.}
...
; 
; =  {(((sc.vadd[1].B*6600000.)+of.vadd[1].B)+sl.max.vadd[1].B)} {3300.}
...
; 
; =  {(((sc.vadd[1].OUT*6600000.)+of.vadd[1].OUT)+sl.max.vadd[1].OUT)} {1650.}
...
; 
; =  {(((sc.itov[2].X*1100.)+of.itov[2].X)+sl.max.itov[2].X)} {10.}
...
; 
; =  {(((sc.itov[2].Y*6600000.)+of.itov[2].Y)+sl.max.itov[2].Y)} {3300.}
...
; 
; =  {(((sc.itov[2].K*6000.)+of.itov[2].K)+sl.max.itov[2].K)} {330.}
...
; 
; =  {(((sc.iadd[3].D*1100.)+of.iadd[3].D)+sl.max.iadd[3].D)} {5.}
...
; 
; =  {(((sc.iadd[3].OUT*1500.)+of.iadd[3].OUT)+sl.max.iadd[3].OUT)} {10.}
(assert (= (+ (+ (* sc_54 1500.) of_54) sltop_54) 10.))
; 
; >=  {((sc.iadd[3].A*1500.)+of.iadd[3].A)} {5.}
(assert (<= (+ (* sc_52 1500.) of_52) 5.))
; 
; <=  {((sc.iadd[3].A*1500.)+of.iadd[3].A)} {0.}
...
; 
; =  {(((sc.iadd[4].OUT*1100.)+of.iadd[4].OUT)+sl.max.iadd[4].OUT)} {10.}
...
; 
; >=  {((sc.iadd[4].B*1100.)+of.iadd[4].B)} {5.}
(assert (<= (+ (* sc_58 1100.) of_58) 5.))
; 
; <=  {((sc.iadd[4].B*1100.)+of.iadd[4].B)} {0.}
(assert (>= (+ (* sc_58 1100.) of_58) 0.))
...
(assert (= of_49 of_22))
; 
; =  {sc.vadd[1].OUT2} {sc.vtoi[4].X}
(assert (= sc_24 sc_28))
; 
; =  {of.vadd[1].OUT2} {of.vtoi[4].X}
(assert (= of_24 of_28))
; 
...
(assert (= of_54 of_62))
; 
; =  {sc.iadd[3].OUT} {sc.vgain[0].Z}
(assert (= sc_54 sc_2))
; 
; =  {of.iadd[3].OUT} {of.vgain[0].Z}
(assert (= of_54 of_2))
; 
