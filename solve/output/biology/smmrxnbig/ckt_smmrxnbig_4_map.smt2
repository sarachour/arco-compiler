...
(assert (= (+ (+ (* sc_10 3200.) of_10) sltop_10) 3300.))
...
(assert (= (+ (+ (* sc_11 3200.) of_11) sltop_11) 3300.))
...
(assert (= (+ (+ (* sc_12 3200.) of_12) sltop_12) 3300.))
...
(assert (= (+ (+ (* sc_13 3200.) of_13) sltop_13) 3300.))
...
(assert (= (+ (+ (* sc_14 5500.) of_14) sltop_14) 3300.))
...
(assert (= (+ (+ (* sc_15 5500.) of_15) sltop_15) 3300.))
...
; 
; =  {(((sc.mm[0].X*5500.)+of.mm[0].X)+sl.max.mm[0].X)} {3300.}
...
; 
; =  {(((sc.mm[0].XY*3200.)+of.mm[0].XY)+sl.max.mm[0].XY)} {3300.}
(assert (= (+ (+ (* sc_22 3200.) of_22) sltop_22) 3300.))
...
; 
; =  {(((sc.mm[0].Y*3200.)+of.mm[0].Y)+sl.max.mm[0].Y)} {3300.}
(assert (= (+ (+ (* sc_23 3200.) of_23) sltop_23) 3300.))
; 
...
; 
; >=  {((sc.mm[0].Ytot*3200.)+of.mm[0].Ytot)} {3300.}
(assert (<= (+ (* sc_18 3200.) of_18) 3300.))
; 
; <=  {((sc.mm[0].Ytot*3200.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_18 3200.) of_18) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*5500.)+of.mm[0].Xtot)} {3300.}
(assert (<= (+ (* sc_20 5500.) of_20) 3300.))
; 
; <=  {((sc.mm[0].Xtot*5500.)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_20 5500.) of_20) 0.0001))
; 
...
(assert (= of_25 of_24))
; 
; >=  {((sc.input.V[2].X*3200.)+of.input.V[2].X)} {3300.}
(assert (<= (+ (* sc_24 3200.) of_24) 3300.))
; 
; <=  {((sc.input.V[2].X*3200.)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_24 3200.) of_24) 0.))
; 
; >=  {((sc.input.V[2].O*3200.)+of.input.V[2].O)} {3300.}
(assert (<= (+ (* sc_25 3200.) of_25) 3300.))
; 
; <=  {((sc.input.V[2].O*3200.)+of.input.V[2].O)} {0.}
(assert (>= (+ (* sc_25 3200.) of_25) 0.))
...
; 
; =  {(((sc.iadd[1].D*3200.)+of.iadd[1].D)+sl.max.iadd[1].D)} {5.}
(assert (= (+ (+ (* sc_30 3200.) of_30) sltop_30) 5.))
; 
...
; 
; =  {(((sc.iadd[1].OUT*5500.)+of.iadd[1].OUT)+sl.max.iadd[1].OUT)} {10.}
(assert (= (+ (+ (* sc_34 5500.) of_34) sltop_34) 10.))
; 
; >=  {((sc.iadd[1].A*1.)+of.iadd[1].A)} {5.}
(assert (<= (+ (* sc_32 1.) of_32) 5.))
; 
; <=  {((sc.iadd[1].A*1.)+of.iadd[1].A)} {0.}
(assert (>= (+ (* sc_32 1.) of_32) 0.))
; 
; >=  {((sc.iadd[1].B*5499.)+of.iadd[1].B)} {5.}
(assert (<= (+ (* sc_33 5499.) of_33) 5.))
; 
; <=  {((sc.iadd[1].B*5499.)+of.iadd[1].B)} {0.}
(assert (>= (+ (* sc_33 5499.) of_33) 0.))
...
(assert (= (+ (+ (* sc_35 5500.) of_35) sltop_35) 10.))
...
(assert (= (+ (+ (* sc_36 5500.) of_36) sltop_36) 10.))
; 
...
(assert (= of_23 of_12))
; 
; =  {sc.input.I[2].O} {sc.mm[0].kf}
(assert (= sc_1 sc_19))
; 
; =  {of.input.I[2].O} {of.mm[0].kf}
(assert (= of_1 of_19))
; 
