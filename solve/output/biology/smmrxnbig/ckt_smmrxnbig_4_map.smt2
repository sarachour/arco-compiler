...
; 
; =  {(((sc.vtoi[4].X*1100.)+of.vtoi[4].X)+sl.max.vtoi[4].X)} {3300.}
...
; 
; =  {(((sc.vtoi[4].Y*1100.)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
...
(assert (<= (+ (* sc_47 0.125) of_47) 3300.))
; 
; <=  {((sc.input.V[0].O*0.125)+of.input.V[0].O)} {0.}
(assert (>= (+ (* sc_47 0.125) of_47) 0.))
...
(assert (= of_11 of_32))
; 
; =  {sc.input.V[14].O} {sc.vtoi[4].K}
(assert (= sc_51 sc_30))
; 
; =  {of.input.V[14].O} {of.vtoi[4].K}
(assert (= of_51 of_30))
; 
...
(assert (= of_3 of_61))
; 
; =  {sc.vtoi[4].Y} {sc.iadd[0].D}
(assert (= sc_31 sc_63))
; 
; =  {of.vtoi[4].Y} {of.iadd[0].D}
(assert (= of_31 of_63))
