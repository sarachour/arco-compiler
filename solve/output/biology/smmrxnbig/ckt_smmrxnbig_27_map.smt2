...
; 
; >=  {((sc.iadd[0].B*1100.)+of.iadd[0].B)} {5.}
(assert (<= (+ (* sc_53 1100.) of_53) 5.))
; 
; <=  {((sc.iadd[0].B*1100.)+of.iadd[0].B)} {0.}
(assert (>= (+ (* sc_53 1100.) of_53) 0.))
...
; 
; >=  {((sc.iadd[1].B*1500.)+of.iadd[1].B)} {5.}
(assert (<= (+ (* sc_58 1500.) of_58) 5.))
; 
; <=  {((sc.iadd[1].B*1500.)+of.iadd[1].B)} {0.}
(assert (>= (+ (* sc_58 1500.) of_58) 0.))
...
(assert (= of_3 of_48))
; 
; =  {sc.vtoi[4].Y} {sc.iadd[1].D}
(assert (= sc_30 sc_55))
; 
; =  {of.vtoi[4].Y} {of.iadd[1].D}
(assert (= of_30 of_55))
