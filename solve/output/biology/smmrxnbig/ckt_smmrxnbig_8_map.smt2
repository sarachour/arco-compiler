...
(assert (= of_11 of_10))
; 
; >=  {((sc.input.I[4].X*-1100.)+of.input.I[4].X)} {10.}
(assert (<= (+ (* sc_10 -1100.) of_10) 10.))
; 
; <=  {((sc.input.I[4].X*-1100.)+of.input.I[4].X)} {0.}
(assert (>= (+ (* sc_10 -1100.) of_10) 0.))
; 
; >=  {((sc.input.I[4].O*-1100.)+of.input.I[4].O)} {10.}
(assert (<= (+ (* sc_11 -1100.) of_11) 10.))
; 
; <=  {((sc.input.I[4].O*-1100.)+of.input.I[4].O)} {0.}
(assert (>= (+ (* sc_11 -1100.) of_11) 0.))
...
(assert (= of_13 of_12))
; 
; >=  {((sc.input.I[5].X*1500.)+of.input.I[5].X)} {10.}
(assert (<= (+ (* sc_12 1500.) of_12) 10.))
; 
; <=  {((sc.input.I[5].X*1500.)+of.input.I[5].X)} {0.}
(assert (>= (+ (* sc_12 1500.) of_12) 0.))
; 
; >=  {((sc.input.I[5].O*1500.)+of.input.I[5].O)} {10.}
(assert (<= (+ (* sc_13 1500.) of_13) 10.))
; 
; <=  {((sc.input.I[5].O*1500.)+of.input.I[5].O)} {0.}
(assert (>= (+ (* sc_13 1500.) of_13) 0.))
...
(assert (= (+ (+ (* sc_54 1500.) of_54) sltop_54) 10.))
; 
...
; 
; >=  {((sc.iadd[0].B*1500.)+of.iadd[0].B)} {5.}
(assert (<= (+ (* sc_53 1500.) of_53) 5.))
; 
; <=  {((sc.iadd[0].B*1500.)+of.iadd[0].B)} {0.}
(assert (>= (+ (* sc_53 1500.) of_53) 0.))
...
; 
; >=  {((sc.iadd[1].D*-1100.)+of.iadd[1].D)} {5.}
(assert (<= (+ (* sc_55 -1100.) of_55) 5.))
; 
; <=  {((sc.iadd[1].D*-1100.)+of.iadd[1].D)} {0.}
(assert (>= (+ (* sc_55 -1100.) of_55) 0.))
...
; 
; =  {(((sc.iadd[1].C*1100.)+of.iadd[1].C)+sl.max.iadd[1].C)} {5.}
(assert (= (+ (+ (* sc_56 1100.) of_56) sltop_56) 5.))
...
; 
; =  {(((sc.iadd[1].OUT*1100.)+of.iadd[1].OUT)+sl.max.iadd[1].OUT)} {10.}
(assert (= (+ (+ (* sc_59 1100.) of_59) sltop_59) 10.))
; 
...
; 
; =  {sc.input.I[0].O} {sc.iadd[0].A}
(assert (= sc_7 sc_52))
; 
; =  {of.input.I[0].O} {of.iadd[0].A}
(assert (= of_7 of_52))
; 
; =  {sc.input.I[4].O} {sc.iadd[1].D}
(assert (= sc_11 sc_55))
; 
; =  {of.input.I[4].O} {of.iadd[1].D}
(assert (= of_11 of_55))
; 
; =  {sc.input.I[3].O} {sc.iadd[1].B}
(assert (= sc_9 sc_58))
; 
; =  {of.input.I[3].O} {of.iadd[1].B}
(assert (= of_9 of_58))
; 
...
(assert (= of_54 of_62))
; 
; =  {sc.iadd[0].OUT} {sc.vgain[2].Z}
(assert (= sc_54 sc_2))
; 
; =  {of.iadd[0].OUT} {of.vgain[2].Z}
(assert (= of_54 of_2))
; 
...
(assert (= of_59 of_60))
; 
; =  {sc.iadd[1].OUT} {sc.itov[4].X}
(assert (= sc_59 sc_47))
; 
; =  {of.iadd[1].OUT} {of.itov[4].X}
(assert (= of_59 of_47))
; 
...
(assert (= of_42 of_19))
; 
; =  {sc.input.V[5].O} {sc.vgain[2].X}
(assert (= sc_44 sc_0))
; 
; =  {of.input.V[5].O} {of.vgain[2].X}
(assert (= of_44 of_0))
; 
