...
; 
; =  {(((sc.vtoi[1].X*1100.)+of.vtoi[1].X)+sl.max.vtoi[1].X)} {3300.}
...
; 
; =  {(((sc.vtoi[1].Y*1100.)+of.vtoi[1].Y)+sl.max.vtoi[1].Y)} {3300.}
...
(assert (= of_39 of_16))
; 
; =  {sc.input.V[9].O} {sc.vtoi[1].K}
(assert (= sc_47 sc_30))
; 
; =  {of.input.V[9].O} {of.vtoi[1].K}
(assert (= of_47 of_30))
; 
...
(assert (= of_38 of_14))
; 
; =  {sc.vtoi[1].Y} {sc.iadd[0].D}
(assert (= sc_31 sc_63))
; 
; =  {of.vtoi[1].Y} {of.iadd[0].D}
(assert (= of_31 of_63))
; 
