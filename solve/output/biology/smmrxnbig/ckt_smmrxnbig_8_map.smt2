...
; 
; =  {(((sc.vtoi[2].X*3200.)+of.vtoi[2].X)+sl.max.vtoi[2].X)} {3300.}
...
; 
; =  {(((sc.vtoi[2].Y*3200.)+of.vtoi[2].Y)+sl.max.vtoi[2].Y)} {3300.}
...
(assert (= of_5 of_35))
; 
; =  {sc.vtoi[2].Y} {sc.iadd[3].D}
(assert (= sc_31 sc_58))
; 
; =  {of.vtoi[2].Y} {of.iadd[3].D}
(assert (= of_31 of_58))
; 
