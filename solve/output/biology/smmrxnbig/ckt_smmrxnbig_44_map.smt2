...
; 
; >=  {((sc.iadd[3].C*-1100.)+of.iadd[3].C)} {5.}
(assert (<= (+ (* sc_51 -1100.) of_51) 5.))
; 
; <=  {((sc.iadd[3].C*-1100.)+of.iadd[3].C)} {0.}
...
; 
; =  {(((sc.iadd[3].OUT*1100.)+of.iadd[3].OUT)+sl.max.iadd[3].OUT)} {10.}
...
(assert (= of_9 of_56))
; 
; =  {sc.input.I[4].O} {sc.iadd[3].C}
(assert (= sc_11 sc_51))
; 
; =  {of.input.I[4].O} {of.iadd[3].C}
(assert (= of_11 of_51))
; 
