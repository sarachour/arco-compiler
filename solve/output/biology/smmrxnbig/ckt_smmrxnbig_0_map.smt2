...
(assert (= of_1 of_0))
; 
; >=  {((sc.input.I[0].X*0.0001)+of.input.I[0].X)} {10.}
(assert (<= (+ (* sc_0 0.0001) of_0) 10.))
; 
; <=  {((sc.input.I[0].X*0.0001)+of.input.I[0].X)} {0.}
(assert (>= (+ (* sc_0 0.0001) of_0) 0.))
; 
; >=  {((sc.input.I[0].O*0.0001)+of.input.I[0].O)} {10.}
(assert (<= (+ (* sc_1 0.0001) of_1) 10.))
; 
; <=  {((sc.input.I[0].O*0.0001)+of.input.I[0].O)} {0.}
(assert (>= (+ (* sc_1 0.0001) of_1) 0.))
...
(assert (= (+ (+ (* sc_8 6800.) of_8) sltop_8_1) 3300.))
...
(assert (= (+ (+ (* sc_9 6800.) of_9) sltop_9_1) 3300.))
...
; 
; =  {(((sc.mm[0].X*6800.)+of.mm[0].X)+sl.max.mm[0].X.1)} {1000.}
(assert (= (+ (+ (* sc_15 6800.) of_15) sltop_15_1) 1000.))
...
; 
; =  {(((sc.mm[0].XY*4400.)+of.mm[0].XY)+sl.max.mm[0].XY.1)} {10000.}
(assert (= (+ (+ (* sc_16 4400.) of_16) sltop_16_1) 10000.))
...
; 
; =  {(((sc.mm[0].Y*4400.)+of.mm[0].Y)+sl.max.mm[0].Y.1)} {1000.}
(assert (= (+ (+ (* sc_17 4400.) of_17) sltop_17_1) 1000.))
; 
...
; 
; >=  {((sc.mm[0].Ytot*4400.)+of.mm[0].Ytot)} {1000.}
(assert (<= (+ (* sc_12 4400.) of_12) 1000.))
; 
; <=  {((sc.mm[0].Ytot*4400.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_12 4400.) of_12) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*6800.)+of.mm[0].Xtot)} {1000.}
(assert (<= (+ (* sc_14 6800.) of_14) 1000.))
; 
; <=  {((sc.mm[0].Xtot*6800.)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_14 6800.) of_14) 0.0001))
; 
; >=  {((sc.mm[0].kf*0.0001)+of.mm[0].kf)} {0.01}
(assert (<= (+ (* sc_13 0.0001) of_13) 0.01))
; 
; <=  {((sc.mm[0].kf*0.0001)+of.mm[0].kf)} {0.0001}
(assert (>= (+ (* sc_13 0.0001) of_13) 0.0001))
(declare-fun slbot_15_1 () Real)
(assert (<= slbot_15_1 1e-08))
(declare-fun sltop_15_1 () Real)
(assert (>= sltop_15_1 1e-08))
...
(assert (= of_19 of_18))
; 
; >=  {((sc.input.V[2].X*6800.)+of.input.V[2].X)} {3300.}
(assert (<= (+ (* sc_18 6800.) of_18) 3300.))
; 
; <=  {((sc.input.V[2].X*6800.)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_18 6800.) of_18) 0.))
; 
; >=  {((sc.input.V[2].O*6800.)+of.input.V[2].O)} {3300.}
(assert (<= (+ (* sc_19 6800.) of_19) 3300.))
; 
; <=  {((sc.input.V[2].O*6800.)+of.input.V[2].O)} {0.}
(assert (>= (+ (* sc_19 6800.) of_19) 0.))
