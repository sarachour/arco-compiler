...
(assert (= (+ (+ (* sc_4 1100.) of_4) sltop_4) 3300.))
...
(assert (= (+ (+ (* sc_5 1100.) of_5) sltop_5) 3300.))
...
(assert (= (+ (+ (* sc_6 1100.) of_6) sltop_6) 3300.))
...
(assert (= (+ (+ (* sc_7 1100.) of_7) sltop_7) 3300.))
...
(assert (= (+ (+ (* sc_8 1500.) of_8) sltop_8) 3300.))
...
(assert (= (+ (+ (* sc_9 1500.) of_9) sltop_9) 3300.))
...
(assert (= (+ (+ (* sc_16 1100.) of_16) sltop_16) 1.))
...
(assert (<= (+ (* sc_12 1100.) of_12) 3300.))
; 
; <=  {((sc.mm[0].Ytot*1100.)+of.mm[0].Ytot)} {0.0001}
(assert (>= (+ (* sc_12 1100.) of_12) 0.0001))
; 
; >=  {((sc.mm[0].Xtot*1500.)+of.mm[0].Xtot)} {3300.}
(assert (<= (+ (* sc_14 1500.) of_14) 3300.))
; 
; <=  {((sc.mm[0].Xtot*1500.)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_14 1500.) of_14) 0.0001))
; 
...
(assert (>= (+ (* sc_18 1100.) of_18) 0.))
; 
; >=  {((sc.input.V[2].O*1100.)+of.input.V[2].O)} {3300.}
(assert (<= (+ (* sc_19 1100.) of_19) 3300.))
; 
; <=  {((sc.input.V[2].O*1100.)+of.input.V[2].O)} {0.}
(assert (>= (+ (* sc_19 1100.) of_19) 0.))
