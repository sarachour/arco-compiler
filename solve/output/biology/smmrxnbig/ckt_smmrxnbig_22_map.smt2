...
(assert (= of_11 of_10))
; 
; >=  {((sc.input.I[4].X*1500.)+of.input.I[4].X)} {10.}
(assert (<= (+ (* sc_10 1500.) of_10) 10.))
; 
; <=  {((sc.input.I[4].X*1500.)+of.input.I[4].X)} {0.}
(assert (>= (+ (* sc_10 1500.) of_10) 0.))
; 
; >=  {((sc.input.I[4].O*1500.)+of.input.I[4].O)} {10.}
(assert (<= (+ (* sc_11 1500.) of_11) 10.))
; 
; <=  {((sc.input.I[4].O*1500.)+of.input.I[4].O)} {0.}
(assert (>= (+ (* sc_11 1500.) of_11) 0.))
...
(assert (= of_13 of_12))
; 
; >=  {((sc.input.I[5].X*1100.)+of.input.I[5].X)} {10.}
(assert (<= (+ (* sc_12 1100.) of_12) 10.))
; 
; <=  {((sc.input.I[5].X*1100.)+of.input.I[5].X)} {0.}
(assert (>= (+ (* sc_12 1100.) of_12) 0.))
; 
; >=  {((sc.input.I[5].O*1100.)+of.input.I[5].O)} {10.}
(assert (<= (+ (* sc_13 1100.) of_13) 10.))
; 
; <=  {((sc.input.I[5].O*1100.)+of.input.I[5].O)} {0.}
(assert (>= (+ (* sc_13 1100.) of_13) 0.))
...
; 
; >=  {((sc.iadd[1].A*1100.)+of.iadd[1].A)} {5.}
(assert (<= (+ (* sc_57 1100.) of_57) 5.))
; 
; <=  {((sc.iadd[1].A*1100.)+of.iadd[1].A)} {0.}
(assert (>= (+ (* sc_57 1100.) of_57) 0.))
; 
...
(assert (= of_30 of_50))
; 
; =  {sc.input.I[4].O} {sc.iadd[0].B}
(assert (= sc_11 sc_53))
; 
; =  {of.input.I[4].O} {of.iadd[0].B}
(assert (= of_11 of_53))
; 
