...
; 
; >=  {((sc.iadd[0].D*-1100.)+of.iadd[0].D)} {5.}
(assert (<= (+ (* sc_50 -1100.) of_50) 5.))
; 
; <=  {((sc.iadd[0].D*-1100.)+of.iadd[0].D)} {0.}
...
; 
; =  {(((sc.iadd[0].C*1100.)+of.iadd[0].C)+sl.max.iadd[0].C)} {5.}
(assert (= (+ (+ (* sc_51 1100.) of_51) sltop_51) 5.))
...
(assert (= of_59 of_2))
; 
; =  {sc.input.I[4].O} {sc.iadd[0].D}
(assert (= sc_11 sc_50))
; 
; =  {of.input.I[4].O} {of.iadd[0].D}
(assert (= of_11 of_50))
; 
