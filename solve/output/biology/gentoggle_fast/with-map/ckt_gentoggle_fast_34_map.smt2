...
(assert (= of_39 of_161))
; 
; =  {sc.input.I[23].O} {sc.iadd[17].A}
(assert (= sc_51 sc_162))
; 
; =  {of.input.I[23].O} {of.iadd[17].A}
(assert (= of_51 of_162))
; 
