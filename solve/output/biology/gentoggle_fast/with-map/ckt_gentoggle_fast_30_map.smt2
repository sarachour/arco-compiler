...
(assert (= (+ (+ (* sc_199 15.6) of_199) sltop_199) 5.))
...
(assert (= of_24 of_119))
; 
; =  {sc.input.I[34].O} {sc.iadd[18].A}
(assert (= sc_28 sc_198))
; 
; =  {of.input.I[34].O} {of.iadd[18].A}
(assert (= of_28 of_198))
; 
...
(assert (= of_76 of_123))
; 
; =  {sc.input.I[33].O} {sc.iadd[18].D}
(assert (= sc_54 sc_196))
; 
; =  {of.input.I[33].O} {of.iadd[18].D}
(assert (= of_54 of_196))
; 
...
(assert (= of_32 of_171))
; 
; =  {sc.switch[13].PROD} {sc.iadd[18].B}
(assert (= sc_8 sc_199))
; 
; =  {of.switch[13].PROD} {of.iadd[18].B}
(assert (= of_8 of_199))
; 
