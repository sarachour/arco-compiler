...
(assert (= of_120 of_64))
; 
; =  {sc.input.I[22].O} {sc.iadd[10].D}
(assert (= sc_55 sc_131))
; 
; =  {of.input.I[22].O} {of.iadd[10].D}
(assert (= of_55 of_131))
; 
...
(assert (= of_130 of_83))
; 
; =  {sc.input.I[21].O} {sc.iadd[10].B}
(assert (= sc_35 sc_134))
; 
; =  {of.input.I[21].O} {of.iadd[10].B}
(assert (= of_35 of_134))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_130 0.) sltop_130 (- sltop_130)) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= sltop_66 0.) sltop_66 (- sltop_66))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_126 0.) slbot_126 (- slbot_126))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= slbot_59 0.) slbot_59 (- slbot_59))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= sltop_58 0.) sltop_58 (- sltop_58))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= sltop_135 0.) sltop_135 (- sltop_135))) (ite (>= sltop_75 0.) sltop_75 (- sltop_75))) (ite (>= slbot_75 0.) slbot_75 (- slbot_75))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_135 0.) slbot_135 (- slbot_135))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= slbot_66 0.) slbot_66 (- slbot_66))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_57 0.) sltop_57 (- sltop_57))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_57 0.) slbot_57 (- slbot_57))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_73 0.) slbot_73 (- slbot_73))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_126 0.) sltop_126 (- sltop_126))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_73 0.) sltop_73 (- sltop_73))) (ite (>= slbot_58 0.) slbot_58 (- slbot_58))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_59 0.) sltop_59 (- sltop_59)))))
(check-sat)
