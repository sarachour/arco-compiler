...
(assert (= (+ (+ (* sc_173 15.6) of_173) sltop_173) 5.))
; 
...
(assert (= of_15 of_163))
; 
; =  {sc.input.I[29].O} {sc.iadd[18].D}
(assert (= sc_19 sc_171))
; 
; =  {of.input.I[29].O} {of.iadd[18].D}
(assert (= of_19 of_171))
; 
...
(assert (= of_55 of_147))
; 
; =  {sc.input.I[27].O} {sc.iadd[18].C}
(assert (= sc_37 sc_172))
; 
; =  {of.input.I[27].O} {of.iadd[18].C}
(assert (= of_37 of_172))
; 
...
(assert (= of_124 of_74))
; 
; =  {sc.input.I[28].O} {sc.iadd[18].B}
(assert (= sc_57 sc_174))
; 
; =  {of.input.I[28].O} {of.iadd[18].B}
(assert (= of_57 of_174))
; 
