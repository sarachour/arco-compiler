...
; 
; =  {(((sc.iadd[14].B*15.6)+of.iadd[14].B)+sl.max.iadd[14].B)} {5.}
(assert (= (+ (+ (* sc_152 15.6) of_152) sltop_152) 5.))
...
(assert (= of_133 of_64))
; 
; =  {sc.input.I[18].O} {sc.iadd[14].C}
(assert (= sc_53 sc_150))
; 
; =  {of.input.I[18].O} {of.iadd[14].C}
(assert (= of_53 of_150))
; 
...
(assert (= of_17 of_141))
; 
; =  {sc.input.I[20].O} {sc.iadd[14].A}
(assert (= sc_15 sc_151))
; 
; =  {of.input.I[20].O} {of.iadd[14].A}
(assert (= of_15 of_151))
; 
...
(assert (= of_3 of_75))
; 
; =  {sc.switch[4].PROD} {sc.iadd[14].B}
(assert (= sc_13 sc_152))
; 
; =  {of.switch[4].PROD} {of.iadd[14].B}
(assert (= of_13 of_152))
; 
...
; 
; =  {sc.input.I[19].O} {sc.iadd[14].D}
(assert (= sc_55 sc_149))
; 
; =  {of.input.I[19].O} {of.iadd[14].D}
(assert (= of_55 of_149))
; 
