...
(assert (= (+ (+ (* sc_127 15.6) of_127) sltop_127) 5.))
; 
...
(assert (= of_78 of_118))
; 
; =  {sc.input.I[18].O} {sc.iadd[10].B}
(assert (= sc_42 sc_128))
; 
; =  {of.input.I[18].O} {of.iadd[10].B}
(assert (= of_42 of_128))
; 
...
(assert (= of_28 of_77))
; 
; =  {sc.input.V[12].O} {sc.vtoi[5].K}
(assert (= sc_90 sc_70))
; 
; =  {of.input.V[12].O} {of.vtoi[5].K}
(assert (= of_90 of_70))
; 
...
(assert (= of_10 of_122))
; 
; =  {sc.input.I[17].O} {sc.iadd[10].C}
(assert (= sc_40 sc_126))
; 
; =  {of.input.I[17].O} {of.iadd[10].C}
(assert (= of_40 of_126))
; 
