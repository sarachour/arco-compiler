...
(assert (= (+ (+ (* sc_87 15.6) of_87) sltop_87) 5.))
...
(assert (= of_88 of_53))
; 
; =  {sc.input.I[12].O} {sc.iadd[0].A}
(assert (= sc_8 sc_86))
; 
; =  {of.input.I[12].O} {of.iadd[0].A}
(assert (= of_8 of_86))
; 
...
(assert (= of_69 of_29))
; 
; =  {sc.input.I[11].O} {sc.iadd[0].D}
(assert (= sc_10 sc_84))
; 
; =  {of.input.I[11].O} {of.iadd[0].D}
(assert (= of_10 of_84))
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_1 0.) sltop_1 (- sltop_1)) (ite (>= sltop_41 0.) sltop_41 (- sltop_41))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_49 0.) slbot_49 (- slbot_49))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= sltop_49 0.) sltop_49 (- sltop_49))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_41 0.) slbot_41 (- slbot_41))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_48 0.) slbot_48 (- slbot_48))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_48 0.) sltop_48 (- sltop_48))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_1 0.) slbot_1 (- slbot_1))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12)))))
(check-sat)
