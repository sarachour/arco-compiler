...
(assert (>= (+ (* sc_68 156.25) of_68) 0.))
; 
; >=  {((sc.input.I[1].O*156.25)+of.input.I[1].O)} {10.}
(assert (<= (+ (* sc_69 156.25) of_69) 10.))
; 
; <=  {((sc.input.I[1].O*156.25)+of.input.I[1].O)} {0.}
(assert (>= (+ (* sc_69 156.25) of_69) 0.))
...
(assert (= (+ (+ (* sc_187 0.) of_187) slbot_187) 0.))
; 
; =  {(((sc.iadd[17].A*15.6)+of.iadd[17].A)+sl.max.iadd[17].A)} {5.}
(assert (= (+ (+ (* sc_187 15.6) of_187) sltop_187) 5.))
; 
...
; 
; =  {sc.input.I[35].O} {sc.iadd[17].D}
(assert (= sc_21 sc_185))
; 
; =  {of.input.I[35].O} {of.iadd[17].D}
(assert (= of_21 of_185))
; 
...
(assert (= of_139 of_86))
; 
; =  {sc.input.I[34].O} {sc.iadd[17].B}
(assert (= sc_25 sc_188))
; 
; =  {of.input.I[34].O} {of.iadd[17].B}
(assert (= of_25 of_188))
; 
...
(assert (= of_69 of_114))
; 
; =  {sc.input.I[33].O} {sc.iadd[17].C}
(assert (= sc_49 sc_186))
; 
; =  {of.input.I[33].O} {of.iadd[17].C}
(assert (= of_49 of_186))
; 
...
(assert (= of_73 of_173))
; 
; =  {sc.switch[4].PROD} {sc.iadd[17].A}
(assert (= sc_13 sc_187))
; 
; =  {of.switch[4].PROD} {of.iadd[17].A}
(assert (= of_13 of_187))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_96 0.) sltop_96 (- sltop_96)) (ite (>= sltop_158 0.) sltop_158 (- sltop_158))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_149 0.) sltop_149 (- sltop_149))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_151 0.) slbot_151 (- slbot_151))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= slbot_158 0.) slbot_158 (- slbot_158))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= sltop_151 0.) sltop_151 (- sltop_151))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= sltop_163 0.) sltop_163 (- sltop_163))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_163 0.) slbot_163 (- slbot_163))) (ite (>= slbot_168 0.) slbot_168 (- slbot_168))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_168 0.) sltop_168 (- sltop_168))) (ite (>= sltop_178 0.) sltop_178 (- sltop_178))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= sltop_147 0.) sltop_147 (- sltop_147))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_169 0.) slbot_169 (- slbot_169))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_178 0.) slbot_178 (- slbot_178))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= slbot_147 0.) slbot_147 (- slbot_147))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_169 0.) sltop_169 (- sltop_169))) (ite (>= slbot_187 0.) slbot_187 (- slbot_187))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= slbot_149 0.) slbot_149 (- slbot_149))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170))) (ite (>= sltop_187 0.) sltop_187 (- sltop_187)))))
(check-sat)
