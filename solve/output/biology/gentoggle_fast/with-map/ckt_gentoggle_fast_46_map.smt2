...
(assert (<= (+ (* sc_33 156.25) of_33) 10.))
; 
; <=  {((sc.input.I[0].O*156.25)+of.input.I[0].O)} {0.}
(assert (>= (+ (* sc_33 156.25) of_33) 0.))
...
(assert (= (+ (+ (* sc_109 305175.78125) of_109) sltop_109) 10.))
; 
...
(assert (= (+ (+ (* sc_112 0.000511998322284) of_112) slbot_112) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[4].GE*156.25)+of.igenebind[4].GE)+sl.max.igenebind[4].GE)} {9.9999999}
(assert (= (+ (+ (* sc_112 156.25) of_112) sltop_112) 9.9999999))
; 
; >=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {10.}
(assert (<= (+ (* sc_111 156.25) of_111) 10.))
; 
; <=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {0.0001}
(assert (>= (+ (* sc_111 156.25) of_111) 0.0001))
(declare-fun slbot_112 () Real)
(declare-fun sltop_112 () Real)
; 
; =  {(((sc.igenebind[4].GE*0.000511998322284)+of.igenebind[4].GE)+sl.min.igenebind[4].GE)} {9.90099009901e-07}
...
(assert (= (+ (+ (* sc_113 -1.) of_113) slbot_113) 0.0001))
; 
; =  {(((sc.igenebind[18].TF*-0.4)+of.igenebind[18].TF)+sl.max.igenebind[18].TF)} {10.}
(assert (= (+ (+ (* sc_113 -0.4) of_113) sltop_113) 10.))
; 
...
(assert (= (+ (+ (* sc_116 0.) of_116) slbot_116) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[18].GE*1.66666666667)+of.igenebind[18].GE)+sl.max.igenebind[18].GE)} {9.9999999}
(assert (= (+ (+ (* sc_116 1.66666666667) of_116) sltop_116) 9.9999999))
; 
...
(assert (= (+ (+ (* sc_152 0.000511998322284) of_152) slbot_152) 1.))
; 
; =  {(((sc.itov[12].K*156.25)+of.itov[12].K)+sl.max.itov[12].K)} {330.}
(assert (= (+ (+ (* sc_152 156.25) of_152) sltop_152) 330.))
(declare-fun slbot_153 () Real)
(declare-fun sltop_153 () Real)
; 
; =  {(((sc.itov[12].Y*0.00204799328914)+of.itov[12].Y)+sl.min.itov[12].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_165 -156.25) of_165) slbot_165) 0.))
; 
; =  {(((sc.iadd[11].D*0.)+of.iadd[11].D)+sl.max.iadd[11].D)} {5.}
(assert (= (+ (+ (* sc_165 0.) of_165) sltop_165) 5.))
; 
; >=  {((sc.iadd[11].C*1.)+of.iadd[11].C)} {5.}
(assert (<= (+ (* sc_166 1.) of_166) 5.))
; 
...
(assert (= (+ (+ (* sc_169 155.25) of_169) sltop_169) 10.))
; 
...
(assert (= sc_108 sc_158))
; 
; =  {of.igenebind[2].GE} {of.itov[0].K}
(assert (= of_108 of_158))
; 
...
(assert (= sc_104 sc_165))
; 
; =  {of.vtoi[3].Y} {of.iadd[11].D}
(assert (= of_104 of_165))
; 
...
(assert (= of_136 of_1))
; 
; =  {sc.input.I[26].O} {sc.igenebind[18].Vmax}
(assert (= sc_39 sc_115))
; 
; =  {of.input.I[26].O} {of.igenebind[18].Vmax}
(assert (= of_39 of_115))
; 
...
(assert (= sc_116 sc_188))
; 
; =  {of.igenebind[18].GE} {of.iadd[17].B}
(assert (= of_116 of_188))
; 
...
(assert (= of_140 of_96))
; 
; =  {sc.input.I[30].O} {sc.iadd[20].D}
(assert (= sc_55 sc_160))
; 
; =  {of.input.I[30].O} {of.iadd[20].D}
(assert (= of_55 of_160))
; 
...
(assert (= sc_142 sc_155))
; 
; =  {of.input.V[16].O} {of.itov[9].K}
(assert (= of_142 of_155))
; 
...
(assert (= of_35 of_176))
; 
; =  {sc.input.I[28].O} {sc.igenebind[18].K}
(assert (= sc_69 sc_114))
; 
; =  {of.input.I[28].O} {of.igenebind[18].K}
(assert (= of_69 of_114))
; 
; =  {sc.igenebind[4].GE} {sc.itov[12].K}
(assert (= sc_112 sc_152))
; 
; =  {of.igenebind[4].GE} {of.itov[12].K}
(assert (= of_112 of_152))
; 
...
(assert (= of_45 of_171))
; 
; =  {sc.input.I[31].O} {sc.iadd[20].A}
(assert (= sc_29 sc_162))
; 
; =  {of.input.I[31].O} {of.iadd[20].A}
(assert (= of_29 of_162))
; 
...
(assert (= sc_164 sc_106))
; 
; =  {of.iadd[20].OUT} {of.igenebind[2].K}
(assert (= of_164 of_106))
; 
...
(assert (= of_126 of_83))
; 
; =  {sc.input.I[29].O} {sc.iadd[20].C}
(assert (= sc_19 sc_161))
; 
; =  {of.input.I[29].O} {of.iadd[20].C}
(assert (= of_19 of_161))
; 
...
(assert (= of_144 of_92))
; 
; =  {sc.input.I[20].O} {sc.itov[12].X}
(assert (= sc_17 sc_151))
; 
; =  {of.input.I[20].O} {of.itov[12].X}
(assert (= of_17 of_151))
; 
...
; 
; =  {sc.input.I[27].O} {sc.iadd[19].C}
(assert (= sc_41 sc_191))
; 
; =  {of.input.I[27].O} {of.iadd[19].C}
(assert (= of_41 of_191))
; 
...
(assert (and (and (= sc_95 sc_79) (= sc_95 sc_88)) (= sc_95 sc_81)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_130 0.) sltop_130 (- sltop_130)) (ite (>= sltop_158 0.) sltop_158 (- sltop_158))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_183 0.) sltop_183 (- sltop_183))) (ite (>= slbot_183 0.) slbot_183 (- slbot_183))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_156 0.) slbot_156 (- slbot_156))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_158 0.) slbot_158 (- slbot_158))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_188 0.) sltop_188 (- sltop_188))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= sltop_163 0.) sltop_163 (- sltop_163))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_194 0.) slbot_194 (- slbot_194))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= slbot_163 0.) slbot_163 (- slbot_163))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_173 0.) sltop_173 (- sltop_173))) (ite (>= sltop_178 0.) sltop_178 (- sltop_178))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= slbot_188 0.) slbot_188 (- slbot_188))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= slbot_169 0.) slbot_169 (- slbot_169))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_178 0.) slbot_178 (- slbot_178))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= sltop_156 0.) sltop_156 (- sltop_156))) (ite (>= slbot_173 0.) slbot_173 (- slbot_173))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_194 0.) sltop_194 (- sltop_194))) (ite (>= sltop_169 0.) sltop_169 (- sltop_169))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113)))))
(check-sat)
