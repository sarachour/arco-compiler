...
(assert (= of_23 of_22))
; 
; >=  {((sc.input.I[13].X*15.6)+of.input.I[13].X)} {10.}
(assert (<= (+ (* sc_22 15.6) of_22) 10.))
; 
; <=  {((sc.input.I[13].X*15.6)+of.input.I[13].X)} {0.}
(assert (>= (+ (* sc_22 15.6) of_22) 0.))
; 
; >=  {((sc.input.I[13].O*15.6)+of.input.I[13].O)} {10.}
(assert (<= (+ (* sc_23 15.6) of_23) 10.))
; 
; <=  {((sc.input.I[13].O*15.6)+of.input.I[13].O)} {0.}
...
(assert (= (+ (+ (* sc_62 156.25) of_62) sltop_62) 3300.))
...
(assert (= (+ (+ (* sc_64 0.) of_64) slbot_64) 0.0001))
; 
...
(assert (= (+ (+ (* sc_65 0.) of_65) slbot_65) 0.0001))
; 
...
(assert (= sc_76 (* 1. sc_77)))
; 
; =  {sc.vadd[1].A} {(1.*sc.vadd[1].C)} {(1.*sc.vadd[1].D)}
(assert (and (= sc_76 (* 1. sc_75)) (= sc_76 (* 1. sc_74))))
; no offset
(assert (= (- (+ of_76 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
; 
; =  {sc.vadd[1].OUT} {(sc.vadd[1].A*1.)}
(assert (= sc_78 (* sc_76 1.)))
; 
; =  {of.vadd[1].OUT} {0.}
(assert (= of_78 0.))
; no scale
...
(assert (and (= sc_76 (* 1. sc_75)) (= sc_76 (* (* 1. sc_74) sc_79))))
; no offset
(assert (= (- (+ of_76 0.) (+ 0. 0.)) 0.))
; no offset
(assert (= 0. 0.))
...
(assert (= (+ (+ (* sc_82 305175.78125) of_82) sltop_82) 3300.))
...
(assert (= (+ (+ (* sc_81 3.2768e-06) of_81) sltop_81) 3300.))
(declare-fun slbot_82 () Real)
(declare-fun sltop_82 () Real)
; 
; =  {(((sc.vtoi[7].Y*0.)+of.vtoi[7].Y)+sl.min.vtoi[7].Y)} {0.00030303030303}
...
(assert (= (+ (+ (* sc_85 0.) of_85) slbot_85) 0.00030303030303))
; 
; =  {(((sc.vtoi[14].Y*1.66666666667)+of.vtoi[14].Y)+sl.max.vtoi[14].Y)} {3300.}
(assert (= (+ (+ (* sc_85 1.66666666667) of_85) sltop_85) 3300.))
...
(assert (= (+ (+ (* sc_88 -156.25) of_88) slbot_88) 0.00030303030303))
; 
; =  {(((sc.vtoi[3].Y*0.)+of.vtoi[3].Y)+sl.max.vtoi[3].Y)} {3300.}
(assert (= (+ (+ (* sc_88 0.) of_88) sltop_88) 3300.))
; 
...
(assert (= (+ (+ (* sc_90 15.6) of_90) sltop_90) 10.))
...
(assert (= (+ (+ (* sc_93 305175.78125) of_93) sltop_93) 10.))
; 
...
(assert (= (+ (+ (* sc_109 0.6) of_109) sltop_109) 3300.))
...
(assert (= (+ (+ (* sc_110 0.6) of_110) sltop_110) 3300.))
...
(assert (= (+ (+ (* sc_134 0.) of_134) slbot_134) 0.0001))
; 
; =  {(((sc.itov[9].X*3.2768e-06)+of.itov[9].X)+sl.max.itov[9].X)} {10.}
(assert (= (+ (+ (* sc_134 3.2768e-06) of_134) sltop_134) 10.))
...
(assert (= (+ (+ (* sc_136 3.2768e-06) of_136) sltop_136) 3300.))
; 
; >=  {((sc.itov[9].K*1.)+of.itov[9].K)} {330.}
(assert (<= (+ (* sc_135 1.) of_135) 330.))
; 
; <=  {((sc.itov[9].K*1.)+of.itov[9].K)} {1.}
(assert (>= (+ (* sc_135 1.) of_135) 1.))
(declare-fun slbot_136 () Real)
(declare-fun sltop_136 () Real)
; 
; =  {(((sc.itov[9].Y*0.)+of.itov[9].Y)+sl.min.itov[9].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_140 -156.25) of_140) slbot_140) 0.))
; 
; =  {(((sc.iadd[11].D*0.)+of.iadd[11].D)+sl.max.iadd[11].D)} {5.}
(assert (= (+ (+ (* sc_140 0.) of_140) sltop_140) 5.))
; 
; >=  {((sc.iadd[11].C*1.)+of.iadd[11].C)} {5.}
(assert (<= (+ (* sc_141 1.) of_141) 5.))
; 
...
(assert (= (+ (+ (* sc_144 -1.) of_144) slbot_144) -10.))
; 
; =  {(((sc.iadd[11].OUT*155.25)+of.iadd[11].OUT)+sl.max.iadd[11].OUT)} {10.}
(assert (= (+ (+ (* sc_144 155.25) of_144) sltop_144) 10.))
; 
...
(assert (= (+ (+ (* sc_149 0.) of_149) slbot_149) -10.))
; 
; =  {(((sc.iadd[6].OUT*305175.78125)+of.iadd[6].OUT)+sl.max.iadd[6].OUT)} {10.}
(assert (= (+ (+ (* sc_149 305175.78125) of_149) sltop_149) 10.))
; 
...
(assert (= (+ (+ (* sc_148 0.) of_148) slbot_148) 0.))
; 
; =  {(((sc.iadd[6].B*305175.78125)+of.iadd[6].B)+sl.max.iadd[6].B)} {5.}
(assert (= (+ (+ (* sc_148 305175.78125) of_148) sltop_148) 5.))
(declare-fun slbot_149 () Real)
(declare-fun sltop_149 () Real)
; 
; =  {(((sc.iadd[6].OUT*0.)+of.iadd[6].OUT)+sl.min.iadd[6].OUT)} {-10.}
...
; 
; =  {(((sc.iadd[17].A*15.6)+of.iadd[17].A)+sl.max.iadd[17].A)} {5.}
(assert (= (+ (+ (* sc_162 15.6) of_162) sltop_162) 5.))
; 
...
(assert (= (+ (+ (* sc_164 15.6) of_164) sltop_164) 10.))
; 
...
(assert (= sc_149 sc_158))
; 
; =  {of.iadd[6].OUT} {of.iadd[5].B}
(assert (= of_149 of_158))
; 
...
(assert (= sc_116 sc_135))
; 
; =  {of.input.V[15].O} {of.itov[9].K}
(assert (= of_116 of_135))
; 
; =  {sc.input.I[25].O} {sc.iadd[17].B}
(assert (= sc_53 sc_163))
; 
; =  {of.input.I[25].O} {of.iadd[17].B}
(assert (= of_53 of_163))
; 
; =  {sc.input.I[26].O} {sc.iadd[17].D}
(assert (= sc_33 sc_160))
; 
; =  {of.input.I[26].O} {of.iadd[17].D}
(assert (= of_33 of_160))
; 
; =  {sc.input.I[18].O} {sc.switch[10].Kmod}
(assert (= sc_59 sc_6))
; 
; =  {of.input.I[18].O} {of.switch[10].Kmod}
(assert (= of_59 of_6))
; 
...
(assert (= of_49 of_145))
; 
; =  {sc.input.I[16].O} {sc.igenebind[2].TF}
(assert (= sc_45 sc_89))
; 
; =  {of.input.I[16].O} {of.igenebind[2].TF}
(assert (= of_45 of_89))
; 
...
(assert (= of_120 of_1))
; 
; =  {sc.switch[15].PROD} {sc.iadd[17].A}
(assert (= sc_13 sc_162))
; 
; =  {of.switch[15].PROD} {of.iadd[17].A}
(assert (= of_13 of_162))
; 
...
(assert (= of_112 of_67))
; 
; =  {sc.input.I[14].O} {sc.itov[0].X}
(assert (= sc_41 sc_137))
; 
; =  {of.input.I[14].O} {of.itov[0].X}
(assert (= of_41 of_137))
; 
...
(assert (= of_124 of_76))
; 
; =  {sc.input.I[20].O} {sc.iadd[11].C}
(assert (= sc_17 sc_141))
; 
; =  {of.input.I[20].O} {of.iadd[11].C}
(assert (= of_17 of_141))
; 
...
(assert (= of_43 of_161))
; 
; =  {sc.input.I[15].O} {sc.itov[12].X}
(assert (= sc_37 sc_131))
; 
; =  {of.input.I[15].O} {of.itov[12].X}
(assert (= of_37 of_131))
; 
...
(assert (= of_130 of_0))
; 
; =  {sc.input.I[13].O} {sc.igenebind[2].Vmax}
(assert (= sc_23 sc_91))
; 
; =  {of.input.I[13].O} {of.igenebind[2].Vmax}
(assert (= of_23 of_91))
; 
...
(assert (= of_164 of_90))
; 
; =  {sc.input.I[17].O} {sc.igenebind[4].K}
(assert (= sc_57 sc_94))
; 
; =  {of.input.I[17].O} {of.igenebind[4].K}
(assert (= of_57 of_94))
; 
...
(assert (= of_126 of_75))
; 
; =  {sc.input.I[19].O} {sc.switch[10].Vmax}
(assert (= sc_61 sc_7))
; 
; =  {of.input.I[19].O} {of.switch[10].Vmax}
(assert (= of_61 of_7))
; 
...
(assert (= of_31 of_152))
(assert (<= (* (/ 1. sc_63) 0.001) 0.1))
(assert (<= (* (/ 1. sc_65) 0.001) 0.1))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[13].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_79 sc_63) (= sc_79 sc_72)) (= sc_79 sc_65)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= slbot_92 0.) slbot_92 (- slbot_92))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_158 0.) sltop_158 (- sltop_158))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_149 0.) sltop_149 (- sltop_149))) (ite (>= sltop_65 0.) sltop_65 (- sltop_65))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_133 0.) slbot_133 (- slbot_133))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_138 0.) sltop_138 (- sltop_138))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= sltop_132 0.) sltop_132 (- sltop_132))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= sltop_133 0.) sltop_133 (- sltop_133))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_138 0.) slbot_138 (- slbot_138))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= sltop_64 0.) sltop_64 (- sltop_64))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_158 0.) slbot_158 (- slbot_158))) (ite (>= sltop_153 0.) sltop_153 (- sltop_153))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_139 0.) slbot_139 (- slbot_139))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= slbot_153 0.) slbot_153 (- slbot_153))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= sltop_139 0.) sltop_139 (- sltop_139))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= slbot_132 0.) slbot_132 (- slbot_132))) (ite (>= slbot_134 0.) slbot_134 (- slbot_134))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_144 0.) slbot_144 (- slbot_144))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_64 0.) slbot_64 (- slbot_64))) (ite (>= sltop_71 0.) sltop_71 (- sltop_71))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_71 0.) slbot_71 (- slbot_71))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= slbot_65 0.) slbot_65 (- slbot_65))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_134 0.) sltop_134 (- sltop_134))) (ite (>= sltop_148 0.) sltop_148 (- sltop_148))) (ite (>= slbot_148 0.) slbot_148 (- slbot_148))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_149 0.) slbot_149 (- slbot_149))) (ite (>= sltop_144 0.) sltop_144 (- sltop_144)))))
(check-sat)
