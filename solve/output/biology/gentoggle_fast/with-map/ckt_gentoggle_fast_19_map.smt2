...
(assert (= (+ (+ (* sc_122 0.) of_122) slbot_122) 0.))
; 
; =  {(((sc.iadd[12].A*15.6)+of.iadd[12].A)+sl.max.iadd[12].A)} {5.}
(assert (= (+ (+ (* sc_122 15.6) of_122) sltop_122) 5.))
; 
...
(assert (= of_114 of_53))
; 
; =  {sc.input.I[18].O} {sc.iadd[12].B}
(assert (= sc_42 sc_123))
; 
; =  {of.input.I[18].O} {of.iadd[12].B}
(assert (= of_42 of_123))
; 
...
(assert (= of_96 of_0))
; 
; =  {sc.input.V[12].O} {sc.vtoi[7].K}
(assert (= sc_90 sc_70))
; 
; =  {of.input.V[12].O} {of.vtoi[7].K}
(assert (= of_90 of_70))
; 
...
(assert (= of_119 of_2))
; 
; =  {sc.input.I[19].O} {sc.iadd[12].D}
(assert (= sc_44 sc_120))
; 
; =  {of.input.I[19].O} {of.iadd[12].D}
(assert (= of_44 of_120))
; 
