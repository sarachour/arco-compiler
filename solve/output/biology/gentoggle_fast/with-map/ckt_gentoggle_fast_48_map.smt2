...
(assert (= (+ (+ (* sc_193 0.) of_193) slbot_193) 0.))
; 
; =  {(((sc.iadd[18].B*15.6)+of.iadd[18].B)+sl.max.iadd[18].B)} {5.}
(assert (= (+ (+ (* sc_193 15.6) of_193) sltop_193) 5.))
