...
(assert (= (+ (+ (* sc_124 15.6) of_124) sltop_124) 10.))
...
(assert (= (+ (+ (* sc_129 1.66666666667) of_129) sltop_129) 10.))
; 
...
(assert (= (+ (+ (* sc_128 1.66666666667) of_128) sltop_128) 5.))
(declare-fun slbot_129 () Real)
(declare-fun sltop_129 () Real)
; 
; =  {(((sc.iadd[9].OUT*0.)+of.iadd[9].OUT)+sl.min.iadd[9].OUT)} {-10.}
...
(assert (= (+ (+ (* sc_130 -0.6) of_130) slbot_130) 0.))
; 
; =  {(((sc.iadd[11].D*0.)+of.iadd[11].D)+sl.max.iadd[11].D)} {5.}
(assert (= (+ (+ (* sc_130 0.) of_130) sltop_130) 5.))
; 
; >=  {((sc.iadd[11].C*1.)+of.iadd[11].C)} {5.}
(assert (<= (+ (* sc_131 1.) of_131) 5.))
; 
...
(assert (= (+ (+ (* sc_134 -1.) of_134) slbot_134) -10.))
; 
; =  {(((sc.iadd[11].OUT*-0.4)+of.iadd[11].OUT)+sl.max.iadd[11].OUT)} {10.}
(assert (= (+ (+ (* sc_134 -0.4) of_134) sltop_134) 10.))
; 
...
(assert (= of_114 of_53))
; 
; =  {sc.input.I[22].O} {sc.iadd[12].A}
(assert (= sc_44 sc_122))
; 
; =  {of.input.I[22].O} {of.iadd[12].A}
(assert (= of_44 of_122))
; 
...
(assert (= of_38 of_125))
; 
; =  {sc.input.I[16].O} {sc.igenebind[10].K}
(assert (= sc_34 sc_76))
; 
; =  {of.input.I[16].O} {of.igenebind[10].K}
(assert (= of_34 of_76))
; 
...
(assert (= of_124 of_80))
; 
; =  {sc.input.I[14].O} {sc.igenebind[10].Vmax}
(assert (= sc_32 sc_77))
; 
; =  {of.input.I[14].O} {of.igenebind[10].Vmax}
(assert (= of_32 of_77))
; 
...
(assert (= of_8 of_117))
; 
; =  {sc.input.V[8].O} {sc.vtoi[6].K}
(assert (= sc_86 sc_73))
; 
; =  {of.input.V[8].O} {of.vtoi[6].K}
(assert (= of_86 of_73))
; 
...
(assert (= sc_129 sc_118))
; 
; =  {of.iadd[9].OUT} {of.iadd[8].B}
(assert (= of_129 of_118))
; 
