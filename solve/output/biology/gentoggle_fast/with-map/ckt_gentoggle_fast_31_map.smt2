...
(assert (= of_13 0.))
; 
; >=  {((sc.switch[12].n*-500.)+of.switch[12].n)} {3300.}
(assert (<= (+ (* sc_9 -500.) of_9) 3300.))
; 
; <=  {((sc.switch[12].n*-500.)+of.switch[12].n)} {0.5}
(assert (>= (+ (* sc_9 -500.) of_9) 0.5))
; 
; >=  {((sc.switch[12].SUB*-2.)+of.switch[12].SUB)} {10.}
(assert (<= (+ (* sc_10 -2.) of_10) 10.))
; 
; <=  {((sc.switch[12].SUB*-2.)+of.switch[12].SUB)} {0.0001}
...
; 
; =  {(((sc.switch[12].PROD*-0.6)+of.switch[12].PROD)+sl.min.switch[12].PROD)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_13 -0.6) of_13) slbot_13) 9.99934002508e-38))
; 
; =  {(((sc.switch[12].PROD*0.)+of.switch[12].PROD)+sl.max.switch[12].PROD)} {9.9999999}
...
; 
; =  {(((sc.switch[12].Vmax*0.6)+of.switch[12].Vmax)+sl.max.switch[12].Vmax)} {10.}
...
(assert (= (+ (+ (* sc_105 0.00204799328914) of_105) slbot_105) -1650.))
; 
; =  {(((sc.vadd[19].OUT*625.)+of.vadd[19].OUT)+sl.max.vadd[19].OUT)} {1650.}
(assert (= (+ (+ (* sc_105 625.) of_105) sltop_105) 1650.))
(declare-fun slbot_106 () Real)
(declare-fun sltop_106 () Real)
; 
; =  {(((sc.vadd[19].OUT2*0.)+of.vadd[19].OUT2)+sl.min.vadd[19].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_117 -1.) of_117) slbot_117) 0.0001))
; 
; =  {(((sc.igenebind[16].TF*-0.4)+of.igenebind[16].TF)+sl.max.igenebind[16].TF)} {10.}
(assert (= (+ (+ (* sc_117 -0.4) of_117) sltop_117) 10.))
; 
...
(assert (= (+ (+ (* sc_120 0.) of_120) slbot_120) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[16].GE*1.66666666667)+of.igenebind[16].GE)+sl.max.igenebind[16].GE)} {9.9999999}
(assert (= (+ (+ (* sc_120 1.66666666667) of_120) sltop_120) 9.9999999))
; 
...
(assert (= (+ (+ (* sc_121 0.) of_121) slbot_121) 0.0001))
; 
; =  {(((sc.igenebind[4].TF*305175.78125)+of.igenebind[4].TF)+sl.max.igenebind[4].TF)} {10.}
(assert (= (+ (+ (* sc_121 305175.78125) of_121) sltop_121) 10.))
; 
...
(assert (= (+ (+ (* sc_124 0.000511998322284) of_124) slbot_124) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[4].GE*156.25)+of.igenebind[4].GE)+sl.max.igenebind[4].GE)} {9.9999999}
(assert (= (+ (+ (* sc_124 156.25) of_124) sltop_124) 9.9999999))
; 
; >=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {10.}
(assert (<= (+ (* sc_123 156.25) of_123) 10.))
; 
; <=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {0.0001}
(assert (>= (+ (* sc_123 156.25) of_123) 0.0001))
(declare-fun slbot_124 () Real)
(declare-fun sltop_124 () Real)
; 
; =  {(((sc.igenebind[4].GE*0.000511998322284)+of.igenebind[4].GE)+sl.min.igenebind[4].GE)} {9.90099009901e-07}
...
(assert (= (+ (+ (* sc_157 3.2768e-06) of_157) sltop_157) 10.))
...
(assert (= (+ (+ (* sc_159 3.2768e-06) of_159) sltop_159) 3300.))
; 
...
(assert (= (+ (+ (* sc_161 0.939759036145) of_161) slbot_161) 1.))
; 
; =  {(((sc.itov[0].K*15.6)+of.itov[0].K)+sl.max.itov[0].K)} {330.}
(assert (= (+ (+ (* sc_161 15.6) of_161) sltop_161) 330.))
(declare-fun slbot_162 () Real)
(declare-fun sltop_162 () Real)
; 
; =  {(((sc.itov[0].Y*3.75903614458)+of.itov[0].Y)+sl.min.itov[0].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_198 15.6) of_198) sltop_198) 5.))
; 
...
(assert (= (+ (+ (* sc_200 15.6) of_200) sltop_200) 10.))
; 
; =  {sc.igenebind[2].GE} {sc.itov[0].K}
(assert (= sc_116 sc_161))
; 
; =  {of.igenebind[2].GE} {of.itov[0].K}
(assert (= of_116 of_161))
; 
...
(assert (= of_99 of_89))
; 
; =  {sc.input.I[0].O} {sc.switch[12].Vmax}
(assert (= sc_40 sc_12))
; 
; =  {of.input.I[0].O} {of.switch[12].Vmax}
(assert (= of_40 of_12))
; 
; =  {sc.vtoi[3].Y} {sc.iadd[11].D}
(assert (= sc_112 sc_166))
; 
; =  {of.vtoi[3].Y} {of.iadd[11].D}
(assert (= of_112 of_166))
; 
...
; 
; =  {sc.input.I[22].O} {sc.itov[18].X}
(assert (= sc_88 sc_163))
; 
; =  {of.input.I[22].O} {of.itov[18].X}
(assert (= of_88 of_163))
; 
...
(assert (= of_148 of_1))
; 
; =  {sc.input.I[35].O} {sc.iadd[18].C}
(assert (= sc_26 sc_197))
; 
; =  {of.input.I[35].O} {of.iadd[18].C}
(assert (= of_26 of_197))
; 
; =  {sc.input.I[14].O} {sc.iadd[15].A}
(assert (= sc_58 sc_173))
; 
; =  {of.input.I[14].O} {of.iadd[15].A}
(assert (= of_58 of_173))
; 
; =  {sc.input.V[11].O} {sc.vadd[19].D}
(assert (= sc_140 sc_101))
; 
; =  {of.input.V[11].O} {of.vadd[19].D}
(assert (= of_140 of_101))
; 
...
(assert (= of_68 of_192))
; 
; =  {sc.input.I[36].O} {sc.iadd[18].B}
(assert (= sc_54 sc_199))
; 
; =  {of.input.I[36].O} {of.iadd[18].B}
(assert (= of_54 of_199))
; 
; =  {sc.iadd[5].OUT} {sc.igenebind[4].TF}
(assert (= sc_190 sc_121))
; 
; =  {of.iadd[5].OUT} {of.igenebind[4].TF}
(assert (= of_190 of_121))
; 
...
(assert (= of_60 of_160))
; 
; =  {sc.input.V[5].O} {sc.vadd[19].A}
(assert (= sc_154 sc_103))
; 
; =  {of.input.V[5].O} {of.vadd[19].A}
(assert (= of_154 of_103))
; 
...
(assert (= sc_120 sc_174))
; 
; =  {of.igenebind[16].GE} {of.iadd[15].B}
(assert (= of_120 of_174))
; 
; =  {sc.input.V[6].O} {sc.vadd[19].OUT2_0}
(assert (= sc_146 sc_100))
; 
; =  {of.input.V[6].O} {of.vadd[19].OUT2_0}
(assert (= of_146 of_100))
; 
; =  {sc.switch[12].PROD} {sc.iadd[17].D}
(assert (= sc_13 sc_191))
; 
; =  {of.switch[12].PROD} {of.iadd[17].D}
(assert (= of_13 of_191))
; 
...
(assert (= of_185 of_6))
; 
; =  {sc.input.I[28].O} {sc.switch[12].Kmod}
(assert (= sc_80 sc_11))
; 
; =  {of.input.I[28].O} {of.switch[12].Kmod}
(assert (= of_80 of_11))
; 
...
(assert (= sc_124 sc_164))
; 
; =  {of.igenebind[4].GE} {of.itov[18].K}
(assert (= of_124 of_164))
; 
...
(assert (= of_52 of_178))
; 
; =  {sc.input.I[31].O} {sc.igenebind[16].K}
(assert (= sc_38 sc_118))
; 
; =  {of.input.I[31].O} {of.igenebind[16].K}
(assert (= of_38 of_118))
; 
...
(assert (= of_3 of_108))
; 
; =  {sc.input.I[37].O} {sc.iadd[18].D}
(assert (= sc_56 sc_196))
; 
; =  {of.input.I[37].O} {of.iadd[18].D}
(assert (= of_56 of_196))
; 
...
; 
; =  {sc.input.I[18].O} {sc.switch[13].SUB}
(assert (= sc_84 sc_5))
; 
; =  {of.input.I[18].O} {of.switch[13].SUB}
(assert (= of_84 of_5))
; 
...
(assert (= of_106 of_7))
; 
; =  {sc.input.V[8].O} {sc.switch[12].n}
(assert (= sc_128 sc_9))
; 
; =  {of.input.V[8].O} {of.switch[12].n}
(assert (= of_128 of_9))
; 
...
(assert (= of_20 of_186))
; 
; =  {sc.input.V[12].O} {sc.switch[13].n}
(assert (= sc_134 sc_4))
; 
; =  {of.input.V[12].O} {of.switch[13].n}
(assert (= of_134 of_4))
; 
...
(assert (= of_150 of_95))
; 
; =  {sc.input.I[20].O} {sc.switch[12].SUB}
(assert (= sc_22 sc_10))
; 
; =  {of.input.I[20].O} {of.switch[12].SUB}
(assert (= of_22 of_10))
; 
...
(assert (= of_126 of_96))
; 
; =  {sc.input.I[29].O} {sc.igenebind[16].Vmax}
(assert (= sc_24 sc_119))
; 
; =  {of.input.I[29].O} {of.igenebind[16].Vmax}
(assert (= of_24 of_119))
; 
; =  {sc.input.I[15].O} {sc.iadd[15].C}
(assert (= sc_50 sc_172))
; 
; =  {of.input.I[15].O} {of.iadd[15].C}
(assert (= of_50 of_172))
; 
...
(assert (= of_156 of_14))
; 
; =  {sc.input.I[13].O} {sc.iadd[15].D}
(assert (= sc_32 sc_171))
; 
; =  {of.input.I[13].O} {of.iadd[15].D}
(assert (= of_32 of_171))
; 
...
(assert (= of_8 of_198))
; 
; =  {sc.input.I[17].O} {sc.iadd[17].B}
(assert (= sc_82 sc_194))
; 
; =  {of.input.I[17].O} {of.iadd[17].B}
(assert (= of_82 of_194))
; 
...
(assert (= of_86 of_115))
; 
; =  {sc.input.V[4].O} {sc.vadd[19].C}
(assert (= sc_152 sc_102))
; 
; =  {of.input.V[4].O} {of.vadd[19].C}
(assert (= of_152 of_102))
(assert (<= (* (/ 1. sc_90) 0.001) 0.1))
(assert (<= (* (/ 1. sc_92) 0.001) 0.1))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[19].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_99 sc_90) (= sc_99 sc_106)) (= sc_99 sc_92)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_175 0.) slbot_175 (- slbot_175))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_104 0.) sltop_104 (- sltop_104))) (ite (>= sltop_164 0.) sltop_164 (- sltop_164))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_166 0.) sltop_166 (- sltop_166))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= slbot_124 0.) slbot_124 (- slbot_124))) (ite (>= slbot_116 0.) slbot_116 (- slbot_116))) (ite (>= slbot_166 0.) slbot_166 (- slbot_166))) (ite (>= slbot_104 0.) slbot_104 (- slbot_104))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= sltop_110 0.) sltop_110 (- sltop_110))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_180 0.) sltop_180 (- sltop_180))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_161 0.) sltop_161 (- sltop_161))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= sltop_198 0.) sltop_198 (- sltop_198))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_110 0.) slbot_110 (- slbot_110))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= slbot_161 0.) slbot_161 (- slbot_161))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= sltop_175 0.) sltop_175 (- sltop_175))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= slbot_198 0.) slbot_198 (- slbot_198))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= sltop_116 0.) sltop_116 (- sltop_116))) (ite (>= sltop_124 0.) sltop_124 (- sltop_124))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= slbot_180 0.) slbot_180 (- slbot_180))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= slbot_164 0.) slbot_164 (- slbot_164))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170)))))
(check-sat)
