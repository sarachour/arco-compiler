...
(assert (= of_44 of_121))
; 
; =  {sc.input.I[26].O} {sc.iadd[12].A}
(assert (= sc_24 sc_123))
; 
; =  {of.input.I[26].O} {of.iadd[12].A}
(assert (= of_24 of_123))
; 
