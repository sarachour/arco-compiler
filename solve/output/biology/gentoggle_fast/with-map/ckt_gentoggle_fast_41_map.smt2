...
(assert (= of_88 of_87))
; 
; >=  {((sc.input.I[22].X*-0.5)+of.input.I[22].X)} {10.}
(assert (<= (+ (* sc_87 -0.5) of_87) 10.))
; 
; <=  {((sc.input.I[22].X*-0.5)+of.input.I[22].X)} {0.}
(assert (>= (+ (* sc_87 -0.5) of_87) 0.))
; 
; >=  {((sc.input.I[22].O*-0.5)+of.input.I[22].O)} {10.}
(assert (<= (+ (* sc_88 -0.5) of_88) 10.))
; 
; <=  {((sc.input.I[22].O*-0.5)+of.input.I[22].O)} {0.}
(assert (>= (+ (* sc_88 -0.5) of_88) 0.))
...
(assert (= (+ (+ (* sc_168 15.6) of_168) sltop_168) 5.))
; 
...
(assert (= of_18 of_196))
; 
; =  {sc.input.I[21].O} {sc.itov[12].X}
(assert (= sc_60 sc_157))
; 
; =  {of.input.I[21].O} {of.itov[12].X}
(assert (= of_60 of_157))
; 
...
(assert (= of_146 of_93))
; 
; =  {sc.input.I[28].O} {sc.switch[14].SUB}
(assert (= sc_80 sc_15))
; 
; =  {of.input.I[28].O} {of.switch[14].SUB}
(assert (= of_80 of_15))
; 
