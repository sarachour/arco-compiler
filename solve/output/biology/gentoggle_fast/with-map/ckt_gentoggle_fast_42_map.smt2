...
(assert (= (+ (+ (* sc_36 0.6) of_36) sltop_36) 10.))
...
(assert (= (+ (+ (* sc_94 3.75903614458) of_94) slbot_94) 0.))
; 
...
(assert (= (+ (+ (* sc_95 3.75903614458) of_95) slbot_95) -1650.))
; 
; =  {(((sc.vadd[1].OUT*62.4)+of.vadd[1].OUT)+sl.max.vadd[1].OUT)} {1650.}
(assert (= (+ (+ (* sc_95 62.4) of_95) sltop_95) 1650.))
(declare-fun slbot_96 () Real)
(declare-fun sltop_96 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_102 0.00204799328914) of_102) slbot_102) -1650.))
; 
; =  {(((sc.vadd[19].OUT*625.)+of.vadd[19].OUT)+sl.max.vadd[19].OUT)} {1650.}
(assert (= (+ (+ (* sc_102 625.) of_102) sltop_102) 1650.))
(declare-fun slbot_103 () Real)
(declare-fun sltop_103 () Real)
; 
; =  {(((sc.vadd[19].OUT2*0.)+of.vadd[19].OUT2)+sl.min.vadd[19].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_114 -1.) of_114) slbot_114) 0.0001))
; 
; =  {(((sc.igenebind[16].TF*-0.4)+of.igenebind[16].TF)+sl.max.igenebind[16].TF)} {10.}
(assert (= (+ (+ (* sc_114 -0.4) of_114) sltop_114) 10.))
; 
...
(assert (= (+ (+ (* sc_117 0.) of_117) slbot_117) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[16].GE*1.66666666667)+of.igenebind[16].GE)+sl.max.igenebind[16].GE)} {9.9999999}
(assert (= (+ (+ (* sc_117 1.66666666667) of_117) sltop_117) 9.9999999))
; 
...
(assert (= (+ (+ (* sc_118 305175.78125) of_118) sltop_118) 10.))
; 
...
(assert (= (+ (+ (* sc_121 0.000511998322284) of_121) slbot_121) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[4].GE*156.25)+of.igenebind[4].GE)+sl.max.igenebind[4].GE)} {9.9999999}
(assert (= (+ (+ (* sc_121 156.25) of_121) sltop_121) 9.9999999))
; 
; >=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {10.}
(assert (<= (+ (* sc_120 156.25) of_120) 10.))
; 
; <=  {((sc.igenebind[4].Vmax*156.25)+of.igenebind[4].Vmax)} {0.0001}
(assert (>= (+ (* sc_120 156.25) of_120) 0.0001))
(declare-fun slbot_121 () Real)
(declare-fun sltop_121 () Real)
; 
; =  {(((sc.igenebind[4].GE*0.000511998322284)+of.igenebind[4].GE)+sl.min.igenebind[4].GE)} {9.90099009901e-07}
...
(assert (= (+ (+ (* sc_152 3.2768e-06) of_152) sltop_152) 10.))
...
(assert (= (+ (+ (* sc_156 0.939759036145) of_156) slbot_156) 1.))
; 
; =  {(((sc.itov[0].K*15.6)+of.itov[0].K)+sl.max.itov[0].K)} {330.}
(assert (= (+ (+ (* sc_156 15.6) of_156) sltop_156) 330.))
(declare-fun slbot_157 () Real)
(declare-fun sltop_157 () Real)
; 
; =  {(((sc.itov[0].Y*3.75903614458)+of.itov[0].Y)+sl.min.itov[0].Y)} {0.0001}
...
; 
; =  {(((sc.iadd[12].C*0.)+of.iadd[12].C)+sl.min.iadd[12].C)} {0.}
(assert (= (+ (+ (* sc_162 0.) of_162) slbot_162) 0.))
; 
; =  {(((sc.iadd[12].C*0.6)+of.iadd[12].C)+sl.max.iadd[12].C)} {5.}
(assert (= (+ (+ (* sc_162 0.6) of_162) sltop_162) 5.))
(declare-fun slbot_165 () Real)
(declare-fun sltop_165 () Real)
; 
; =  {(((sc.iadd[12].OUT*-0.6)+of.iadd[12].OUT)+sl.min.iadd[12].OUT)} {-10.}
(assert (= (+ (+ (* sc_165 -0.6) of_165) slbot_165) -10.))
; 
; =  {(((sc.iadd[12].OUT*0.)+of.iadd[12].OUT)+sl.max.iadd[12].OUT)} {10.}
(assert (= (+ (+ (* sc_165 0.) of_165) sltop_165) 10.))
; 
...
(assert (= sc_113 sc_156))
; 
; =  {of.igenebind[2].GE} {of.itov[0].K}
(assert (= of_113 of_156))
; 
...
(assert (= of_96 of_86))
; 
; =  {sc.input.I[0].O} {sc.iadd[12].C}
(assert (= sc_37 sc_162))
; 
; =  {of.input.I[0].O} {of.iadd[12].C}
(assert (= of_37 of_162))
; 
...
(assert (= of_85 of_112))
; 
; =  {sc.input.I[32].O} {sc.igenebind[16].K}
(assert (= sc_83 sc_115))
; 
; =  {of.input.I[32].O} {of.igenebind[16].K}
(assert (= of_83 of_115))
; 
...
(assert (= sc_106 sc_179))
; 
; =  {of.vtoi[7].Y} {of.iadd[6].B}
(assert (= of_106 of_179))
; 
; =  {sc.input.V[14].O} {sc.itov[9].K}
(assert (= sc_143 sc_153))
; 
; =  {of.input.V[14].O} {of.itov[9].K}
(assert (= of_143 of_153))
; 
; =  {sc.iadd[12].OUT} {sc.iadd[17].D}
(assert (= sc_165 sc_191))
; 
; =  {of.iadd[12].OUT} {of.iadd[17].D}
(assert (= of_165 of_191))
; 
; =  {sc.input.I[35].O} {sc.iadd[18].A}
(assert (= sc_21 sc_198))
; 
; =  {of.input.I[35].O} {of.iadd[18].A}
(assert (= of_21 of_198))
; 
; =  {sc.input.I[14].O} {sc.iadd[14].A}
(assert (= sc_53 sc_183))
; 
; =  {of.input.I[14].O} {of.iadd[14].A}
(assert (= of_53 of_183))
; 
; =  {sc.input.I[30].O} {sc.igenebind[16].Vmax}
(assert (= sc_63 sc_116))
; 
; =  {of.input.I[30].O} {of.igenebind[16].Vmax}
(assert (= of_63 of_116))
; 
; =  {sc.input.V[11].O} {sc.switch[13].n}
(assert (= sc_137 sc_4))
; 
; =  {of.input.V[11].O} {of.switch[13].n}
(assert (= of_137 of_4))
; 
; =  {sc.iadd[5].OUT} {sc.igenebind[4].TF}
(assert (= sc_190 sc_118))
; 
; =  {of.iadd[5].OUT} {of.igenebind[4].TF}
(assert (= of_190 of_118))
; 
...
(assert (= of_157 of_94))
; 
; =  {sc.input.I[24].O} {sc.itov[18].X}
(assert (= sc_59 sc_158))
; 
; =  {of.input.I[24].O} {of.itov[18].X}
(assert (= of_59 of_158))
; 
; =  {sc.input.I[12].O} {sc.iadd[12].B}
(assert (= sc_31 sc_164))
; 
; =  {of.input.I[12].O} {of.iadd[12].B}
(assert (= of_31 of_164))
; 
; =  {sc.input.I[10].O} {sc.iadd[12].A}
(assert (= sc_41 sc_163))
; 
; =  {of.input.I[10].O} {of.iadd[12].A}
(assert (= of_41 of_163))
; 
...
(assert (= of_23 of_168))
; 
; =  {sc.input.I[21].O} {sc.switch[13].SUB}
(assert (= sc_55 sc_5))
; 
; =  {of.input.I[21].O} {of.switch[13].SUB}
(assert (= of_55 of_5))
; 
...
(assert (= sc_149 sc_100))
; 
; =  {of.input.V[5].O} {of.vadd[19].A}
(assert (= of_149 of_100))
; 
...
(assert (= sc_117 sc_174))
; 
; =  {of.igenebind[16].GE} {of.iadd[15].B}
(assert (= of_117 of_174))
; 
...
(assert (= sc_121 sc_159))
; 
; =  {of.igenebind[4].GE} {of.itov[18].K}
(assert (= of_121 of_159))
; 
...
(assert (= of_133 of_91))
; 
; =  {sc.input.I[18].O} {sc.iadd[15].C}
(assert (= sc_79 sc_172))
; 
; =  {of.input.I[18].O} {of.iadd[15].C}
(assert (= of_79 of_172))
; 
...
(assert (= of_65 of_187))
; 
; =  {sc.input.I[16].O} {sc.iadd[15].D}
(assert (= sc_57 sc_171))
; 
; =  {of.input.I[16].O} {of.iadd[15].D}
(assert (= of_57 of_171))
; 
...
(assert (= of_123 of_93))
; 
; =  {sc.input.I[20].O} {sc.iadd[17].B}
(assert (= sc_17 sc_194))
; 
; =  {of.input.I[20].O} {of.iadd[17].B}
(assert (= of_17 of_194))
; 
...
(assert (= of_25 of_196))
; 
; =  {sc.input.I[15].O} {sc.iadd[14].C}
(assert (= sc_47 sc_182))
; 
; =  {of.input.I[15].O} {of.iadd[14].C}
(assert (= of_47 of_182))
; 
...
(assert (= of_73 of_120))
; 
; =  {sc.input.I[33].O} {sc.iadd[18].C}
(assert (= sc_51 sc_197))
; 
; =  {of.input.I[33].O} {of.iadd[18].C}
(assert (= of_51 of_197))
; 
; =  {sc.input.I[13].O} {sc.iadd[14].D}
(assert (= sc_29 sc_181))
; 
; =  {of.input.I[13].O} {of.iadd[14].D}
(assert (= of_29 of_181))
; 
...
(assert (= of_127 of_90))
; 
; =  {sc.input.I[17].O} {sc.iadd[15].A}
(assert (= sc_77 sc_173))
; 
; =  {of.input.I[17].O} {of.iadd[15].A}
(assert (= of_77 of_173))
; 
...
(assert (= of_135 of_0))
; 
; =  {sc.input.V[10].O} {sc.vadd[19].D}
(assert (= sc_139 sc_98))
; 
; =  {of.input.V[10].O} {of.vadd[19].D}
(assert (= of_139 of_98))
; 
...
(assert (= of_147 of_99))
; 
; =  {sc.input.I[19].O} {sc.iadd[17].A}
(assert (= sc_81 sc_193))
; 
; =  {of.input.I[19].O} {of.iadd[17].A}
(assert (= of_81 of_193))
(assert (<= (* (/ 1. sc_87) 0.001) 0.1))
(assert (<= (* (/ 1. sc_89) 0.001) 0.1))
; 
; =  {sc.vadd[1].OUT2} {sc.output.V[0].O} {sc.vadd[19].OUT2} {sc.output.V[1].O}
(assert (and (and (= sc_96 sc_87) (= sc_96 sc_103)) (= sc_96 sc_89)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_199 0.) sltop_199 (- sltop_199))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_175 0.) slbot_175 (- slbot_175))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_189 0.) slbot_189 (- slbot_189))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_157 0.) slbot_157 (- slbot_157))) (ite (>= slbot_179 0.) slbot_179 (- slbot_179))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_190 0.) sltop_190 (- sltop_190))) (ite (>= slbot_191 0.) slbot_191 (- slbot_191))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= slbot_159 0.) slbot_159 (- slbot_159))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_199 0.) slbot_199 (- slbot_199))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_109 0.) sltop_109 (- sltop_109))) (ite (>= sltop_121 0.) sltop_121 (- sltop_121))) (ite (>= sltop_166 0.) sltop_166 (- sltop_166))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_95 0.) slbot_95 (- slbot_95))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= slbot_166 0.) slbot_166 (- slbot_166))) (ite (>= sltop_152 0.) sltop_152 (- sltop_152))) (ite (>= sltop_157 0.) sltop_157 (- sltop_157))) (ite (>= slbot_190 0.) slbot_190 (- slbot_190))) (ite (>= slbot_200 0.) slbot_200 (- slbot_200))) (ite (>= sltop_189 0.) sltop_189 (- sltop_189))) (ite (>= sltop_154 0.) sltop_154 (- sltop_154))) (ite (>= slbot_174 0.) slbot_174 (- slbot_174))) (ite (>= slbot_162 0.) slbot_162 (- slbot_162))) (ite (>= slbot_170 0.) slbot_170 (- slbot_170))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_156 0.) slbot_156 (- slbot_156))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_121 0.) slbot_121 (- slbot_121))) (ite (>= sltop_180 0.) sltop_180 (- sltop_180))) (ite (>= sltop_195 0.) sltop_195 (- sltop_195))) (ite (>= sltop_165 0.) sltop_165 (- sltop_165))) (ite (>= slbot_152 0.) slbot_152 (- slbot_152))) (ite (>= sltop_200 0.) sltop_200 (- sltop_200))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= sltop_159 0.) sltop_159 (- sltop_159))) (ite (>= sltop_162 0.) sltop_162 (- sltop_162))) (ite (>= slbot_185 0.) slbot_185 (- slbot_185))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_179 0.) sltop_179 (- sltop_179))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_175 0.) sltop_175 (- sltop_175))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_118 0.) sltop_118 (- sltop_118))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= slbot_165 0.) slbot_165 (- slbot_165))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= sltop_184 0.) sltop_184 (- sltop_184))) (ite (>= slbot_109 0.) slbot_109 (- slbot_109))) (ite (>= slbot_160 0.) slbot_160 (- slbot_160))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_154 0.) slbot_154 (- slbot_154))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= slbot_117 0.) slbot_117 (- slbot_117))) (ite (>= sltop_117 0.) sltop_117 (- sltop_117))) (ite (>= sltop_174 0.) sltop_174 (- sltop_174))) (ite (>= slbot_180 0.) slbot_180 (- slbot_180))) (ite (>= slbot_113 0.) slbot_113 (- slbot_113))) (ite (>= slbot_106 0.) slbot_106 (- slbot_106))) (ite (>= slbot_195 0.) slbot_195 (- slbot_195))) (ite (>= sltop_156 0.) sltop_156 (- sltop_156))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= slbot_184 0.) slbot_184 (- slbot_184))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= sltop_95 0.) sltop_95 (- sltop_95))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= slbot_118 0.) slbot_118 (- slbot_118))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_106 0.) sltop_106 (- sltop_106))) (ite (>= sltop_160 0.) sltop_160 (- sltop_160))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_185 0.) sltop_185 (- sltop_185))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_113 0.) sltop_113 (- sltop_113))) (ite (>= sltop_191 0.) sltop_191 (- sltop_191))) (ite (>= sltop_170 0.) sltop_170 (- sltop_170)))))
(check-sat)
