...
(assert (= (+ (+ (* sc_91 15.6) of_91) sltop_91) 5.))
; 
...
(assert (= of_70 of_50))
; 
; =  {sc.input.V[12].O} {sc.vtoi[6].K}
(assert (= sc_64 sc_48))
; 
; =  {of.input.V[12].O} {of.vtoi[6].K}
(assert (= of_64 of_48))
; 
...
(assert (= of_85 of_38))
; 
; =  {sc.switch[5].PROD} {sc.iadd[0].A}
(assert (= sc_4 sc_91))
; 
; =  {of.switch[5].PROD} {of.iadd[0].A}
(assert (= of_4 of_91))
; 
