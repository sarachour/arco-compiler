...
(assert (<= (+ (* sc_33 4.) of_33) 10.))
; 
; <=  {((sc.input.I[16].X*4.)+of.input.I[16].X)} {0.}
(assert (>= (+ (* sc_33 4.) of_33) 0.))
; 
...
(assert (= (+ (+ (* sc_123 15.6) of_123) sltop_123) 5.))
; 
...
(assert (= (+ (+ (* sc_136 0.6) of_136) sltop_136) 5.))
; 
...
(assert (= of_4 of_123))
; 
; =  {sc.input.V[9].O} {sc.switch[7].n}
(assert (= sc_95 sc_0))
; 
; =  {of.input.V[9].O} {of.switch[7].n}
(assert (= of_95 of_0))
; 
...
(assert (= of_115 of_61))
; 
; =  {sc.input.I[22].O} {sc.iadd[12].B}
(assert (= sc_52 sc_124))
; 
; =  {of.input.I[22].O} {of.iadd[12].B}
(assert (= of_52 of_124))
; 
; =  {sc.input.I[18].O} {sc.igenebind[10].Vmax}
(assert (= sc_48 sc_82))
; 
; =  {of.input.I[18].O} {of.igenebind[10].Vmax}
(assert (= of_48 of_82))
; 
...
(assert (= of_18 of_128))
; 
; =  {sc.input.I[16].O} {sc.itov[4].X}
(assert (= sc_34 sc_110))
; 
; =  {of.input.I[16].O} {of.itov[4].X}
(assert (= of_34 of_110))
; 
...
(assert (= of_89 of_59))
; 
; =  {sc.input.I[20].O} {sc.igenebind[10].K}
(assert (= sc_8 sc_81))
; 
; =  {of.input.I[20].O} {of.igenebind[10].K}
(assert (= of_8 of_81))
; 
...
; 
; =  {sc.input.I[23].O} {sc.iadd[12].D}
(assert (= sc_42 sc_121))
; 
; =  {of.input.I[23].O} {of.iadd[12].D}
(assert (= of_42 of_121))
; 
; =  {sc.input.I[21].O} {sc.iadd[12].C}
(assert (= sc_30 sc_122))
; 
; =  {of.input.I[21].O} {of.iadd[12].C}
(assert (= of_30 of_122))
; 
...
(assert (= of_105 of_66))
; 
; =  {sc.input.I[19].O} {sc.iadd[11].C}
(assert (= sc_50 sc_132))
; 
; =  {of.input.I[19].O} {of.iadd[11].C}
(assert (= of_50 of_132))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_77 0.) sltop_77 (- sltop_77)) (ite (>= sltop_130 0.) sltop_130 (- sltop_130))) (ite (>= slbot_80 0.) slbot_80 (- slbot_80))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_72 0.) slbot_72 (- slbot_72))) (ite (>= sltop_125 0.) sltop_125 (- sltop_125))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= sltop_120 0.) sltop_120 (- sltop_120))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_53 0.) slbot_53 (- slbot_53))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_120 0.) slbot_120 (- slbot_120))) (ite (>= slbot_119 0.) slbot_119 (- slbot_119))) (ite (>= sltop_112 0.) sltop_112 (- sltop_112))) (ite (>= slbot_130 0.) slbot_130 (- slbot_130))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= sltop_111 0.) sltop_111 (- sltop_111))) (ite (>= slbot_125 0.) slbot_125 (- slbot_125))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= slbot_111 0.) slbot_111 (- slbot_111))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_115 0.) slbot_115 (- slbot_115))) (ite (>= slbot_131 0.) slbot_131 (- slbot_131))) (ite (>= sltop_62 0.) sltop_62 (- sltop_62))) (ite (>= slbot_55 0.) slbot_55 (- slbot_55))) (ite (>= slbot_54 0.) slbot_54 (- slbot_54))) (ite (>= slbot_56 0.) slbot_56 (- slbot_56))) (ite (>= sltop_131 0.) sltop_131 (- sltop_131))) (ite (>= sltop_136 0.) sltop_136 (- sltop_136))) (ite (>= slbot_68 0.) slbot_68 (- slbot_68))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_115 0.) sltop_115 (- sltop_115))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_135 0.) sltop_135 (- sltop_135))) (ite (>= sltop_68 0.) sltop_68 (- sltop_68))) (ite (>= slbot_77 0.) slbot_77 (- slbot_77))) (ite (>= slbot_114 0.) slbot_114 (- slbot_114))) (ite (>= slbot_136 0.) slbot_136 (- slbot_136))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= slbot_135 0.) slbot_135 (- slbot_135))) (ite (>= slbot_69 0.) slbot_69 (- slbot_69))) (ite (>= sltop_119 0.) sltop_119 (- sltop_119))) (ite (>= sltop_72 0.) sltop_72 (- sltop_72))) (ite (>= sltop_55 0.) sltop_55 (- sltop_55))) (ite (>= sltop_70 0.) sltop_70 (- sltop_70))) (ite (>= sltop_80 0.) sltop_80 (- sltop_80))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= slbot_112 0.) slbot_112 (- slbot_112))) (ite (>= sltop_114 0.) sltop_114 (- sltop_114))) (ite (>= slbot_140 0.) slbot_140 (- slbot_140))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= slbot_63 0.) slbot_63 (- slbot_63))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= sltop_123 0.) sltop_123 (- sltop_123))) (ite (>= sltop_54 0.) sltop_54 (- sltop_54))) (ite (>= slbot_61 0.) slbot_61 (- slbot_61))) (ite (>= sltop_129 0.) sltop_129 (- sltop_129))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= slbot_129 0.) slbot_129 (- slbot_129))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_62 0.) slbot_62 (- slbot_62))) (ite (>= sltop_56 0.) sltop_56 (- sltop_56))) (ite (>= sltop_140 0.) sltop_140 (- sltop_140))) (ite (>= slbot_70 0.) slbot_70 (- slbot_70))) (ite (>= sltop_53 0.) sltop_53 (- sltop_53))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= slbot_123 0.) slbot_123 (- slbot_123))) (ite (>= sltop_61 0.) sltop_61 (- sltop_61))) (ite (>= sltop_69 0.) sltop_69 (- sltop_69))) (ite (>= sltop_63 0.) sltop_63 (- sltop_63)))))
(check-sat)
