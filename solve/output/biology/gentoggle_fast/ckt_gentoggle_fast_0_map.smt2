...
(declare-fun slbot_14_2 () Real)
(assert (<= slbot_14_2 1e-08))
(declare-fun sltop_14_2 () Real)
(assert (>= sltop_14_2 1e-08))
; 
; =  {(((sc.vdadd[0].OUT*-12.5175903614)+of.vdadd[0].OUT)+sl.min.vdadd[0].OUT.2)} {-120000.}
(assert (= (+ (+ (* sc_14 -12.5175903614) of_14) slbot_14_2) -120000.))
; 
; =  {(((sc.vdadd[0].OUT*13.32)+of.vdadd[0].OUT)+sl.max.vdadd[0].OUT.2)} {6600.}
(assert (= (+ (+ (* sc_14 13.32) of_14) sltop_14_2) 6600.))
; 
...
(declare-fun slbot_19_2 () Real)
(assert (<= slbot_19_2 1e-08))
(declare-fun sltop_19_2 () Real)
(assert (>= sltop_19_2 1e-08))
; 
; =  {(((sc.vdadd[5].OUT*-14.5106145251)+of.vdadd[5].OUT)+sl.min.vdadd[5].OUT.2)} {-120000.}
(assert (= (+ (+ (* sc_19 -14.5106145251) of_19) slbot_19_2) -120000.))
; 
; =  {(((sc.vdadd[5].OUT*15.6)+of.vdadd[5].OUT)+sl.max.vdadd[5].OUT.2)} {3300.}
(assert (= (+ (+ (* sc_19 15.6) of_19) sltop_19_2) 3300.))
; 
...
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_1_1 0.) slbot_1_1 (- slbot_1_1)) (ite (>= slbot_122_1 0.) slbot_122_1 (- slbot_122_1))) (ite (>= sltop_17_1 0.) sltop_17_1 (- sltop_17_1))) (ite (>= sltop_113_1 0.) sltop_113_1 (- sltop_113_1))) (ite (>= slbot_108_1 0.) slbot_108_1 (- slbot_108_1))) (ite (>= slbot_19_1 0.) slbot_19_1 (- slbot_19_1))) (ite (>= sltop_62_1 0.) sltop_62_1 (- sltop_62_1))) (ite (>= slbot_57_1 0.) slbot_57_1 (- slbot_57_1))) (ite (>= sltop_88_1 0.) sltop_88_1 (- sltop_88_1))) (ite (>= slbot_6_1 0.) slbot_6_1 (- slbot_6_1))) (ite (>= slbot_22_1 0.) slbot_22_1 (- slbot_22_1))) (ite (>= sltop_60_1 0.) sltop_60_1 (- sltop_60_1))) (ite (>= sltop_57_1 0.) sltop_57_1 (- sltop_57_1))) (ite (>= sltop_14_2 0.) sltop_14_2 (- sltop_14_2))) (ite (>= slbot_107_1 0.) slbot_107_1 (- slbot_107_1))) (ite (>= sltop_71_1 0.) sltop_71_1 (- sltop_71_1))) (ite (>= sltop_87_1 0.) sltop_87_1 (- sltop_87_1))) (ite (>= slbot_4_1 0.) slbot_4_1 (- slbot_4_1))) (ite (>= sltop_6_1 0.) sltop_6_1 (- sltop_6_1))) (ite (>= sltop_112_1 0.) sltop_112_1 (- sltop_112_1))) (ite (>= sltop_122_1 0.) sltop_122_1 (- sltop_122_1))) (ite (>= sltop_21_1 0.) sltop_21_1 (- sltop_21_1))) (ite (>= slbot_14_1 0.) slbot_14_1 (- slbot_14_1))) (ite (>= sltop_19_1 0.) sltop_19_1 (- sltop_19_1))) (ite (>= slbot_19_2 0.) slbot_19_2 (- slbot_19_2))) (ite (>= sltop_19_2 0.) sltop_19_2 (- sltop_19_2))) (ite (>= sltop_23_1 0.) sltop_23_1 (- sltop_23_1))) (ite (>= slbot_104_1 0.) slbot_104_1 (- slbot_104_1))) (ite (>= slbot_9_1 0.) slbot_9_1 (- slbot_9_1))) (ite (>= sltop_104_1 0.) sltop_104_1 (- sltop_104_1))) (ite (>= sltop_59_1 0.) sltop_59_1 (- sltop_59_1))) (ite (>= sltop_9_1 0.) sltop_9_1 (- sltop_9_1))) (ite (>= sltop_69_1 0.) sltop_69_1 (- sltop_69_1))) (ite (>= sltop_117_1 0.) sltop_117_1 (- sltop_117_1))) (ite (>= slbot_69_1 0.) slbot_69_1 (- slbot_69_1))) (ite (>= slbot_117_1 0.) slbot_117_1 (- slbot_117_1))) (ite (>= sltop_63_1 0.) sltop_63_1 (- sltop_63_1))) (ite (>= slbot_65_1 0.) slbot_65_1 (- slbot_65_1))) (ite (>= slbot_118_1 0.) slbot_118_1 (- slbot_118_1))) (ite (>= sltop_56_1 0.) sltop_56_1 (- sltop_56_1))) (ite (>= slbot_71_1 0.) slbot_71_1 (- slbot_71_1))) (ite (>= slbot_112_1 0.) slbot_112_1 (- slbot_112_1))) (ite (>= slbot_17_1 0.) slbot_17_1 (- slbot_17_1))) (ite (>= sltop_65_1 0.) sltop_65_1 (- sltop_65_1))) (ite (>= slbot_87_1 0.) slbot_87_1 (- slbot_87_1))) (ite (>= slbot_88_1 0.) slbot_88_1 (- slbot_88_1))) (ite (>= slbot_58_1 0.) slbot_58_1 (- slbot_58_1))) (ite (>= sltop_12_1 0.) sltop_12_1 (- sltop_12_1))) (ite (>= slbot_21_1 0.) slbot_21_1 (- slbot_21_1))) (ite (>= slbot_59_1 0.) slbot_59_1 (- slbot_59_1))) (ite (>= sltop_22_1 0.) sltop_22_1 (- sltop_22_1))) (ite (>= sltop_118_1 0.) sltop_118_1 (- sltop_118_1))) (ite (>= sltop_4_1 0.) sltop_4_1 (- sltop_4_1))) (ite (>= sltop_14_1 0.) sltop_14_1 (- sltop_14_1))) (ite (>= slbot_14_2 0.) slbot_14_2 (- slbot_14_2))) (ite (>= slbot_113_1 0.) slbot_113_1 (- slbot_113_1))) (ite (>= sltop_107_1 0.) sltop_107_1 (- sltop_107_1))) (ite (>= sltop_1_1 0.) sltop_1_1 (- sltop_1_1))) (ite (>= slbot_12_1 0.) slbot_12_1 (- slbot_12_1))) (ite (>= slbot_23_1 0.) slbot_23_1 (- slbot_23_1))) (ite (>= sltop_58_1 0.) sltop_58_1 (- sltop_58_1))) (ite (>= slbot_63_1 0.) slbot_63_1 (- slbot_63_1))) (ite (>= sltop_108_1 0.) sltop_108_1 (- sltop_108_1))) (ite (>= slbot_56_1 0.) slbot_56_1 (- slbot_56_1))) (ite (>= slbot_60_1 0.) slbot_60_1 (- slbot_60_1))) (ite (>= slbot_62_1 0.) slbot_62_1 (- slbot_62_1)))))
(check-sat)
