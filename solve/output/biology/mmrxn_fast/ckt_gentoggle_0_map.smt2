...
(assert (<= (+ (* sc_58 0.0156) of_58) 10.))
; 
; <=  {((sc.input.I[1].X*0.0156)+of.input.I[1].X)} {0.}
(assert (>= (+ (* sc_58 0.0156) of_58) 0.))
; 
...
(assert (= (+ (+ (* sc_68 0.15625) of_68) sltop_68) 3300.))
...
(assert (= (+ (+ (* sc_69 0.15625) of_69) sltop_69) 3300.))
...
(assert (= (+ (+ (* sc_70 0.0156) of_70) sltop_70) 3300.))
...
; 
; =  {(((sc.vadd[14].B*0.619026085325)+of.vadd[14].B)+sl.min.vadd[14].B)} {0.}
(assert (= (+ (+ (* sc_76 0.619026085325) of_76) slbot_76) 0.))
; 
; =  {(((sc.vadd[14].B*0.625)+of.vadd[14].B)+sl.max.vadd[14].B)} {3300.}
(assert (= (+ (+ (* sc_76 0.625) of_76) sltop_76) 3300.))
(declare-fun slbot_77 () Real)
(declare-fun sltop_77 () Real)
; 
; =  {(((sc.vadd[14].OUT*0.619026085325)+of.vadd[14].OUT)+sl.min.vadd[14].OUT)} {-1650.}
(assert (= (+ (+ (* sc_77 0.619026085325) of_77) slbot_77) -1650.))
; 
; =  {(((sc.vadd[14].OUT*0.625)+of.vadd[14].OUT)+sl.max.vadd[14].OUT)} {1650.}
(assert (= (+ (+ (* sc_77 0.625) of_77) sltop_77) 1650.))
(declare-fun slbot_78 () Real)
(declare-fun sltop_78 () Real)
; 
; =  {(((sc.vadd[14].OUT2*0.)+of.vadd[14].OUT2)+sl.min.vadd[14].OUT2)} {0.}
...
; 
; >=  {((sc.vadd[17].D*4.)+of.vadd[17].D)} {3300.}
(assert (<= (+ (* sc_80 4.) of_80) 3300.))
; 
; <=  {((sc.vadd[17].D*4.)+of.vadd[17].D)} {0.}
...
; 
; =  {(((sc.vadd[17].OUT2*0.15625)+of.vadd[17].OUT2)+sl.max.vadd[17].OUT2)} {3300.}
(assert (= (+ (+ (* sc_85 0.15625) of_85) sltop_85) 3300.))
(declare-fun slbot_83 () Real)
(declare-fun sltop_83 () Real)
; 
; =  {(((sc.vadd[17].B*0.0614415124065)+of.vadd[17].B)+sl.min.vadd[17].B)} {0.}
(assert (= (+ (+ (* sc_83 0.0614415124065) of_83) slbot_83) 0.))
; 
; =  {(((sc.vadd[17].B*0.0624)+of.vadd[17].B)+sl.max.vadd[17].B)} {3300.}
(assert (= (+ (+ (* sc_83 0.0624) of_83) sltop_83) 3300.))
(declare-fun slbot_84 () Real)
(declare-fun sltop_84 () Real)
; 
; =  {(((sc.vadd[17].OUT*0.0614415124065)+of.vadd[17].OUT)+sl.min.vadd[17].OUT)} {-1650.}
(assert (= (+ (+ (* sc_84 0.0614415124065) of_84) slbot_84) -1650.))
; 
; =  {(((sc.vadd[17].OUT*0.0624)+of.vadd[17].OUT)+sl.max.vadd[17].OUT)} {1650.}
(assert (= (+ (+ (* sc_84 0.0624) of_84) sltop_84) 1650.))
(declare-fun slbot_85 () Real)
(declare-fun sltop_85 () Real)
; 
; =  {(((sc.vadd[17].OUT2*0.)+of.vadd[17].OUT2)+sl.min.vadd[17].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_88 0.00965050555471) of_88) sltop_88) 3300.))
...
(assert (= (+ (+ (* sc_87 103.621514368) of_87) sltop_87) 3300.))
(declare-fun slbot_88 () Real)
(declare-fun sltop_88 () Real)
; 
; =  {(((sc.vtoi[8].Y*0.)+of.vtoi[8].Y)+sl.min.vtoi[8].Y)} {0.00030303030303}
...
(assert (= of_98 0.))
; 
; >=  {((sc.igenebind[15].TF*1.)+of.igenebind[15].TF)} {10.}
(assert (<= (+ (* sc_95 1.) of_95) 10.))
; 
; <=  {((sc.igenebind[15].TF*1.)+of.igenebind[15].TF)} {0.0001}
(assert (>= (+ (* sc_95 1.) of_95) 0.0001))
(declare-fun slbot_96 () Real)
(declare-fun sltop_96 () Real)
; 
; =  {(((sc.igenebind[15].K*0.)+of.igenebind[15].K)+sl.min.igenebind[15].K)} {0.0001}
(assert (= (+ (+ (* sc_96 0.) of_96) slbot_96) 0.0001))
; 
; =  {(((sc.igenebind[15].K*0.0156)+of.igenebind[15].K)+sl.max.igenebind[15].K)} {10.}
(assert (= (+ (+ (* sc_96 0.0156) of_96) sltop_96) 10.))
(declare-fun slbot_98 () Real)
(declare-fun sltop_98 () Real)
; 
; =  {(((sc.igenebind[15].GE*0.0153603781016)+of.igenebind[15].GE)+sl.min.igenebind[15].GE)} {9.90099009901e-07}
(assert (= (+ (+ (* sc_98 0.0153603781016) of_98) slbot_98) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[15].GE*0.0156)+of.igenebind[15].GE)+sl.max.igenebind[15].GE)} {9.9999999}
(assert (= (+ (+ (* sc_98 0.0156) of_98) sltop_98) 9.9999999))
; 
; >=  {((sc.igenebind[15].Vmax*0.0156)+of.igenebind[15].Vmax)} {10.}
(assert (<= (+ (* sc_97 0.0156) of_97) 10.))
; 
; <=  {((sc.igenebind[15].Vmax*0.0156)+of.igenebind[15].Vmax)} {0.0001}
(assert (>= (+ (* sc_97 0.0156) of_97) 0.0001))
...
(assert (= (+ (+ (* sc_99 0.00965050555471) of_99) sltop_99) 10.))
; 
...
; 
; =  {(((sc.igenebind[5].GE*0.154756521331)+of.igenebind[5].GE)+sl.min.igenebind[5].GE)} {9.90099009901e-07}
(assert (= (+ (+ (* sc_102 0.154756521331) of_102) slbot_102) 9.90099009901e-07))
; 
; =  {(((sc.igenebind[5].GE*0.15625)+of.igenebind[5].GE)+sl.max.igenebind[5].GE)} {9.9999999}
(assert (= (+ (+ (* sc_102 0.15625) of_102) sltop_102) 9.9999999))
; 
; >=  {((sc.igenebind[5].Vmax*0.15625)+of.igenebind[5].Vmax)} {10.}
(assert (<= (+ (* sc_101 0.15625) of_101) 10.))
; 
; <=  {((sc.igenebind[5].Vmax*0.15625)+of.igenebind[5].Vmax)} {0.0001}
(assert (>= (+ (* sc_101 0.15625) of_101) 0.0001))
(declare-fun slbot_102 () Real)
(declare-fun sltop_102 () Real)
; 
; =  {(((sc.igenebind[5].GE*0.154756521331)+of.igenebind[5].GE)+sl.min.igenebind[5].GE)} {9.90099009901e-07}
...
(assert (= of_139 0.))
; 
; >=  {((sc.itov[13].X*4.)+of.itov[13].X)} {10.}
(assert (<= (+ (* sc_137 4.) of_137) 10.))
; 
; <=  {((sc.itov[13].X*4.)+of.itov[13].X)} {0.0001}
(assert (>= (+ (* sc_137 4.) of_137) 0.0001))
(declare-fun slbot_139 () Real)
(declare-fun sltop_139 () Real)
; 
; =  {(((sc.itov[13].Y*0.619026085325)+of.itov[13].Y)+sl.min.itov[13].Y)} {0.0001}
(assert (= (+ (+ (* sc_139 0.619026085325) of_139) slbot_139) 0.0001))
; 
; =  {(((sc.itov[13].Y*0.625)+of.itov[13].Y)+sl.max.itov[13].Y)} {3300.}
(assert (= (+ (+ (* sc_139 0.625) of_139) sltop_139) 3300.))
(declare-fun slbot_138 () Real)
(declare-fun sltop_138 () Real)
; 
; =  {(((sc.itov[13].K*0.154756521331)+of.itov[13].K)+sl.min.itov[13].K)} {1.}
(assert (= (+ (+ (* sc_138 0.154756521331) of_138) slbot_138) 1.))
; 
; =  {(((sc.itov[13].K*0.15625)+of.itov[13].K)+sl.max.itov[13].K)} {330.}
(assert (= (+ (+ (* sc_138 0.15625) of_138) sltop_138) 330.))
(declare-fun slbot_139 () Real)
(declare-fun sltop_139 () Real)
; 
; =  {(((sc.itov[13].Y*0.619026085325)+of.itov[13].Y)+sl.min.itov[13].Y)} {0.0001}
...
; 
; =  {(((sc.itov[16].Y*0.0614415124065)+of.itov[16].Y)+sl.min.itov[16].Y)} {0.0001}
(assert (= (+ (+ (* sc_145 0.0614415124065) of_145) slbot_145) 0.0001))
; 
; =  {(((sc.itov[16].Y*0.0624)+of.itov[16].Y)+sl.max.itov[16].Y)} {3300.}
(assert (= (+ (+ (* sc_145 0.0624) of_145) sltop_145) 3300.))
(declare-fun slbot_144 () Real)
(declare-fun sltop_144 () Real)
; 
; =  {(((sc.itov[16].K*0.0153603781016)+of.itov[16].K)+sl.min.itov[16].K)} {1.}
(assert (= (+ (+ (* sc_144 0.0153603781016) of_144) slbot_144) 1.))
; 
; =  {(((sc.itov[16].K*0.0156)+of.itov[16].K)+sl.max.itov[16].K)} {330.}
(assert (= (+ (+ (* sc_144 0.0156) of_144) sltop_144) 330.))
(declare-fun slbot_145 () Real)
(declare-fun sltop_145 () Real)
; 
; =  {(((sc.itov[16].Y*0.0614415124065)+of.itov[16].Y)+sl.min.itov[16].Y)} {0.0001}
...
(assert (= of_39 of_173))
; 
; =  {sc.igenebind[15].GE} {sc.itov[16].K}
(assert (= sc_98 sc_144))
; 
; =  {of.igenebind[15].GE} {of.itov[16].K}
(assert (= of_98 of_144))
; 
...
(assert (= of_139 of_76))
; 
; =  {sc.input.I[0].O} {sc.igenebind[5].Vmax}
(assert (= sc_29 sc_101))
; 
; =  {of.input.I[0].O} {of.igenebind[5].Vmax}
(assert (= of_29 of_101))
; 
; =  {sc.input.V[9].O} {sc.vtoi[4].K}
(assert (= sc_114 sc_93))
; 
; =  {of.input.V[9].O} {of.vtoi[4].K}
(assert (= of_114 of_93))
; 
; =  {sc.iadd[13].OUT} {sc.igenebind[15].K}
(assert (= sc_160 sc_96))
; 
; =  {of.iadd[13].OUT} {of.igenebind[15].K}
(assert (= of_160 of_96))
; 
; =  {sc.input.I[22].O} {sc.igenebind[15].TF}
(assert (= sc_67 sc_95))
; 
; =  {of.input.I[22].O} {of.igenebind[15].TF}
(assert (= of_67 of_95))
; 
...
(assert (= of_122 of_1))
; 
; =  {sc.input.I[25].O} {sc.iadd[13].D}
(assert (= sc_55 sc_156))
; 
; =  {of.input.I[25].O} {of.iadd[13].D}
(assert (= of_55 of_156))
; 
; =  {sc.input.I[26].O} {sc.iadd[13].A}
(assert (= sc_33 sc_158))
; 
; =  {of.input.I[26].O} {of.iadd[13].A}
(assert (= of_33 of_158))
; 
; =  {sc.input.I[18].O} {sc.itov[16].X}
(assert (= sc_63 sc_143))
; 
; =  {of.input.I[18].O} {of.itov[16].X}
(assert (= of_63 of_143))
; 
; =  {sc.input.I[9].O} {sc.iadd[6].A}
(assert (= sc_27 sc_168))
; 
; =  {of.input.I[9].O} {of.iadd[6].A}
(assert (= of_27 of_168))
; 
...
(assert (= of_53 of_171))
; 
; =  {sc.input.V[14].O} {sc.vtoi[8].X}
(assert (= sc_126 sc_86))
; 
; =  {of.input.V[14].O} {of.vtoi[8].X}
(assert (= of_126 of_86))
; 
...
(assert (= of_165 of_5))
; 
; =  {sc.igenebind[5].GE} {sc.itov[13].K}
(assert (= sc_102 sc_138))
; 
; =  {of.igenebind[5].GE} {of.itov[13].K}
(assert (= of_102 of_138))
; 
; =  {sc.input.V[11].O} {sc.vadd[17].D}
(assert (= sc_118 sc_80))
; 
; =  {of.input.V[11].O} {of.vadd[17].D}
(assert (= of_118 of_80))
; 
...
(assert (= of_78 of_12))
; 
; =  {sc.input.I[14].O} {sc.iadd[12].A}
(assert (= sc_41 sc_163))
; 
; =  {of.input.I[14].O} {of.iadd[12].A}
(assert (= of_41 of_163))
; 
; =  {sc.vadd[17].OUT2} {sc.vtoi[4].X}
(assert (= sc_85 sc_92))
; 
; =  {of.vadd[17].OUT2} {of.vtoi[4].X}
(assert (= of_85 of_92))
; 
; =  {sc.vadd[17].OUT2} {sc.output.V[0].X}
(assert (= sc_85 sc_68))
; 
; =  {of.vadd[17].OUT2} {of.output.V[0].X}
(assert (= of_85 of_68))
; 
...
(assert (= of_15 of_146))
; 
; =  {sc.input.V[8].O} {sc.vadd[14].OUT2_0}
(assert (= sc_106 sc_72))
; 
; =  {of.input.V[8].O} {of.vadd[14].OUT2_0}
(assert (= of_106 of_72))
; 
...
(assert (= of_104 of_4))
; 
; =  {sc.input.I[20].O} {sc.switch[11].Kmod}
(assert (= sc_17 sc_6))
; 
; =  {of.input.I[20].O} {of.switch[11].Kmod}
(assert (= of_17 of_6))
; 
...
(assert (= of_3 of_87))
; 
; =  {sc.input.I[24].O} {sc.iadd[13].C}
(assert (= sc_45 sc_157))
; 
; =  {of.input.I[24].O} {of.iadd[13].C}
(assert (= of_45 of_157))
; 
; =  {sc.input.I[15].O} {sc.iadd[12].B}
(assert (= sc_37 sc_164))
; 
; =  {of.input.I[15].O} {of.iadd[12].B}
(assert (= of_37 of_164))
; 
; =  {sc.input.I[10].O} {sc.iadd[6].C}
(assert (= sc_35 sc_167))
; 
; =  {of.input.I[10].O} {of.iadd[6].C}
(assert (= of_35 of_167))
; 
; =  {sc.input.I[12].O} {sc.iadd[7].A}
(assert (= sc_25 sc_153))
; 
; =  {of.input.I[12].O} {of.iadd[7].A}
(assert (= of_25 of_153))
; 
; =  {sc.input.I[1].O} {sc.igenebind[15].Vmax}
(assert (= sc_59 sc_97))
; 
; =  {of.input.I[1].O} {of.igenebind[15].Vmax}
(assert (= of_59 of_97))
; 
...
(assert (= of_21 of_172))
; 
; =  {sc.input.I[13].O} {sc.iadd[7].C}
(assert (= sc_23 sc_152))
; 
; =  {of.input.I[13].O} {of.iadd[7].C}
(assert (= of_23 of_152))
; 
...
; 
; =  {sc.input.V[7].O} {sc.vadd[17].OUT2_0}
(assert (= sc_108 sc_79))
; 
; =  {of.input.V[7].O} {of.vadd[17].OUT2_0}
(assert (= of_108 of_79))
; 
; =  {sc.input.I[17].O} {sc.itov[13].X}
(assert (= sc_61 sc_137))
; 
; =  {of.input.I[17].O} {of.itov[13].X}
(assert (= of_61 of_137))
; 
...
(assert (= of_150 of_11))
; 
; =  {sc.input.I[8].O} {sc.iadd[6].D}
(assert (= sc_19 sc_166))
; 
; =  {of.input.I[8].O} {of.iadd[6].D}
(assert (= of_19 of_166))
; 
...
(assert (= of_8 of_140))
; 
; =  {sc.input.I[21].O} {sc.switch[11].Vmax}
(assert (= sc_43 sc_7))
; 
; =  {of.input.I[21].O} {of.switch[11].Vmax}
(assert (= of_43 of_7))
; 
...
(assert (= of_88 of_154))
; 
; =  {sc.input.V[10].O} {sc.vadd[14].D}
(assert (= sc_120 sc_73))
; 
; =  {of.input.V[10].O} {of.vadd[14].D}
(assert (= of_120 of_73))
; 
...
(assert (= of_142 of_2))
; 
; =  {sc.input.V[16].O} {sc.itov[10].K}
(assert (= sc_128 sc_141))
; 
; =  {of.input.V[16].O} {of.itov[10].K}
(assert (= of_128 of_141))
; 
...
(assert (= of_145 of_83))
; 
; =  {sc.input.I[19].O} {sc.igenebind[5].K}
(assert (= sc_65 sc_100))
; 
; =  {of.input.I[19].O} {of.igenebind[5].K}
(assert (= of_65 of_100))
; 
; =  {sc.input.V[5].O} {sc.vadd[17].C}
(assert (= sc_134 sc_81))
; 
; =  {of.input.V[5].O} {of.vadd[17].C}
(assert (= of_134 of_81))
; 
...
(assert (= of_132 of_74))
; 
; =  {sc.input.V[6].O} {sc.vadd[17].A}
(assert (= sc_124 sc_82))
; 
; =  {of.input.V[6].O} {of.vadd[17].A}
(assert (= of_124 of_82))
; 
; =  {sc.input.I[11].O} {sc.iadd[7].D}
(assert (= sc_31 sc_151))
; 
; =  {of.input.I[11].O} {of.iadd[7].D}
(assert (= of_31 of_151))
; 
