...
; 
; >=  {((sc.switch[7].SUB*1.)+of.switch[7].SUB)} {10.}
(assert (<= (+ (* sc_1 1.) of_1) 10.))
; 
; <=  {((sc.switch[7].SUB*1.)+of.switch[7].SUB)} {0.0001}
(assert (>= (+ (* sc_1 1.) of_1) 0.0001))
; 
; >=  {((sc.switch[7].Kmod*0.246913580247)+of.switch[7].Kmod)} {10.}
(assert (<= (+ (* sc_2 0.246913580247) of_2) 10.))
; 
; <=  {((sc.switch[7].Kmod*0.246913580247)+of.switch[7].Kmod)} {0.0001}
...
(assert (= of_16 of_15))
; 
; >=  {((sc.input.I[4].X*25.232)+of.input.I[4].X)} {10.}
(assert (<= (+ (* sc_15 25.232) of_15) 10.))
; 
; <=  {((sc.input.I[4].X*25.232)+of.input.I[4].X)} {0.}
(assert (>= (+ (* sc_15 25.232) of_15) 0.))
; 
; >=  {((sc.input.I[4].O*25.232)+of.input.I[4].O)} {10.}
(assert (<= (+ (* sc_16 25.232) of_16) 10.))
; 
; <=  {((sc.input.I[4].O*25.232)+of.input.I[4].O)} {0.}
(assert (>= (+ (* sc_16 25.232) of_16) 0.))
...
(assert (= of_18 of_17))
; 
; >=  {((sc.input.I[5].X*0.246913580247)+of.input.I[5].X)} {10.}
(assert (<= (+ (* sc_17 0.246913580247) of_17) 10.))
; 
; <=  {((sc.input.I[5].X*0.246913580247)+of.input.I[5].X)} {0.}
(assert (>= (+ (* sc_17 0.246913580247) of_17) 0.))
; 
; >=  {((sc.input.I[5].O*0.246913580247)+of.input.I[5].O)} {10.}
(assert (<= (+ (* sc_18 0.246913580247) of_18) 10.))
; 
; <=  {((sc.input.I[5].O*0.246913580247)+of.input.I[5].O)} {0.}
(assert (>= (+ (* sc_18 0.246913580247) of_18) 0.))
...
(assert (= (+ (+ (* sc_24 3.154) of_24) sltop_24_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_27 5.05) of_27) sltop_27_1) 3300.))
...
(assert (= (+ (+ (* sc_28 3.154) of_28) sltop_28_1) 1650.))
(declare-fun slbot_29_1 () Real)
(assert (<= slbot_29_1 1e-08))
(declare-fun sltop_29_1 () Real)
(assert (>= sltop_29_1 1e-08))
...
(assert (= (+ (+ (* sc_34 0.42) of_34) sltop_34_1) 3300.))
...
(assert (= (+ (+ (* sc_35 0.42) of_35) sltop_35_1) 1650.))
(declare-fun slbot_36_1 () Real)
(assert (<= slbot_36_1 1e-08))
(declare-fun sltop_36_1 () Real)
(assert (>= sltop_36_1 1e-08))
...
(assert (= (+ (+ (* sc_108 5.05) of_108) sltop_108_1) 10.))
...
(assert (= (+ (+ (* sc_110 5.05) of_110) sltop_110_1) 3300.))
; 
; >=  {((sc.itov[10].K*1.)+of.itov[10].K)} {330.}
(assert (<= (+ (* sc_109 1.) of_109) 330.))
; 
...
; 
; =  {(((sc.iadd[11].OUT*0.)+of.iadd[11].OUT)+sl.min.iadd[11].OUT.1)} {-10.}
(assert (= (+ (+ (* sc_121 0.) of_121) slbot_121_1) -10.))
; 
; =  {(((sc.iadd[11].OUT*5.05)+of.iadd[11].OUT)+sl.max.iadd[11].OUT.1)} {10.}
...
; 
; =  {(((sc.iadd[11].B*0.)+of.iadd[11].B)+sl.min.iadd[11].B.1)} {0.}
(assert (= (+ (+ (* sc_120 0.) of_120) slbot_120_1) 0.))
; 
; =  {(((sc.iadd[11].B*5.05)+of.iadd[11].B)+sl.max.iadd[11].B.1)} {5.}
...
(assert (= of_93 of_45))
; 
; =  {sc.vadd[4].OUT2} {sc.itov[12].K}
(assert (= sc_50 sc_100))
; 
; =  {of.vadd[4].OUT2} {of.itov[12].K}
(assert (= of_50 of_100))
; 
...
(assert (= of_50 of_106))
; 
; =  {sc.input.I[6].O} {sc.itov[12].X}
(assert (= sc_12 sc_99))
; 
; =  {of.input.I[6].O} {of.itov[12].X}
(assert (= of_12 of_99))
; 
...
(assert (= of_36 of_21))
; 
; =  {sc.input.I[0].O} {sc.iadd[11].D}
(assert (= sc_10 sc_117))
; 
; =  {of.input.I[0].O} {of.iadd[11].D}
(assert (= of_10 of_117))
; 
...
(assert (= of_69 of_25))
; 
; =  {sc.switch[7].PROD} {sc.iadd[11].B}
(assert (= sc_4 sc_120))
; 
; =  {of.switch[7].PROD} {of.iadd[11].B}
(assert (= of_4 of_120))
; 
...
(assert (= of_77 of_51))
; 
; =  {sc.input.I[4].O} {sc.itov[3].X}
(assert (= sc_16 sc_111))
; 
; =  {of.input.I[4].O} {of.itov[3].X}
(assert (= of_16 of_111))
; 
...
(assert (= of_14 of_105))
; 
; =  {sc.input.I[5].O} {sc.switch[7].Kmod}
(assert (= sc_18 sc_2))
; 
; =  {of.input.I[5].O} {of.switch[7].Kmod}
(assert (= of_18 of_2))
; 
...
(assert (= of_61 of_26))
; 
; =  {sc.input.I[2].O} {sc.iadd[11].C}
(assert (= sc_6 sc_118))
; 
; =  {of.input.I[2].O} {of.iadd[11].C}
(assert (= of_6 of_118))
; 
...
(assert (= of_42 of_115))
; 
; =  {sc.input.I[1].O} {sc.iadd[11].A}
(assert (= sc_20 sc_119))
; 
; =  {of.input.I[1].O} {of.iadd[11].A}
(assert (= of_20 of_119))
; 
; =  {sc.iadd[11].OUT} {sc.itov[10].X}
(assert (= sc_121 sc_108))
; 
; =  {of.iadd[11].OUT} {of.itov[10].X}
(assert (= of_121 of_108))
; 
