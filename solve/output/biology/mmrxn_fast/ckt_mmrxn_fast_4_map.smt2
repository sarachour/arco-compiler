...
(assert (= of_4 0.))
; 
; >=  {((sc.switch[7].n*-500.)+of.switch[7].n)} {3300.}
(assert (<= (+ (* sc_0 -500.) of_0) 3300.))
; 
; <=  {((sc.switch[7].n*-500.)+of.switch[7].n)} {500.}
(assert (>= (+ (* sc_0 -500.) of_0) 500.))
; 
; >=  {((sc.switch[7].SUB*4.05)+of.switch[7].SUB)} {10.}
(assert (<= (+ (* sc_1 4.05) of_1) 10.))
; 
; <=  {((sc.switch[7].SUB*4.05)+of.switch[7].SUB)} {0.0001}
...
; 
; =  {(((sc.switch[7].PROD*0.)+of.switch[7].PROD)+sl.min.switch[7].PROD.1)} {9.99934002508e-38}
(assert (= (+ (+ (* sc_4 0.) of_4) slbot_4_1) 9.99934002508e-38))
; 
; =  {(((sc.switch[7].PROD*5.05)+of.switch[7].PROD)+sl.max.switch[7].PROD.1)} {9.999900001}
...
; 
; =  {(((sc.switch[7].Vmax*0.)+of.switch[7].Vmax)+sl.min.switch[7].Vmax.1)} {0.0001}
(assert (= (+ (+ (* sc_3 0.) of_3) slbot_3_1) 0.0001))
; 
; =  {(((sc.switch[7].Vmax*1.)+of.switch[7].Vmax)+sl.max.switch[7].Vmax.1)} {10.}
...
(assert (<= (+ (* sc_6 25.232) of_6) 10.))
; 
; <=  {((sc.input.I[2].O*25.232)+of.input.I[2].O)} {0.}
(assert (>= (+ (* sc_6 25.232) of_6) 0.))
...
(assert (= (+ (+ (* sc_15 1.) of_15) sltop_15_1) 3300.))
...
(assert (<= (+ (* sc_17 0.124) of_17) 3300.))
; 
; <=  {((sc.vadd[8].OUT2_0*0.124)+of.vadd[8].OUT2_0)} {0.}
(assert (>= (+ (* sc_17 0.124) of_17) 0.))
...
; 
; =  {(((sc.vadd[8].D*3.154)+of.vadd[8].D)+sl.max.vadd[8].D.1)} {3300.}
(assert (= (+ (+ (* sc_18 3.154) of_18) sltop_18_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_23 1.) of_23) sltop_23_1) 3300.))
...
; 
; =  {(((sc.vadd[8].B*5.05)+of.vadd[8].B)+sl.max.vadd[8].B.1)} {3300.}
(assert (= (+ (+ (* sc_21 5.05) of_21) sltop_21_1) 3300.))
...
(assert (= (+ (+ (* sc_22 0.) of_22) slbot_22_1) -1650.))
; 
; =  {(((sc.vadd[8].OUT*3.154)+of.vadd[8].OUT)+sl.max.vadd[8].OUT.1)} {1650.}
(assert (= (+ (+ (* sc_22 3.154) of_22) sltop_22_1) 1650.))
(declare-fun slbot_23_1 () Real)
(assert (<= slbot_23_1 1e-08))
(declare-fun sltop_23_1 () Real)
(assert (>= sltop_23_1 1e-08))
...
(assert (= (+ (+ (* sc_36 6.308) of_36) sltop_36_1) 1650.))
...
(assert (= (+ (+ (* sc_34 25.232) of_34) sltop_34_1) 3300.))
; 
...
(assert (<= (+ (* sc_39 2.525) of_39) 3300.))
; 
; <=  {((sc.vadd[4].D*2.525)+of.vadd[4].D)} {0.}
(assert (>= (+ (* sc_39 2.525) of_39) 0.))
; 
...
(assert (= (+ (+ (* sc_42 6.308) of_42) sltop_42_1) 3300.))
...
(assert (= (+ (+ (* sc_43 6.308) of_43) sltop_43_1) 1650.))
(declare-fun slbot_44_1 () Real)
(assert (<= slbot_44_1 1e-08))
(declare-fun sltop_44_1 () Real)
(assert (>= sltop_44_1 1e-08))
...
(assert (and (= (* sc_48 1.) (* 1. sc_47)) (= (* sc_48 1.) (* (* 1. sc_46) sc_51))))
; 
...
(assert (= (+ (+ (* sc_46 3.154) of_46) sltop_46_1) 3300.))
; 
...
(assert (= (+ (+ (* sc_51 1.) of_51) sltop_51_1) 3300.))
...
(assert (= (+ (+ (* sc_49 4.63) of_49) sltop_49_1) 3300.))
...
(assert (= (+ (+ (* sc_50 3.154) of_50) sltop_50_1) 1650.))
(declare-fun slbot_51_1 () Real)
(assert (<= slbot_51_1 1e-08))
(declare-fun sltop_51_1 () Real)
(assert (>= sltop_51_1 1e-08))
...
; 
; =  {(((sc.itov[9].Y*3.154)+of.itov[9].Y)+sl.max.itov[9].Y.1)} {3300.}
(assert (= (+ (+ (* sc_95 3.154) of_95) sltop_95_1) 3300.))
; 
; >=  {((sc.itov[9].K*3.154)+of.itov[9].K)} {330.}
(assert (<= (+ (* sc_94 3.154) of_94) 330.))
; 
; <=  {((sc.itov[9].K*3.154)+of.itov[9].K)} {1.}
(assert (>= (+ (* sc_94 3.154) of_94) 1.))
(declare-fun slbot_95_1 () Real)
(assert (<= slbot_95_1 1e-08))
(declare-fun sltop_95_1 () Real)
(assert (>= sltop_95_1 1e-08))
...
(assert (<= (+ (* sc_96 4.63) of_96) 10.))
; 
; <=  {((sc.itov[0].X*4.63)+of.itov[0].X)} {0.0001}
(assert (>= (+ (* sc_96 4.63) of_96) 0.0001))
...
(assert (= (+ (+ (* sc_98 4.63) of_98) sltop_98_1) 3300.))
...
(assert (= (+ (+ (* sc_97 1.) of_97) sltop_97_1) 330.))
(declare-fun slbot_98_1 () Real)
(assert (<= slbot_98_1 1e-08))
(declare-fun sltop_98_1 () Real)
(assert (>= sltop_98_1 1e-08))
...
; 
; =  {(((sc.itov[10].X*5.05)+of.itov[10].X)+sl.max.itov[10].X.1)} {10.}
...
; 
; =  {(((sc.itov[10].Y*5.05)+of.itov[10].Y)+sl.max.itov[10].Y.1)} {3300.}
...
(assert (<= (+ (* sc_105 25.232) of_105) 10.))
; 
; <=  {((sc.itov[3].X*25.232)+of.itov[3].X)} {0.0001}
(assert (>= (+ (* sc_105 25.232) of_105) 0.0001))
...
(assert (= (+ (+ (* sc_107 25.232) of_107) sltop_107_1) 3300.))
...
(assert (= of_87 of_39))
; 
; =  {sc.vadd[4].OUT2} {sc.itov[11].K}
(assert (= sc_44 sc_100))
; 
; =  {of.vadd[4].OUT2} {of.itov[11].K}
(assert (= of_44 of_100))
; 
; =  {sc.vadd[4].OUT2} {sc.switch[7].Vmax}
(assert (= sc_44 sc_3))
; 
; =  {of.vadd[4].OUT2} {of.switch[7].Vmax}
(assert (= of_44 of_3))
; 
...
(assert (= of_51 of_93))
; 
; =  {sc.input.I[0].O} {sc.switch[7].SUB}
(assert (= sc_8 sc_1))
; 
; =  {of.input.I[0].O} {of.switch[7].SUB}
(assert (= of_8 of_1))
; 
; =  {sc.input.V[9].O} {sc.vadd[8].C}
(assert (= sc_63 sc_19))
; 
; =  {of.input.V[9].O} {of.vadd[8].C}
(assert (= of_63 of_19))
; 
; =  {sc.switch[7].PROD} {sc.itov[10].X}
(assert (= sc_4 sc_102))
; 
; =  {of.switch[7].PROD} {of.itov[10].X}
(assert (= of_4 of_102))
; 
...
(assert (= of_59 of_26))
; 
; =  {sc.input.I[4].O} {sc.switch[7].Kmod}
(assert (= sc_12 sc_2))
; 
; =  {of.input.I[4].O} {of.switch[7].Kmod}
(assert (= of_12 of_2))
; 
; =  {sc.input.I[3].O} {sc.itov[11].X}
(assert (= sc_10 sc_99))
; 
; =  {of.input.I[3].O} {of.itov[11].X}
(assert (= of_10 of_99))
; 
; =  {sc.input.V[14].O} {sc.switch[7].n}
(assert (= sc_75 sc_0))
; 
; =  {of.input.V[14].O} {of.switch[7].n}
(assert (= of_75 of_0))
; 
...
(assert (= of_55 of_20))
; 
; =  {sc.input.I[2].O} {sc.itov[3].X}
(assert (= sc_6 sc_105))
; 
; =  {of.input.I[2].O} {of.itov[3].X}
(assert (= of_6 of_105))
; 
...
(assert (= of_57 of_35))
; 
; =  {sc.vadd[8].OUT2} {sc.itov[3].K}
(assert (= sc_23 sc_106))
; 
; =  {of.vadd[8].OUT2} {of.itov[3].K}
(assert (= of_23 of_106))
; 
...
(assert (= of_69 of_24))
; 
; =  {sc.itov[10].Y} {sc.vadd[8].B}
(assert (= sc_104 sc_21))
; 
; =  {of.itov[10].Y} {of.vadd[8].B}
(assert (= of_104 of_21))
; 
...
(assert (= of_77 of_17))
; 
; =  {sc.input.V[18].O} {sc.itov[10].K}
(assert (= sc_89 sc_103))
; 
; =  {of.input.V[18].O} {of.itov[10].K}
(assert (= of_89 of_103))
; 
...
(assert (= of_73 of_41))
(assert (<= (* (/ 1. sc_16) 0.001) 0.1))
; 
; =  {sc.vadd[12].OUT2} {sc.output.V[0].O} {sc.vadd[1].OUT2} {sc.vadd[8].OUT2} {sc.vadd[4].OUT2}
(assert (and (and (and (= sc_30 sc_16) (= sc_30 sc_51)) (= sc_30 sc_23)) (= sc_30 sc_44)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_34_1 0.) sltop_34_1 (- sltop_34_1)) (ite (>= slbot_28_1 0.) slbot_28_1 (- slbot_28_1))) (ite (>= slbot_108_1 0.) slbot_108_1 (- slbot_108_1))) (ite (>= sltop_93_1 0.) sltop_93_1 (- sltop_93_1))) (ite (>= slbot_22_1 0.) slbot_22_1 (- slbot_22_1))) (ite (>= sltop_95_1 0.) sltop_95_1 (- sltop_95_1))) (ite (>= sltop_18_1 0.) sltop_18_1 (- sltop_18_1))) (ite (>= slbot_107_1 0.) slbot_107_1 (- slbot_107_1))) (ite (>= slbot_110_1 0.) slbot_110_1 (- slbot_110_1))) (ite (>= sltop_28_1 0.) sltop_28_1 (- sltop_28_1))) (ite (>= slbot_92_1 0.) slbot_92_1 (- slbot_92_1))) (ite (>= sltop_92_1 0.) sltop_92_1 (- sltop_92_1))) (ite (>= sltop_101_1 0.) sltop_101_1 (- sltop_101_1))) (ite (>= slbot_4_1 0.) slbot_4_1 (- slbot_4_1))) (ite (>= slbot_18_1 0.) slbot_18_1 (- slbot_18_1))) (ite (>= slbot_95_1 0.) slbot_95_1 (- slbot_95_1))) (ite (>= sltop_51_1 0.) sltop_51_1 (- sltop_51_1))) (ite (>= slbot_16_1 0.) slbot_16_1 (- slbot_16_1))) (ite (>= sltop_21_1 0.) sltop_21_1 (- sltop_21_1))) (ite (>= sltop_43_1 0.) sltop_43_1 (- sltop_43_1))) (ite (>= slbot_51_1 0.) slbot_51_1 (- slbot_51_1))) (ite (>= slbot_97_1 0.) slbot_97_1 (- slbot_97_1))) (ite (>= slbot_49_1 0.) slbot_49_1 (- slbot_49_1))) (ite (>= sltop_49_1 0.) sltop_49_1 (- sltop_49_1))) (ite (>= sltop_23_1 0.) sltop_23_1 (- sltop_23_1))) (ite (>= slbot_104_1 0.) slbot_104_1 (- slbot_104_1))) (ite (>= slbot_36_1 0.) slbot_36_1 (- slbot_36_1))) (ite (>= slbot_34_1 0.) slbot_34_1 (- slbot_34_1))) (ite (>= sltop_104_1 0.) sltop_104_1 (- sltop_104_1))) (ite (>= slbot_44_1 0.) slbot_44_1 (- slbot_44_1))) (ite (>= slbot_90_1 0.) slbot_90_1 (- slbot_90_1))) (ite (>= slbot_46_1 0.) slbot_46_1 (- slbot_46_1))) (ite (>= slbot_100_1 0.) slbot_100_1 (- slbot_100_1))) (ite (>= slbot_109_1 0.) slbot_109_1 (- slbot_109_1))) (ite (>= sltop_29_1 0.) sltop_29_1 (- sltop_29_1))) (ite (>= sltop_98_1 0.) sltop_98_1 (- sltop_98_1))) (ite (>= slbot_101_1 0.) slbot_101_1 (- slbot_101_1))) (ite (>= slbot_15_1 0.) slbot_15_1 (- slbot_15_1))) (ite (>= sltop_3_1 0.) sltop_3_1 (- sltop_3_1))) (ite (>= sltop_110_1 0.) sltop_110_1 (- sltop_110_1))) (ite (>= slbot_98_1 0.) slbot_98_1 (- slbot_98_1))) (ite (>= slbot_106_1 0.) slbot_106_1 (- slbot_106_1))) (ite (>= slbot_50_1 0.) slbot_50_1 (- slbot_50_1))) (ite (>= sltop_36_1 0.) sltop_36_1 (- sltop_36_1))) (ite (>= sltop_109_1 0.) sltop_109_1 (- sltop_109_1))) (ite (>= slbot_21_1 0.) slbot_21_1 (- slbot_21_1))) (ite (>= slbot_42_1 0.) slbot_42_1 (- slbot_42_1))) (ite (>= sltop_90_1 0.) sltop_90_1 (- sltop_90_1))) (ite (>= sltop_102_1 0.) sltop_102_1 (- sltop_102_1))) (ite (>= slbot_3_1 0.) slbot_3_1 (- slbot_3_1))) (ite (>= sltop_15_1 0.) sltop_15_1 (- sltop_15_1))) (ite (>= sltop_30_1 0.) sltop_30_1 (- sltop_30_1))) (ite (>= slbot_93_1 0.) slbot_93_1 (- slbot_93_1))) (ite (>= sltop_97_1 0.) sltop_97_1 (- sltop_97_1))) (ite (>= sltop_22_1 0.) sltop_22_1 (- sltop_22_1))) (ite (>= sltop_100_1 0.) sltop_100_1 (- sltop_100_1))) (ite (>= sltop_4_1 0.) sltop_4_1 (- sltop_4_1))) (ite (>= sltop_44_1 0.) sltop_44_1 (- sltop_44_1))) (ite (>= sltop_16_1 0.) sltop_16_1 (- sltop_16_1))) (ite (>= slbot_102_1 0.) slbot_102_1 (- slbot_102_1))) (ite (>= sltop_106_1 0.) sltop_106_1 (- sltop_106_1))) (ite (>= sltop_46_1 0.) sltop_46_1 (- sltop_46_1))) (ite (>= sltop_107_1 0.) sltop_107_1 (- sltop_107_1))) (ite (>= sltop_50_1 0.) sltop_50_1 (- sltop_50_1))) (ite (>= slbot_23_1 0.) slbot_23_1 (- slbot_23_1))) (ite (>= slbot_30_1 0.) slbot_30_1 (- slbot_30_1))) (ite (>= sltop_42_1 0.) sltop_42_1 (- sltop_42_1))) (ite (>= sltop_108_1 0.) sltop_108_1 (- sltop_108_1))) (ite (>= slbot_29_1 0.) slbot_29_1 (- slbot_29_1))) (ite (>= slbot_43_1 0.) slbot_43_1 (- slbot_43_1)))))
(check-sat)
