...
; 
; >=  {((sc.vgain[6].Y*0.049504950495)+of.vgain[6].Y)} {3300.}
(assert (<= (+ (* sc_1 0.049504950495) of_1) 3300.))
; 
; <=  {((sc.vgain[6].Y*0.049504950495)+of.vgain[6].Y)} {1.}
...
; 
; =  {(((sc.vgain[6].P*1.2524)+of.vgain[6].P)+sl.max.vgain[6].P)} {5445000.}
(assert (= (+ (+ (* sc_3 1.2524) of_3) sltop_3) 5445000.))
; 
; >=  {((sc.vgain[6].Z*1.)+of.vgain[6].Z)} {3300.}
(assert (<= (+ (* sc_2 1.) of_2) 3300.))
; 
; <=  {((sc.vgain[6].Z*1.)+of.vgain[6].Z)} {0.0001}
...
(assert (= (+ (+ (* sc_50 0.400482304) of_50) sltop_50) 3300.))
...
(assert (= (+ (+ (* sc_51 0.400482304) of_51) sltop_51) 1650.))
(declare-fun slbot_52 () Real)
(declare-fun sltop_52 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_103 0.124) of_103) sltop_103) 10.))
...
(assert (= (+ (+ (* sc_105 1.564384) of_105) sltop_105) 3300.))
; 
; >=  {((sc.itov[11].K*12.616)+of.itov[11].K)} {330.}
(assert (<= (+ (* sc_104 12.616) of_104) 330.))
; 
; <=  {((sc.itov[11].K*12.616)+of.itov[11].K)} {1.}
(assert (>= (+ (* sc_104 12.616) of_104) 1.))
(declare-fun slbot_105 () Real)
(declare-fun sltop_105 () Real)
; 
; =  {(((sc.itov[11].Y*0.)+of.itov[11].Y)+sl.min.itov[11].Y)} {0.0001}
...
(assert (<= (+ (* sc_106 0.84) of_106) 10.))
; 
; <=  {((sc.itov[4].X*0.84)+of.itov[4].X)} {0.0001}
(assert (>= (+ (* sc_106 0.84) of_106) 0.0001))
...
(assert (= (+ (+ (* sc_108 0.10416) of_108) sltop_108) 3300.))
...
(assert (= (+ (+ (* sc_107 0.124) of_107) sltop_107) 330.))
(declare-fun slbot_108 () Real)
(declare-fun sltop_108 () Real)
; 
; =  {(((sc.itov[4].Y*0.)+of.itov[4].Y)+sl.min.itov[4].Y)} {0.0001}
...
(assert (= of_56 of_41))
; 
; =  {sc.input.I[2].O} {sc.itov[4].X}
(assert (= sc_5 sc_106))
; 
; =  {of.input.I[2].O} {of.itov[4].X}
(assert (= of_5 of_106))
; 
...
(assert (= of_9 of_97))
; 
; =  {sc.input.V[1].O} {sc.vgain[6].Y}
(assert (= sc_86 sc_1))
; 
; =  {of.input.V[1].O} {of.vgain[6].Y}
(assert (= of_86 of_1))
; 
...
(assert (= of_78 of_25))
; 
; =  {sc.input.V[18].O} {sc.vgain[6].Z}
(assert (= sc_90 sc_2))
; 
; =  {of.input.V[18].O} {of.vgain[6].Z}
(assert (= of_90 of_2))
; 
...
(assert (and (and (and (and (and (and (= sc_31 sc_13) (= sc_31 sc_45)) (= sc_31 sc_17)) (= sc_31 sc_24)) (= sc_31 sc_11)) (= sc_31 sc_52)) (= sc_31 sc_15)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_0 0.) slbot_0 (- slbot_0))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= slbot_44 0.) slbot_44 (- slbot_44))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_103 0.) slbot_103 (- slbot_103))) (ite (>= slbot_107 0.) slbot_107 (- slbot_107))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_105 0.) sltop_105 (- sltop_105))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_51 0.) sltop_51 (- sltop_51))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_98 0.) slbot_98 (- slbot_98))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= slbot_108 0.) slbot_108 (- slbot_108))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= sltop_52 0.) sltop_52 (- sltop_52))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_0 0.) sltop_0 (- sltop_0))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_107 0.) sltop_107 (- sltop_107))) (ite (>= sltop_44 0.) sltop_44 (- sltop_44))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= sltop_103 0.) sltop_103 (- sltop_103))) (ite (>= sltop_98 0.) sltop_98 (- sltop_98))) (ite (>= slbot_105 0.) slbot_105 (- slbot_105))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_52 0.) slbot_52 (- slbot_52))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_51 0.) slbot_51 (- slbot_51))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_43 0.) slbot_43 (- slbot_43))) (ite (>= slbot_50 0.) slbot_50 (- slbot_50))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_50 0.) sltop_50 (- sltop_50))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= sltop_43 0.) sltop_43 (- sltop_43))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_108 0.) sltop_108 (- sltop_108)))))
(check-sat)
