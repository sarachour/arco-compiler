...
(assert (= (+ (+ (* sc_19 10.1) of_19) sltop_19) 3300.))
...
(assert (<= (+ (* sc_43 0.049504950495) of_43) 3300.))
; 
; <=  {((sc.input.V[2].X*0.049504950495)+of.input.V[2].X)} {0.}
(assert (>= (+ (* sc_43 0.049504950495) of_43) 0.))
; 
...
(assert (<= (+ (* sc_91 50.464) of_91) 10.))
; 
; <=  {((sc.itov[0].X*50.464)+of.itov[0].X)} {0.0001}
(assert (>= (+ (* sc_91 50.464) of_91) 0.0001))
...
(assert (= (+ (+ (* sc_93 50.464) of_93) sltop_93) 3300.))
...
; 
; =  {(((sc.itov[6].Y*9.26)+of.itov[6].Y)+sl.max.itov[6].Y)} {3300.}
(assert (= (+ (+ (* sc_99 9.26) of_99) sltop_99) 3300.))
; 
; >=  {((sc.itov[6].K*9.26)+of.itov[6].K)} {330.}
(assert (<= (+ (* sc_98 9.26) of_98) 330.))
; 
; <=  {((sc.itov[6].K*9.26)+of.itov[6].K)} {1.}
...
(assert (= of_80 of_8))
; 
; =  {sc.vadd[1].OUT2} {sc.vgain[9].X}
(assert (= sc_42 sc_0))
; 
; =  {of.vadd[1].OUT2} {of.vgain[9].X}
(assert (= of_42 of_0))
; 
...
(assert (= of_52 of_18))
; 
; =  {sc.input.V[14].O} {sc.vadd[10].C}
(assert (= sc_68 sc_17))
; 
; =  {of.input.V[14].O} {of.vadd[10].C}
(assert (= of_68 of_17))
; 
...
(assert (= of_90 of_9))
; 
; =  {sc.input.V[12].O} {sc.vadd[7].C}
(assert (= sc_54 sc_10))
; 
; =  {of.input.V[12].O} {of.vadd[7].C}
(assert (= of_54 of_10))
; 
...
(assert (= of_93 of_25))
; 
; =  {sc.vadd[10].OUT2} {sc.itov[0].K}
(assert (= sc_21 sc_92))
; 
; =  {of.vadd[10].OUT2} {of.itov[0].K}
(assert (= of_21 of_92))
; 
...
(assert (= of_21 of_88))
; 
; =  {sc.input.V[20].O} {sc.vgain[9].Z}
(assert (= sc_46 sc_2))
; 
; =  {of.input.V[20].O} {of.vgain[9].Z}
(assert (= of_46 of_2))
; 
; =  {sc.input.V[1].O} {sc.itov[6].K}
(assert (= sc_78 sc_98))
; 
; =  {of.input.V[1].O} {of.itov[6].K}
(assert (= of_78 of_98))
; 
...
(assert (= of_62 of_30))
; 
; =  {sc.input.V[18].O} {sc.vadd[10].OUT2_0}
(assert (= sc_82 sc_15))
; 
; =  {of.input.V[18].O} {of.vadd[10].OUT2_0}
(assert (= of_82 of_15))
; 
; =  {sc.input.V[16].O} {sc.itov[8].K}
(assert (= sc_70 sc_89))
; 
; =  {of.input.V[16].O} {of.itov[8].K}
(assert (= of_70 of_89))
; 
...
(assert (= of_76 of_38))
; 
; =  {sc.input.V[6].O} {sc.vadd[3].B}
(assert (= sc_66 sc_26))
; 
; =  {of.input.V[6].O} {of.vadd[3].B}
(assert (= of_66 of_26))
(assert (<= (* sc_7 0.001) 0.1))
; 
; =  {sc.vadd[5].OUT2} {sc.output.V[0].O} {sc.vadd[7].OUT2} {sc.vadd[10].OUT2} {sc.vadd[1].OUT2}
(assert (and (and (and (= sc_35 sc_7) (= sc_35 sc_14)) (= sc_35 sc_21)) (= sc_35 sc_42)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_0 0.) slbot_0 (- slbot_0))) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_20 0.) slbot_20 (- slbot_20))) (ite (>= sltop_27 0.) sltop_27 (- sltop_27))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= sltop_42 0.) sltop_42 (- sltop_42))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= sltop_100 0.) sltop_100 (- sltop_100))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= sltop_34 0.) sltop_34 (- sltop_34))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_86 0.) sltop_86 (- sltop_86))) (ite (>= slbot_42 0.) slbot_42 (- slbot_42))) (ite (>= slbot_34 0.) slbot_34 (- slbot_34))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_27 0.) slbot_27 (- slbot_27))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= sltop_41 0.) sltop_41 (- sltop_41))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_0 0.) sltop_0 (- sltop_0))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_41 0.) slbot_41 (- slbot_41))) (ite (>= sltop_20 0.) sltop_20 (- sltop_20))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_86 0.) slbot_86 (- slbot_86))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= slbot_100 0.) slbot_100 (- slbot_100))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
