...
(assert (= of_51 of_102))
; 
; =  {sc.input.I[0].O} {sc.switch[9].SUB}
(assert (= sc_8 sc_1))
; 
; =  {of.input.I[0].O} {of.switch[9].SUB}
(assert (= of_8 of_1))
; 
...
(assert (= of_71 of_45))
; 
; =  {sc.input.I[3].O} {sc.itov[7].X}
(assert (= sc_10 sc_93))
; 
; =  {of.input.I[3].O} {of.itov[7].X}
(assert (= of_10 of_93))
; 
; =  {sc.input.I[4].O} {sc.switch[9].Kmod}
(assert (= sc_12 sc_2))
; 
; =  {of.input.I[4].O} {of.switch[9].Kmod}
(assert (= of_12 of_2))
; 
