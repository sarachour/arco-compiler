...
(assert (= (+ (+ (* sc_10 0.84) of_10) sltop_10) 3300.))
...
(assert (= (+ (+ (* sc_11 0.84) of_11) sltop_11) 1650.))
(declare-fun slbot_12 () Real)
(declare-fun sltop_12 () Real)
; 
; =  {(((sc.vadd[7].OUT2*0.)+of.vadd[7].OUT2)+sl.min.vadd[7].OUT2)} {0.}
...
(assert (<= (+ (* sc_36 0.0396322130628) of_36) 3300.))
; 
; <=  {((sc.input.V[20].X*0.0396322130628)+of.input.V[20].X)} {0.}
(assert (>= (+ (* sc_36 0.0396322130628) of_36) 0.))
; 
; >=  {((sc.input.V[20].O*0.0396322130628)+of.input.V[20].O)} {3300.}
(assert (<= (+ (* sc_37 0.0396322130628) of_37) 3300.))
; 
; <=  {((sc.input.V[20].O*0.0396322130628)+of.input.V[20].O)} {0.}
(assert (>= (+ (* sc_37 0.0396322130628) of_37) 0.))
...
(assert (<= (+ (* sc_83 10.1) of_83) 330.))
; 
; <=  {((sc.itov[0].K*10.1)+of.itov[0].K)} {1.}
(assert (>= (+ (* sc_83 10.1) of_83) 1.))
(declare-fun slbot_84 () Real)
(declare-fun sltop_84 () Real)
; 
; =  {(((sc.itov[0].Y*0.)+of.itov[0].Y)+sl.min.itov[0].Y)} {0.0001}
...
(assert (= of_63 of_29))
; 
; =  {sc.input.V[2].O} {sc.itov[8].K}
(assert (= sc_35 sc_80))
; 
; =  {of.input.V[2].O} {of.itov[8].K}
(assert (= of_35 of_80))
; 
...
(assert (= of_69 of_83))
; 
; =  {sc.input.V[20].O} {sc.vgain[3].Y}
(assert (= sc_37 sc_1))
; 
; =  {of.input.V[20].O} {of.vgain[3].Y}
(assert (= of_37 of_1))
; 
...
(assert (and (and (and (= sc_12 sc_5) (= sc_12 sc_19)) (= sc_12 sc_33)) (= sc_12 sc_26)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= slbot_78 0.) slbot_78 (- slbot_78))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_10 0.) slbot_10 (- slbot_10))) (ite (>= slbot_11 0.) slbot_11 (- slbot_11))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= sltop_11 0.) sltop_11 (- sltop_11))) (ite (>= sltop_76 0.) sltop_76 (- sltop_76))) (ite (>= sltop_81 0.) sltop_81 (- sltop_81))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_79 0.) sltop_79 (- sltop_79))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= sltop_10 0.) sltop_10 (- sltop_10))) (ite (>= slbot_76 0.) slbot_76 (- slbot_76))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= sltop_5 0.) sltop_5 (- sltop_5))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= slbot_81 0.) slbot_81 (- slbot_81))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_5 0.) slbot_5 (- slbot_5))) (ite (>= sltop_78 0.) sltop_78 (- sltop_78))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= slbot_79 0.) slbot_79 (- slbot_79))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12)))))
(check-sat)
