...
; 
; =  {(((sc.vgain[7].X*1.)+of.vgain[7].X)+sl.max.vgain[7].X)} {3300.}
...
; 
; =  {(((sc.vgain[7].P*10.1)+of.vgain[7].P)+sl.max.vgain[7].P)} {5445000.}
...
; 
; =  {(((sc.vadd[8].B*10.1)+of.vadd[8].B)+sl.max.vadd[8].B)} {3300.}
...
; 
; =  {(((sc.vadd[5].B*9.26)+of.vadd[5].B)+sl.max.vadd[5].B)} {3300.}
...
(assert (= (+ (+ (* sc_85 0.84) of_85) sltop_85) 3300.))
; 
; >=  {((sc.itov[0].K*0.84)+of.itov[0].K)} {330.}
(assert (<= (+ (* sc_84 0.84) of_84) 330.))
; 
; <=  {((sc.itov[0].K*0.84)+of.itov[0].K)} {1.}
(assert (>= (+ (* sc_84 0.84) of_84) 1.))
(declare-fun slbot_85 () Real)
(declare-fun sltop_85 () Real)
; 
; =  {(((sc.itov[0].Y*0.)+of.itov[0].Y)+sl.min.itov[0].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_91 9.26) of_91) sltop_91) 3300.))
; 
