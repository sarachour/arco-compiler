...
(assert (= (+ (+ (* sc_35 9.26) of_35) sltop_35) 3300.))
...
(assert (= (+ (+ (* sc_105 12.616) of_105) sltop_105) 3300.))
; 
...
(assert (= of_50 of_34))
; 
; =  {sc.input.V[2].O} {sc.itov[2].K}
(assert (= sc_46 sc_92))
; 
; =  {of.input.V[2].O} {of.itov[2].K}
(assert (= of_46 of_92))
; 
...
(assert (= of_37 of_94))
; 
; =  {sc.input.V[19].O} {sc.vadd[6].OUT2_0}
(assert (= sc_88 sc_24))
; 
; =  {of.input.V[19].O} {of.vadd[6].OUT2_0}
(assert (= of_88 of_24))
; 
