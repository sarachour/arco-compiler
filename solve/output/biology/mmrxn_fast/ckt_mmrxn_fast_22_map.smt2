...
(assert (= of_96 of_25))
; 
; =  {sc.input.V[20].O} {sc.vgain[4].X}
(assert (= sc_46 sc_0))
; 
; =  {of.input.V[20].O} {of.vgain[4].X}
(assert (= of_46 of_0))
; 
...
(assert (= of_70 of_101))
; 
; =  {sc.input.V[18].O} {sc.vadd[5].OUT2_0}
(assert (= sc_82 sc_29))
; 
; =  {of.input.V[18].O} {of.vadd[5].OUT2_0}
(assert (= of_82 of_29))
; 
