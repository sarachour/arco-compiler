...
; 
; =  {(((sc.vgain[0].P*12.616)+of.vgain[0].P)+sl.max.vgain[0].P)} {5445000.}
...
; 
; =  {(((sc.vgain[3].P*10.1)+of.vgain[3].P)+sl.max.vgain[3].P)} {5445000.}
...
(assert (= (+ (+ (* sc_14 0.84) of_14) sltop_14) 3300.))
...
(assert (= (+ (+ (* sc_15 0.84) of_15) sltop_15) 1650.))
(declare-fun slbot_16 () Real)
(declare-fun sltop_16 () Real)
; 
; =  {(((sc.vadd[7].OUT2*0.)+of.vadd[7].OUT2)+sl.min.vadd[7].OUT2)} {0.}
...
; 
; =  {(((sc.vadd[4].D*12.616)+of.vadd[4].D)+sl.max.vadd[4].D)} {3300.}
...
; 
; =  {(((sc.vadd[4].B*10.1)+of.vadd[4].B)+sl.max.vadd[4].B)} {3300.}
...
(assert (<= (+ (* sc_32 10.1) of_32) 3300.))
; 
; <=  {((sc.vadd[1].D*10.1)+of.vadd[1].D)} {0.}
(assert (>= (+ (* sc_32 10.1) of_32) 0.))
; 
...
(assert (<= (+ (* sc_64 0.0396322130628) of_64) 3300.))
; 
; <=  {((sc.input.V[21].X*0.0396322130628)+of.input.V[21].X)} {0.}
(assert (>= (+ (* sc_64 0.0396322130628) of_64) 0.))
; 
; >=  {((sc.input.V[21].O*0.0396322130628)+of.input.V[21].O)} {3300.}
(assert (<= (+ (* sc_65 0.0396322130628) of_65) 3300.))
; 
; <=  {((sc.input.V[21].O*0.0396322130628)+of.input.V[21].O)} {0.}
(assert (>= (+ (* sc_65 0.0396322130628) of_65) 0.))
...
(assert (= (+ (+ (* sc_83 12.616) of_83) sltop_83) 330.))
(declare-fun slbot_84 () Real)
(declare-fun sltop_84 () Real)
; 
; =  {(((sc.itov[2].Y*0.)+of.itov[2].Y)+sl.min.itov[2].Y)} {0.0001}
...
(assert (= (+ (+ (* sc_93 0.84) of_93) sltop_93) 3300.))
; 
...
(assert (= of_84 of_35))
; 
; =  {sc.input.V[17].O} {sc.vadd[4].OUT2_0}
(assert (= sc_77 sc_24))
; 
; =  {of.input.V[17].O} {of.vadd[4].OUT2_0}
(assert (= of_77 of_24))
; 
...
(assert (= of_37 of_6))
; 
; =  {sc.vadd[1].OUT2} {sc.itov[8].X}
(assert (= sc_37 sc_85))
; 
; =  {of.vadd[1].OUT2} {of.itov[8].X}
(assert (= of_37 of_85))
; 
...
(assert (= of_63 of_89))
; 
; =  {sc.input.V[11].O} {sc.vadd[7].D}
(assert (= sc_55 sc_11))
; 
; =  {of.input.V[11].O} {of.vadd[7].D}
(assert (= of_55 of_11))
; 
...
(assert (= of_87 of_21))
; 
; =  {sc.input.V[8].O} {sc.vadd[7].OUT2_0}
(assert (= sc_43 sc_10))
; 
; =  {of.input.V[8].O} {of.vadd[7].OUT2_0}
(assert (= of_43 of_10))
; 
...
(assert (= of_49 of_19))
; 
; =  {sc.input.V[2].O} {sc.vgain[3].Y}
(assert (= sc_39 sc_5))
; 
; =  {of.input.V[2].O} {of.vgain[3].Y}
(assert (= of_39 of_5))
; 
...
(assert (= of_81 of_4))
; 
; =  {sc.input.V[21].O} {sc.vgain[0].Y}
(assert (= sc_65 sc_1))
; 
; =  {of.input.V[21].O} {of.vgain[0].Y}
(assert (= of_65 of_1))
; 
...
; 
; =  {sc.vadd[7].OUT2} {sc.output.V[0].O} {sc.vadd[9].OUT2} {sc.vadd[4].OUT2} {sc.vadd[1].OUT2}
(assert (and (and (and (= sc_16 sc_9) (= sc_16 sc_23)) (= sc_16 sc_30)) (= sc_16 sc_37)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= sltop_36 0.) sltop_36 (- sltop_36)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= slbot_29 0.) slbot_29 (- slbot_29))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= sltop_23 0.) sltop_23 (- sltop_23))) (ite (>= slbot_22 0.) slbot_22 (- slbot_22))) (ite (>= sltop_87 0.) sltop_87 (- sltop_87))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_91 0.) sltop_91 (- sltop_91))) (ite (>= slbot_35 0.) slbot_35 (- slbot_35))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= slbot_83 0.) slbot_83 (- slbot_83))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_84 0.) slbot_84 (- slbot_84))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_37 0.) slbot_37 (- slbot_37))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= sltop_29 0.) sltop_29 (- sltop_29))) (ite (>= slbot_36 0.) slbot_36 (- slbot_36))) (ite (>= sltop_82 0.) sltop_82 (- sltop_82))) (ite (>= slbot_85 0.) slbot_85 (- slbot_85))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= sltop_22 0.) sltop_22 (- sltop_22))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_82 0.) slbot_82 (- slbot_82))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_8 0.) sltop_8 (- sltop_8))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= sltop_85 0.) sltop_85 (- sltop_85))) (ite (>= slbot_9 0.) slbot_9 (- slbot_9))) (ite (>= sltop_9 0.) sltop_9 (- sltop_9))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= slbot_91 0.) slbot_91 (- slbot_91))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= slbot_30 0.) slbot_30 (- slbot_30))) (ite (>= slbot_87 0.) slbot_87 (- slbot_87))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= slbot_6 0.) slbot_6 (- slbot_6))) (ite (>= sltop_30 0.) sltop_30 (- sltop_30))) (ite (>= sltop_83 0.) sltop_83 (- sltop_83))) (ite (>= sltop_37 0.) sltop_37 (- sltop_37))) (ite (>= slbot_23 0.) slbot_23 (- slbot_23))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_35 0.) sltop_35 (- sltop_35))) (ite (>= sltop_6 0.) sltop_6 (- sltop_6))) (ite (>= sltop_84 0.) sltop_84 (- sltop_84))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= slbot_8 0.) slbot_8 (- slbot_8))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
