...
; 
; =  {(((sc.vgain[0].P*1.564384)+of.vgain[0].P)+sl.max.vgain[0].P)} {5445000.}
...
; 
; =  {(((sc.vgain[5].X*0.124)+of.vgain[5].X)+sl.max.vgain[5].X)} {3300.}
...
; 
; =  {(((sc.vgain[5].P*1.2524)+of.vgain[5].P)+sl.max.vgain[5].P)} {5445000.}
...
; 
; =  {(((sc.vadd[9].D*1.564384)+of.vadd[9].D)+sl.max.vadd[9].D)} {3300.}
(assert (= (+ (+ (* sc_21 1.564384) of_21) sltop_21) 3300.))
; 
...
; 
; =  {(((sc.vadd[9].OUT2*0.256)+of.vadd[9].OUT2)+sl.max.vadd[9].OUT2)} {3300.}
(assert (= (+ (+ (* sc_26 0.256) of_26) sltop_26) 3300.))
...
; 
; =  {(((sc.vadd[9].B*1.14824)+of.vadd[9].B)+sl.max.vadd[9].B)} {3300.}
(assert (= (+ (+ (* sc_24 1.14824) of_24) sltop_24) 3300.))
...
; 
; =  {(((sc.vadd[9].OUT*1.564384)+of.vadd[9].OUT)+sl.max.vadd[9].OUT)} {1650.}
(assert (= (+ (+ (* sc_25 1.564384) of_25) sltop_25) 1650.))
(declare-fun slbot_26 () Real)
(declare-fun sltop_26 () Real)
; 
; =  {(((sc.vadd[9].OUT2*0.)+of.vadd[9].OUT2)+sl.min.vadd[9].OUT2)} {0.}
...
; 
; =  {(((sc.vadd[6].D*3.229696)+of.vadd[6].D)+sl.max.vadd[6].D)} {3300.}
(assert (= (+ (+ (* sc_28 3.229696) of_28) sltop_28) 3300.))
; 
...
; 
; =  {(((sc.vadd[6].B*1.2524)+of.vadd[6].B)+sl.max.vadd[6].B)} {3300.}
(assert (= (+ (+ (* sc_31 1.2524) of_31) sltop_31) 3300.))
...
; 
; =  {(((sc.vadd[6].OUT*3.229696)+of.vadd[6].OUT)+sl.max.vadd[6].OUT)} {1650.}
(assert (= (+ (+ (* sc_32 3.229696) of_32) sltop_32) 1650.))
(declare-fun slbot_33 () Real)
(declare-fun sltop_33 () Real)
; 
; =  {(((sc.vadd[6].OUT2*0.)+of.vadd[6].OUT2)+sl.min.vadd[6].OUT2)} {0.}
...
(assert (= (+ (+ (* sc_38 0.10416) of_38) sltop_38) 3300.))
...
(assert (= (+ (+ (* sc_39 0.10416) of_39) sltop_39) 1650.))
(declare-fun slbot_40 () Real)
(declare-fun sltop_40 () Real)
; 
; =  {(((sc.vadd[4].OUT2*0.)+of.vadd[4].OUT2)+sl.min.vadd[4].OUT2)} {0.}
...
(assert (<= (+ (* sc_42 10.1) of_42) 3300.))
; 
; <=  {((sc.vadd[1].D*10.1)+of.vadd[1].D)} {0.}
(assert (>= (+ (* sc_42 10.1) of_42) 0.))
; 
...
(assert (= (+ (+ (* sc_47 0.124) of_47) sltop_47) 3300.))
...
(assert (= (+ (+ (* sc_45 0.400482304) of_45) sltop_45) 3300.))
...
(assert (= (+ (+ (* sc_46 0.400482304) of_46) sltop_46) 1650.))
(declare-fun slbot_47 () Real)
(declare-fun sltop_47 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2)} {0.}
...
(assert (<= (+ (* sc_80 0.049504950495) of_80) 3300.))
; 
...
(assert (<= (+ (* sc_81 0.049504950495) of_81) 3300.))
; 
; <=  {((sc.input.V[1].O*0.049504950495)+of.input.V[1].O)} {0.}
(assert (>= (+ (* sc_81 0.049504950495) of_81) 0.))
...
(assert (<= (+ (* sc_86 0.0396322130628) of_86) 3300.))
; 
...
(assert (<= (+ (* sc_87 0.0396322130628) of_87) 3300.))
; 
; <=  {((sc.input.V[19].O*0.0396322130628)+of.input.V[19].O)} {0.}
(assert (>= (+ (* sc_87 0.0396322130628) of_87) 0.))
...
(assert (= (+ (+ (* sc_90 0.400482304) of_90) sltop_90) 3300.))
...
(assert (= (+ (+ (* sc_89 1.564384) of_89) sltop_89) 330.))
(declare-fun slbot_90 () Real)
(declare-fun sltop_90 () Real)
; 
; =  {(((sc.itov[2].Y*0.)+of.itov[2].Y)+sl.min.itov[2].Y)} {0.0001}
...
(assert (= of_93 0.))
; 
; >=  {((sc.itov[8].X*9.26)+of.itov[8].X)} {10.}
(assert (<= (+ (* sc_91 9.26) of_91) 10.))
; 
; <=  {((sc.itov[8].X*9.26)+of.itov[8].X)} {0.0001}
...
; 
; =  {(((sc.itov[8].Y*1.14824)+of.itov[8].Y)+sl.max.itov[8].Y)} {3300.}
...
; 
; =  {(((sc.itov[7].X*0.256)+of.itov[7].X)+sl.max.itov[7].X)} {10.}
...
; 
; =  {(((sc.itov[7].Y*3.229696)+of.itov[7].Y)+sl.max.itov[7].Y)} {3300.}
(assert (= (+ (+ (* sc_96 3.229696) of_96) sltop_96) 3300.))
; 
...
; 
; =  {(((sc.itov[10].X*0.124)+of.itov[10].X)+sl.max.itov[10].X)} {10.}
...
; 
; =  {(((sc.itov[10].Y*1.564384)+of.itov[10].Y)+sl.max.itov[10].Y)} {3300.}
...
(assert (= of_102 0.))
; 
; >=  {((sc.itov[3].X*0.84)+of.itov[3].X)} {10.}
(assert (<= (+ (* sc_100 0.84) of_100) 10.))
; 
; <=  {((sc.itov[3].X*0.84)+of.itov[3].X)} {0.0001}
(assert (>= (+ (* sc_100 0.84) of_100) 0.0001))
...
(assert (= (+ (+ (* sc_102 0.10416) of_102) sltop_102) 3300.))
...
(assert (= of_40 of_18))
; 
; =  {sc.input.V[17].O} {sc.vgain[5].Z}
(assert (= sc_83 sc_6))
; 
; =  {of.input.V[17].O} {of.vgain[5].Z}
(assert (= of_83 of_6))
; 
...
(assert (= of_47 of_4))
; 
; =  {sc.vadd[1].OUT2} {sc.itov[8].K}
(assert (= sc_47 sc_92))
; 
; =  {of.vadd[1].OUT2} {of.itov[8].K}
(assert (= of_47 of_92))
; 
...
(assert (= of_47 of_16))
; 
; =  {sc.input.I[0].O} {sc.itov[8].X}
(assert (= sc_9 sc_91))
; 
; =  {of.input.I[0].O} {of.itov[8].X}
(assert (= of_9 of_91))
; 
...
(assert (= of_96 of_28))
; 
; =  {sc.input.V[19].O} {sc.vgain[0].Y}
(assert (= sc_87 sc_1))
; 
; =  {of.input.V[19].O} {of.vgain[0].Y}
(assert (= of_87 of_1))
; 
...
(assert (= of_79 of_34))
; 
; =  {sc.vadd[6].OUT2} {sc.vgain[0].Z}
(assert (= sc_33 sc_2))
; 
; =  {of.vadd[6].OUT2} {of.vgain[0].Z}
(assert (= of_33 of_2))
; 
...
(assert (= of_33 of_97))
; 
; =  {sc.vadd[6].OUT2} {sc.output.V[2].X}
(assert (= sc_33 sc_12))
; 
; =  {of.vadd[6].OUT2} {of.output.V[2].X}
(assert (= of_33 of_12))
; 
...
; 
; =  {sc.vadd[9].OUT2} {sc.output.V[0].O} {sc.vadd[4].OUT2} {sc.output.V[1].O} {sc.vadd[6].OUT2} {sc.output.V[2].O} {sc.vadd[1].OUT2} {sc.output.V[3].O}
(assert (and (and (and (and (and (and (= sc_26 sc_15) (= sc_26 sc_40)) (= sc_26 sc_19)) (= sc_26 sc_33)) (= sc_26 sc_13)) (= sc_26 sc_47)) (= sc_26 sc_17)))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (ite (>= slbot_92 0.) slbot_92 (- slbot_92)) (ite (>= slbot_14 0.) slbot_14 (- slbot_14))) (ite (>= sltop_96 0.) sltop_96 (- sltop_96))) (ite (>= sltop_14 0.) sltop_14 (- sltop_14))) (ite (>= sltop_18 0.) sltop_18 (- sltop_18))) (ite (>= slbot_16 0.) slbot_16 (- slbot_16))) (ite (>= sltop_32 0.) sltop_32 (- sltop_32))) (ite (>= sltop_90 0.) sltop_90 (- sltop_90))) (ite (>= sltop_4 0.) sltop_4 (- sltop_4))) (ite (>= slbot_3 0.) slbot_3 (- slbot_3))) (ite (>= slbot_46 0.) slbot_46 (- slbot_46))) (ite (>= slbot_26 0.) slbot_26 (- slbot_26))) (ite (>= slbot_2 0.) slbot_2 (- slbot_2))) (ite (>= slbot_18 0.) slbot_18 (- slbot_18))) (ite (>= slbot_96 0.) slbot_96 (- slbot_96))) (ite (>= slbot_99 0.) slbot_99 (- slbot_99))) (ite (>= sltop_2 0.) sltop_2 (- sltop_2))) (ite (>= sltop_13 0.) sltop_13 (- sltop_13))) (ite (>= sltop_15 0.) sltop_15 (- sltop_15))) (ite (>= sltop_24 0.) sltop_24 (- sltop_24))) (ite (>= sltop_31 0.) sltop_31 (- sltop_31))) (ite (>= sltop_94 0.) sltop_94 (- sltop_94))) (ite (>= slbot_28 0.) slbot_28 (- slbot_28))) (ite (>= slbot_45 0.) slbot_45 (- slbot_45))) (ite (>= sltop_19 0.) sltop_19 (- sltop_19))) (ite (>= slbot_38 0.) slbot_38 (- slbot_38))) (ite (>= sltop_45 0.) sltop_45 (- sltop_45))) (ite (>= sltop_17 0.) sltop_17 (- sltop_17))) (ite (>= sltop_3 0.) sltop_3 (- sltop_3))) (ite (>= sltop_40 0.) sltop_40 (- sltop_40))) (ite (>= slbot_7 0.) slbot_7 (- slbot_7))) (ite (>= sltop_99 0.) sltop_99 (- sltop_99))) (ite (>= slbot_12 0.) slbot_12 (- slbot_12))) (ite (>= slbot_89 0.) slbot_89 (- slbot_89))) (ite (>= slbot_13 0.) slbot_13 (- slbot_13))) (ite (>= slbot_32 0.) slbot_32 (- slbot_32))) (ite (>= sltop_101 0.) sltop_101 (- sltop_101))) (ite (>= slbot_88 0.) slbot_88 (- slbot_88))) (ite (>= slbot_101 0.) slbot_101 (- slbot_101))) (ite (>= sltop_88 0.) sltop_88 (- sltop_88))) (ite (>= slbot_19 0.) slbot_19 (- slbot_19))) (ite (>= sltop_28 0.) sltop_28 (- sltop_28))) (ite (>= sltop_7 0.) sltop_7 (- sltop_7))) (ite (>= sltop_38 0.) sltop_38 (- sltop_38))) (ite (>= slbot_15 0.) slbot_15 (- slbot_15))) (ite (>= slbot_17 0.) slbot_17 (- slbot_17))) (ite (>= sltop_39 0.) sltop_39 (- sltop_39))) (ite (>= sltop_89 0.) sltop_89 (- sltop_89))) (ite (>= sltop_92 0.) sltop_92 (- sltop_92))) (ite (>= sltop_12 0.) sltop_12 (- sltop_12))) (ite (>= slbot_31 0.) slbot_31 (- slbot_31))) (ite (>= slbot_90 0.) slbot_90 (- slbot_90))) (ite (>= slbot_25 0.) slbot_25 (- slbot_25))) (ite (>= slbot_24 0.) slbot_24 (- slbot_24))) (ite (>= slbot_4 0.) slbot_4 (- slbot_4))) (ite (>= sltop_16 0.) sltop_16 (- sltop_16))) (ite (>= sltop_102 0.) sltop_102 (- sltop_102))) (ite (>= slbot_21 0.) slbot_21 (- slbot_21))) (ite (>= slbot_93 0.) slbot_93 (- slbot_93))) (ite (>= sltop_97 0.) sltop_97 (- sltop_97))) (ite (>= sltop_47 0.) sltop_47 (- sltop_47))) (ite (>= sltop_93 0.) sltop_93 (- sltop_93))) (ite (>= slbot_94 0.) slbot_94 (- slbot_94))) (ite (>= sltop_46 0.) sltop_46 (- sltop_46))) (ite (>= sltop_25 0.) sltop_25 (- sltop_25))) (ite (>= sltop_26 0.) sltop_26 (- sltop_26))) (ite (>= slbot_39 0.) slbot_39 (- slbot_39))) (ite (>= slbot_47 0.) slbot_47 (- slbot_47))) (ite (>= slbot_33 0.) slbot_33 (- slbot_33))) (ite (>= sltop_33 0.) sltop_33 (- sltop_33))) (ite (>= slbot_40 0.) slbot_40 (- slbot_40))) (ite (>= slbot_97 0.) slbot_97 (- slbot_97))) (ite (>= slbot_102 0.) slbot_102 (- slbot_102))) (ite (>= sltop_21 0.) sltop_21 (- sltop_21)))))
(check-sat)
