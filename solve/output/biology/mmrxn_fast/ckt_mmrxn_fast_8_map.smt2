...
(assert (= of_68 of_18))
; 
; =  {sc.input.V[11].O} {sc.vadd[7].C}
(assert (= sc_60 sc_10))
; 
; =  {of.input.V[11].O} {of.vadd[7].C}
(assert (= of_60 of_10))
; 
...
(assert (= of_90 of_9))
; 
; =  {sc.input.V[12].O} {sc.vadd[7].A}
(assert (= sc_54 sc_11))
; 
; =  {of.input.V[12].O} {of.vadd[7].A}
(assert (= of_54 of_11))
; 
...
(assert (= of_21 of_88))
; 
; =  {sc.input.V[20].O} {sc.vgain[6].X}
(assert (= sc_46 sc_0))
; 
; =  {of.input.V[20].O} {of.vgain[6].X}
(assert (= of_46 of_0))
; 
