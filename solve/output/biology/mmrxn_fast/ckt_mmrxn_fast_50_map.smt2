...
(assert (= of_84 of_83))
; 
; >=  {((sc.input.V[17].X*20.2)+of.input.V[17].X)} {3300.}
(assert (<= (+ (* sc_83 20.2) of_83) 3300.))
; 
; <=  {((sc.input.V[17].X*20.2)+of.input.V[17].X)} {0.}
(assert (>= (+ (* sc_83 20.2) of_83) 0.))
; 
; >=  {((sc.input.V[17].O*20.2)+of.input.V[17].O)} {3300.}
(assert (<= (+ (* sc_84 20.2) of_84) 3300.))
; 
; <=  {((sc.input.V[17].O*20.2)+of.input.V[17].O)} {0.}
(assert (>= (+ (* sc_84 20.2) of_84) 0.))
...
(assert (= of_96 of_42))
; 
; =  {sc.input.V[22].O} {sc.vgain[2].Y}
(assert (= sc_90 sc_1))
; 
; =  {of.input.V[22].O} {of.vgain[2].Y}
(assert (= of_90 of_1))
; 
