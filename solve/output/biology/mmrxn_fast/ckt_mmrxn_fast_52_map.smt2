...
(assert (= (+ (+ (* sc_39 12.616) of_39) sltop_39) 3300.))
; 
...
(assert (= (+ (+ (* sc_42 10.1) of_42) sltop_42) 3300.))
...
(assert (= (+ (+ (* sc_43 12.616) of_43) sltop_43) 1650.))
(declare-fun slbot_44 () Real)
(declare-fun sltop_44 () Real)
; 
; =  {(((sc.vadd[1].OUT2*0.)+of.vadd[1].OUT2)+sl.min.vadd[1].OUT2)} {0.}
...
(assert (= of_56 of_10))
; 
; =  {sc.input.V[3].O} {sc.vgain[0].Y}
(assert (= sc_76 sc_5))
; 
; =  {of.input.V[3].O} {of.vgain[0].Y}
(assert (= of_76 of_5))
; 
