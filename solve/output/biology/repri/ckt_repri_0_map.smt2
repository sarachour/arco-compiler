...
; 
; >=  {((sc.vdadd[10].OUT_0*10.)+of.vdadd[10].OUT_0)} {3300.}
(assert (<= (+ (* sc_29 10.) of_29) 3300.))
; 
; <=  {((sc.vdadd[10].OUT_0*10.)+of.vdadd[10].OUT_0)} {0.}
(assert (>= (+ (* sc_29 10.) of_29) 0.))
...
; 
; >=  {((sc.vdadd[6].OUT_0*20.)+of.vdadd[6].OUT_0)} {3300.}
(assert (<= (+ (* sc_34 20.) of_34) 3300.))
; 
; <=  {((sc.vdadd[6].OUT_0*20.)+of.vdadd[6].OUT_0)} {0.}
(assert (>= (+ (* sc_34 20.) of_34) 0.))
...
; 
; >=  {((sc.input.V[3].X*10.)+of.input.V[3].X)} {3300.}
(assert (<= (+ (* sc_118 10.) of_118) 3300.))
; 
; <=  {((sc.input.V[3].X*10.)+of.input.V[3].X)} {0.}
(assert (>= (+ (* sc_118 10.) of_118) 0.))
; 
; >=  {((sc.input.V[3].O*10.)+of.input.V[3].O)} {3300.}
(assert (<= (+ (* sc_119 10.) of_119) 3300.))
; 
; <=  {((sc.input.V[3].O*10.)+of.input.V[3].O)} {0.}
(assert (>= (+ (* sc_119 10.) of_119) 0.))
...
(assert (= of_59 of_15))
; 
; =  {sc.input.V[9].O} {sc.vdadd[10].B}
(assert (= sc_103 sc_31))
; 
; =  {of.input.V[9].O} {of.vdadd[10].B}
(assert (= of_103 of_31))
; 
...
(assert (= of_79 of_132))
; 
; =  {sc.vdadd[10].OUT} {sc.ihill_rep[7].S}
(assert (= sc_32 sc_4))
; 
; =  {of.vdadd[10].OUT} {of.ihill_rep[7].S}
(assert (= of_32 of_4))
; 
...
(assert (= of_69 of_16))
; 
; =  {sc.input.V[13].O} {sc.vdadd[4].B}
(assert (= sc_99 sc_46))
; 
; =  {of.input.V[13].O} {of.vdadd[4].B}
(assert (= of_99 of_46))
; 
...
(assert (= of_37 of_90))
; 
; =  {sc.vdadd[6].OUT} {sc.ihill_rep[11].S}
(assert (= sc_37 sc_9))
; 
; =  {of.vdadd[6].OUT} {of.ihill_rep[11].S}
(assert (= of_37 of_9))
; 
...
(assert (= of_27 of_80))
; 
; =  {sc.input.V[11].O} {sc.vdadd[0].A}
(assert (= sc_107 sc_25))
; 
; =  {of.input.V[11].O} {of.vdadd[0].A}
(assert (= of_107 of_25))
; 
; =  {sc.input.V[8].O} {sc.vdadd[6].B}
(assert (= sc_95 sc_36))
; 
; =  {of.input.V[8].O} {of.vdadd[6].B}
(assert (= of_95 of_36))
; 
; =  {sc.input.V[12].O} {sc.vdadd[8].A}
(assert (= sc_101 sc_20))
; 
; =  {of.input.V[12].O} {of.vdadd[8].A}
(assert (= of_101 of_20))
; 
...
(assert (= of_93 of_3))
; 
; =  {sc.input.V[3].O} {sc.vdadd[10].OUT_0}
(assert (= sc_119 sc_29))
; 
; =  {of.input.V[3].O} {of.vdadd[10].OUT_0}
(assert (= of_119 of_29))
; 
...
(assert (= of_22 of_84))
; 
; =  {sc.input.V[10].O} {sc.vdadd[8].OUT_0}
(assert (= sc_109 sc_19))
; 
; =  {of.input.V[10].O} {of.vdadd[8].OUT_0}
(assert (= of_109 of_19))
; 
...
(assert (= of_47 of_82))
; 
; =  {sc.input.V[16].O} {sc.vdadd[6].OUT_0}
(assert (= sc_117 sc_34))
; 
; =  {of.input.V[16].O} {of.vdadd[6].OUT_0}
(assert (= of_117 of_34))
; 
...
(assert (= of_131 of_30))
; 
; =  {sc.input.V[4].O} {sc.vdadd[0].OUT_0}
(assert (= sc_121 sc_24))
; 
; =  {of.input.V[4].O} {of.vdadd[0].OUT_0}
(assert (= of_121 of_24))
; 
; =  {sc.input.V[5].O} {sc.vdadd[3].OUT_0}
(assert (= sc_123 sc_39))
; 
; =  {of.input.V[5].O} {of.vdadd[3].OUT_0}
(assert (= of_123 of_39))
; 
; =  {sc.input.V[6].O} {sc.vdadd[3].B}
(assert (= sc_113 sc_41))
; 
; =  {of.input.V[6].O} {of.vdadd[3].B}
(assert (= of_113 of_41))
; 
...
(assert (<= (* (/ 1. sc_83) 1) 100.))
(assert (not (= 1. sc_83)))
(assert (<= (* (/ 1. sc_91) 1) 100.))
(assert (<= (* (/ 1. sc_91) 1) 100.))
(assert (not (= 1. sc_91)))
(assert (<= (* (/ 1. sc_81) 1) 100.))
(assert (<= (* (/ 1. sc_81) 1) 100.))
(assert (not (= 1. sc_81)))
(assert (<= (* (/ 1. sc_85) 1) 100.))
(assert (<= (* (/ 1. sc_85) 1) 100.))
(assert (not (= 1. sc_85)))
(assert (<= (* (/ 1. sc_87) 1) 100.))
(assert (<= (* (/ 1. sc_87) 1) 100.))
(assert (not (= 1. sc_87)))
(assert (<= (* (/ 1. sc_89) 1) 100.))
(assert (<= (* (/ 1. sc_89) 1) 100.))
(assert (not (= 1. sc_89)))
(assert (not (= 1. sc_17)))
(assert (not (= 1. sc_12)))
