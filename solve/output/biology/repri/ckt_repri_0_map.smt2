...
; 
; =  {(((sc.vgain[2].P*180.617997398)+of.vgain[2].P)+sl.max.vgain[2].P.1)} {5000.}
(assert (= (+ (+ (* sc_2 180.617997398) of_2) sltop_2_1) 5000.))
...
; 
; =  {(((sc.vgain[2].Z*60.)+of.vgain[2].Z)+sl.max.vgain[2].Z.1)} {10.}
(assert (= (+ (+ (* sc_1 60.) of_1) sltop_1_1) 10.))
...
; 
; =  {(((sc.ihill_rep[7].S*180.)+of.ihill_rep[7].S)+sl.max.ihill_rep[7].S.1)} {10.}
(assert (= (+ (+ (* sc_4 180.) of_4) sltop_4_1) 10.))
(declare-fun slbot_7_1 () Real)
(assert (<= slbot_7_1 1e-08))
(declare-fun sltop_7_1 () Real)
(assert (>= sltop_7_1 1e-08))
; 
; =  {(((sc.ihill_rep[7].REP*0.0235058823529)+of.ihill_rep[7].REP)+sl.min.ihill_rep[7].REP.1)} {0.}
(assert (= (+ (+ (* sc_7 0.0235058823529) of_7) slbot_7_1) 0.))
; 
...
; 
; =  {(((sc.ihill_rep[11].S*180.)+of.ihill_rep[11].S)+sl.max.ihill_rep[11].S.1)} {10.}
(assert (= (+ (+ (* sc_9 180.) of_9) sltop_9_1) 10.))
(declare-fun slbot_12_1 () Real)
(assert (<= slbot_12_1 1e-08))
(declare-fun sltop_12_1 () Real)
(assert (>= sltop_12_1 1e-08))
; 
; =  {(((sc.ihill_rep[11].REP*0.0235058823529)+of.ihill_rep[11].REP)+sl.min.ihill_rep[11].REP.1)} {0.}
(assert (= (+ (+ (* sc_12 0.0235058823529) of_12) slbot_12_1) 0.))
; 
...
; 
; =  {(((sc.ihill_rep[1].S*180.)+of.ihill_rep[1].S)+sl.max.ihill_rep[1].S.1)} {10.}
(assert (= (+ (+ (* sc_14 180.) of_14) sltop_14_1) 10.))
(declare-fun slbot_17_1 () Real)
(assert (<= slbot_17_1 1e-08))
(declare-fun sltop_17_1 () Real)
(assert (>= sltop_17_1 1e-08))
; 
; =  {(((sc.ihill_rep[1].REP*0.0235058823529)+of.ihill_rep[1].REP)+sl.min.ihill_rep[1].REP.1)} {0.}
(assert (= (+ (+ (* sc_17 0.0235058823529) of_17) slbot_17_1) 0.))
; 
...
; 
; =  {(((sc.vdadd[8].OUT*60.)+of.vdadd[8].OUT)+sl.max.vdadd[8].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_22 60.) of_22) sltop_22_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[8].B*0.0235058823529)+of.vdadd[8].B)+sl.min.vdadd[8].B.1)} {0.}
(assert (= (+ (+ (* sc_21 0.0235058823529) of_21) slbot_21_1) 0.))
; 
...
; 
; =  {(((sc.vdadd[0].OUT*60.)+of.vdadd[0].OUT)+sl.max.vdadd[0].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_27 60.) of_27) sltop_27_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[0].B*0.0235058823529)+of.vdadd[0].B)+sl.min.vdadd[0].B.1)} {0.}
(assert (= (+ (+ (* sc_26 0.0235058823529) of_26) slbot_26_1) 0.))
; 
...
; 
; =  {(((sc.vdadd[10].OUT*180.)+of.vdadd[10].OUT)+sl.max.vdadd[10].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_32 180.) of_32) sltop_32_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[10].A*180.617997398)+of.vdadd[10].A)+sl.max.vdadd[10].A.1)} {3300.}
(assert (= (+ (+ (* sc_30 180.617997398) of_30) sltop_30_1) 3300.))
; 
...
; 
; =  {(((sc.vdadd[6].OUT*60.)+of.vdadd[6].OUT)+sl.max.vdadd[6].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_37 60.) of_37) sltop_37_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[6].A*0.0235058823529)+of.vdadd[6].A)+sl.min.vdadd[6].A.1)} {0.}
(assert (= (+ (+ (* sc_35 0.0235058823529) of_35) slbot_35_1) 0.))
; 
...
; 
; =  {(((sc.vdadd[3].OUT*180.)+of.vdadd[3].OUT)+sl.max.vdadd[3].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_42 180.) of_42) sltop_42_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[3].A*180.617997398)+of.vdadd[3].A)+sl.max.vdadd[3].A.1)} {3300.}
(assert (= (+ (+ (* sc_40 180.617997398) of_40) sltop_40_1) 3300.))
; 
...
; 
; =  {(((sc.vdadd[5].OUT*180.)+of.vdadd[5].OUT)+sl.max.vdadd[5].OUT.1)} {12000.}
(assert (= (+ (+ (* sc_47 180.) of_47) sltop_47_1) 12000.))
; 
...
; 
; =  {(((sc.vdadd[5].A*180.617997398)+of.vdadd[5].A)+sl.max.vdadd[5].A.1)} {3300.}
(assert (= (+ (+ (* sc_45 180.617997398) of_45) sltop_45_1) 3300.))
; 
...
; 
; =  {(((sc.output.V[2].X*60.)+of.output.V[2].X)+sl.max.output.V[2].X.1)} {3300.}
(assert (= (+ (+ (* sc_72 60.) of_72) sltop_72_1) 3300.))
...
; 
; =  {(((sc.output.V[2].O*60.)+of.output.V[2].O)+sl.max.output.V[2].O.1)} {3300.}
(assert (= (+ (+ (* sc_73 60.) of_73) sltop_73_1) 3300.))
...
; 
; =  {(((sc.output.V[0].X*60.)+of.output.V[0].X)+sl.max.output.V[0].X.1)} {3300.}
(assert (= (+ (+ (* sc_74 60.) of_74) sltop_74_1) 3300.))
...
; 
; =  {(((sc.output.V[0].O*60.)+of.output.V[0].O)+sl.max.output.V[0].O.1)} {3300.}
(assert (= (+ (+ (* sc_75 60.) of_75) sltop_75_1) 3300.))
...
; 
; =  {(((sc.output.V[3].X*60.)+of.output.V[3].X)+sl.max.output.V[3].X.1)} {3300.}
(assert (= (+ (+ (* sc_76 60.) of_76) sltop_76_1) 3300.))
...
; 
; =  {(((sc.output.V[3].O*60.)+of.output.V[3].O)+sl.max.output.V[3].O.1)} {3300.}
(assert (= (+ (+ (* sc_77 60.) of_77) sltop_77_1) 3300.))
...
; 
; =  {(((sc.output.V[4].X*180.)+of.output.V[4].X)+sl.max.output.V[4].X.1)} {3300.}
(assert (= (+ (+ (* sc_78 180.) of_78) sltop_78_1) 3300.))
...
; 
; =  {(((sc.output.V[4].O*180.)+of.output.V[4].O)+sl.max.output.V[4].O.1)} {3300.}
(assert (= (+ (+ (* sc_79 180.) of_79) sltop_79_1) 3300.))
...
; 
; =  {(((sc.output.V[5].X*180.)+of.output.V[5].X)+sl.max.output.V[5].X.1)} {3300.}
(assert (= (+ (+ (* sc_80 180.) of_80) sltop_80_1) 3300.))
...
; 
; =  {(((sc.output.V[5].O*180.)+of.output.V[5].O)+sl.max.output.V[5].O.1)} {3300.}
(assert (= (+ (+ (* sc_81 180.) of_81) sltop_81_1) 3300.))
...
; 
; =  {(((sc.output.V[1].X*180.)+of.output.V[1].X)+sl.max.output.V[1].X.1)} {3300.}
(assert (= (+ (+ (* sc_82 180.) of_82) sltop_82_1) 3300.))
...
; 
; =  {(((sc.output.V[1].O*180.)+of.output.V[1].O)+sl.max.output.V[1].O.1)} {3300.}
(assert (= (+ (+ (* sc_83 180.) of_83) sltop_83_1) 3300.))
...
; 
; =  {(((sc.itov[9].X*60.)+of.itov[9].X)+sl.max.itov[9].X.1)} {10.}
(assert (= (+ (+ (* sc_120 60.) of_120) sltop_120_1) 10.))
...
; 
; =  {(((sc.itov[9].Y*180.617997398)+of.itov[9].Y)+sl.max.itov[9].Y.1)} {3300.}
(assert (= (+ (+ (* sc_122 180.617997398) of_122) sltop_122_1) 3300.))
; 
...
; 
; =  {(((sc.itov[4].X*60.)+of.itov[4].X)+sl.max.itov[4].X.1)} {10.}
(assert (= (+ (+ (* sc_123 60.) of_123) sltop_123_1) 10.))
...
; 
; =  {(((sc.itov[4].Y*180.617997398)+of.itov[4].Y)+sl.max.itov[4].Y.1)} {3300.}
(assert (= (+ (+ (* sc_125 180.617997398) of_125) sltop_125_1) 3300.))
; 
...
(assert (= of_42 of_82))
; 
; =  {sc.vdadd[3].OUT} {sc.ihill_rep[11].S}
(assert (= sc_42 sc_9))
; 
; =  {of.vdadd[3].OUT} {of.ihill_rep[11].S}
(assert (= of_42 of_9))
; 
...
(assert (= of_63 of_23))
; 
; =  {sc.vdadd[5].OUT} {sc.ihill_rep[1].S}
(assert (= sc_47 sc_14))
; 
; =  {of.vdadd[5].OUT} {of.ihill_rep[1].S}
(assert (= of_47 of_14))
; 
...
(assert (= of_57 of_15))
; 
; =  {sc.input.V[9].O} {sc.vdadd[8].OUT_0}
(assert (= sc_95 sc_19))
; 
; =  {of.input.V[9].O} {of.vdadd[8].OUT_0}
(assert (= of_95 of_19))
; 
...
(assert (= of_65 of_16))
; 
; =  {sc.input.V[13].O} {sc.vdadd[8].A}
(assert (= sc_91 sc_20))
; 
; =  {of.input.V[13].O} {of.vdadd[8].A}
(assert (= of_91 of_20))
; 
...
(assert (= of_27 of_1))
; 
; =  {sc.input.V[11].O} {sc.vdadd[10].OUT_0}
(assert (= sc_99 sc_29))
; 
; =  {of.input.V[11].O} {of.vdadd[10].OUT_0}
(assert (= of_99 of_29))
; 
; =  {sc.input.V[8].O} {sc.vdadd[6].OUT_0}
(assert (= sc_87 sc_34))
; 
; =  {of.input.V[8].O} {of.vdadd[6].OUT_0}
(assert (= of_87 of_34))
; 
...
(assert (= of_93 of_25))
; 
; =  {sc.input.V[3].O} {sc.vdadd[0].OUT_0}
(assert (= sc_111 sc_24))
; 
; =  {of.input.V[3].O} {of.vdadd[0].OUT_0}
(assert (= of_111 of_24))
; 
...
(assert (= of_97 of_13))
; 
; =  {sc.input.V[10].O} {sc.vdadd[10].B}
(assert (= sc_101 sc_31))
; 
; =  {of.input.V[10].O} {of.vdadd[10].B}
(assert (= of_101 of_31))
; 
...
(assert (= of_122 of_30))
; 
; =  {sc.input.V[5].O} {sc.vdadd[3].B}
(assert (= sc_115 sc_41))
; 
; =  {of.input.V[5].O} {of.vdadd[3].B}
(assert (= of_115 of_41))
; 
; =  {sc.input.V[4].O} {sc.vdadd[3].OUT_0}
(assert (= sc_113 sc_39))
; 
; =  {of.input.V[4].O} {of.vdadd[3].OUT_0}
(assert (= of_113 of_39))
; 
; =  {sc.input.V[6].O} {sc.vdadd[5].OUT_0}
(assert (= sc_105 sc_44))
; 
; =  {of.input.V[6].O} {of.vdadd[5].OUT_0}
(assert (= of_105 of_44))
; 
