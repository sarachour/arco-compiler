...
(assert (= (+ (+ (* sc_38 0.11) of_38) sltop_38) 1.))
...
(assert (<= (+ (* sc_48 0.11) of_48) 3300.))
; 
; <=  {((sc.input.V[0].X*0.11)+of.input.V[0].X)} {0.}
(assert (>= (+ (* sc_48 0.11) of_48) 0.))
; 
; >=  {((sc.input.V[0].O*0.11)+of.input.V[0].O)} {3300.}
(assert (<= (+ (* sc_49 0.11) of_49) 3300.))
; 
...
(assert (= of_5 of_66))
; 
; =  {sc.vtoi[2].Y} {sc.iadd[4].D}
(assert (= sc_31 sc_63))
; 
; =  {of.vtoi[2].Y} {of.iadd[4].D}
(assert (= of_31 of_63))
; 
