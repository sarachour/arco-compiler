...
(assert (= of_8 0.))
; 
; >=  {((sc.switch[1].n*0.)+of.switch[1].n)} {5.}
(assert (<= (+ (* sc_5 0.) of_5) 5.))
; 
; <=  {((sc.switch[1].n*0.)+of.switch[1].n)} {0.5}
...
; 
; =  {(((sc.switch[1].Vmax*1.)+of.switch[1].Vmax)+sl.max.switch[1].Vmax)} {10.}
(assert (= (+ (+ (* sc_7 1.) of_7) sltop_7) 10.))
(declare-fun slbot_8 () Real)
(declare-fun sltop_8 () Real)
; 
; =  {(((sc.switch[1].PROD*0.)+of.switch[1].PROD)+sl.min.switch[1].PROD)} {6.20921323059e-10}
(assert (= (+ (+ (* sc_8 0.) of_8) slbot_8) 6.20921323059e-10))
; 
; =  {(((sc.switch[1].PROD*1.)+of.switch[1].PROD)+sl.max.switch[1].PROD)} {9.99995000037}
...
(assert (<= (+ (* sc_38 0.11) of_38) 3300.))
; 
; <=  {((sc.mm[0].Xtot*0.11)+of.mm[0].Xtot)} {0.0001}
(assert (>= (+ (* sc_38 0.11) of_38) 0.0001))
...
; 
; =  {sc.switch[1].PROD} {sc.iadd[4].D}
(assert (= sc_8 sc_63))
; 
; =  {of.switch[1].PROD} {of.iadd[4].D}
(assert (= of_8 of_63))
; 
...
(assert (= of_33 of_19))
; 
; =  {sc.vadd[2].OUT2} {sc.switch[1].Vmax}
(assert (= sc_33 sc_7))
; 
; =  {of.vadd[2].OUT2} {of.switch[1].Vmax}
(assert (= of_33 of_7))
; 
...
(assert (= of_39 of_21))
; 
; =  {sc.input.V[8].O} {sc.switch[1].n}
(assert (= sc_45 sc_5))
; 
; =  {of.input.V[8].O} {of.switch[1].n}
(assert (= of_45 of_5))
; 
