...
; 
; =  {(((sc.mm[2].X*0.11)+of.mm[2].X)+sl.max.mm[2].X.1)} {3300.}
...
; 
; =  {(((sc.mm[2].Y*0.15)+of.mm[2].Y)+sl.max.mm[2].Y.1)} {3300.}
(assert (= (+ (+ (* sc_30 0.15) of_30) sltop_30_1) 3300.))
; 
; >=  {((sc.mm[2].Ytot*0.15)+of.mm[2].Ytot)} {3300.}
(assert (<= (+ (* sc_25 0.15) of_25) 3300.))
; 
; <=  {((sc.mm[2].Ytot*0.15)+of.mm[2].Ytot)} {0.0001}
(assert (>= (+ (* sc_25 0.15) of_25) 0.0001))
; 
; >=  {((sc.mm[2].Xtot*0.11)+of.mm[2].Xtot)} {3300.}
(assert (<= (+ (* sc_27 0.11) of_27) 3300.))
; 
; <=  {((sc.mm[2].Xtot*0.11)+of.mm[2].Xtot)} {0.0001}
...
(assert (= of_42 of_1))
; 
; =  {sc.input.V[4].O} {sc.mm[2].Ytot}
(assert (= sc_40 sc_25))
; 
; =  {of.input.V[4].O} {of.mm[2].Ytot}
(assert (= of_40 of_25))
; 
