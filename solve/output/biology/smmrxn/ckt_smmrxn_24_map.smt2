...
; 
; =  {sc.input.I[6].O} {sc.mm[0].kf}
(assert (= sc_11 sc_38))
; 
; =  {of.input.I[6].O} {of.mm[0].kf}
(assert (= of_11 of_38))
; 
...
(assert (= of_73 of_76))
; 
; =  {sc.iadd[5].OUT} {sc.vgain[1].Z}
(assert (= sc_73 sc_2))
; 
; =  {of.iadd[5].OUT} {of.vgain[1].Z}
(assert (= of_73 of_2))
; 
...
(assert (= of_19 of_67))
; 
; =  {sc.input.I[7].O} {sc.mm[0].kr}
(assert (= sc_7 sc_35))
; 
; =  {of.input.I[7].O} {of.mm[0].kr}
(assert (= of_7 of_35))
; 
...
(assert (= of_41 of_64))
; 
; =  {sc.mm[0].XY} {sc.iadd[5].D}
(assert (= sc_41 sc_69))
; 
; =  {of.mm[0].XY} {of.iadd[5].D}
(assert (= of_41 of_69))
; 
...
(assert (and (and (= sc_21 sc_25) (= sc_21 sc_34)) (= sc_21 sc_41)))
