...
; 
; =  {(((sc.mm[3].X*0.15)+of.mm[3].X)+sl.max.mm[3].X.1)} {3300.}
...
; 
; =  {(((sc.mm[3].Y*0.11)+of.mm[3].Y)+sl.max.mm[3].Y.1)} {3300.}
...
(assert (= of_36 of_25))
; 
; =  {sc.input.V[4].O} {sc.mm[3].Xtot}
(assert (= sc_42 sc_27))
; 
; =  {of.input.V[4].O} {of.mm[3].Xtot}
(assert (= of_42 of_27))
; 
...
(assert (= of_44 of_1))
; 
; =  {sc.input.V[6].O} {sc.vgain[0].X}
(assert (= sc_38 sc_0))
; 
; =  {of.input.V[6].O} {of.vgain[0].X}
(assert (= of_38 of_0))
