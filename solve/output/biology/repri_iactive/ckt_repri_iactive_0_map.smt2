...
(assert (= of_1 0.))
; 
; =  {sc.vgain[0].P} {(sc.vgain[0].X*sc.vgain[0].Z)}
...
; 
; =  {(((sc.vgain[0].X*0.)+of.vgain[0].X)+sl.min.vgain[0].X.1)} {0.}
(assert (= (+ (+ (* sc_0 0.) of_0) slbot_0_1) 0.))
; 
; =  {(((sc.vgain[0].X*10.)+of.vgain[0].X)+sl.max.vgain[0].X.1)} {500.}
(assert (= (+ (+ (* sc_0 10.) of_0) sltop_0_1) 500.))
...
; 
; =  {(((sc.vgain[0].P*30.1029995664)+of.vgain[0].P)+sl.max.vgain[0].P.1)} {5000.}
(assert (= (+ (+ (* sc_2 30.1029995664) of_2) sltop_2_1) 5000.))
; 
; >=  {((sc.vgain[0].Z*3.01029995664)+of.vgain[0].Z)} {10.}
(assert (<= (+ (* sc_1 3.01029995664) of_1) 10.))
; 
; <=  {((sc.vgain[0].Z*3.01029995664)+of.vgain[0].Z)} {0.}
...
(assert (= of_3 0.))
; 
; =  {(sc.ihill_rep[2].Km^2)} {(sc.ihill_rep[2].S^2)}
...
(assert (= 0. 0.))
; 
; =  {sc.ihill_rep[2].REP} {(sc.ihill_rep[2].Vmax*((sc.ihill_rep[2].Km^2)/(sc.ihill_rep[2].Km^2)))}
(assert (= sc_7 (* sc_6 (/ (^ sc_5 2) (^ sc_5 2)))))
; 
; =  {of.ihill_rep[2].REP} {0.}
(assert (= of_7 0.))
; 
; >=  {((sc.ihill_rep[2].n*2.)+of.ihill_rep[2].n)} {5.}
(assert (<= (+ (* sc_3 2.) of_3) 5.))
; 
; <=  {((sc.ihill_rep[2].n*2.)+of.ihill_rep[2].n)} {1.}
...
; 
; =  {(((sc.ihill_rep[2].S*0.)+of.ihill_rep[2].S)+sl.min.ihill_rep[2].S.1)} {0.}
(assert (= (+ (+ (* sc_4 0.) of_4) slbot_4_1) 0.))
; 
; =  {(((sc.ihill_rep[2].S*100.)+of.ihill_rep[2].S)+sl.max.ihill_rep[2].S.1)} {10.}
...
; 
; =  {(((sc.ihill_rep[2].REP*0.0192115384615)+of.ihill_rep[2].REP)+sl.min.ihill_rep[2].REP.1)} {0.}
(assert (= (+ (+ (* sc_7 0.0192115384615) of_7) slbot_7_1) 0.))
; 
; =  {(((sc.ihill_rep[2].REP*0.4995)+of.ihill_rep[2].REP)+sl.max.ihill_rep[2].REP.1)} {1000000.}
(assert (= (+ (+ (* sc_7 0.4995) of_7) sltop_7_1) 1000000.))
; 
; >=  {((sc.ihill_rep[2].Km*20.)+of.ihill_rep[2].Km)} {10.}
(assert (<= (+ (* sc_5 20.) of_5) 10.))
; 
; <=  {((sc.ihill_rep[2].Km*20.)+of.ihill_rep[2].Km)} {1.}
(assert (>= (+ (* sc_5 20.) of_5) 1.))
; 
; >=  {((sc.ihill_rep[2].Vmax*0.4995)+of.ihill_rep[2].Vmax)} {10.}
(assert (<= (+ (* sc_6 0.4995) of_6) 10.))
; 
; <=  {((sc.ihill_rep[2].Vmax*0.4995)+of.ihill_rep[2].Vmax)} {0.}
...
(assert (= of_8 0.))
; 
; =  {(sc.ihill_rep[9].Km^2)} {(sc.ihill_rep[9].S^2)}
...
(assert (= 0. 0.))
; 
; =  {sc.ihill_rep[9].REP} {(sc.ihill_rep[9].Vmax*((sc.ihill_rep[9].Km^2)/(sc.ihill_rep[9].Km^2)))}
(assert (= sc_12 (* sc_11 (/ (^ sc_10 2) (^ sc_10 2)))))
; 
; =  {of.ihill_rep[9].REP} {0.}
(assert (= of_12 0.))
; 
; >=  {((sc.ihill_rep[9].n*2.)+of.ihill_rep[9].n)} {5.}
(assert (<= (+ (* sc_8 2.) of_8) 5.))
; 
; <=  {((sc.ihill_rep[9].n*2.)+of.ihill_rep[9].n)} {1.}
...
; 
; =  {(((sc.ihill_rep[9].S*0.)+of.ihill_rep[9].S)+sl.min.ihill_rep[9].S.1)} {0.}
(assert (= (+ (+ (* sc_9 0.) of_9) slbot_9_1) 0.))
; 
; =  {(((sc.ihill_rep[9].S*100.)+of.ihill_rep[9].S)+sl.max.ihill_rep[9].S.1)} {10.}
...
; 
; =  {(((sc.ihill_rep[9].REP*0.0192115384615)+of.ihill_rep[9].REP)+sl.min.ihill_rep[9].REP.1)} {0.}
(assert (= (+ (+ (* sc_12 0.0192115384615) of_12) slbot_12_1) 0.))
; 
; =  {(((sc.ihill_rep[9].REP*0.4995)+of.ihill_rep[9].REP)+sl.max.ihill_rep[9].REP.1)} {1000000.}
(assert (= (+ (+ (* sc_12 0.4995) of_12) sltop_12_1) 1000000.))
; 
; >=  {((sc.ihill_rep[9].Km*20.)+of.ihill_rep[9].Km)} {10.}
(assert (<= (+ (* sc_10 20.) of_10) 10.))
; 
; <=  {((sc.ihill_rep[9].Km*20.)+of.ihill_rep[9].Km)} {1.}
(assert (>= (+ (* sc_10 20.) of_10) 1.))
; 
; >=  {((sc.ihill_rep[9].Vmax*0.4995)+of.ihill_rep[9].Vmax)} {10.}
(assert (<= (+ (* sc_11 0.4995) of_11) 10.))
; 
; <=  {((sc.ihill_rep[9].Vmax*0.4995)+of.ihill_rep[9].Vmax)} {0.}
...
; 
; =  {(((sc.vdadd[8].A*0.0192115384615)+of.vdadd[8].A)+sl.min.vdadd[8].A.1)} {0.}
(assert (= (+ (+ (* sc_20 0.0192115384615) of_20) slbot_20_1) 0.))
; 
...
; 
; >=  {((sc.vdadd[7].A*0.0005)+of.vdadd[7].A)} {3300.}
(assert (<= (+ (* sc_25 0.0005) of_25) 3300.))
; 
; <=  {((sc.vdadd[7].A*0.0005)+of.vdadd[7].A)} {0.}
...
; 
; =  {(((sc.vdadd[7].B*0.0192115384615)+of.vdadd[7].B)+sl.min.vdadd[7].B.1)} {0.}
(assert (= (+ (+ (* sc_26 0.0192115384615) of_26) slbot_26_1) 0.))
; 
; =  {(((sc.vdadd[7].B*0.4995)+of.vdadd[7].B)+sl.max.vdadd[7].B.1)} {3300.}
...
(assert (= of_31 0.))
; 
; =  {sc.vdadd[11].A} {(1.*sc.vdadd[11].B)}
(assert (= sc_30 (* 1. sc_31)))
; 
; =  {sc.vdadd[11].A} {(1.*sc.vdadd[11].D*sc.vdadd[11].OUT)}
(assert (= sc_30 (* (* 1. sc_28) sc_32)))
; 
; =  {sc.vdadd[11].OUT} {sc.vdadd[11].A}
(assert (= sc_32 sc_30))
; no offset
(assert (= of_32 0.))
; no offset
(assert (= (- (+ of_30 0.) 0.) 0.))
; 
; =  {sc.vdadd[11].OUT_0} {sc.vdadd[11].A}
(assert (= sc_29 sc_30))
; 
; =  {of.vdadd[11].OUT_0} {((of.vdadd[11].A+0.)-0.)}
(assert (= of_29 (- (+ of_30 0.) 0.)))
; 
; >=  {((sc.vdadd[11].D*0.03010299956)+of.vdadd[11].D)} {10.}
(assert (<= (+ (* sc_28 0.03010299956) of_28) 10.))
; 
; <=  {((sc.vdadd[11].D*0.03010299956)+of.vdadd[11].D)} {0.}
...
; 
; =  {(((sc.vdadd[11].OUT*0.)+of.vdadd[11].OUT)+sl.min.vdadd[11].OUT.1)} {0.}
...
; 
; <=  {((sc.vdadd[11].OUT_0*0.)+of.vdadd[11].OUT_0)} {0.}
...
; 
; =  {(((sc.vdadd[11].A*0.)+of.vdadd[11].A)+sl.min.vdadd[11].A.1)} {0.}
(assert (= (+ (+ (* sc_30 0.) of_30) slbot_30_1) 0.))
; 
; =  {(((sc.vdadd[11].A*30.1029995664)+of.vdadd[11].A)+sl.max.vdadd[11].A.1)} {3300.}
(assert (= (+ (+ (* sc_30 30.1029995664) of_30) sltop_30_1) 3300.))
(declare-fun slbot_31_1 () Real)
(assert (<= slbot_31_1 1e-08))
(declare-fun sltop_31_1 () Real)
(assert (>= sltop_31_1 1e-08))
; 
; =  {(((sc.vdadd[11].B*0.)+of.vdadd[11].B)+sl.min.vdadd[11].B.1)} {0.}
(assert (= (+ (+ (* sc_31 0.) of_31) slbot_31_1) 0.))
; 
; =  {(((sc.vdadd[11].B*0.1)+of.vdadd[11].B)+sl.max.vdadd[11].B.1)} {3300.}
(assert (= (+ (+ (* sc_31 0.1) of_31) sltop_31_1) 3300.))
(declare-fun slbot_32_1 () Real)
(assert (<= slbot_32_1 1e-08))
(declare-fun sltop_32_1 () Real)
(assert (>= sltop_32_1 1e-08))
...
; 
; >=  {((sc.vdadd[4].D*0.03010299956)+of.vdadd[4].D)} {10.}
(assert (<= (+ (* sc_33 0.03010299956) of_33) 10.))
; 
; <=  {((sc.vdadd[4].D*0.03010299956)+of.vdadd[4].D)} {0.}
...
; 
; =  {(((sc.vdadd[4].A*0.)+of.vdadd[4].A)+sl.min.vdadd[4].A.1)} {0.}
(assert (= (+ (+ (* sc_35 0.) of_35) slbot_35_1) 0.))
; 
; =  {(((sc.vdadd[4].A*30.1029995664)+of.vdadd[4].A)+sl.max.vdadd[4].A.1)} {3300.}
(assert (= (+ (+ (* sc_35 30.1029995664) of_35) sltop_35_1) 3300.))
; 
; >=  {((sc.vdadd[4].B*0.)+of.vdadd[4].B)} {3300.}
(assert (<= (+ (* sc_36 0.) of_36) 3300.))
; 
; <=  {((sc.vdadd[4].B*0.)+of.vdadd[4].B)} {0.}
...
; 
; >=  {((sc.vdadd[5].D*0.15051499783)+of.vdadd[5].D)} {10.}
(assert (<= (+ (* sc_38 0.15051499783) of_38) 10.))
; 
; <=  {((sc.vdadd[5].D*0.15051499783)+of.vdadd[5].D)} {0.}
...
; 
; =  {(((sc.vdadd[5].A*0.0192115384615)+of.vdadd[5].A)+sl.min.vdadd[5].A.1)} {0.}
(assert (= (+ (+ (* sc_40 0.0192115384615) of_40) slbot_40_1) 0.))
; 
; =  {(((sc.vdadd[5].A*0.4995)+of.vdadd[5].A)+sl.max.vdadd[5].A.1)} {3300.}
(assert (= (+ (+ (* sc_40 0.4995) of_40) sltop_40_1) 3300.))
; 
; >=  {((sc.vdadd[5].B*0.0005)+of.vdadd[5].B)} {3300.}
(assert (<= (+ (* sc_41 0.0005) of_41) 3300.))
; 
; <=  {((sc.vdadd[5].B*0.0005)+of.vdadd[5].B)} {0.}
...
; 
; >=  {((sc.vdadd[1].D*0.03010299956)+of.vdadd[1].D)} {10.}
(assert (<= (+ (* sc_43 0.03010299956) of_43) 10.))
; 
; <=  {((sc.vdadd[1].D*0.03010299956)+of.vdadd[1].D)} {0.}
...
; 
; =  {(((sc.vdadd[1].A*0.)+of.vdadd[1].A)+sl.min.vdadd[1].A.1)} {0.}
(assert (= (+ (+ (* sc_45 0.) of_45) slbot_45_1) 0.))
; 
; =  {(((sc.vdadd[1].A*30.1029995664)+of.vdadd[1].A)+sl.max.vdadd[1].A.1)} {3300.}
(assert (= (+ (+ (* sc_45 30.1029995664) of_45) sltop_45_1) 3300.))
; 
; >=  {((sc.vdadd[1].B*0.)+of.vdadd[1].B)} {3300.}
(assert (<= (+ (* sc_46 0.) of_46) 3300.))
; 
; <=  {((sc.vdadd[1].B*0.)+of.vdadd[1].B)} {0.}
...
; 
; =  {(((sc.output.V[2].X*10.)+of.output.V[2].X)+sl.max.output.V[2].X.1)} {3300.}
(assert (= (+ (+ (* sc_80 10.) of_80) sltop_80_1) 3300.))
...
; 
; =  {(((sc.output.V[2].O*10.)+of.output.V[2].O)+sl.max.output.V[2].O.1)} {3300.}
(assert (= (+ (+ (* sc_81 10.) of_81) sltop_81_1) 3300.))
...
; 
; =  {(((sc.output.V[0].X*10.)+of.output.V[0].X)+sl.max.output.V[0].X.1)} {3300.}
(assert (= (+ (+ (* sc_82 10.) of_82) sltop_82_1) 3300.))
...
; 
; =  {(((sc.output.V[0].O*10.)+of.output.V[0].O)+sl.max.output.V[0].O.1)} {3300.}
(assert (= (+ (+ (* sc_83 10.) of_83) sltop_83_1) 3300.))
...
; 
; =  {(((sc.output.V[3].X*10.)+of.output.V[3].X)+sl.max.output.V[3].X.1)} {3300.}
(assert (= (+ (+ (* sc_84 10.) of_84) sltop_84_1) 3300.))
...
; 
; =  {(((sc.output.V[3].O*10.)+of.output.V[3].O)+sl.max.output.V[3].O.1)} {3300.}
(assert (= (+ (+ (* sc_85 10.) of_85) sltop_85_1) 3300.))
...
; 
; =  {(((sc.input.V[0].X*0.1)+of.input.V[0].X)+sl.max.input.V[0].X.1)} {3300.}
(assert (= (+ (+ (* sc_104 0.1) of_104) sltop_104_1) 3300.))
...
(assert (= (+ (+ (* sc_105 0.) of_105) slbot_105_1) 0.))
; 
; =  {(((sc.input.V[0].O*0.1)+of.input.V[0].O)+sl.max.input.V[0].O.1)} {3300.}
(assert (= (+ (+ (* sc_105 0.1) of_105) sltop_105_1) 3300.))
...
(assert (<= (+ (* sc_116 3.01029995664) of_116) 3300.))
; 
; <=  {((sc.input.V[16].X*3.01029995664)+of.input.V[16].X)} {0.}
(assert (>= (+ (* sc_116 3.01029995664) of_116) 0.))
; 
; >=  {((sc.input.V[16].O*3.01029995664)+of.input.V[16].O)} {3300.}
(assert (<= (+ (* sc_117 3.01029995664) of_117) 3300.))
; 
; <=  {((sc.input.V[16].O*3.01029995664)+of.input.V[16].O)} {0.}
(assert (>= (+ (* sc_117 3.01029995664) of_117) 0.))
...
(assert (<= (+ (* sc_118 2.) of_118) 3300.))
; 
; <=  {((sc.input.V[3].X*2.)+of.input.V[3].X)} {0.}
(assert (>= (+ (* sc_118 2.) of_118) 0.))
; 
; >=  {((sc.input.V[3].O*2.)+of.input.V[3].O)} {3300.}
(assert (<= (+ (* sc_119 2.) of_119) 3300.))
; 
; <=  {((sc.input.V[3].O*2.)+of.input.V[3].O)} {0.}
(assert (>= (+ (* sc_119 2.) of_119) 0.))
...
; 
; =  {(((sc.itov[10].X*0.)+of.itov[10].X)+sl.min.itov[10].X.1)} {0.}
(assert (= (+ (+ (* sc_126 0.) of_126) slbot_126_1) 0.))
; 
; =  {(((sc.itov[10].X*10.)+of.itov[10].X)+sl.max.itov[10].X.1)} {10.}
(assert (= (+ (+ (* sc_126 10.) of_126) sltop_126_1) 10.))
(declare-fun slbot_128_1 () Real)
(assert (<= slbot_128_1 1e-08))
(declare-fun sltop_128_1 () Real)
(assert (>= sltop_128_1 1e-08))
; 
; =  {(((sc.itov[10].Y*0.)+of.itov[10].Y)+sl.min.itov[10].Y.1)} {0.}
(assert (= (+ (+ (* sc_128 0.) of_128) slbot_128_1) 0.))
; 
; =  {(((sc.itov[10].Y*30.1029995664)+of.itov[10].Y)+sl.max.itov[10].Y.1)} {3300.}
(assert (= (+ (+ (* sc_128 30.1029995664) of_128) sltop_128_1) 3300.))
; 
; >=  {((sc.itov[10].K*3.01029995664)+of.itov[10].K)} {330.}
(assert (<= (+ (* sc_127 3.01029995664) of_127) 330.))
; 
; <=  {((sc.itov[10].K*3.01029995664)+of.itov[10].K)} {1.}
...
; 
; =  {(((sc.itov[3].X*10.)+of.itov[3].X)+sl.max.itov[3].X.1)} {10.}
(assert (= (+ (+ (* sc_129 10.) of_129) sltop_129_1) 10.))
...
; 
; =  {(((sc.itov[3].Y*30.1029995664)+of.itov[3].Y)+sl.max.itov[3].Y.1)} {3300.}
(assert (= (+ (+ (* sc_131 30.1029995664) of_131) sltop_131_1) 3300.))
; 
; >=  {((sc.itov[3].K*3.01029995664)+of.itov[3].K)} {330.}
(assert (<= (+ (* sc_130 3.01029995664) of_130) 330.))
; 
; <=  {((sc.itov[3].K*3.01029995664)+of.itov[3].K)} {1.}
...
(assert (>= (+ (* sc_136 3.01029995664) of_136) -10.))
; 
; =  {sc.ihill_rep[2].REP} {sc.vdadd[5].A}
(assert (= sc_7 sc_40))
; 
; =  {of.ihill_rep[2].REP} {of.vdadd[5].A}
(assert (= of_7 of_40))
; 
; =  {sc.input.I[6].O} {sc.vdadd[5].D}
(assert (= sc_65 sc_38))
; 
; =  {of.input.I[6].O} {of.vdadd[5].D}
(assert (= of_65 of_38))
; 
; =  {sc.vdadd[5].OUT} {sc.itov[3].X}
(assert (= sc_42 sc_129))
; 
; =  {of.vdadd[5].OUT} {of.itov[3].X}
(assert (= of_42 of_129))
; 
; =  {sc.vdadd[5].OUT} {sc.output.V[0].X}
(assert (= sc_42 sc_82))
; 
; =  {of.vdadd[5].OUT} {of.output.V[0].X}
(assert (= of_42 of_82))
; 
; =  {sc.input.I[0].O} {sc.ihill_rep[2].Km}
(assert (= sc_59 sc_5))
; 
; =  {of.input.I[0].O} {of.ihill_rep[2].Km}
(assert (= of_59 of_5))
; 
...
(assert (= of_103 of_24))
; 
; =  {sc.vdadd[7].OUT} {sc.vgain[0].X}
(assert (= sc_27 sc_0))
; 
; =  {of.vdadd[7].OUT} {of.vgain[0].X}
(assert (= of_27 of_0))
; 
...
(assert (= of_99 of_21))
; 
; =  {sc.input.I[4].O} {sc.ihill_rep[9].Vmax}
(assert (= sc_71 sc_11))
; 
; =  {of.input.I[4].O} {of.ihill_rep[9].Vmax}
(assert (= of_71 of_11))
; 
; =  {sc.input.I[3].O} {sc.ihill_rep[2].Vmax}
(assert (= sc_69 sc_6))
; 
; =  {of.input.I[3].O} {of.ihill_rep[2].Vmax}
(assert (= of_69 of_6))
; 
...
(assert (= of_73 of_16))
; 
; =  {sc.ihill_rep[9].REP} {sc.vdadd[8].A}
(assert (= sc_12 sc_20))
; 
; =  {of.ihill_rep[9].REP} {of.vdadd[8].A}
(assert (= of_12 of_20))
; 
; =  {sc.input.V[14].O} {sc.vdadd[7].A}
(assert (= sc_115 sc_25))
; 
; =  {of.input.V[14].O} {of.vdadd[7].A}
(assert (= of_115 of_25))
; 
...
(assert (= of_49 of_15))
; 
; =  {sc.input.V[12].O} {sc.vdadd[5].B}
(assert (= sc_101 sc_41))
; 
; =  {of.input.V[12].O} {of.vdadd[5].B}
(assert (= of_101 of_41))
; 
; =  {sc.input.V[2].O} {sc.ihill_rep[9].n}
(assert (= sc_93 sc_8))
; 
; =  {of.input.V[2].O} {of.ihill_rep[9].n}
(assert (= of_93 of_8))
; 
; =  {sc.input.V[3].O} {sc.ihill_rep[6].n}
(assert (= sc_119 sc_13))
; 
; =  {of.input.V[3].O} {of.ihill_rep[6].n}
(assert (= of_119 of_13))
; 
; =  {sc.iadd[0].OUT} {sc.vgain[0].Z}
(assert (= sc_136 sc_1))
; 
; =  {of.iadd[0].OUT} {of.vgain[0].Z}
(assert (= of_136 of_1))
; 
; =  {sc.input.I[12].O} {sc.vdadd[4].D}
(assert (= sc_55 sc_33))
; 
; =  {of.input.I[12].O} {of.vdadd[4].D}
(assert (= of_55 of_33))
; 
; =  {sc.input.I[10].O} {sc.vdadd[1].D}
(assert (= sc_63 sc_43))
; 
; =  {of.input.I[10].O} {of.vdadd[1].D}
(assert (= of_63 of_43))
; 
; =  {sc.input.I[1].O} {sc.ihill_rep[9].Km}
(assert (= sc_75 sc_10))
; 
; =  {of.input.I[1].O} {of.ihill_rep[9].Km}
(assert (= of_75 of_10))
; 
...
(assert (= of_53 of_18))
; 
; =  {sc.input.V[1].O} {sc.ihill_rep[2].n}
(assert (= sc_125 sc_3))
; 
; =  {of.input.V[1].O} {of.ihill_rep[2].n}
(assert (= of_125 of_3))
; 
; =  {sc.vgain[0].P} {sc.vdadd[1].A}
(assert (= sc_2 sc_45))
; 
; =  {of.vgain[0].P} {of.vdadd[1].A}
(assert (= of_2 of_45))
; 
...
(assert (= of_77 of_135))
; 
; =  {sc.input.V[7].O} {sc.vdadd[4].OUT_0}
(assert (= sc_97 sc_34))
; 
; =  {of.input.V[7].O} {of.vdadd[4].OUT_0}
(assert (= of_97 of_34))
; 
...
(assert (= of_51 of_23))
; 
; =  {sc.vdadd[1].OUT} {sc.ihill_rep[9].S}
(assert (= sc_47 sc_9))
; 
; =  {of.vdadd[1].OUT} {of.ihill_rep[9].S}
(assert (= of_47 of_9))
; 
; =  {sc.vdadd[1].OUT} {sc.output.V[4].X}
(assert (= sc_47 sc_86))
; 
; =  {of.vdadd[1].OUT} {of.output.V[4].X}
(assert (= of_47 of_86))
; 
; =  {sc.vdadd[11].OUT} {sc.ihill_rep[2].S}
(assert (= sc_32 sc_4))
; 
; =  {of.vdadd[11].OUT} {of.ihill_rep[2].S}
(assert (= of_32 of_4))
; 
; =  {sc.vdadd[11].OUT} {sc.output.V[1].X}
(assert (= sc_32 sc_90))
; 
; =  {of.vdadd[11].OUT} {of.output.V[1].X}
(assert (= of_32 of_90))
; 
; =  {sc.itov[3].Y} {sc.vdadd[4].A}
(assert (= sc_131 sc_35))
; 
; =  {of.itov[3].Y} {of.vdadd[4].A}
(assert (= of_131 of_35))
; 
; =  {sc.vdadd[8].OUT} {sc.itov[10].X}
(assert (= sc_22 sc_126))
; 
; =  {of.vdadd[8].OUT} {of.itov[10].X}
(assert (= of_22 of_126))
; 
; =  {sc.vdadd[8].OUT} {sc.output.V[2].X}
(assert (= sc_22 sc_80))
; 
; =  {of.vdadd[8].OUT} {of.output.V[2].X}
(assert (= of_22 of_80))
; 
; =  {sc.input.V[10].O} {sc.vdadd[11].OUT_0}
(assert (= sc_109 sc_29))
; 
; =  {of.input.V[10].O} {of.vdadd[11].OUT_0}
(assert (= of_109 of_29))
; 
; =  {sc.input.V[0].O} {sc.vdadd[11].B}
(assert (= sc_105 sc_31))
; 
; =  {of.input.V[0].O} {of.vdadd[11].B}
(assert (= of_105 of_31))
; 
; =  {sc.vdadd[4].OUT} {sc.ihill_rep[6].S}
(assert (= sc_37 sc_14))
; 
; =  {of.vdadd[4].OUT} {of.ihill_rep[6].S}
(assert (= of_37 of_14))
; 
; =  {sc.vdadd[4].OUT} {sc.output.V[5].X}
(assert (= sc_37 sc_88))
; 
; =  {of.vdadd[4].OUT} {of.output.V[5].X}
(assert (= of_37 of_88))
; 
; =  {sc.itov[10].Y} {sc.vdadd[11].A}
(assert (= sc_128 sc_30))
; 
; =  {of.itov[10].Y} {of.vdadd[11].A}
(assert (= of_128 of_30))
; 
; =  {sc.input.V[16].O} {sc.itov[3].K}
(assert (= sc_117 sc_130))
; 
; =  {of.input.V[16].O} {of.itov[3].K}
(assert (= of_117 of_130))
; 
; =  {sc.input.V[4].O} {sc.vdadd[4].B}
(assert (= sc_121 sc_36))
; 
; =  {of.input.V[4].O} {of.vdadd[4].B}
(assert (= of_121 of_36))
; 
; =  {sc.ihill_rep[6].REP} {sc.vdadd[7].B}
(assert (= sc_17 sc_26))
; 
; =  {of.ihill_rep[6].REP} {of.vdadd[7].B}
(assert (= of_17 of_26))
; 
; =  {sc.input.V[5].O} {sc.vdadd[1].B}
(assert (= sc_123 sc_46))
; 
; =  {of.input.V[5].O} {of.vdadd[1].B}
(assert (= of_123 of_46))
; 
; =  {sc.input.V[6].O} {sc.vdadd[1].OUT_0}
(assert (= sc_113 sc_44))
; 
; =  {of.input.V[6].O} {of.vdadd[1].OUT_0}
(assert (= of_113 of_44))
; 
; =  {sc.input.I[11].O} {sc.vdadd[11].D}
(assert (= sc_61 sc_28))
; 
; =  {of.input.I[11].O} {of.vdadd[11].D}
(assert (= of_61 of_28))
(assert (<= (/ 1 sc_83) 1000.))
(assert (<= (* sc_83 1) 1000.))
(assert (not (= 1. sc_83)))
