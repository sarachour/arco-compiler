...
; 
; =  {(((sc.vtoi[4].Y*1.)+of.vtoi[4].Y)+sl.max.vtoi[4].Y)} {3300.}
...
; 
; >=  {((sc.iadd[2].A*0.11)+of.iadd[2].A)} {5.}
(assert (<= (+ (* sc_56 0.11) of_56) 5.))
; 
; <=  {((sc.iadd[2].A*0.11)+of.iadd[2].A)} {0.}
...
(assert (= (+ (+ (* sc_63 -1.) of_63) slbot_63) -10.))
; 
; =  {(((sc.iadd[0].OUT*0.)+of.iadd[0].OUT)+sl.max.iadd[0].OUT)} {10.}
(assert (= (+ (+ (* sc_63 0.) of_63) sltop_63) 10.))
; 
...
(assert (= of_30 of_31))
; 
; =  {sc.input.I[6].O} {sc.iadd[2].B}
(assert (= sc_13 sc_57))
; 
; =  {of.input.I[6].O} {of.iadd[2].B}
(assert (= of_13 of_57))
; 
; =  {sc.input.I[0].O} {sc.iadd[2].A}
(assert (= sc_11 sc_56))
; 
; =  {of.input.I[0].O} {of.iadd[2].A}
(assert (= of_11 of_56))
; 
...
(assert (= of_9 of_55))
; 
; =  {sc.input.V[7].O} {sc.vtoi[4].K}
(assert (= sc_42 sc_35))
; 
; =  {of.input.V[7].O} {of.vtoi[4].K}
(assert (= of_42 of_35))
; 
