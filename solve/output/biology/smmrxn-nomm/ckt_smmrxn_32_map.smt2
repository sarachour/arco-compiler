...
; 
; >=  {((sc.iadd[5].A*0.11)+of.iadd[5].A)} {5.}
(assert (<= (+ (* sc_61 0.11) of_61) 5.))
; 
; <=  {((sc.iadd[5].A*0.11)+of.iadd[5].A)} {0.}
...
(assert (= of_13 of_60))
; 
; =  {sc.input.I[0].O} {sc.iadd[5].A}
(assert (= sc_11 sc_61))
; 
; =  {of.input.I[0].O} {of.iadd[5].A}
(assert (= of_11 of_61))
; 
...
(assert (= of_19 of_65))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[5].D}
(assert (= sc_33 sc_59))
; 
; =  {of.vtoi[0].Y} {of.iadd[5].D}
(assert (= of_33 of_59))
; 
...
(assert (= of_63 of_69))
; 
; =  {sc.iadd[5].OUT} {sc.itov[4].X}
(assert (= sc_63 sc_51))
; 
; =  {of.iadd[5].OUT} {of.itov[4].X}
(assert (= of_63 of_51))
; 
...
(assert (= of_50 of_24))
; 
; =  {sc.input.I[7].O} {sc.iadd[5].B}
(assert (= sc_9 sc_62))
; 
; =  {of.input.I[7].O} {of.iadd[5].B}
(assert (= of_9 of_62))
; 
