...
; 
; =  {(((sc.vtoi[5].Y*-1.)+of.vtoi[5].Y)+sl.min.vtoi[5].Y)} {0.00030303030303}
(assert (= (+ (+ (* sc_36 -1.) of_36) slbot_36) 0.00030303030303))
; 
; =  {(((sc.vtoi[5].Y*0.)+of.vtoi[5].Y)+sl.max.vtoi[5].Y)} {3300.}
(assert (= (+ (+ (* sc_36 0.) of_36) sltop_36) 3300.))
; 
...
(assert (= (+ (+ (* sc_54 1.) of_54) sltop_54) 5.))
; 
...
(assert (= (+ (+ (* sc_58 -1.) of_58) slbot_58) -10.))
; 
; =  {(((sc.iadd[0].OUT*0.)+of.iadd[0].OUT)+sl.max.iadd[0].OUT)} {10.}
(assert (= (+ (+ (* sc_58 0.) of_58) sltop_58) 10.))
; 
...
; 
; >=  {((sc.iadd[6].D*-0.11)+of.iadd[6].D)} {5.}
(assert (<= (+ (* sc_59 -0.11) of_59) 5.))
; 
; <=  {((sc.iadd[6].D*-0.11)+of.iadd[6].D)} {0.}
(assert (>= (+ (* sc_59 -0.11) of_59) 0.))
; 
...
; 
; =  {(((sc.iadd[6].OUT*1.)+of.iadd[6].OUT)+sl.max.iadd[6].OUT)} {10.}
...
; 
; =  {(((sc.iadd[6].B*-1.)+of.iadd[6].B)+sl.min.iadd[6].B)} {0.}
(assert (= (+ (+ (* sc_62 -1.) of_62) slbot_62) 0.))
; 
; =  {(((sc.iadd[6].B*0.)+of.iadd[6].B)+sl.max.iadd[6].B)} {5.}
(assert (= (+ (+ (* sc_62 0.) of_62) sltop_62) 5.))
(declare-fun slbot_63 () Real)
(declare-fun sltop_63 () Real)
; 
; =  {(((sc.iadd[6].OUT*0.)+of.iadd[6].OUT)+sl.min.iadd[6].OUT)} {-10.}
...
; 
; >=  {((sc.iadd[1].D*-0.15)+of.iadd[1].D)} {5.}
(assert (<= (+ (* sc_64 -0.15) of_64) 5.))
; 
; <=  {((sc.iadd[1].D*-0.15)+of.iadd[1].D)} {0.}
...
(assert (= (+ (+ (* sc_67 -1.) of_67) slbot_67) 0.))
; 
; =  {(((sc.iadd[1].B*0.)+of.iadd[1].B)+sl.max.iadd[1].B)} {5.}
(assert (= (+ (+ (* sc_67 0.) of_67) sltop_67) 5.))
(declare-fun slbot_68 () Real)
(declare-fun sltop_68 () Real)
; 
; =  {(((sc.iadd[1].OUT*0.)+of.iadd[1].OUT)+sl.min.iadd[1].OUT)} {-10.}
...
(assert (= of_13 of_60))
; 
; =  {sc.iadd[6].OUT} {sc.output.I[0].X}
(assert (= sc_63 sc_69))
; 
; =  {of.iadd[6].OUT} {of.output.I[0].X}
(assert (= of_63 of_69))
; 
; =  {sc.iadd[6].OUT} {sc.itov[4].X}
(assert (= sc_63 sc_51))
; 
; =  {of.iadd[6].OUT} {of.itov[4].X}
(assert (= of_63 of_51))
; 
...
(assert (= of_11 of_59))
; 
; =  {sc.vtoi[5].Y} {sc.iadd[6].B}
(assert (= sc_36 sc_62))
; 
; =  {of.vtoi[5].Y} {of.iadd[6].B}
(assert (= of_36 of_62))
; 
...
(assert (= of_5 of_57))
; 
; =  {sc.input.V[3].O} {sc.vtoi[5].K}
(assert (= sc_44 sc_35))
; 
; =  {of.input.V[3].O} {of.vtoi[5].K}
(assert (= of_44 of_35))
; 
...
(assert (= of_38 of_27))
; 
; =  {sc.vadd[3].OUT2} {sc.vtoi[6].X}
(assert (= sc_30 sc_31))
; 
; =  {of.vadd[3].OUT2} {of.vtoi[6].X}
(assert (= of_30 of_31))
; 
...
(assert (= of_48 of_0))
; 
; =  {sc.input.V[6].O} {sc.vtoi[6].K}
(assert (= sc_42 sc_32))
; 
; =  {of.input.V[6].O} {of.vtoi[6].K}
(assert (= of_42 of_32))
; 
...
(assert (= sc_30 sc_23))
(assert (= __minima__ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (* (ite (>= sltop_36 0) sltop_36 (- sltop_36)) 1.) (* (ite (>= slbot_29 0) slbot_29 (- slbot_29)) 1.)) (* (ite (>= sltop_72 0) sltop_72 (- sltop_72)) 1.)) (* (ite (>= slbot_22 0) slbot_22 (- slbot_22)) 1.)) (* (ite (>= sltop_23 0) sltop_23 (- sltop_23)) 1.)) (* (ite (>= sltop_52 0) sltop_52 (- sltop_52)) 1.)) (* (ite (>= slbot_72 0) slbot_72 (- slbot_72)) 1.)) (* (ite (>= sltop_70 0) sltop_70 (- sltop_70)) 1.)) (* (ite (>= slbot_3 0) slbot_3 (- slbot_3)) 1.)) (* (ite (>= slbot_53 0) slbot_53 (- slbot_53)) 1.)) (* (ite (>= slbot_63 0) slbot_63 (- slbot_63)) 1.)) (* (ite (>= sltop_28 0) sltop_28 (- sltop_28)) 1.)) (* (ite (>= sltop_54 0) sltop_54 (- sltop_54)) 1.)) (* (ite (>= slbot_2 0) slbot_2 (- slbot_2)) 1.)) (* (ite (>= sltop_67 0) sltop_67 (- sltop_67)) 1.)) (* (ite (>= sltop_71 0) sltop_71 (- sltop_71)) 1.)) (* (ite (>= sltop_29 0) sltop_29 (- sltop_29)) 1.)) (* (ite (>= sltop_58 0) sltop_58 (- sltop_58)) 1.)) (* (ite (>= slbot_31 0) slbot_31 (- slbot_31)) 1.)) (* (ite (>= slbot_36 0) slbot_36 (- slbot_36)) 1.)) (* (ite (>= slbot_71 0) slbot_71 (- slbot_71)) 1.)) (* (ite (>= sltop_22 0) sltop_22 (- sltop_22)) 1.)) (* (ite (>= sltop_2 0) sltop_2 (- sltop_2)) 1.)) (* (ite (>= sltop_31 0) sltop_31 (- sltop_31)) 1.)) (* (ite (>= slbot_28 0) slbot_28 (- slbot_28)) 1.)) (* (ite (>= sltop_62 0) sltop_62 (- sltop_62)) 1.)) (* (ite (>= slbot_67 0) slbot_67 (- slbot_67)) 1.)) (* (ite (>= slbot_62 0) slbot_62 (- slbot_62)) 1.)) (* (ite (>= slbot_52 0) slbot_52 (- slbot_52)) 1.)) (* (ite (>= slbot_54 0) slbot_54 (- slbot_54)) 1.)) (* (ite (>= slbot_51 0) slbot_51 (- slbot_51)) 1.)) (* (ite (>= sltop_51 0) sltop_51 (- sltop_51)) 1.)) (* (ite (>= sltop_34 0) sltop_34 (- sltop_34)) 1.)) (* (ite (>= slbot_30 0) slbot_30 (- slbot_30)) 1.)) (* (ite (>= slbot_68 0) slbot_68 (- slbot_68)) 1.)) (* (ite (>= slbot_70 0) slbot_70 (- slbot_70)) 1.)) (* (ite (>= sltop_30 0) sltop_30 (- sltop_30)) 1.)) (* (ite (>= sltop_53 0) sltop_53 (- sltop_53)) 1.)) (* (ite (>= sltop_68 0) sltop_68 (- sltop_68)) 1.)) (* (ite (>= slbot_23 0) slbot_23 (- slbot_23)) 1.)) (* (ite (>= sltop_69 0) sltop_69 (- sltop_69)) 1.)) (* (ite (>= slbot_34 0) slbot_34 (- slbot_34)) 1.)) (* (ite (>= sltop_63 0) sltop_63 (- sltop_63)) 1.)) (* (ite (>= sltop_3 0) sltop_3 (- sltop_3)) 1.)) (* (ite (>= slbot_58 0) slbot_58 (- slbot_58)) 1.)) (* (ite (>= slbot_69 0) slbot_69 (- slbot_69)) 1.)) (* (ite (>= slbot_33 0) slbot_33 (- slbot_33)) 1.)) (* (ite (>= sltop_33 0) sltop_33 (- sltop_33)) 1.))))
(check-sat)
