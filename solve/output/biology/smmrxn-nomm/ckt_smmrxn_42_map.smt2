...
(assert (= (+ (+ (* sc_33 -1.) of_33) slbot_33) 0.00030303030303))
; 
; =  {(((sc.vtoi[0].Y*0.)+of.vtoi[0].Y)+sl.max.vtoi[0].Y)} {3300.}
(assert (= (+ (+ (* sc_33 0.) of_33) sltop_33) 3300.))
; 
...
; 
; =  {(((sc.vtoi[1].X*1.)+of.vtoi[1].X)+sl.max.vtoi[1].X)} {3300.}
...
; 
; =  {(((sc.vtoi[1].Y*1.)+of.vtoi[1].Y)+sl.max.vtoi[1].Y)} {3300.}
...
(assert (<= (+ (* sc_64 -0.11) of_64) 5.))
; 
; <=  {((sc.iadd[1].D*-0.11)+of.iadd[1].D)} {0.}
(assert (>= (+ (* sc_64 -0.11) of_64) 0.))
; 
...
(assert (= of_15 of_56))
; 
; =  {sc.input.I[4].O} {sc.iadd[2].B}
(assert (= sc_17 sc_57))
; 
; =  {of.input.I[4].O} {of.iadd[2].B}
(assert (= of_17 of_57))
; 
...
(assert (= of_19 of_55))
; 
; =  {sc.vtoi[0].Y} {sc.iadd[1].B}
(assert (= sc_33 sc_67))
; 
; =  {of.vtoi[0].Y} {of.iadd[1].B}
(assert (= of_33 of_67))
; 
; =  {sc.vtoi[1].Y} {sc.iadd[2].D}
(assert (= sc_36 sc_54))
; 
; =  {of.vtoi[1].Y} {of.iadd[2].D}
(assert (= of_36 of_54))
; 
...
(assert (= of_30 of_31))
; 
; =  {sc.input.V[3].O} {sc.vtoi[0].K}
(assert (= sc_44 sc_32))
; 
; =  {of.input.V[3].O} {of.vtoi[0].K}
(assert (= of_44 of_32))
; 
...
(assert (= of_58 of_62))
; 
; =  {sc.input.I[8].O} {sc.iadd[3].D}
(assert (= sc_7 sc_59))
; 
; =  {of.input.I[8].O} {of.iadd[3].D}
(assert (= of_7 of_59))
; 
...
(assert (= of_40 of_1))
; 
; =  {sc.input.V[5].O} {sc.vgain[4].X}
(assert (= sc_48 sc_0))
; 
; =  {of.input.V[5].O} {of.vgain[4].X}
(assert (= of_48 of_0))
; 
; =  {sc.input.V[4].O} {sc.vadd[5].D}
(assert (= sc_46 sc_25))
; 
; =  {of.input.V[4].O} {of.vadd[5].D}
(assert (= of_46 of_25))
; 
