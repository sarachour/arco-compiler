...
(assert (= (+ (+ (* sc_27 -1.) of_27) slbot_27) 0.00030303030303))
; 
; =  {(((sc.vtoi[0].Y*0.)+of.vtoi[0].Y)+sl.max.vtoi[0].Y)} {3300.}
(assert (= (+ (+ (* sc_27 0.) of_27) sltop_27) 3300.))
; 
...
; 
; >=  {((sc.iadd[2].A*0.15)+of.iadd[2].A)} {5.}
(assert (<= (+ (* sc_50 0.15) of_50) 5.))
; 
; <=  {((sc.iadd[2].A*0.15)+of.iadd[2].A)} {0.}
...
(assert (= of_11 of_51))
; 
; =  {sc.input.I[5].O} {sc.iadd[2].A}
(assert (= sc_13 sc_50))
; 
; =  {of.input.I[5].O} {of.iadd[2].A}
(assert (= of_13 of_50))
; 
...
(assert (= of_3 of_46))
; 
; =  {sc.iadd[1].OUT} {sc.itov[5].X}
(assert (= sc_57 sc_45))
; 
; =  {of.iadd[1].OUT} {of.itov[5].X}
(assert (= of_57 of_45))
; 
...
(assert (= of_34 of_1))
; 
; =  {sc.input.V[5].O} {sc.vgain[3].X}
(assert (= sc_42 sc_0))
; 
; =  {of.input.V[5].O} {of.vgain[3].X}
(assert (= of_42 of_0))
; 
