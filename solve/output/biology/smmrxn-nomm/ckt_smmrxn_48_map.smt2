...
(assert (= (+ (+ (* sc_66 1.) of_66) sltop_66) 5.))
...
(assert (= of_42 of_66))
; 
; =  {sc.input.I[2].O} {sc.iadd[0].D}
(assert (= sc_5 sc_65))
; 
; =  {of.input.I[2].O} {of.iadd[0].D}
(assert (= of_5 of_65))
; 
