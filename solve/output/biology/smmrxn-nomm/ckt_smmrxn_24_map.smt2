...
(assert (= of_63 of_71))
; 
; =  {sc.iadd[0].OUT} {sc.vgain[3].Z}
(assert (= sc_63 sc_2))
; 
; =  {of.iadd[0].OUT} {of.vgain[3].Z}
(assert (= of_63 of_2))
; 
...
(assert (= of_9 of_55))
; 
; =  {sc.iadd[2].OUT} {sc.itov[5].X}
(assert (= sc_58 sc_51))
; 
; =  {of.iadd[2].OUT} {of.itov[5].X}
(assert (= of_58 of_51))
; 
...
(assert (= of_40 of_1))
; 
; =  {sc.input.V[5].O} {sc.vtoi[1].K}
(assert (= sc_46 sc_35))
; 
; =  {of.input.V[5].O} {of.vtoi[1].K}
(assert (= of_46 of_35))
; 
