/* $Id: b3set.c,v 3.1 96/12/08 19:59:17 yuhua Release $  */
/* 
$Log:	b3set.c,v $
 ...
 * 
*/
static char rcsid[] = "$Id: b3set.c,v 3.1 96/12/08 19:59:17 yuhua Release $";
	...
	{   /* allocate a chunk of the state vector */
            ...
            *states += BSIM3numStates;
            ...
            if (!here->BSIM3sourceAreaGiven)
                here->BSIM3sourceArea = 0;
            if (!here->BSIM3sourcePerimeterGiven)
                here->BSIM3sourcePerimeter = 0;
            if (!here->BSIM3sourceSquaresGiven)
                here->BSIM3sourceSquares = 1;
            if (!here->BSIM3wGiven)
                here->BSIM3w = 5e-6;
