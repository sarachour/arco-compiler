/* $Id: b3temp.c,v 3.1 96/12/08 19:59:49 yuhua Release $  */
/* 
$Log:	b3temp.c,v $
 ...
 * 
*/
static char rcsid[] = "$Id: b3temp.c,v 3.1 96/12/08 19:59:49 yuhua Release $";
    ...
    {    Temp = ckt->CKTtemp;
	 ...
	 {    pSizeDependParamKnot = model->pSizeDependParamKnot;
		  ...
		  {   IFuid namarray[2];
                      namarray[0] = model->BSIM3modName;
                      namarray[1] = here->BSIM3name;
                      (*(SPfrontEnd->IFerror)) (ERR_FATAL, "Fatal error(s) detected during BSIM3V3 parameter checking for %s in model %s", namarray);
                      return(E_BADPARM);   
		  }
